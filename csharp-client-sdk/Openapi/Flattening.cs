...
namespace Openapi
{
    ...
    public interface IFlattening
    {
        ...
        Task<RequiredBodyAllOptionalResponse> RequiredBodyAllOptionalAsync(ObjWithOptionalProperties request);
    }
    ...
    public class Flattening: IFlattening
    {
        ...
        public async Task<RequiredBodyAllOptionalResponse> RequiredBodyAllOptionalAsync(ObjWithOptionalProperties request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<RequiredBodyAllOptionalRes>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
