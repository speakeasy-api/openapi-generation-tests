...
namespace Openapi
{
    ...
    public interface IGeneration
    {
        ...
        Task<DecimalParamWithDefaultResponse> DecimalParamWithDefaultAsync(decimal decimalInput = 903275809834567300000M);
        ...
        /// </summary>
        Task<DeprecatedOperationWithMultilineCommentGetResponse> DeprecatedOperationWithMultilineCommentGetAsync(string? deprecatedParameter = null, string? newParameter = null);
    ...
    public class Generation: IGeneration
    {
        ...
        public async Task<DecimalParamWithDefaultResponse> DecimalParamWithDefaultAsync(decimal decimalInput = 903275809834567300000M)
        {
        ...
        [Obsolete("This method will be removed in a future release, please migrate away from it as soon as possible. Use SimplePathParameterObjects instead")]
        public async Task<DeprecatedOperationWithMultilineCommentGetResponse> DeprecatedOperationWithMultilineCommentGetAsync(string? deprecatedParameter = null, string? newParameter = null)
        {
            var request = new DeprecatedOperationWithMultilineCommentGetRequest()
            {
                DeprecatedParameter = deprecatedParameter,
                NewParameter = newParameter,
            };
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/anything/deprecatedOperationWithMultilineComment", request);
            ...
            var hookCtx = new HookContext("deprecatedOperationWithMultilineCommentGet", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {                
                return new DeprecatedOperationWithMultilineCommentGetResponse()
                {
                    StatusCode = responseStatusCode,
                    ContentType = contentType,
                    RawResponse = httpResponse
        ...
        public async Task<UsageExamplePostResponse> UsageExamplePostAsync(UsageExamplePostSecurity security, UsageExamplePostRequest request)
        {
            ...
            var hookCtx = new HookContext("usageExamplePost", null, () => security);
