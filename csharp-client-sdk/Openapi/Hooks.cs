...
namespace Openapi
{
    ...
    {
        Task<AuthorizationHeaderModificationResponse> AuthorizationHeaderModificationAsync(AuthorizationHeaderModificationSecurity security);
    ...
    public class Hooks: IHooks
    {
        ...
        public async Task<AuthorizationHeaderModificationResponse> AuthorizationHeaderModificationAsync(AuthorizationHeaderModificationSecurity security)
        {
            ...
            if((response.StatusCode == 200))
            {
                ...
                {
                    response.Token = JsonConvert.DeserializeObject<AuthorizationHeaderModificationToken>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
