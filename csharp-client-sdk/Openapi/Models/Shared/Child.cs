    ...
    public class Child {
        ...
        public class ChildConverter : JsonConverter
        {
            ...
            { 
                ...
                try
                {
                    OneOfCircularReferenceObject? oneOfCircularReferenceObject = JsonConvert.DeserializeObject<OneOfCircularReferenceObject>(json, new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, MissingMemberHandling = MissingMemberHandling.Error, Converters = Utilities.GetJsonConverters(typeof(OneOfCircularReferenceObject), "string")});
