    ...
    public class ExampleVehicle {
        ...
        public class ExampleVehicleConverter : JsonConverter
        {
            ...
            { 
                ...
                try
                {
                    ExampleBoat? exampleBoat = JsonConvert.DeserializeObject<ExampleBoat>(json, new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, MissingMemberHandling = MissingMemberHandling.Error, Converters = Utilities.GetJsonConverters(typeof(ExampleBoat), "string")});
                ...
                try
                {
                    ExampleCar? exampleCar = JsonConvert.DeserializeObject<ExampleCar>(json, new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, MissingMemberHandling = MissingMemberHandling.Error, Converters = Utilities.GetJsonConverters(typeof(ExampleCar), "string")});
