    ...
    public class StronglyTypedOneOfDiscriminatedObject {
        ...
        public class StronglyTypedOneOfDiscriminatedObjectConverter : JsonConverter
        {
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                {
                    TaggedObject1? taggedObject1 = ResponseBodyDeserializer.Deserialize<TaggedObject1>(jo.ToString(), missingMemberHandling: MissingMemberHandling.Error);
                ...
                {
                    TaggedObject2? taggedObject2 = ResponseBodyDeserializer.Deserialize<TaggedObject2>(jo.ToString(), missingMemberHandling: MissingMemberHandling.Error);
                ...
                {
                    TaggedObject3? taggedObject3 = ResponseBodyDeserializer.Deserialize<TaggedObject3>(jo.ToString(), missingMemberHandling: MissingMemberHandling.Error);
