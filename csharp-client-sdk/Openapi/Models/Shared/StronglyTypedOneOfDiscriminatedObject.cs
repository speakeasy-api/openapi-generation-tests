...
namespace Openapi.Models.Shared
{
    ...
    public class StronglyTypedOneOfDiscriminatedObject {
        ...
        public static StronglyTypedOneOfDiscriminatedObject CreateTag1(TaggedObject1 tag1) {
            ...
            tag1.Tag = TagExtension.ToEnum(StronglyTypedOneOfDiscriminatedObjectType.Tag1.ToString());
        ...
        public static StronglyTypedOneOfDiscriminatedObject CreateTag3(TaggedObject3 tag3) {
            ...
            string typStr = StronglyTypedOneOfDiscriminatedObjectType.Tag3.ToString();
        ...
        public class StronglyTypedOneOfDiscriminatedObjectConverter : JsonConverter
        {
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                {
                    TaggedObject1? taggedObject1 = JsonConvert.DeserializeObject<TaggedObject1>(jo.ToString(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, MissingMemberHandling = MissingMemberHandling.Error, Converters = Utilities.GetJsonConverters(typeof(TaggedObject1), "string")});
                    return new StronglyTypedOneOfDiscriminatedObject(StronglyTypedOneOfDiscriminatedObjectType.Tag1) {
                        TaggedObject1 = taggedObject1,
                    };
                }
                if (discriminator == StronglyTypedOneOfDiscriminatedObjectType.Tag2.ToString())
                {
                    TaggedObject2? taggedObject2 = JsonConvert.DeserializeObject<TaggedObject2>(jo.ToString(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, MissingMemberHandling = MissingMemberHandling.Error, Converters = Utilities.GetJsonConverters(typeof(TaggedObject2), "string")});
                    return new StronglyTypedOneOfDiscriminatedObject(StronglyTypedOneOfDiscriminatedObjectType.Tag2) {
                        TaggedObject2 = taggedObject2,
                    };
                }
                if (discriminator == StronglyTypedOneOfDiscriminatedObjectType.Tag3.ToString())
                {
                    TaggedObject3? taggedObject3 = JsonConvert.DeserializeObject<TaggedObject3>(jo.ToString(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, MissingMemberHandling = MissingMemberHandling.Error, Converters = Utilities.GetJsonConverters(typeof(TaggedObject3), "string")});
                    return new StronglyTypedOneOfDiscriminatedObject(StronglyTypedOneOfDiscriminatedObjectType.Tag3) {
