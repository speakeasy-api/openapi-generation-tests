    ...
    public class StronglyTypedOneOfObject {
        ...
        public class StronglyTypedOneOfObjectConverter : JsonConverter
        {
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                {
                    SimpleObjectWithType? simpleObjectWithType = JsonConvert.DeserializeObject<SimpleObjectWithType>(jo.ToString(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, MissingMemberHandling = MissingMemberHandling.Error, Converters = Utilities.GetJsonConverters(typeof(SimpleObjectWithType), "string")});
                    return new StronglyTypedOneOfObject(StronglyTypedOneOfObjectType.SimpleObjectWithType) {
                        SimpleObjectWithType = simpleObjectWithType,
                    };
                }
                if (discriminator == StronglyTypedOneOfObjectType.DeepObjectWithType.ToString())
                {
                    DeepObjectWithType? deepObjectWithType = JsonConvert.DeserializeObject<DeepObjectWithType>(jo.ToString(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, MissingMemberHandling = MissingMemberHandling.Error, Converters = Utilities.GetJsonConverters(typeof(DeepObjectWithType), "string")});
                    return new StronglyTypedOneOfObject(StronglyTypedOneOfObjectType.DeepObjectWithType) {
