    ...
    public class StronglyTypedOneOfObject {
        ...
        public class StronglyTypedOneOfObjectConverter : JsonConverter
        {
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                {
                    SimpleObjectWithType? simpleObjectWithType = ResponseBodyDeserializer.Deserialize<SimpleObjectWithType>(jo.ToString(), missingMemberHandling: MissingMemberHandling.Error);
                ...
                {
                    DeepObjectWithType? deepObjectWithType = ResponseBodyDeserializer.Deserialize<DeepObjectWithType>(jo.ToString(), missingMemberHandling: MissingMemberHandling.Error);
