    ...
    public class StronglyTypedOneOfObjectWithNonStandardDiscriminatorName {
        ...
        public class StronglyTypedOneOfObjectWithNonStandardDiscriminatorNameConverter : JsonConverter
        {
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                {
                    SimpleObjectWithNonStandardTypeName? simpleObjectWithNonStandardTypeName = ResponseBodyDeserializer.Deserialize<SimpleObjectWithNonStandardTypeName>(jo.ToString());
                    return CreateSimpleObjectWithNonStandardTypeName(simpleObjectWithNonStandardTypeName!);
                }
                if (discriminator == StronglyTypedOneOfObjectWithNonStandardDiscriminatorNameType.DeepObjectWithNonStandardTypeName.ToString())
                {
                    DeepObjectWithNonStandardTypeName? deepObjectWithNonStandardTypeName = ResponseBodyDeserializer.Deserialize<DeepObjectWithNonStandardTypeName>(jo.ToString());
                    return CreateDeepObjectWithNonStandardTypeName(deepObjectWithNonStandardTypeName!);
                }
