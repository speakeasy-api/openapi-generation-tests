    ...
    public class StronglyTypedOneOfObjectWithNonStandardDiscriminatorName {
        ...
        public class StronglyTypedOneOfObjectWithNonStandardDiscriminatorNameConverter : JsonConverter
        {
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                {
                    SimpleObjectWithNonStandardTypeName? simpleObjectWithNonStandardTypeName = ResponseBodyDeserializer.Deserialize<SimpleObjectWithNonStandardTypeName>(jo.ToString(), missingMemberHandling: MissingMemberHandling.Error);
                ...
                {
                    DeepObjectWithNonStandardTypeName? deepObjectWithNonStandardTypeName = ResponseBodyDeserializer.Deserialize<DeepObjectWithNonStandardTypeName>(jo.ToString(), missingMemberHandling: MissingMemberHandling.Error);
