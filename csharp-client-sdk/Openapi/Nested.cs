...
namespace Openapi
{
    ...
    public class Nested: INested
    {
        ...
        public Nested(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
            ...
            First = new SDKNestedFirst(_defaultClient, _securityClient, _serverUrl, SDKConfiguration);
            Second = new SDKSecond(_defaultClient, _securityClient, _serverUrl, SDKConfiguration);
        }
