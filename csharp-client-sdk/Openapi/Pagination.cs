...
namespace Openapi
{
    ...
    public class Pagination: IPagination
    {
        ...
        */
        ...
        /**
        * PaginationCursorNonNumericServerList contains the list of server urls available to the SDK.
        */
        ...
        */
        ...
        /**
        * PaginationURLParamsServerList contains the list of server urls available to the SDK.
        */
        ...
        public async Task<PaginationCursorNonNumericResponse> PaginationCursorNonNumericAsync(string? cursor = null, string? serverUrl = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.Res = JsonConvert.DeserializeObject<PaginationCursorNonNumericRes>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<PaginationURLParamsResponse> PaginationURLParamsAsync(long attempts, string? isReferencePath = null, string? serverUrl = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.Res = JsonConvert.DeserializeObject<PaginationURLParamsRes>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
