...
namespace Openapi
{
    ...
    public interface IPagination
    {
        ...
        Task<PaginationLimitOffsetDefaultOffsetParamsResponse> PaginationLimitOffsetDefaultOffsetParamsAsync(long? limit = 15, long? offset = 10, string? serverUrl = null);
        ...
        Task<PaginationWithRetriesResponse> PaginationWithRetriesAsync(string? cursor = null, string? faultSettings = "{\"error_code\": 503, \"error_count\": 3}", string? requestId = "paginationWithRetries", string? serverUrl = null, RetryConfig? retryConfig = null);
    ...
    public class Pagination: IPagination
    {
        ...
        public async Task<PaginationLimitOffsetDefaultOffsetParamsResponse> PaginationLimitOffsetDefaultOffsetParamsAsync(long? limit = 15, long? offset = 10, string? serverUrl = null)
        {
        ...
        public async Task<PaginationWithRetriesResponse> PaginationWithRetriesAsync(string? cursor = null, string? faultSettings = "{\"error_code\": 503, \"error_count\": 3}", string? requestId = "paginationWithRetries", string? serverUrl = null, RetryConfig? retryConfig = null)
        {
