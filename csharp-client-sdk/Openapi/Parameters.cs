...
namespace Openapi
{
    ...
    public interface IParameters
    {
        ...
        Task<HeaderParamsNilResponse> HeaderParamsNilAsync(HeaderParamsNilRequest request);
    ...
    public class Parameters: IParameters
    {
        ...
        public Parameters(ISpeakeasyHttpClient client, Func<Openapi.Models.Shared.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<FormQueryParamsArrayResponse> FormQueryParamsArrayAsync(List<string>? arrParam = null, List<long>? arrParamExploded = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<FormQueryParamsArrayRes>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
        ...
        public async Task<FormQueryParamsMapResponse> FormQueryParamsMapAsync(Dictionary<string, string>? mapParam = null, Dictionary<string, long>? mapParamExploded = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<FormQueryParamsMapRes>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
        ...
        public async Task<FormQueryParamsRefParamObjectResponse> FormQueryParamsRefParamObjectAsync(RefQueryParamObj? refObjParam = null, RefQueryParamObjExploded? refObjParamExploded = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<FormQueryParamsRefParamObjectRes>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
        ...
        public async Task<HeaderParamsNilResponse> HeaderParamsNilAsync(HeaderParamsNilRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();

            var urlString = baseUrl + "/anything/headers/nil";
            ...
            var hookCtx = new HookContext("headerParamsNil", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<HeaderParamsNilRes>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var response = new HeaderParamsNilResponse()
                    {
                        StatusCode = responseStatusCode,
                        ContentType = contentType,
                        RawResponse = httpResponse
        ...
        public async Task<PipeDelimitedQueryParamsArrayResponse> PipeDelimitedQueryParamsArrayAsync(List<string>? arrParam = null, List<long>? arrParamExploded = null, Dictionary<string, string>? mapParam = null, SimpleObject? objParam = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<PipeDelimitedQueryParamsArrayRes>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
