...
namespace Openapi
{
    ...
    public interface IParameters
    {
        ...
        Task<PathEncodingResponse> PathEncodingAsync(string param1, string param2);
    ...
    public class Parameters: IParameters
    {
        ...
        public async Task<PathEncodingResponse> PathEncodingAsync(string param1, string param2)
        {
            var request = new PathEncodingRequest()
            {
                Param1 = param1,
                Param2 = param2,
            };
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/pathencoding/{param1}/{param2}", request);
            ...
            var hookCtx = new HookContext("pathEncoding", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {                
                return new PathEncodingResponse()
                {
                    StatusCode = responseStatusCode,
                    ContentType = contentType,
                    RawResponse = httpResponse
