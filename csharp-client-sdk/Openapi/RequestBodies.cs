...
namespace Openapi
{
    ...
    public class RequestBodies: IRequestBodies
    {
        ...
        private const string _userAgent = "speakeasy-sdk/csharp 0.4.0 2.286.4 0.1.0 openapi";
        ...
        public async Task<NullEnumPostResponse> NullEnumPostAsync(ObjectWithNullEnums request)
        {
            ...
            if((response.StatusCode == 200))
            {
                ...
                {
                    response.Res = JsonConvert.DeserializeObject<NullEnumPostRes>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<NullableObjectPostResponse> NullableObjectPostAsync(NullableObject? request = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.Res = JsonConvert.DeserializeObject<NullableObjectPostRes>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Include, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<NullableRequiredEmptyObjectPostResponse> NullableRequiredEmptyObjectPostAsync(NullableRequiredEmptyObjectPostRequestBody request)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.Object = JsonConvert.DeserializeObject<NullableRequiredEmptyObjectPostResponseBody>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<NullableRequiredPropertyPostResponse> NullableRequiredPropertyPostAsync(NullableRequiredPropertyPostRequestBody request)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.Object = JsonConvert.DeserializeObject<NullableRequiredPropertyPostResponseBody>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<NullableRequiredSharedObjectPostResponse> NullableRequiredSharedObjectPostAsync(NullableRequiredSharedObjectPostRequestBody request)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.Object = JsonConvert.DeserializeObject<NullableRequiredSharedObjectPostResponseBody>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<RequestBodyPostJsonDataTypesComplexNumberArraysResponse> RequestBodyPostJsonDataTypesComplexNumberArraysAsync(ComplexNumberArrays request)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.Res = JsonConvert.DeserializeObject<RequestBodyPostJsonDataTypesComplexNumberArraysRes>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<RequestBodyPostJsonDataTypesComplexNumberMapsResponse> RequestBodyPostJsonDataTypesComplexNumberMapsAsync(ComplexNumberMaps request)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.Res = JsonConvert.DeserializeObject<RequestBodyPostJsonDataTypesComplexNumberMapsRes>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<RequestBodyPostNotNullableNotRequiredStringBodyResponse> RequestBodyPostNotNullableNotRequiredStringBodyAsync(string? request = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.Object = JsonConvert.DeserializeObject<RequestBodyPostNotNullableNotRequiredStringBodyResponseBody>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Include, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<RequestBodyPostNullableNotRequiredStringBodyResponse> RequestBodyPostNullableNotRequiredStringBodyAsync(string? request = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.Object = JsonConvert.DeserializeObject<RequestBodyPostNullableNotRequiredStringBodyResponseBody>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Include, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<RequestBodyPostNullableRequiredStringBodyResponse> RequestBodyPostNullableRequiredStringBodyAsync(string? request = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.Object = JsonConvert.DeserializeObject<RequestBodyPostNullableRequiredStringBodyResponseBody>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Include, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<RequestBodyPutMultipartOptionalRequestBodyResponse> RequestBodyPutMultipartOptionalRequestBodyAsync(RequestBodyPutMultipartOptionalRequestBodyRequestBody? request = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.Res = JsonConvert.DeserializeObject<RequestBodyPutMultipartOptionalRequestBodyRes>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Include, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<RequestBodyReadOnlyUnionResponse> RequestBodyReadOnlyUnionAsync(WeaklyTypedOneOfReadOnlyObjectInput request, string? serverUrl = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.WeaklyTypedOneOfReadOnlyObject = JsonConvert.DeserializeObject<WeaklyTypedOneOfReadOnlyObject>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<RequestBodyReadWriteOnlyUnionResponse> RequestBodyReadWriteOnlyUnionAsync(WeaklyTypedOneOfReadWriteObject request, string? serverUrl = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.WeaklyTypedOneOfReadWriteObject = JsonConvert.DeserializeObject<WeaklyTypedOneOfReadWriteObjectOutput>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<RequestBodyWriteOnlyUnionResponse> RequestBodyWriteOnlyUnionAsync(WeaklyTypedOneOfWriteOnlyObject request, string? serverUrl = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.WeaklyTypedOneOfWriteOnlyObject = JsonConvert.DeserializeObject<WeaklyTypedOneOfWriteOnlyObjectOutput>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
