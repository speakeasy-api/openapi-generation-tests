...
namespace Openapi
{
    ...
    {
        Task<CreateFileResponse> CreateFileAsync(CreateFileRequestBody? request = null);
    ...
    public class Resource: IResource
    {
        ...
        public async Task<CreateFileResponse> CreateFileAsync(CreateFileRequestBody? request = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<FileResource>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
