...
namespace Openapi
{
    ...
    {
        /**
        * RetriesAfterServerList contains the list of server urls available to the SDK.
        */
        ...
        /**
        * RetriesConnectErrorGetServerList contains the list of server urls available to the SDK.
        */
