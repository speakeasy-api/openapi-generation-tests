...
namespace Openapi
{
    ...
    public interface ISDK
    {
        ...
        /// </summary>
        Task<AmbiguousQueryParamResponse> AmbiguousQueryParamAsync(Console console);
    ...
    public class SDK: ISDK
    {
        ...
        public async Task<AmbiguousQueryParamResponse> AmbiguousQueryParamAsync(Console console)
        {
