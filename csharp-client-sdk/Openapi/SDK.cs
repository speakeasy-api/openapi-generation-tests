...
namespace Openapi
{
    ...
    public interface ISDK
    {
        ...
        Task<PostAdditionalPropertiesWithNullableFieldsResponse> PostAdditionalPropertiesWithNullableFieldsAsync(PostAdditionalPropertiesWithNullableFieldsRequestBody request);
    ...
    public class SDK: ISDK
    {
        ...
        public SDK(Openapi.Models.Shared.Security? security = null, Func<Openapi.Models.Shared.Security>? securitySource = null, bool? globalHeaderParam = null, string? globalHiddenHeaderParam = null, string? globalHiddenPathParam = null, string? globalHiddenQueryParam = null, long? globalPathParam = null, string? globalQueryParam = null, int? serverIndex = null, string?  hostname = null, string?  port = null, ServerSomething? something = null, string?  protocol = null, string? serverUrl = null, Dictionary<string, string>? urlParams = null, ISpeakeasyHttpClient? client = null, RetryConfig? retryConfig = null)
        {
            if (serverIndex != null)
            {
        ...
        public async Task<AuthenticatedRequestResponse> AuthenticatedRequestAsync(AuthenticatedRequestSecurity security, AuthenticatedRequestRequestBody? request = null)
        {
            ...
            Func<AuthenticatedRequestSecurity>? securitySource = null;
            if (security != null)
            {
            ...
            var hookCtx = new HookContext("authenticatedRequest", null, securitySource);
        ...
        public async Task<PostAdditionalPropertiesWithNullableFieldsResponse> PostAdditionalPropertiesWithNullableFieldsAsync(PostAdditionalPropertiesWithNullableFieldsRequestBody request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<PostAdditionalPropertiesWithNullableFieldsResponseBody>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
