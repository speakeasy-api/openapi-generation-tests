...
namespace Openapi
{
    ...
    public class SDK: ISDK
    {
        ...
        public SDK(Security? security = null, long? globalPathParam = null, string? globalQueryParam = null, int? serverIndex = null, string?  hostname = null, ServerSomething? something = null, string?  protocol = null, string?  port = null, string? serverUrl = null, Dictionary<string, string>? urlParams = null, ISpeakeasyHttpClient? client = null)
        {
            if (serverUrl != null) {
                if (urlParams != null) {
