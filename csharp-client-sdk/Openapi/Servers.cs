...
namespace Openapi
{
    ...
    public interface IServers
    {
        ...
        Task<ServersOverrideGlobalServerURLResponse> ServersOverrideGlobalServerURLAsync();
        Task<ServersOverrideOperationServerURLResponse> ServersOverrideOperationServerURLAsync(string? serverUrl = null);
    }
    ...
    public class Servers: IServers
    {
        ...
        /// <summary>
        /// Server identifiers available for the serversOverrideOperationServerURL operation.
        /// </summary>
        ...
        /// <summary>
        /// Server URLs available for the serversOverrideOperationServerURL operation.
        /// </summary>
        public static readonly Dictionary<ServersOverrideOperationServerURLServers, string> ServersOverrideOperationServerURLServerMap = new Dictionary<ServersOverrideOperationServerURLServers, string>()
        {
            { ServersOverrideOperationServerURLServers.Main, "{protocol}://{hostname}:{port}/{base_path}" },
        };
        ...
        public async Task<ServersOverrideGlobalServerURLResponse> ServersOverrideGlobalServerURLAsync()
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();

            var urlString = baseUrl + "/ping#serversOverrideGlobalServerURL";
            ...
            var hookCtx = new HookContext("serversOverrideGlobalServerURL", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {                
                return new ServersOverrideGlobalServerURLResponse()
                {
                    StatusCode = responseStatusCode,
                    ContentType = contentType,
                    RawResponse = httpResponse
        ...
        public async Task<ServersOverrideOperationServerURLResponse> ServersOverrideOperationServerURLAsync(string? serverUrl = null)
        {
            string baseUrl = Utilities.TemplateUrl(ServersOverrideOperationServerURLServerMap[ServersOverrideOperationServerURLServers.Main], new Dictionary<string, string>(){
            ...
            var urlString = baseUrl + "/ping#serversOverrideOperationServerURL";
            ...
            var hookCtx = new HookContext("serversOverrideOperationServerURL", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {                
                return new ServersOverrideOperationServerURLResponse()
                {
                    StatusCode = responseStatusCode,
                    ContentType = contentType,
                    RawResponse = httpResponse
