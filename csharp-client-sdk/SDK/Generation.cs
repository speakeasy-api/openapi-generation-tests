...
namespace SDK
{
    ...
    public interface IGenerationSDK
    {
        ...
        Task<IgnoresPostResponse> IgnoresPostAsync(IgnoresPostApplicationJSON requestBody, string? testParam = null);
        Task<NameOverrideGetResponse> NameOverrideAsync(NameOverrideGetEnumNameOverride testEnumQueryParam, string testQueryParam);
        ...
        Task<TypedParameterGenerationGetResponse> TypedParameterGenerationGetAsync(BigInteger? bigint = null, LocalDate? date = null, decimal? decimalP = null, TypedParameterGenerationGetObj? obj = null);
    ...
    public class GenerationSDK: IGenerationSDK
    {
        ...
        public async Task<AnchorTypesGetResponse> AnchorTypesGetAsync()
        {
            ...
            if((response.StatusCode == 200))
            {
                ...
                {
                    response.TypeFromAnchor = JsonConvert.DeserializeObject<TypeFromAnchor>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<GetGlobalNameOverrideResponse> GlobalNameOverriddenAsync()
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.GetGlobalNameOverride200ApplicationJSONObject = JsonConvert.DeserializeObject<GetGlobalNameOverride200ApplicationJSON>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<IgnoredGenerationGetResponse> IgnoredGenerationGetAsync()
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.IgnoredGenerationGet200ApplicationJSONObject = JsonConvert.DeserializeObject<IgnoredGenerationGet200ApplicationJSON>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<IgnoresPostResponse> IgnoresPostAsync(IgnoresPostApplicationJSON requestBody, string? testParam = null)
        {
        ...
        public async Task<NameOverrideGetResponse> NameOverrideAsync(NameOverrideGetEnumNameOverride testEnumQueryParam, string testQueryParam)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.OverriddenResponse = JsonConvert.DeserializeObject<OverriddenResponse>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
        ...
        public async Task<TypedParameterGenerationGetResponse> TypedParameterGenerationGetAsync(BigInteger? bigint = null, LocalDate? date = null, decimal? decimalP = null, TypedParameterGenerationGetObj? obj = null)
        {
        ...
        public async Task<UsageExamplePostResponse> UsageExamplePostAsync(UsageExamplePostSecurity security, UsageExamplePostRequest? request = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.UsageExamplePost200ApplicationJSONObject = JsonConvert.DeserializeObject<UsageExamplePost200ApplicationJSON>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
