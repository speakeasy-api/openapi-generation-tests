...
namespace SDK
{
    ...
    public class ResourceSDK: IResourceSDK
    {
        ...
        public ResourceSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
