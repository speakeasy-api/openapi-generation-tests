...
public class ServersShould
{
    ...
    public async Task SelectGlobalServerValid()
    {
        ...
        string url = "http://127.0.0.1:35123";
        var sdk = new SDK(serverUrl: url);

        Assert.Equal(url, sdk.SDKConfiguration.GetTemplatedServerDetails());
    ...
    public async Task SelectServerWithIDValid()
    {
        ...
        var res = await sdk.Servers.SelectServerWithIDAsync(
            serverUrl: Servers.SelectServerWithIDServerMap[Servers.SelectServerWithIDServers.Valid]
        );
