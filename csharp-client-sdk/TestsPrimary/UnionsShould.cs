...
public class UnionsShould
{
    ...
    public async Task StronglyTypedOneOfPost_Basic()
    {
        ...
        Assert.Equal(StronglyTypedOneOfObjectType.SimpleObjectWithType, res.Res.Json.Type.ToString());
    ...
    public async Task CollectionOneOfPost()
    {
        ...
        var req = CollectionOneOfObject.CreateArrayOfAny(
            new List<object>
            {
                "one", "two"
            }
    ...
    public async Task StronglyTypedOneOfPostWithNonStandardDiscriminatorName()
    {
        ...
        Assert.Equal(200, res.StatusCode);
        Assert.Equal(StronglyTypedOneOfObjectWithNonStandardDiscriminatorNameType.SimpleObjectWithNonStandardTypeName, res.Res.Json.Type.ToString());
    ...
    public async Task NullableOneOfTypeInObject()
    {
        ...
        foreach (var test in tests)
        {
            ...
            var res = await s.Unions.NullableOneOfTypeInObjectPostAsync((NullableOneOfTypeInObject)req);
            Assert.Equal(200, res.StatusCode);
    ...
    public async Task DateTimeBigintUnion()
    {
        ...
        var req = UnionDateTimeBigIntRequestBody.CreateDateTime(System.DateTime.Parse("2020-01-01T00:00:00Z").ToUniversalTime());
        ...
        var nextRes = await s.Unions.UnionDateTimeBigIntAsync(UnionDateTimeBigIntRequestBody.CreateBigint(9007199254740991));
