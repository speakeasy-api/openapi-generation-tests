...
public class ServersShould
{
    ...
    public async Task SelectGlobalServerByNameWithTemplatesValid()
    {
        ...
        Assert.Equal("http://127.0.0.1:35123", sdk.SDKConfiguration.GetTemplatedServerDetails());
    ...
    public async Task SelectGlobalServerByNameWithTemplatesBroken()
    {
        ...
        Assert.Equal("http://broken:12345", sdk.SDKConfiguration.GetTemplatedServerDetails());
