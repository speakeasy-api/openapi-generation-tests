...
public class ErrorsShould
{
    ...
    public async Task TestStatusGetError_DefaultErrorCodes()
    {
        ...
        var ex = await Assert.ThrowsAsync<APIException>(() => sdk.Errors.StatusGetErrorAsync(400));
        Assert.Equal(HttpStatusCode.BadRequest, ex.Response.StatusCode);

        var ex2 = await Assert.ThrowsAsync<APIException>(() => sdk.Errors.StatusGetErrorAsync(500));
