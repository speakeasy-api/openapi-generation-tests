...
var res = await sdk.Generation.TypedParameterGenerationGetAsync(Bigint: 879275, Date: LocalDate.FromDateTime(System.DateTime.Parse("2024-11-18")), Decimal: 3346.96M, Obj: new Obj() {
    Bool = false,
    Num = 4778.06D,
    Str = "string",
});
