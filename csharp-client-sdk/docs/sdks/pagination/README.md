...
var res = await sdk.Pagination.PaginationEncapsulatedParameterAsync(req);
...
var res = await sdk.Pagination.PaginationLimitOffsetDefaultOffsetBodyAsync(req);
...
var res = await sdk.Pagination.PaginationLimitOffsetOptionalPageParamsAsync(page: 624091);
