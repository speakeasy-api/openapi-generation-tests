...
NullableRequiredPropertyPostRequestBody req = new NullableRequiredPropertyPostRequestBody() {
    ...
    NullableRequiredDateTime = System.DateTime.Parse("2025-07-13T08:11:28.024Z"),
...
RequestBodyPostApplicationJsonArrayOfUnionsRequestBody req = new RequestBodyPostApplicationJsonArrayOfUnionsRequestBody() {
    Dates = new List<LocalDate>() {
        LocalDate.FromDateTime(System.DateTime.Parse("2023-11-15")),
    },
...
byte[] req = System.Text.Encoding.UTF8.GetBytes("0xDFED6bCc5A");

var res = await sdk.RequestBodies.RequestBodyPostWildcardAsync(req);
...
byte[] req = System.Text.Encoding.UTF8.GetBytes("0x5bF1f34D13");
...
var res = await sdk.RequestBodies.RequestBodyPutBytesWithParamsAsync(
    requestBody: System.Text.Encoding.UTF8.GetBytes("0xCBc4b0D930"),
...
RequestBodyPutMultipartFileRefRequestBody req = new RequestBodyPutMultipartFileRefRequestBody() {};

var res = await sdk.RequestBodies.RequestBodyPutMultipartFileRefAsync(req);
