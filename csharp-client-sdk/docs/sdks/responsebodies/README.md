...
FlattenedEnvelopePaginationResponseResponse? res = await sdk.ResponseBodies.FlattenedEnvelopePaginationResponseAsync(cursor: "<value>");
...
var res = await sdk.ResponseBodies.ResponseBodies2xxJSONObjectAllOptionalPropertiesAsync();
...
ObjWithObjAdditionalProperties req = new ObjWithObjAdditionalProperties() {
    ...
    Datetime = System.DateTime.Parse("2024-11-12T16:06:00.892Z"),
