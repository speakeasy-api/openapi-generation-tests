...
StronglyTypedOneOfObject req = StronglyTypedOneOfObject.CreateDeepObjectWithType(
    new DeepObjectWithType() {
        Any = DeepObjectWithTypeAny.CreateStr(
            "anyOf[0]"
        ),
...
List<UnionOfArrays> req = new List<UnionOfArrays>() {
    new UnionOfArrays() {
        Foo = "<value>",
    },
};
...
| Parameter                                                   | Type                                                        | Required                                                    | Description                                                 |
| ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- |
| `request`                                                   | List<[UnionOfArrays](../../Models/Shared/UnionOfArrays.md)> | :heavy_check_mark:                                          | The request object to use for the request.                  |
