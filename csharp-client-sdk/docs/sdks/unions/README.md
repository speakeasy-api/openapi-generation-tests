...
UnionBigIntDecimalRequestBody req = Operations.CreateUnionBigIntDecimalRequestBodyDecimal(
9001.32M,
);
...
| Parameter                                                                                 | Type                                                                                      | Required                                                                                  | Description                                                                               |
| ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| `request`                                                                                 | [UnionBigIntDecimalRequestBody](../../Models/Operations/UnionBigIntDecimalRequestBody.md) | :heavy_check_mark:                                                                        | The request object to use for the request.                                                |
