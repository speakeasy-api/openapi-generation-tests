...
var res = await sdk.Unions.FlattenedTypedObjectPostAsync("Legacy");
...
var res = await sdk.Unions.MixedTypeOneOfPostAsync("SAS");
...
var res = await sdk.Unions.NullableOneOfSchemaPostAsync("deliquesce");
...
var res = await sdk.Unions.PrimitiveTypeOneOfPostAsync("Grocery");
...
var res = await sdk.Unions.StronglyTypedOneOfPostAsync("spicy");
...
var res = await sdk.Unions.TypedObjectNullableOneOfPostAsync("Agender");
...
var res = await sdk.Unions.TypedObjectOneOfPostAsync("shrivel");
...
var res = await sdk.Unions.WeaklyTypedOneOfPostAsync("Unbranded");
