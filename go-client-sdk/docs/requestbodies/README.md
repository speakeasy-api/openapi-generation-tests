...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONArray(ctx, []shared.SimpleObject{
        shared.SimpleObject{
            ...
            BigintStr: types.MustBigIntFromString("557369"),
            Bool: true,
    ...
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONArrayOfMap(ctx, []map[string]shared.SimpleObject{
        map[string]shared.SimpleObject{
            ...
            "recusandae": shared.SimpleObject{
                Any: "aperiam",
                Bigint: big.NewInt(715179),
                BigintStr: types.MustBigIntFromString("799796"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONDeep(ctx, shared.DeepObject{
        ...
        Arr: []shared.SimpleObject{
            shared.SimpleObject{
                Any: "molestiae",
                Bigint: big.NewInt(35362),
                BigintStr: types.MustBigIntFromString("783648"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
            ...
            shared.SimpleObject{
                Any: "praesentium",
                Bigint: big.NewInt(159867),
                BigintStr: types.MustBigIntFromString("536178"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
        ...
        Obj: shared.SimpleObject{
            Any: "et",
            Bigint: big.NewInt(456911),
            BigintStr: types.MustBigIntFromString("910545"),
            Bool: true,
            BoolOpt: sdk.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONMap(ctx, map[string]shared.SimpleObject{
        ...
        "sit": shared.SimpleObject{
            Any: "culpa",
            Bigint: big.NewInt(731398),
            BigintStr: types.MustBigIntFromString("240020"),
            Bool: true,
            BoolOpt: sdk.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONMapObj(ctx, map[string]shared.SimpleObject{
        "minus": shared.SimpleObject{
            Any: "quaerat",
            Bigint: big.NewInt(959167),
            BigintStr: types.MustBigIntFromString("232865"),
            Bool: true,
            BoolOpt: sdk.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONMapOfArray(ctx, map[string][]shared.SimpleObject{
        "a": []shared.SimpleObject{
            shared.SimpleObject{
                Any: "quas",
                Bigint: big.NewInt(457223),
                BigintStr: types.MustBigIntFromString("97468"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
            ...
            shared.SimpleObject{
                ...
                BigintStr: types.MustBigIntFromString("85001"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
            ...
            shared.SimpleObject{
                Any: "similique",
                Bigint: big.NewInt(633608),
                BigintStr: types.MustBigIntFromString("398434"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
        ...
        "earum": []shared.SimpleObject{
            shared.SimpleObject{
                Any: "in",
                Bigint: big.NewInt(258684),
                BigintStr: types.MustBigIntFromString("727697"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
            ...
            shared.SimpleObject{
                ...
                BigintStr: types.MustBigIntFromString("958983"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
        ...
        "reprehenderit": []shared.SimpleObject{
            ...
            shared.SimpleObject{
                ...
                BigintStr: types.MustBigIntFromString("929292"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONMapOfMap(ctx, map[string]map[string]shared.SimpleObject{
        "tenetur": map[string]shared.SimpleObject{
            "at": shared.SimpleObject{
                Any: "et",
                Bigint: big.NewInt(454162),
                BigintStr: types.MustBigIntFromString("55965"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
        ...
        "consectetur": map[string]shared.SimpleObject{
        ...
        "eum": map[string]shared.SimpleObject{
            "ab": shared.SimpleObject{
                Any: "corrupti",
                Bigint: big.NewInt(251941),
                BigintStr: types.MustBigIntFromString("32465"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
            ...
            "dicta": shared.SimpleObject{
                ...
                BigintStr: types.MustBigIntFromString("244651"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostFormDeep(ctx, shared.DeepObject{
        Any: shared.SimpleObject{
            Any: "in",
            Bigint: big.NewInt(348519),
            BigintStr: types.MustBigIntFromString("937285"),
            Bool: true,
            BoolOpt: sdk.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
        ...
        Arr: []shared.SimpleObject{
            shared.SimpleObject{
                ...
                BigintStr: types.MustBigIntFromString("697142"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
            ...
            shared.SimpleObject{
                ...
                BigintStr: types.MustBigIntFromString("992012"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
            ...
            shared.SimpleObject{
                Any: "amet",
                Bigint: big.NewInt(105906),
                BigintStr: types.MustBigIntFromString("489509"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
        ...
        Int: 916727,
        Map: map[string]shared.SimpleObject{
            "vitae": shared.SimpleObject{
                Any: "accusamus",
                Bigint: big.NewInt(631126),
                BigintStr: types.MustBigIntFromString("272437"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
            ...
            "minus": shared.SimpleObject{
                Any: "dolores",
                Bigint: big.NewInt(503934),
                BigintStr: types.MustBigIntFromString("449292"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
        ...
        Obj: shared.SimpleObject{
            Any: "temporibus",
            Bigint: big.NewInt(351870),
            BigintStr: types.MustBigIntFromString("237742"),
            Bool: true,
            BoolOpt: sdk.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostFormSimple(ctx, shared.SimpleObject{
        Any: "pariatur",
        Bigint: big.NewInt(519643),
        BigintStr: types.MustBigIntFromString("940210"),
        Bool: true,
        BoolOpt: sdk.Bool(true),
        Date: types.MustDateFromString("2020-01-01"),
        DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostMultipleContentTypesComponentFiltered(ctx, shared.SimpleObject{
        Any: "sit",
        Bigint: big.NewInt(699575),
        BigintStr: types.MustBigIntFromString("148829"),
        Bool: true,
        BoolOpt: sdk.Bool(true),
        Date: types.MustDateFromString("2020-01-01"),
        DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.RequestBodies.RequestBodyPutBytes(ctx, []byte("sapiente"))
    if err != nil {
        log.Fatal(err)
    }
    ...
    res, err := s.RequestBodies.RequestBodyPutMultipartDeep(ctx, shared.DeepObject{
        ...
        Arr: []shared.SimpleObject{
            ...
            shared.SimpleObject{
                ...
                BigintStr: types.MustBigIntFromString("975752"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
        ...
        Map: map[string]shared.SimpleObject{
            "facilis": shared.SimpleObject{
                Any: "quaerat",
                Bigint: big.NewInt(277773),
                BigintStr: types.MustBigIntFromString("373035"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
            ...
            "sit": shared.SimpleObject{
                Any: "nobis",
                Bigint: big.NewInt(625637),
                BigintStr: types.MustBigIntFromString("333507"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
            ...
            "reiciendis": shared.SimpleObject{
                ...
                BigintStr: types.MustBigIntFromString("48690"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
        ...
        Obj: shared.SimpleObject{
            Any: "in",
            Bigint: big.NewInt(889234),
            BigintStr: types.MustBigIntFromString("104627"),
            Bool: true,
            BoolOpt: sdk.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPutMultipartSimple(ctx, shared.SimpleObject{
        Any: "voluptatum",
        Bigint: big.NewInt(622385),
        BigintStr: types.MustBigIntFromString("944708"),
        Bool: true,
        BoolOpt: sdk.Bool(true),
        Date: types.MustDateFromString("2020-01-01"),
        DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.RequestBodies.RequestBodyPutString(ctx, "neque")
    if err != nil {
        log.Fatal(err)
    }
