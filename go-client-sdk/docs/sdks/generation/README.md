...
func main() {
    ...
    res, err := s.Generation.UsageExamplePost(ctx, operations.UsageExamplePostRequest{
        ...
        BigintParameter: big.NewInt(569663),
        BigintStrParameter: big.NewInt(352778),
        BoolParameter: true,
        DateParameter: types.MustDateFromString("2022-11-22"),
        DateTimeDefaultParameter: types.MustTimeFromString("2022-07-01T07:46:46.050Z"),
        DateTimeParameter: types.MustTimeFromString("2024-10-20T01:22:27.683Z"),
        DecimalParameter: types.MustNewDecimalFromString("1062.86"),
        DecimalStrParameter: types.MustNewDecimalFromString("2346.83"),
