...
func main() {
    ...
    operationSecurity := operations.AuthorizationHeaderModificationSecurity{
            APIKeyAuth: "Token YOUR_API_KEY",
        }

    ctx := context.Background()
    res, err := s.Hooks.AuthorizationHeaderModification(ctx, operationSecurity)
    if err != nil {
        log.Fatal(err)
    }
...
| `security`                                                                                                                   | [operations.AuthorizationHeaderModificationSecurity](../../pkg/models/operations/authorizationheadermodificationsecurity.md) | :heavy_check_mark:                                                                                                           | The security requirements to use for the request.                                                                            |
