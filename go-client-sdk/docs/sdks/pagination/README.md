...
func main() {
    ...
    res, err := s.Pagination.PaginationCursorBody(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res.Res != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Pagination.PaginationCursorNonNumeric(ctx, cursor)
    if err != nil {
        log.Fatal(err)
    }
    if res.Res != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Pagination.PaginationLimitOffsetDeepOutputsPageBody(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res.Res != nil {
...
func main() {
    ...
    request := shared.LimitOffsetConfig{}
    ctx := context.Background()
    res, err := s.Pagination.PaginationLimitOffsetOffsetBody(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res.Res != nil {
...
func main() {
    ...
    var limit *int64 = openapi.Int64(661976)

    var offset *int64 = openapi.Int64(600173)
    ctx := context.Background()
...
func main() {
    ...
    request := shared.LimitOffsetConfig{}
    ctx := context.Background()
    res, err := s.Pagination.PaginationLimitOffsetPageBody(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res.Res != nil {
...
func main() {
    ...
    var attempts int64 = 778920

    var isReferencePath *string = openapi.String("<value>")
    ctx := context.Background()
    res, err := s.Pagination.PaginationURLParams(ctx, attempts, isReferencePath)
    if err != nil {
        log.Fatal(err)
    }
    if res.Res != nil {
