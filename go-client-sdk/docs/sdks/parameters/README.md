...
func main() {
    ...
    res, err := s.Parameters.DeepObjectQueryParamsDeepObject(ctx, shared.DeepObjectQueryParams{
        ...
        Oneof: openapi.Pointer(shared.CreateOneofStr(
            "test",
        )),
        Oneofnestedobject: openapi.Pointer(shared.CreateOneofnestedobjectTwo(
            shared.Two{
                Nested: openapi.String("test"),
            },
        )),
        Str: "test",
    })
...
func main() {
    ...
    res, err := s.Parameters.HeaderParamsNil(ctx, operations.HeaderParamsNilRequest{
        NullableHeader: openapi.String("<value>"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| `ctx`                                                                                      | [context.Context](https://pkg.go.dev/context#Context)                                      | :heavy_check_mark:                                                                         | The context to use for the request.                                                        |
| `request`                                                                                  | [operations.HeaderParamsNilRequest](../../pkg/models/operations/headerparamsnilrequest.md) | :heavy_check_mark:                                                                         | The request object to use for the request.                                                 |
| `opts`                                                                                     | [][operations.Option](../../pkg/models/operations/option.md)                               | :heavy_minus_sign:                                                                         | The options for this request.                                                              |

### Response

**[*operations.HeaderParamsNilResponse](../../pkg/models/operations/headerparamsnilresponse.md), error**
