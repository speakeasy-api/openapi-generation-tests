...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostJSONDataTypesArrayDate(ctx, []types.Date{
        types.MustDateFromString("2023-03-22"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.RequestBodies.RequestBodyPostJSONDataTypesDate(ctx, types.MustDateFromString("2023-03-04"))
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.RequestBodies.RequestBodyPostJSONDataTypesDateTime(ctx, types.MustTimeFromString("2024-03-03T18:54:52.196Z"))
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostJSONDataTypesMapDateTime(ctx, map[string]time.Time{
        "key": types.MustTimeFromString("2023-09-04T08:15:28.024Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPutMultipartOptionalRequestBody(ctx, &operations.RequestBodyPutMultipartOptionalRequestBodyRequestBody{
        SampleFile: &operations.SampleFile{
            Content: []byte("0xEEdefEf24a"),
