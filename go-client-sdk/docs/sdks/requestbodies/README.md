...
func main() {
    ...
    ctx := context.Background()
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONArrayOfUnions(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    var request any = os.Open("example.file")
    ctx := context.Background()
...
func main() {
    ...
    var requestBody any = os.Open("example.file")
