...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPutMultipartDeep(ctx, shared.DeepObject{
        ...
        Arr: []shared.SimpleObject{
            shared.SimpleObject{
                Any: "harum",
                Bigint: big.NewInt(192718),
                BigintStr: types.MustBigIntFromString("987349"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
                Decimal: sdk.Float64(9180.92),
                Enum: shared.EnumTwo,
                Float32: 2.2222222,
                Int: 999999,
                Int32: 1,
            ...
            shared.SimpleObject{
                Any: "nemo",
                Bigint: big.NewInt(455898),
                BigintStr: types.MustBigIntFromString("501063"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
                Decimal: sdk.Float64(6423.52),
                Enum: shared.EnumTwo,
                Float32: 2.2222222,
                Int: 999999,
                Int32: 1,
        ...
        Map: map[string]shared.SimpleObject{
            "incidunt": shared.SimpleObject{
                Any: "quasi",
                Bigint: big.NewInt(524380),
                BigintStr: types.MustBigIntFromString("851854"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
                Decimal: sdk.Float64(1173.8),
                Enum: shared.EnumTwo,
                Float32: 2.2222222,
                Int: 999999,
                Int32: 1,
            ...
            "consectetur": shared.SimpleObject{
                Any: "aperiam",
                Bigint: big.NewInt(585432),
                BigintStr: types.MustBigIntFromString("970732"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
                Decimal: sdk.Float64(7468.37),
                Enum: shared.EnumTwo,
                Float32: 2.2222222,
                Int: 999999,
                Int32: 1,
            ...
            "eos": shared.SimpleObject{
                Any: "occaecati",
                Bigint: big.NewInt(612867),
                BigintStr: types.MustBigIntFromString("170099"),
                Bool: true,
                BoolOpt: sdk.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
                Decimal: sdk.Float64(813.69),
                Enum: shared.EnumTwo,
                Float32: 2.2222222,
                Int: 999999,
                Int32: 1,
        ...
        Obj: shared.SimpleObject{
            Any: "distinctio",
            Bigint: big.NewInt(608593),
            BigintStr: types.MustBigIntFromString("966390"),
            Bool: true,
            BoolOpt: sdk.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
            Decimal: sdk.Float64(3283.79),
            Enum: shared.EnumTwo,
            Float32: 2.2222222,
            Int: 999999,
            Int32: 1,
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPutMultipartSimple(ctx, shared.SimpleObject{
        Any: "itaque",
        Bigint: big.NewInt(415608),
        BigintStr: types.MustBigIntFromString("520761"),
        Bool: true,
        BoolOpt: sdk.Bool(true),
        Date: types.MustDateFromString("2020-01-01"),
        DateTime: types.MustTimeFromString("2020-01-01T00:00:00Z"),
        Decimal: sdk.Float64(9366.18),
        Enum: shared.EnumTwo,
        Float32: 2.2222222,
        Int: 999999,
        Int32: 1,
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.RequestBodies.RequestBodyPutString(ctx, "vero")
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    requestBody := "voluptatem"
    queryStringParam := "ipsam"
