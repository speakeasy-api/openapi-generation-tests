...
func main() {
    ...
    res, err := s.Retries.RetriesAfter(ctx, requestID, nil, nil)
    if err != nil {
        log.Fatal(err)
    }
    if res.Retries != nil {
...
func main() {
    ...
    var requestID string = "<value>"
    ctx := context.Background()
    res, err := s.Retries.RetriesFlatEmptyResponsePost(ctx, requestID, nil, nil)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    var requestID string = "<value>"
    ctx := context.Background()
    res, err := s.Retries.RetriesGet(ctx, requestID, nil)
    if err != nil {
        log.Fatal(err)
    }
    if res.Retries != nil {
...
func main() {
    ...
    var requestID string = "<value>"
    ctx := context.Background()
    res, err := s.Retries.RetriesPost(ctx, requestID, nil, nil)
    if err != nil {
        log.Fatal(err)
    }
    if res.Retries != nil {
