...
func main() {
    ...
    ctx := context.Background()
    res, err := s.IgnoredGenerationPut(ctx, "<value>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.MultilineExample(ctx, &operations.MultilineExampleRequestBody{
        Message: "hello\n" +
        "there!",
    })
    if err != nil {
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ctx`                                                                                                                                                    | [context.Context](https://pkg.go.dev/context#Context)                                                                                                    | :heavy_check_mark:                                                                                                                                       | The context to use for the request.                                                                                                                      |
| `request`                                                                                                                                                | [operations.PostAdditionalPropertiesWithNullableFieldsRequestBody](../../pkg/models/operations/postadditionalpropertieswithnullablefieldsrequestbody.md) | :heavy_check_mark:                                                                                                                                       | The request object to use for the request.                                                                                                               |
| `opts`                                                                                                                                                   | [][operations.Option](../../pkg/models/operations/option.md)                                                                                             | :heavy_minus_sign:                                                                                                                                       | The options for this request.                                                                                                                            |

### Response

**[*operations.PostAdditionalPropertiesWithNullableFieldsResponse](../../pkg/models/operations/postadditionalpropertieswithnullablefieldsresponse.md), error**
