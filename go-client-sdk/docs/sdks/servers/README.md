...
func main() {
    ...
    res, err := s.Servers.ServersOverrideGlobalServerURL(ctx)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
**[*operations.ServersOverrideGlobalServerURLResponse](../../pkg/models/operations/serversoverrideglobalserverurlresponse.md), error**
...
func main() {
    ...
    res, err := s.Servers.ServersOverrideOperationServerURL(ctx)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
**[*operations.ServersOverrideOperationServerURLResponse](../../pkg/models/operations/serversoverrideoperationserverurlresponse.md), error**
