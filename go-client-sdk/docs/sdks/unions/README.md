...
func main() {
    ...
    res, err := s.Unions.ConstDiscriminatedOneOf(ctx, shared.CreateConstDiscriminatedOneOfTag2(
        shared.ConstObject2{
            ProfileID: "<id>",
        },
    ))
...
func main() {
    ...
    res, err := s.Unions.DiscriminatedOneMultipleMembershipsHasWheels(ctx, shared.CreateHasWheelsFour(
        shared.Car{},
    ))
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Unions.NullableOneOfRefInObjectPost(ctx, shared.NullableOneOfRefInObject{
        ...
        NullableOneOfTwo: openapi.Pointer(shared.CreateNullableOneOfTwoTypedObject2(
            shared.TypedObject2{
...
func main() {
    ...
    res, err := s.Unions.NullableOneOfSchemaPost(ctx, openapi.Pointer(operations.CreateNullableOneOfSchemaPostRequestBodyTypedObject2(
        shared.TypedObject2{
            Type: shared.TypedObject2TypeObj2,
            Value: "<value>",
        },
...
func main() {
    ...
    res, err := s.Unions.NullableOneOfTypeInObjectPost(ctx, shared.NullableOneOfTypeInObject{
        ...
        NullableOneOfTwo: openapi.Pointer(shared.CreateNullableOneOfTypeInObjectNullableOneOfTwoInteger(
            895897,
        )),
        OneOfOne: false,
    })
...
func main() {
    ...
    res, err := s.Unions.StronglyTypedOneOfDiscriminatedPost(ctx, shared.CreateStronglyTypedOneOfDiscriminatedObjectTag1(
...
func main() {
    ...
    res, err := s.Unions.TypedObjectNullableOneOfPost(ctx, openapi.Pointer(shared.CreateTypedObjectNullableOneOfTypedObject2(
        shared.TypedObject2{
            Type: shared.TypedObject2TypeObj2,
            Value: "<value>",
        },
...
func main() {
    ...
    res, err := s.Unions.UnionBigIntStrDecimal(ctx, operations.CreateUnionBigIntStrDecimalRequestBodyDecimal(
        types.MustNewDecimalFromString("2045.56"),
    ))
    if err != nil {
        log.Fatal(err)
    }
