...
func (s *Documentation) GetDocumentationPerLanguage(ctx context.Context, language string, opts ...operations.Option) (*operations.GetDocumentationPerLanguageResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/docs/per-language-docs")
	if err != nil {
