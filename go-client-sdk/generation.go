...
func (s *generation) TypedParameterGenerationGet(ctx context.Context, bigint *big.Int, date *types.Date, obj *operations.TypedParameterGenerationGetObj) (*operations.TypedParameterGenerationGetResponse, error) {
