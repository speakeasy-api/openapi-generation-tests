...
func (s *Hooks) AuthorizationHeaderModification(ctx context.Context, security operations.AuthorizationHeaderModificationSecurity) (*operations.AuthorizationHeaderModificationResponse, error) {
