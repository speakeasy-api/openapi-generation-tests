...
func (s *Parameters) JSONQueryParamsObjectSmaller(ctx context.Context, deepObjParam shared.DeepObjectSmaller, simpleObjParam shared.SimpleObject) (*operations.JSONQueryParamsObjectSmallerResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
