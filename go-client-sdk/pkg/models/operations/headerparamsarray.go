...
type HeaderParamsArrayHeaders struct {
	XHeaderArray string `json:"X-Header-Array"`
}

func (o *HeaderParamsArrayHeaders) GetXHeaderArray() string {
	if o == nil {
		return ""
	}
	return o.XHeaderArray
...
type HeaderParamsArrayRes struct {
	Headers HeaderParamsArrayHeaders `json:"headers"`
}

func (o *HeaderParamsArrayRes) GetHeaders() HeaderParamsArrayHeaders {
	if o == nil {
		return HeaderParamsArrayHeaders{}
	}
	return o.Headers
}
