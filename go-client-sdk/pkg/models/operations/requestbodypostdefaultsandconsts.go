...
type RequestBodyPostDefaultsAndConstsResponseBody struct {
	JSON shared.DefaultsAndConsts `json:"json"`
}

func (o *RequestBodyPostDefaultsAndConstsResponseBody) GetJSON() shared.DefaultsAndConsts {
	if o == nil {
		return shared.DefaultsAndConsts{}
	}
	return o.JSON
}
