...
func (o *RequestBodyPostMultipleContentTypesSplitFormRes) GetForm() map[string]any {
	if o == nil {
		return nil
	}
	return o.Form
...
func (o *RequestBodyPostMultipleContentTypesSplitFormRes) GetJSON() map[string]any {
	if o == nil {
		return nil
	}
	return o.JSON
