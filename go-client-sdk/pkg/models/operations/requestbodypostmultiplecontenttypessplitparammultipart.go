...
func (o *RequestBodyPostMultipleContentTypesSplitParamMultipartRes) GetForm() map[string]any {
	if o == nil {
		return nil
	}
	return o.Form
...
func (o *RequestBodyPostMultipleContentTypesSplitParamMultipartRes) GetJSON() map[string]any {
	if o == nil {
		return nil
	}
	return o.JSON
