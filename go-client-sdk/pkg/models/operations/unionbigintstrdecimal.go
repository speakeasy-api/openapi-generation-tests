...
func (u *UnionBigIntStrDecimalRequestBody) UnmarshalJSON(data []byte) error {
	...
	return fmt.Errorf("could not unmarshal `%s` into any supported union types for UnionBigIntStrDecimalRequestBody", string(data))
}
...
func (u UnionBigIntStrDecimalRequestBody) MarshalJSON() ([]byte, error) {
	...
	return nil, errors.New("could not marshal union type UnionBigIntStrDecimalRequestBody: all fields are null")
}
...
func (u *UnionBigIntStrDecimalJSON) UnmarshalJSON(data []byte) error {
	...
	return fmt.Errorf("could not unmarshal `%s` into any supported union types for UnionBigIntStrDecimalJSON", string(data))
}
...
func (u UnionBigIntStrDecimalJSON) MarshalJSON() ([]byte, error) {
	...
	return nil, errors.New("could not marshal union type UnionBigIntStrDecimalJSON: all fields are null")
}
