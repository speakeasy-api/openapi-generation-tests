...
func (u *UnionDateTimeBigIntRequestBody) UnmarshalJSON(data []byte) error {
	...
	return fmt.Errorf("could not unmarshal `%s` into any supported union types for UnionDateTimeBigIntRequestBody", string(data))
}
...
func (u UnionDateTimeBigIntRequestBody) MarshalJSON() ([]byte, error) {
	...
	return nil, errors.New("could not marshal union type UnionDateTimeBigIntRequestBody: all fields are null")
}
...
func (u *UnionDateTimeBigIntJSON) UnmarshalJSON(data []byte) error {
	...
	return fmt.Errorf("could not unmarshal `%s` into any supported union types for UnionDateTimeBigIntJSON", string(data))
}
...
func (u UnionDateTimeBigIntJSON) MarshalJSON() ([]byte, error) {
	...
	return nil, errors.New("could not marshal union type UnionDateTimeBigIntJSON: all fields are null")
}
