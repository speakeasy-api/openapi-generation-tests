...
type UnionNestedEnumsFormRequestBody struct {
	NestedEnumArray *shared.NestedEnumArray `queryParam:"inline"`
	NestedEnumMap   *shared.NestedEnumMap   `queryParam:"inline"`
...
type UnionNestedEnumsFormRes struct {
	Form map[string]any `json:"form"`
}

func (o *UnionNestedEnumsFormRes) GetForm() map[string]any {
	if o == nil {
...
func (o *UnionNestedEnumsFormResponse) GetRes() *UnionNestedEnumsFormRes {
	if o == nil {
		return nil
	}
	return o.Res
