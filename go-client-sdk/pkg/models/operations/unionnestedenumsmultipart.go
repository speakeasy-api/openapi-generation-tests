...
type Enums struct {
	ArrayOfEnum []shared.Enum          `queryParam:"inline"`
	MapOfEnum   map[string]shared.Enum `queryParam:"inline"`
...
type UnionNestedEnumsMultipartRes struct {
	Form map[string]any `json:"form"`
}

func (o *UnionNestedEnumsMultipartRes) GetForm() map[string]any {
	if o == nil {
...
type UnionNestedEnumsMultipartResponse struct {
	...
	// OK
	Res *UnionNestedEnumsMultipartRes
}
...
func (o *UnionNestedEnumsMultipartResponse) GetRes() *UnionNestedEnumsMultipartRes {
	if o == nil {
		return nil
	}
	return o.Res
