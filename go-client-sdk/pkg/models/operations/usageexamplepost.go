...
type UsageExamplePostRequestBody struct {
	...
	FakerCamelCasePropertyNameStrings shared.FakerCamelCasePropertyNameStrings `json:"fakerCamelCasePropertyNameStrings"`
	// A set of strings with format values that lead to relevant examples being generated for them
	FakerFormattedStrings shared.FakerFormattedStrings `json:"fakerFormattedStrings"`
	// A set of strings with kebob case fieldnames that lead to relevant examples being generated for them
	FakerKebobCasePropertyNameStrings shared.FakerKebobCasePropertyNameStrings `json:"fakerKebobCasePropertyNameStrings"`
	// A set of strings with pascal case fieldnames that lead to relevant examples being generated for them
	FakerPascalCasePropertyNameStrings shared.FakerPascalCasePropertyNameStrings `json:"fakerPascalCasePropertyNameStrings"`
	// A set of strings with snake case fieldnames that lead to relevant examples being generated for them
	FakerSnakeCasePropertyNameStrings shared.FakerSnakeCasePropertyNameStrings `json:"fakerSnakeCasePropertyNameStrings"`
	// A simple object that uses all our supported primitive types and enums and has optional properties.
	SimpleObject shared.SimpleObject `json:"simpleObject"`
}

func (o *UsageExamplePostRequestBody) GetFakerCamelCasePropertyNameStrings() shared.FakerCamelCasePropertyNameStrings {
	if o == nil {
		return shared.FakerCamelCasePropertyNameStrings{}
	}
	return o.FakerCamelCasePropertyNameStrings
}

func (o *UsageExamplePostRequestBody) GetFakerFormattedStrings() shared.FakerFormattedStrings {
	if o == nil {
		return shared.FakerFormattedStrings{}
	}
	return o.FakerFormattedStrings
}

func (o *UsageExamplePostRequestBody) GetFakerKebobCasePropertyNameStrings() shared.FakerKebobCasePropertyNameStrings {
	if o == nil {
		return shared.FakerKebobCasePropertyNameStrings{}
	}
	return o.FakerKebobCasePropertyNameStrings
}

func (o *UsageExamplePostRequestBody) GetFakerPascalCasePropertyNameStrings() shared.FakerPascalCasePropertyNameStrings {
	if o == nil {
		return shared.FakerPascalCasePropertyNameStrings{}
	}
	return o.FakerPascalCasePropertyNameStrings
}

func (o *UsageExamplePostRequestBody) GetFakerSnakeCasePropertyNameStrings() shared.FakerSnakeCasePropertyNameStrings {
	if o == nil {
		return shared.FakerSnakeCasePropertyNameStrings{}
	}
	return o.FakerSnakeCasePropertyNameStrings
}
...
func (o *UsageExamplePostJSON) GetFakerCamelCasePropertyNameStrings() shared.FakerCamelCasePropertyNameStrings {
	if o == nil {
		return shared.FakerCamelCasePropertyNameStrings{}
	}
	return o.FakerCamelCasePropertyNameStrings
...
func (o *UsageExamplePostJSON) GetFakerKebobCasePropertyNameStrings() shared.FakerKebobCasePropertyNameStrings {
	if o == nil {
		return shared.FakerKebobCasePropertyNameStrings{}
	}
	return o.FakerKebobCasePropertyNameStrings
...
func (o *UsageExamplePostJSON) GetFakerPascalCasePropertyNameStrings() shared.FakerPascalCasePropertyNameStrings {
	if o == nil {
		return shared.FakerPascalCasePropertyNameStrings{}
	}
	return o.FakerPascalCasePropertyNameStrings
...
func (o *UsageExamplePostJSON) GetFakerSnakeCasePropertyNameStrings() shared.FakerSnakeCasePropertyNameStrings {
	if o == nil {
		return shared.FakerSnakeCasePropertyNameStrings{}
	}
	return o.FakerSnakeCasePropertyNameStrings
