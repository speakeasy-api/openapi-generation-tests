...
type AnyVal struct {
	SimpleObjectCamelCase *SimpleObjectCamelCase `queryParam:"inline"`
...
func (u *AnyVal) UnmarshalJSON(data []byte) error {
	...
	var simpleObjectCamelCase SimpleObjectCamelCase = SimpleObjectCamelCase{}
	...
	return fmt.Errorf("could not unmarshal `%s` into any supported union types for AnyVal", string(data))
}
...
func (u AnyVal) MarshalJSON() ([]byte, error) {
	...
	return nil, errors.New("could not marshal union type AnyVal: all fields are null")
}
