...
type PrimitiveTypeUnion struct {
	...
	Int32   *int     `queryParam:"inline"`
	Number  *float64 `queryParam:"inline"`
	Float32 *float32 `queryParam:"inline"`
...
func (u *PrimitiveTypeUnion) UnmarshalJSON(data []byte) error {
	...
	return fmt.Errorf("could not unmarshal `%s` into any supported union types for PrimitiveTypeUnion", string(data))
}
...
func (u PrimitiveTypeUnion) MarshalJSON() ([]byte, error) {
	...
	return nil, errors.New("could not marshal union type PrimitiveTypeUnion: all fields are null")
}
