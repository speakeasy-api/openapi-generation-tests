...
type SimpleObject struct {
	...
	DecimalNullableOpt *decimal.Big `decimal:"number" json:"decimalNullableOpt,omitempty" header:"name=decimalNullableOpt" pathParam:"name=decimalNullableOpt" queryParam:"name=decimalNullableOpt" form:"name=decimalNullableOpt" multipartForm:"name=decimalNullableOpt"`
...
func (o *SimpleObject) GetDecimalNullableOpt() *decimal.Big {
	if o == nil {
		return nil
	}
	return o.DecimalNullableOpt
}
