...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "2.2.0",
			GenVersion:        "2.338.10",
			UserAgent:         "speakeasy-sdk/go 2.2.0 2.338.10 0.1.0 openapi",
			Globals:           globals.Globals{},
			ServerDefaults: []map[string]string{
				{},
				{},
...
func (s *SDK) AuthenticatedRequest(ctx context.Context, security operations.AuthenticatedRequestSecurity, request *operations.AuthenticatedRequestRequestBody) (*operations.AuthenticatedRequestResponse, error) {
...
func (s *SDK) IgnoredGenerationPut(ctx context.Context, request string) (*operations.IgnoredGenerationPutResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
