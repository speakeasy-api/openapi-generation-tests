...
// WithGlobalOptionalHiddenPathParam allows setting the GlobalOptionalHiddenPathParam parameter for all supported operations
func WithGlobalOptionalHiddenPathParam(globalOptionalHiddenPathParam string) SDKOption {
	return func(sdk *SDK) {
		sdk.sdkConfiguration.Globals.GlobalOptionalHiddenPathParam = &globalOptionalHiddenPathParam
	}
}

// WithGlobalOptionalPathParam allows setting the GlobalOptionalPathParam parameter for all supported operations
func WithGlobalOptionalPathParam(globalOptionalPathParam string) SDKOption {
	return func(sdk *SDK) {
		sdk.sdkConfiguration.Globals.GlobalOptionalPathParam = &globalOptionalPathParam
	}
}
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "2.2.0",
			GenVersion:        "2.493.32",
			UserAgent:         "speakeasy-sdk/go 2.2.0 2.493.32 0.1.0 openapi",
			Globals:           globals.Globals{},
			ServerDefaults: []map[string]string{
				{},
				{},
	...
	sdk.Methods = newMethods(sdk.sdkConfiguration)
	...
	sdk.StatusCode = newStatusCode(sdk.sdkConfiguration)

	return sdk
}

// AmbiguousQueryParam - Tests conflict with C# System namespace
func (s *SDK) AmbiguousQueryParam(ctx context.Context, console operations.Console, opts ...operations.Option) (*operations.AmbiguousQueryParamResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
		OperationID:    "ambiguousQueryParam",
		OAuth2Scopes:   []string{},
	...
	opURL, err := url.JoinPath(baseURL, "/anything/queryParams/namespaceConflict")
	if err != nil {
	...
	res := &operations.AmbiguousQueryParamResponse{
...
func (s *SDK) MultilineExample(ctx context.Context, request *operations.MultilineExampleRequestBody, opts ...operations.Option) (*operations.MultilineExampleResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
		OperationID:    "multilineExample",
		OAuth2Scopes:   []string{},
		SecuritySource: s.sdkConfiguration.Security,
	}
	...
	opURL, err := url.JoinPath(baseURL, "/anything/multilineExample")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.MultilineExampleResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *SDK) PostAdditionalPropertiesWithNullableFields(ctx context.Context, request operations.PostAdditionalPropertiesWithNullableFieldsRequestBody, opts ...operations.Option) (*operations.PostAdditionalPropertiesWithNullableFieldsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
		OperationID:    "postAdditionalPropertiesWithNullableFields",
		OAuth2Scopes:   []string{},
		SecuritySource: s.sdkConfiguration.Security,
	}
	...
	opURL, err := url.JoinPath(baseURL, "/anything/additionalPropertiesWithNullableFields")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.PostAdditionalPropertiesWithNullableFieldsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.PostAdditionalPropertiesWithNullableFieldsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
