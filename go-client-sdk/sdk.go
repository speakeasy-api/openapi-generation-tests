...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "2.2.0",
			GenVersion:        "2.333.3",
			UserAgent:         "speakeasy-sdk/go 2.2.0 2.333.3 0.1.0 openapi",
			Globals:           globals.Globals{},
			ServerDefaults: []map[string]string{
				{},
				{},
...
func (s *SDK) AuthenticatedRequest(ctx context.Context, request *operations.AuthenticatedRequestRequestBody, security operations.AuthenticatedRequestSecurity) (*operations.AuthenticatedRequestResponse, error) {
