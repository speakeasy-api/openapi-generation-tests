...
func TestParameters_DeepObjectQueryParamsDeepObject(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("deepObjectQueryParamsDeepObject")),
	)
...
func TestParameters_DeepObjectQueryParamsMap(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("deepObjectQueryParamsMap")),
	)
...
func TestParameters_DeepObjectQueryParamsObject(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("deepObjectQueryParamsObject")),
	)
...
func TestParameters_FormQueryParamsArray(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("formQueryParamsArray")),
	)
...
func TestParameters_FormQueryParamsCamelObject(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("formQueryParamsCamelObject")),
	)
...
func TestParameters_FormQueryParamsMap(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("formQueryParamsMap")),
	)
...
func TestParameters_FormQueryParamsObject(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("formQueryParamsObject")),
	)
	...
	assert.NotNil(t, res.Res.Args.Bigint)
	assert.Equal(t, openapi.String("8821239038968084"), res.Res.Args.Bigint)
	assert.NotNil(t, res.Res.Args.BigintStr)
	assert.Equal(t, openapi.String("9223372036854775808"), res.Res.Args.BigintStr)
	assert.Equal(t, "true", res.Res.Args.Bool)
	assert.NotNil(t, res.Res.Args.BoolOpt)
	assert.Equal(t, openapi.String("true"), res.Res.Args.BoolOpt)
	assert.Equal(t, "2020-01-01", res.Res.Args.Date)
	assert.Equal(t, "2020-01-01T00:00:00.001Z", res.Res.Args.DateTime)
	assert.NotNil(t, res.Res.Args.Decimal)
	assert.Equal(t, openapi.String("3.141592653589793"), res.Res.Args.Decimal)
	assert.NotNil(t, res.Res.Args.DecimalStr)
	assert.Equal(t, openapi.String("3.14159265358979344719667586"), res.Res.Args.DecimalStr)
	assert.Equal(t, "one", res.Res.Args.Enum)
	assert.Equal(t, "1.1", res.Res.Args.Float32)
	assert.NotNil(t, res.Res.Args.Float64Str)
	assert.Equal(t, openapi.String("1.1"), res.Res.Args.Float64Str)
	assert.Equal(t, "1", res.Res.Args.Int)
	assert.Equal(t, "1", res.Res.Args.Int32)
	assert.Equal(t, "55", res.Res.Args.Int32Enum)
	assert.NotNil(t, res.Res.Args.Int64Str)
	assert.Equal(t, openapi.String("100"), res.Res.Args.Int64Str)
	...
	assert.NotNil(t, res.Res.Args.StrOpt)
	assert.Equal(t, openapi.String("testOptional"), res.Res.Args.StrOpt)
...
func TestParameters_FormQueryParamsPrimitive(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("formQueryParamsPrimitive")),
	)
...
func TestParameters_FormQueryParamsRefParamObject(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("formQueryParamsRefParamObject")),
	)
...
func TestParameters_HeaderParamsArray(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("headerParamsArray")),
	)
...
func TestParameters_HeaderParamsMap(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("headerParamsMap")),
	)
...
func TestParameters_HeaderParamsObject(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("headerParamsObject")),
	)
...
func TestParameters_HeaderParamsPrimitive(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("headerParamsPrimitive")),
	)
...
func TestParameters_JSONQueryParamsObjectSmaller(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("jsonQueryParamsObjectSmaller")),
	)
...
func TestParameters_MixedParametersCamelCase(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("mixedParametersCamelCase")),
	)
...
func TestParameters_MixedParametersPrimitives(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("mixedParametersPrimitives")),
	)
...
func TestParameters_MixedQueryParams(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("mixedQueryParams")),
	)
...
func TestParameters_PathParameterJSON(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("pathParameterJson")),
	)
...
func TestParameters_PipeDelimitedQueryParamsArray(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("pipeDelimitedQueryParamsArray")),
	)
...
func TestParameters_SimplePathParameterArrays(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("simplePathParameterArrays")),
	)
...
func TestParameters_SimplePathParameterMaps(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("simplePathParameterMaps")),
	)
...
func TestParameters_SimplePathParameterObjects(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("simplePathParameterObjects")),
	)
...
func TestParameters_SimplePathParameterPrimitives(t *testing.T) {
	...
	s := openapi.New(
		openapi.WithClient(createTestHTTPClient("simplePathParameterPrimitives")),
	)
