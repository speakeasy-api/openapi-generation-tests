...
func TestClientCredentials_HookSuccessfullyAuthenticates(t *testing.T) {
	...
	os.Setenv("SPEAKEASY_CLIENT_ID", "speakeasy-sdks")
	os.Setenv("SPEAKEASY_CLIENT_SECRET", "supersecret-"+randSeq(10))
	s2 := openapi.New()
	...
	os.Setenv("SPEAKEASY_CLIENT_ID", "")
	os.Setenv("SPEAKEASY_CLIENT_SECRET", "")
}
