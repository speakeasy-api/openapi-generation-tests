...
func newJSONTeapotClient() *teapotClient {
	return &teapotClient{format: "json", client: &http.Client{}}
}

func newTextTeapotClient() *teapotClient {
	return &teapotClient{format: "text", client: &http.Client{}}
}

func (tc *teapotClient) Do(req *http.Request) (*http.Response, error) {
	req.Header.Set("x-teapot", tc.format)
