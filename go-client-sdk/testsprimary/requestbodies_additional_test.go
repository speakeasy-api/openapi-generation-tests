	...
	tests := []struct {
		...
		},
		{
			...
			arg: operations.NullableRequiredPropertyPostRequestBody{
				...
				NullableRequiredInt:        sdk.Int64(1),
				NullableRequiredDateTime:   types.MustNewTimeFromString("2020-01-01T00:00:00.000000001Z"),
				NullableRequiredBigIntStr:  types.MustNewBigIntFromString("9223372036854775808"),
				NullableRequiredDecimalStr: types.MustNewDecimalFromString("1.1"),
			},
			wantJson: "{\"NullableOptionalInt\":0,\"NullableRequiredArray\":[1,2,3],\"NullableRequiredBigIntStr\":\"9223372036854775808\",\"NullableRequiredDateTime\":\"2020-01-01T00:00:00.000000001Z\",\"NullableRequiredDecimalStr\":\"1.1\",\"NullableRequiredEnum\":\"second\",\"NullableRequiredInt\":1}",
		},
	}
	s := sdk.New()
...
func TestRequestBodyPostNullableRequiredSharedObject(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "All fields set to non-null value",
			arg: operations.NullableRequiredSharedObjectPostRequestBody{
				NullableOptionalObj: &shared.NullableOptionalObject{Required: 1, Optional: sdk.String("test")},
