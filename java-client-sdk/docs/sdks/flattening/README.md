...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ObjWithOptionalProperties req = ObjWithOptionalProperties.builder()
                .build();

        RequiredBodyAllOptionalResponse res = sdk.flattening().requiredBodyAllOptional()
                .request(req)
                .call();
...
| Parameter                                                                     | Type                                                                          | Required                                                                      | Description                                                                   |
| ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| `request`                                                                     | [ObjWithOptionalProperties](../../models/shared/ObjWithOptionalProperties.md) | :heavy_check_mark:                                                            | The request object to use for the request.                                    |

### Response

**[RequiredBodyAllOptionalResponse](../../models/operations/RequiredBodyAllOptionalResponse.md)**
