...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        UsageExamplePostRequest req = UsageExamplePostRequest.builder()
                ...
                .boolParameter(true)
                .dateParameter(LocalDate.parse("2023-09-18"))
                .dateTimeDefaultParameter(OffsetDateTime.parse("2022-10-04T08:37:24.631Z"))
                .dateTimeParameter(OffsetDateTime.parse("2023-01-02T00:16:41.967Z"))
                ...
                .requestBody(UsageExamplePostRequestBody.builder()
                    ...
                    .fakerPascalCasePropertyNameStrings(FakerPascalCasePropertyNameStrings.builder()
                        ...
                        .expiredAt("1723923467779")
                        .expires("<value>")
                        .expiresAt("1759768416516")
                        .extension("mp4v")
                    ...
                    .fakerSnakeCasePropertyNameStrings(FakerSnakeCasePropertyNameStrings.builder()
                        .countryCode("FJ")
                        .createdAt("1730076693469")
                        .expiredAt("1720554769924")
                        .updatedAt("1735000417180")
                        .build())
