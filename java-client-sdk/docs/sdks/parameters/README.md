...
import java.lang.Exception;
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.HeaderParamsNilRequest;
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HeaderParamsNilRequest req = HeaderParamsNilRequest.builder()
                .nullableHeader("<value>")
                .build();

        HeaderParamsNilResponse res = sdk.parameters().headerParamsNil()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        QueryEncodingResponse res = sdk.parameters().queryEncoding()
                .param1("value1")
                .call();
...
**[QueryEncodingResponse](../../models/operations/QueryEncodingResponse.md)**
