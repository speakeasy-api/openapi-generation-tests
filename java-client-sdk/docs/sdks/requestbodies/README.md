    ...
    public static void main(String[] args) {
        try {
            ...
            LocalDate[] req = new LocalDate[]{{
                add(LocalDate.parse("2023-03-22")),
            }};
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            LocalDate req = LocalDate.parse("2023-03-04");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OffsetDateTime req = OffsetDateTime.parse("2024-03-03T18:54:52.196Z");
    ...
    public static void main(String[] args) {
        try {
            ...
            java.util.Map<String, OffsetDateTime> req = new java.util.HashMap<String, OffsetDateTime>(
                ...
                put("key", OffsetDateTime.parse("2023-09-04T08:15:28.024Z"));
            }};
