...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            NullableObject req = NullableObject.builder()
                .required(302382L)
                .optional("<value>")
                .build();
    ...
    public static void main(String[] args) {
        try {
            ...
            NullableRequiredPropertyPostRequestBody req = NullableRequiredPropertyPostRequestBody.builder()
                .nullableRequiredArray(java.util.List.of(
                        2355.17d))
                .nullableRequiredBigIntStr(new BigInteger("9223372036854775807"))
                .nullableRequiredDateTime(OffsetDateTime.parse("2024-03-02T01:02:03.000001Z"))
    ...
    public static void main(String[] args) {
        try {
            ...
            NullableRequiredSharedObjectPostRequestBody req = NullableRequiredSharedObjectPostRequestBody.builder()
                .nullableRequiredObj(NullableObject.builder()
                        .required(86533L)
                        .optional("<value>")
                        .build())
                .nullableOptionalObj(NullableOptionalObject.builder()
                    .required(964394L)
                    .optional("<value>")
                    .build())
                .build();
        ...
        try {
            ...
            DeepObjectCamelCase req = DeepObjectCamelCase.builder()
                .anyVal(AnyVal.of(SimpleObjectCamelCase.builder()
                            ...
                            .numVal(1.1d)
                            .strVal("example")
                            .bigintStrVal(new BigInteger("66469"))
                            .bigintVal(new BigInteger("962909"))
                            .boolOptVal(true)
                            .decimalVal(new BigDecimal("2064.4"))
                            .intOptNullVal(999999L)
                            .numOptNullVal(1.1d)
                            .strOptVal("optional example")
                            .build()))
                ...
                .objVal(SimpleObjectCamelCase.builder()
                        ...
                        .numVal(1.1d)
                        .strVal("example")
                        .bigintStrVal(new BigInteger("424140"))
                        .bigintVal(new BigInteger("942092"))
                        .boolOptVal(true)
                        .decimalVal(new BigDecimal("1379.45"))
                        .intOptNullVal(999999L)
                        .numOptNullVal(1.1d)
                        .strOptVal("optional example")
                        .build())
    ...
    public static void main(String[] args) {
        try {
            ...
            SimpleObjectCamelCase req = SimpleObjectCamelCase.builder()
                ...
                .numVal(1.1d)
                .strVal("example")
                .bigintStrVal(new BigInteger("281697"))
                .bigintVal(new BigInteger("997638"))
                .boolOptVal(true)
                .decimalVal(new BigDecimal("4524.01"))
                .intOptNullVal(999999L)
                .numOptNullVal(1.1d)
                .strOptVal("optional example")
                .build();
    ...
    public static void main(String[] args) {
        try {
            ...
            DefaultsAndConsts req = DefaultsAndConsts.builder()
                .normalField("test")
                .defaultBigInt(new BigInteger("559205"))
                .defaultBigIntStr(new BigInteger("233601"))
                .defaultBool(false)
                .defaultDate(LocalDate.parse("2023-12-15"))
                .defaultDateTime(OffsetDateTime.parse("2024-10-01T00:16:04.498Z"))
                .defaultDecimal(new BigDecimal("1120.58"))
                .defaultDecimalStr(new BigDecimal("8445.08"))
                .defaultEnumInt(DefaultEnumInt.ONE)
    ...
    public static void main(String[] args) {
        try {
            ...
            RequestBodyPostEmptyObjectRequestBody req = RequestBodyPostEmptyObjectRequestBody.builder()
                .empty(Empty.builder()
                    .build())
                .emptyWithEmptyProperties(EmptyWithEmptyProperties.builder()
                    .build())
                .build();
    ...
    public static void main(String[] args) {
        try {
            ...
            ComplexNumberArrays req = ComplexNumberArrays.builder()
                .bigintArray(java.util.List.of(
                    new BigInteger("58951")))
                .bigintStrArray(java.util.List.of(
                    new BigInteger("868208")))
                .decimalArray(java.util.List.of(
                    new BigDecimal("6462.62")))
                .decimalStrArray(java.util.List.of(
                    new BigDecimal("1554.32")))
                .build();
    ...
    public static void main(String[] args) {
        try {
            ...
            ComplexNumberMaps req = ComplexNumberMaps.builder()
                .bigintMap(java.util.Map.ofEntries(
                    entry("key", new BigInteger("470802"))))
                .bigintStrMap(java.util.Map.ofEntries(
                    entry("key", new BigInteger("168045"))))
                .decimalMap(java.util.Map.ofEntries(
                    entry("key", new BigDecimal("7703.92"))))
                .decimalStrMap(java.util.Map.ofEntries(
                    entry("key", new BigDecimal("5046.5"))))
                .build();
    ...
    public static void main(String[] args) {
        try {
            ...
            java.util.Map<String, OffsetDateTime> req = java.util.Map.ofEntries(
                entry("test", OffsetDateTime.parse("2020-01-01T00:00:00.000001Z")));
    ...
    public static void main(String[] args) {
        try {
            ...
            RequestBodyPutMultipartDifferentFileNameRequestBody req = RequestBodyPutMultipartDifferentFileNameRequestBody.builder()
                .differentFileName(DifferentFileName.builder()
                    .content("0xdF19d43dd2".getBytes())
                    .fileName("<value>")
                    .build())
                .build();
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            WeaklyTypedOneOfReadWriteObject req = WeaklyTypedOneOfReadWriteObject.of(SimpleObject.builder()
                    .any("any")
                    .bool(true)
                    .date(LocalDate.parse("2020-01-01"))
                    .dateTime(OffsetDateTime.parse("2020-01-01T00:00:00.000001Z"))
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            WeaklyTypedOneOfWriteOnlyObject req = WeaklyTypedOneOfWriteOnlyObject.of(SimpleObject.builder()
                    .any("any")
                    .bool(true)
                    .date(LocalDate.parse("2020-01-01"))
                    .dateTime(OffsetDateTime.parse("2020-01-01T00:00:00.000001Z"))
