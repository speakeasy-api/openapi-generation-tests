...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.operations.GetArrayDataSourceResponse res = sdk.resource.getArrayDataSource("string");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.operations.UpdateResourceResponse res = sdk.resource.updateResource("string", "string");
