...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            UnionBigIntDecimalRequestBody req = org.openapis.openapi.models.operations.UnionBigIntDecimalRequestBody.of(new BigInteger("863736"));

            UnionBigIntDecimalResponse res = sdk.unions().unionBigIntDecimal()
                .request(req)
                .call();
...
| Parameter                                                                                                                        | Type                                                                                                                             | Required                                                                                                                         | Description                                                                                                                      |
| -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `request`                                                                                                                        | [org.openapis.openapi.models.operations.UnionBigIntDecimalRequestBody](../../models/operations/UnionBigIntDecimalRequestBody.md) | :heavy_check_mark:                                                                                                               | The request object to use for the request.                                                                                       |


### Response

**[Optional<? extends org.openapis.openapi.models.operations.UnionBigIntDecimalResponse>](../../models/operations/UnionBigIntDecimalResponse.md)**
### Errors
