...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        UnionBigIntStrDecimalRequestBody req = UnionBigIntStrDecimalRequestBody.of(new BigDecimal("2045.56"));
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LocalDate req = LocalDate.parse("2024-11-25");
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        UnionDateTimeBigIntRequestBody req = UnionDateTimeBigIntRequestBody.of(OffsetDateTime.parse("2023-10-13T05:48:39.528Z"));
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        OffsetDateTime req = OffsetDateTime.parse("2024-04-12T05:53:48.181Z");
