...
public class Hooks {
    ...
    public org.openapis.openapi.models.operations.AuthorizationHeaderModificationResponse authorizationHeaderModification(org.openapis.openapi.models.operations.AuthorizationHeaderModificationSecurity security) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/bearer#authorizationHeaderModification");
        ...
        org.openapis.openapi.models.operations.AuthorizationHeaderModificationResponse res = new org.openapis.openapi.models.operations.AuthorizationHeaderModificationResponse(contentType, httpRes.statusCode(), httpRes) {{
            token = null;
        }};
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.operations.AuthorizationHeaderModificationToken out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.AuthorizationHeaderModificationToken.class);
                res.token = out;
            }
        }
