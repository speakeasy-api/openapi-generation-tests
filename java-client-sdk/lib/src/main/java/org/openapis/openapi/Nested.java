...
public class Nested {    
    ...
    public org.openapis.openapi.models.operations.NestedGetResponse get() throws Exception {
        ...
        org.openapis.openapi.models.operations.NestedGetResponse res = new org.openapis.openapi.models.operations.NestedGetResponse(contentType, httpRes.statusCode(), httpRes) {{
        }};
