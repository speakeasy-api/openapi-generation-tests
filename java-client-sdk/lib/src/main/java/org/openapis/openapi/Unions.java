...
public class Unions {
    ...
    public org.openapis.openapi.models.operations.WeaklyTypedOneOfNullEnumPostResponse weaklyTypedOneOfNullEnumPost(java.lang.Object request) throws Exception {
        String baseUrl = org.openapis.openapi.utils.Utils.templateUrl(this.sdkConfiguration.serverUrl, this.sdkConfiguration.getServerVariableDefaults());
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/anything/weaklyTypedOneOfNullEnum");
        ...
        org.openapis.openapi.models.operations.WeaklyTypedOneOfNullEnumPostResponse res = new org.openapis.openapi.models.operations.WeaklyTypedOneOfNullEnumPostResponse(contentType, httpRes.statusCode(), httpRes) {{
            res = null;
        }};
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.WeaklyTypedOneOfNullEnumPostRes out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.WeaklyTypedOneOfNullEnumPostRes.class);
                res.res = out;
            }
        }
