...
public class Form {
    ...
    public Form(@JsonProperty("arr") String arr, @JsonProperty("bool") String bool, @JsonProperty("int") String int_, @JsonProperty("map") String map, @JsonProperty("num") String num, @JsonProperty("obj") String obj, @JsonProperty("str") String str) {
        this.arr = arr;
        this.bool = bool;
        this.int_ = int_;
        this.map = map;
