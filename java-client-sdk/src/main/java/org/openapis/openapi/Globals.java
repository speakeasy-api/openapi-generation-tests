...
public class Globals implements
    ...
    public org.openapis.openapi.models.operations.GlobalsHeaderGetResponse globalsHeaderGet(
        ...
        String contentType = httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        org.openapis.openapi.models.operations.GlobalsHeaderGetResponse.Builder resBuilder = 
        ...
        org.openapis.openapi.models.operations.GlobalsHeaderGetResponse res = resBuilder.build();
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GlobalsHeaderGetRes out = mapper.readValue(
                    Utils.toUtf8AndClose(httpRes.body()),
