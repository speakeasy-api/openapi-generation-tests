...
import org.openapis.openapi.models.operations.HeaderParamsNilRequestBuilder;
import org.openapis.openapi.models.operations.HeaderParamsNilRes;
...
public class Parameters implements
    ...
    public HeaderParamsNilRequestBuilder headerParamsNil() {
        return new HeaderParamsNilRequestBuilder(this);
    }

    public HeaderParamsNilResponse headerParamsNil(
            HeaderParamsNilRequest request) throws Exception {
        String _baseUrl = Utils.templateUrl(
                this.sdkConfiguration.serverUrl, this.sdkConfiguration.getServerVariableDefaults());
        String _url = Utils.generateURL(
                _baseUrl,
                "/anything/headers/nil");
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        HeaderParamsNilResponse.Builder _resBuilder = 
            HeaderParamsNilResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        HeaderParamsNilResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                HeaderParamsNilRes _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<HeaderParamsNilRes>() {});
                _res.withRes(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
