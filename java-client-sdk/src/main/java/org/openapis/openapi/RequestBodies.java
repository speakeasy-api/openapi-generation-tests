...
import org.openapis.openapi.models.operations.RequestBodyDeprecatedRequestBodyRefPostRequestBuilder;
...
import org.openapis.openapi.models.operations.RequestBodyGetInferredOptionalRequestWrapperRequestBuilder;
import org.openapis.openapi.models.operations.RequestBodyGetInferredOptionalRequestWrapperResponse;
import org.openapis.openapi.models.operations.RequestBodyGetInferredOptionalRequestWrapperResponseBody;
...
import org.openapis.openapi.models.operations.RequestBodyPostApplicationJsonArrayOfUnionsRequestBuilder;
...
import org.openapis.openapi.models.operations.RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsRequestBuilder;
import org.openapis.openapi.models.operations.RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponse;
import org.openapis.openapi.models.operations.RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponseBody;
...
import org.openapis.openapi.models.operations.RequestBodyPostWildcardRequestBuilder;
import org.openapis.openapi.models.operations.RequestBodyPostWildcardRes;
...
import org.openapis.openapi.models.operations.RequestBodyPutMultipartFileRefRequestBuilder;
import org.openapis.openapi.models.operations.RequestBodyPutMultipartFileRefRes;
...
public class RequestBodies implements
            ...
            MethodCallRequestBodyDeprecatedRequestBodyRefPost,
            MethodCallRequestBodyGetInferredOptionalRequestWrapper,
            ...
            MethodCallRequestBodyPostApplicationJsonArrayOfUnions,
            ...
            MethodCallRequestBodyPostEmptyBodyRetainedWithAllOptionalFields,
            ...
            MethodCallRequestBodyPostWildcard,
            ...
            MethodCallRequestBodyPutMultipartFileRef,
    ...
    /**
     * REQUEST_BODY_GET_INFERRED_OPTIONAL_REQUEST_WRAPPER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] REQUEST_BODY_GET_INFERRED_OPTIONAL_REQUEST_WRAPPER_SERVERS = {
    ...
    /**
     * REQUEST_BODY_POST_APPLICATION_JSON_ARRAY_OF_UNIONS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] REQUEST_BODY_POST_APPLICATION_JSON_ARRAY_OF_UNIONS_SERVERS = {
        "http://localhost:35456",
    };
    ...
    public RequestBodyDeprecatedRequestBodyRefPostRequestBuilder requestBodyDeprecatedRequestBodyRefPost() {
        return new RequestBodyDeprecatedRequestBodyRefPostRequestBuilder(this);
    }

    public RequestBodyDeprecatedRequestBodyRefPostResponse requestBodyDeprecatedRequestBodyRefPost(
            DeprecatedObjectWithExample request) throws Exception {
        String _baseUrl = Utils.templateUrl(
                this.sdkConfiguration.serverUrl, this.sdkConfiguration.getServerVariableDefaults());
        String _url = Utils.generateURL(
                _baseUrl,
                "/anything/requestBodies/deprecatedRequestBodyRef");
        
        HTTPRequest _req = new HTTPRequest(_url, "POST");
        Object _convertedRequest = Utils.convertToShape(
                request, 
                JsonShape.DEFAULT,
                new TypeReference<DeprecatedObjectWithExample>() {});
        SerializedBody _serializedRequestBody = Utils.serializeRequestBody(
                _convertedRequest, 
                "request",
                "json",
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        RequestBodyDeprecatedRequestBodyRefPostResponse.Builder _resBuilder = 
        ...
        RequestBodyDeprecatedRequestBodyRefPostResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                RequestBodyDeprecatedRequestBodyRefPostResponseBody _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<RequestBodyDeprecatedRequestBodyRefPostResponseBody>() {});
                _res.withObject(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
    ...
    public RequestBodyGetInferredOptionalRequestWrapperRequestBuilder requestBodyGetInferredOptionalRequestWrapper() {
        return new RequestBodyGetInferredOptionalRequestWrapperRequestBuilder(this);
    }

    public RequestBodyGetInferredOptionalRequestWrapperResponse requestBodyGetInferredOptionalRequestWrapper(
            RequestBodyGetInferredOptionalRequestWrapperRequest request) throws Exception {
        return requestBodyGetInferredOptionalRequestWrapper(request, Optional.empty());
    }
    
    public RequestBodyGetInferredOptionalRequestWrapperResponse requestBodyGetInferredOptionalRequestWrapper(
            RequestBodyGetInferredOptionalRequestWrapperRequest request,
            Optional<String> serverURL) throws Exception {
        String _baseUrl = Utils.templateUrl(REQUEST_BODY_GET_INFERRED_OPTIONAL_REQUEST_WRAPPER_SERVERS[0], new HashMap<String, String>());
        if (serverURL.isPresent() && !serverURL.get().isBlank()) {
            _baseUrl = serverURL.get();
        }
        String _url = Utils.generateURL(
                _baseUrl,
                "/anything/inferredOptionalRequestWrapper");
        ...
        _req.addQueryParams(Utils.getQueryParams(
                RequestBodyGetInferredOptionalRequestWrapperRequest.class,
                request, 
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        RequestBodyGetInferredOptionalRequestWrapperResponse.Builder _resBuilder = 
            RequestBodyGetInferredOptionalRequestWrapperResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        RequestBodyGetInferredOptionalRequestWrapperResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                RequestBodyGetInferredOptionalRequestWrapperResponseBody _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<RequestBodyGetInferredOptionalRequestWrapperResponseBody>() {});
                _res.withObject(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
    ...
    public RequestBodyPostApplicationJsonArrayOfUnionsRequestBuilder requestBodyPostApplicationJsonArrayOfUnions() {
        return new RequestBodyPostApplicationJsonArrayOfUnionsRequestBuilder(this);
    }

    public RequestBodyPostApplicationJsonArrayOfUnionsResponse requestBodyPostApplicationJsonArrayOfUnions(
            RequestBodyPostApplicationJsonArrayOfUnionsRequestBody request) throws Exception {
        return requestBodyPostApplicationJsonArrayOfUnions(request, Optional.empty());
    }
    
    public RequestBodyPostApplicationJsonArrayOfUnionsResponse requestBodyPostApplicationJsonArrayOfUnions(
            RequestBodyPostApplicationJsonArrayOfUnionsRequestBody request,
            Optional<String> serverURL) throws Exception {
        String _baseUrl = Utils.templateUrl(REQUEST_BODY_POST_APPLICATION_JSON_ARRAY_OF_UNIONS_SERVERS[0], new HashMap<String, String>());
        if (serverURL.isPresent() && !serverURL.get().isBlank()) {
            _baseUrl = serverURL.get();
        }
        String _url = Utils.generateURL(
                _baseUrl,
                "/requestbody#arrayOfUnions");
        
        HTTPRequest _req = new HTTPRequest(_url, "POST");
        Object _convertedRequest = Utils.convertToShape(
                request, 
                JsonShape.DEFAULT,
                new TypeReference<RequestBodyPostApplicationJsonArrayOfUnionsRequestBody>() {});
        SerializedBody _serializedRequestBody = Utils.serializeRequestBody(
                _convertedRequest, 
                "request",
                "json",
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        RequestBodyPostApplicationJsonArrayOfUnionsResponse.Builder _resBuilder = 
        ...
        RequestBodyPostApplicationJsonArrayOfUnionsResponse _res = _resBuilder.build();
    ...
    public RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsRequestBuilder requestBodyPostEmptyBodyRetainedWithAllOptionalFields() {
        return new RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsRequestBuilder(this);
    }

    public RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponse requestBodyPostEmptyBodyRetainedWithAllOptionalFieldsDirect() throws Exception {
        return requestBodyPostEmptyBodyRetainedWithAllOptionalFields(Optional.empty());
    }
    
    public RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponse requestBodyPostEmptyBodyRetainedWithAllOptionalFields(
            Optional<? extends RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsRequestBody> request) throws Exception {
        String _baseUrl = Utils.templateUrl(
                this.sdkConfiguration.serverUrl, this.sdkConfiguration.getServerVariableDefaults());
        String _url = Utils.generateURL(
                _baseUrl,
                "/anything/requestBodies/post/empty-body-retained-with-all-optional-fields");
        
        HTTPRequest _req = new HTTPRequest(_url, "POST");
        Object _convertedRequest = Utils.convertToShape(
                request, 
                JsonShape.DEFAULT,
                new TypeReference<Optional<? extends RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsRequestBody>>() {});
        SerializedBody _serializedRequestBody = Utils.serializeRequestBody(
                _convertedRequest, 
                "request",
                "json",
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponse.Builder _resBuilder = 
            RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponseBody _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponseBody>() {});
                _res.withObject(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
    ...
    public RequestBodyPostWildcardRequestBuilder requestBodyPostWildcard() {
        return new RequestBodyPostWildcardRequestBuilder(this);
    }

    public RequestBodyPostWildcardResponse requestBodyPostWildcardDirect() throws Exception {
        return requestBodyPostWildcard(Optional.empty());
    }
    
    public RequestBodyPostWildcardResponse requestBodyPostWildcard(
            Optional<? extends byte[]> request) throws Exception {
        String _baseUrl = Utils.templateUrl(
                this.sdkConfiguration.serverUrl, this.sdkConfiguration.getServerVariableDefaults());
        String _url = Utils.generateURL(
                _baseUrl,
                "/anything/requestBodies/post/wildcard");
        
        HTTPRequest _req = new HTTPRequest(_url, "POST");
        Object _convertedRequest = Utils.convertToShape(
                request, 
                JsonShape.DEFAULT,
                new TypeReference<Optional<? extends byte[]>>() {});
        SerializedBody _serializedRequestBody = Utils.serializeRequestBody(
                _convertedRequest, 
                "request",
                "raw",
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        RequestBodyPostWildcardResponse.Builder _resBuilder = 
            RequestBodyPostWildcardResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        RequestBodyPostWildcardResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                RequestBodyPostWildcardRes _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<RequestBodyPostWildcardRes>() {});
                _res.withRes(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
    ...
    public RequestBodyPutMultipartFileRefRequestBuilder requestBodyPutMultipartFileRef() {
        return new RequestBodyPutMultipartFileRefRequestBuilder(this);
    }

    public RequestBodyPutMultipartFileRefResponse requestBodyPutMultipartFileRef(
            RequestBodyPutMultipartFileRefRequestBody request) throws Exception {
        String _baseUrl = Utils.templateUrl(
                this.sdkConfiguration.serverUrl, this.sdkConfiguration.getServerVariableDefaults());
        String _url = Utils.generateURL(
                _baseUrl,
                "/anything/requestBodies/put/multipart/fileRef");
        
        HTTPRequest _req = new HTTPRequest(_url, "PUT");
        Object _convertedRequest = Utils.convertToShape(
                request, 
                JsonShape.DEFAULT,
                new TypeReference<RequestBodyPutMultipartFileRefRequestBody>() {});
        SerializedBody _serializedRequestBody = Utils.serializeRequestBody(
                _convertedRequest, 
                "request",
                "multipart",
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        RequestBodyPutMultipartFileRefResponse.Builder _resBuilder = 
            RequestBodyPutMultipartFileRefResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        RequestBodyPutMultipartFileRefResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                RequestBodyPutMultipartFileRefRes _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<RequestBodyPutMultipartFileRefRes>() {});
                _res.withRes(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
