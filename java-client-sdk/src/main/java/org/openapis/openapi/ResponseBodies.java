...
import org.openapis.openapi.models.operations.ResponseBodies2xxJSONObjectAllOptionalPropertiesRequestBuilder;
import org.openapis.openapi.models.operations.ResponseBodies2xxJSONObjectAllOptionalPropertiesResponse;
import org.openapis.openapi.models.operations.ResponseBodies2xxJSONObjectAllOptionalPropertiesResponseBody;
...
public class ResponseBodies implements
            ...
            MethodCallResponseBodies2xxJSONObjectAllOptionalProperties,
    ...
    public ResponseBodies2xxJSONObjectAllOptionalPropertiesRequestBuilder responseBodies2xxJSONObjectAllOptionalProperties() {
        return new ResponseBodies2xxJSONObjectAllOptionalPropertiesRequestBuilder(this);
    }

    public ResponseBodies2xxJSONObjectAllOptionalPropertiesResponse responseBodies2xxJSONObjectAllOptionalPropertiesDirect() throws Exception {
        String _baseUrl = Utils.templateUrl(
                this.sdkConfiguration.serverUrl, this.sdkConfiguration.getServerVariableDefaults());
        String _url = Utils.generateURL(
                _baseUrl,
                "/anything/responseBodies/2xxJSONObjectAllOptionalProperties");
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ResponseBodies2xxJSONObjectAllOptionalPropertiesResponse.Builder _resBuilder = 
        ...
        ResponseBodies2xxJSONObjectAllOptionalPropertiesResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "2XX")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ResponseBodies2xxJSONObjectAllOptionalPropertiesResponseBody _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<ResponseBodies2xxJSONObjectAllOptionalPropertiesResponseBody>() {});
                _res.withObject(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
