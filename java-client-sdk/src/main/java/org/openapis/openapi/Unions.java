...
public class Unions implements
    ...
    public org.openapis.openapi.models.operations.UnionBigIntStrDecimalResponse unionBigIntStrDecimal(
        ...
        String contentType = httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        org.openapis.openapi.models.operations.UnionBigIntStrDecimalResponse.Builder resBuilder = 
        ...
        org.openapis.openapi.models.operations.UnionBigIntStrDecimalResponse res = resBuilder.build();
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.UnionBigIntStrDecimalRes out = mapper.readValue(
                    Utils.toUtf8AndClose(httpRes.body()),
