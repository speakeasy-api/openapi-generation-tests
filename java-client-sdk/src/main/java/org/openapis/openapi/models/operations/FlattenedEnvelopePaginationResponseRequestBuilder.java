...
public class FlattenedEnvelopePaginationResponseRequestBuilder {
    ...
    public FlattenedEnvelopePaginationResponseRequestBuilder cursor(java.lang.String cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = Optional.of(cursor);
        return this;
    }

    public FlattenedEnvelopePaginationResponseRequestBuilder cursor(java.util.Optional<java.lang.String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
