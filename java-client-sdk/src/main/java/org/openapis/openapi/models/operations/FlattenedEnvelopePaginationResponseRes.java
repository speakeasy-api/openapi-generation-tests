...
public class FlattenedEnvelopePaginationResponseRes {
    ...
    public FlattenedEnvelopePaginationResponseRes(
            long numPages,
            java.util.List<String> resultArray) {
    ...
    public FlattenedEnvelopePaginationResponseRes withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public FlattenedEnvelopePaginationResponseRes withResultArray(java.util.List<String> resultArray) {
        Utils.checkNotNull(resultArray, "resultArray");
        this.resultArray = resultArray;
        return this;
    }
