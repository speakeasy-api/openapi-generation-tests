...
public class FormQueryParamsMapRequestBuilder {
    ...
    public FormQueryParamsMapRequestBuilder mapParam(java.util.Map<java.lang.String, java.lang.String> mapParam) {
        Utils.checkNotNull(mapParam, "mapParam");
        this.mapParam = Optional.of(mapParam);
        return this;
    }

    public FormQueryParamsMapRequestBuilder mapParam(java.util.Optional<? extends java.util.Map<java.lang.String, java.lang.String>> mapParam) {
        Utils.checkNotNull(mapParam, "mapParam");
        this.mapParam = mapParam;
        return this;
    }
                
    public FormQueryParamsMapRequestBuilder mapParamExploded(java.util.Map<java.lang.String, java.lang.Long> mapParamExploded) {
        Utils.checkNotNull(mapParamExploded, "mapParamExploded");
        this.mapParamExploded = Optional.of(mapParamExploded);
        return this;
    }

    public FormQueryParamsMapRequestBuilder mapParamExploded(java.util.Optional<? extends java.util.Map<java.lang.String, java.lang.Long>> mapParamExploded) {
        Utils.checkNotNull(mapParamExploded, "mapParamExploded");
