...
public class JsonQueryParamsObjectRequestBuilder {
    ...
    public JsonQueryParamsObjectRequestBuilder deepObjParam(DeepObject deepObjParam) {
        Utils.checkNotNull(deepObjParam, "deepObjParam");
        this.deepObjParam = deepObjParam;
        return this;
    }

    public JsonQueryParamsObjectRequestBuilder simpleObjParam(SimpleObject simpleObjParam) {
