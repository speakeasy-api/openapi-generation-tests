...
public class MultipleOptionsWithSimpleSchemesAuthSecurity {
    ...
    @JsonIgnore
    public Optional<MultipleOptionsWithSimpleSchemesAuthSecurityOption1> option1() {
        return (Optional<MultipleOptionsWithSimpleSchemesAuthSecurityOption1>) option1;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<MultipleOptionsWithSimpleSchemesAuthSecurityOption2> option2() {
        return (Optional<MultipleOptionsWithSimpleSchemesAuthSecurityOption2>) option2;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            Objects.deepEquals(this.option1, other.option1) &&
            Objects.deepEquals(this.option2, other.option2);
    }
