...
public class MultipleSimpleOptionsAuthRequestBuilder {
    ...
    public MultipleSimpleOptionsAuthRequestBuilder serverURL(java.lang.String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public MultipleSimpleOptionsAuthRequestBuilder serverURL(java.util.Optional<java.lang.String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
