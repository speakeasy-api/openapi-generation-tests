...
public class NameOverrideGetOverriddenResponse {
    ...
    public NameOverrideGetOverriddenResponse(
            @JsonProperty("deepAllOf") Optional<? extends DeepOverriddenAllOf> deepOverriddenAllOf,
            @JsonProperty("json") Optional<? extends SimpleObject> json,
            @JsonProperty("allOf") Optional<? extends OverriddenAllOf> overriddenAllOf,
            @JsonProperty("normal") Optional<? extends OverriddenNormal> overriddenNormal) {
     ...
     * https://speakeasy.com/docs - A link to the external docs.
     */
    public NameOverrideGetOverriddenResponse withJson(SimpleObject json) {
        Utils.checkNotNull(json, "json");
     ...
     * https://speakeasy.com/docs - A link to the external docs.
     */
    public NameOverrideGetOverriddenResponse withJson(Optional<? extends SimpleObject> json) {
        Utils.checkNotNull(json, "json");
        this.json = json;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            Objects.deepEquals(this.deepOverriddenAllOf, other.deepOverriddenAllOf) &&
            Objects.deepEquals(this.json, other.json) &&
            Objects.deepEquals(this.overriddenAllOf, other.overriddenAllOf) &&
            Objects.deepEquals(this.overriddenNormal, other.overriddenNormal);
    }
