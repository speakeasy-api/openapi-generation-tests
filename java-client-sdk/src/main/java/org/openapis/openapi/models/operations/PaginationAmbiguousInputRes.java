...
public class PaginationAmbiguousInputRes {
    ...
    @JsonCreator
    public PaginationAmbiguousInputRes(
    ...
    public PaginationAmbiguousInputRes withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = Optional.ofNullable(next);
        return this;
    }

    public PaginationAmbiguousInputRes withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public PaginationAmbiguousInputRes withNumPages(long numPages) {
        Utils.checkNotNull(numPages, "numPages");
        this.numPages = numPages;
        return this;
    }

    public PaginationAmbiguousInputRes withResultArray(List<Long> resultArray) {
        Utils.checkNotNull(resultArray, "resultArray");
        this.resultArray = resultArray;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PaginationAmbiguousInputRes other = (PaginationAmbiguousInputRes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PaginationAmbiguousInputRes.class,
                "next", next,
                "numPages", numPages,
    ...
    public final static class Builder {
        ...
        public PaginationAmbiguousInputRes build() {
            return new PaginationAmbiguousInputRes(
                next,
                numPages,
                resultArray);
        }
