...
public class PaginationBodyWrappedRequestRequestBuilder {

    private PaginationBodyWrappedRequestRequest request;
    private Optional<String> serverURL = Optional.empty();
    private final SDKMethodInterfaces.MethodCallPaginationBodyWrappedRequest sdk;

    public PaginationBodyWrappedRequestRequestBuilder(SDKMethodInterfaces.MethodCallPaginationBodyWrappedRequest sdk) {
        this.sdk = sdk;
    }

    public PaginationBodyWrappedRequestRequestBuilder request(PaginationBodyWrappedRequestRequest request) {
        Utils.checkNotNull(request, "request");
        this.request = request;
        return this;
    }
                
    public PaginationBodyWrappedRequestRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public PaginationBodyWrappedRequestRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = serverURL;
        return this;
    }

    public PaginationBodyWrappedRequestResponse call() throws Exception {

        return sdk.paginationBodyWrappedRequest(
            request,
            serverURL);
    }
     ...
     **/  
    public Stream<PaginationBodyWrappedRequestResponse> callAsStream() {
