...
public class PaginationCursorNonNumericRequestBuilder {
    ...
    public PaginationCursorNonNumericRequestBuilder cursor(Optional<String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
    ...
    public PaginationCursorNonNumericRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
