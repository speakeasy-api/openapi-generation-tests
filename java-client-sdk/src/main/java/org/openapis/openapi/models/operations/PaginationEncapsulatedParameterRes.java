...
public class PaginationEncapsulatedParameterRes {
    ...
    @JsonCreator
    public PaginationEncapsulatedParameterRes(
    ...
    public PaginationEncapsulatedParameterRes withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = Optional.ofNullable(next);
        return this;
    }

    public PaginationEncapsulatedParameterRes withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public PaginationEncapsulatedParameterRes withNumPages(long numPages) {
        Utils.checkNotNull(numPages, "numPages");
        this.numPages = numPages;
        return this;
    }

    public PaginationEncapsulatedParameterRes withResultArray(List<Long> resultArray) {
        Utils.checkNotNull(resultArray, "resultArray");
        this.resultArray = resultArray;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PaginationEncapsulatedParameterRes other = (PaginationEncapsulatedParameterRes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PaginationEncapsulatedParameterRes.class,
                "next", next,
                "numPages", numPages,
    ...
    public final static class Builder {
        ...
        public PaginationEncapsulatedParameterRes build() {
            return new PaginationEncapsulatedParameterRes(
                next,
                numPages,
                resultArray);
        }
