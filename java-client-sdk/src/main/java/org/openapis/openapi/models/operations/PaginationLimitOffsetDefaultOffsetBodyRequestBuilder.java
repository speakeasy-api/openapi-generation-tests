...
public class PaginationLimitOffsetDefaultOffsetBodyRequestBuilder {

    private LimitOffsetConfigWithDefaults request;
    private Optional<String> serverURL = Optional.empty();
    private final SDKMethodInterfaces.MethodCallPaginationLimitOffsetDefaultOffsetBody sdk;

    public PaginationLimitOffsetDefaultOffsetBodyRequestBuilder(SDKMethodInterfaces.MethodCallPaginationLimitOffsetDefaultOffsetBody sdk) {
        this.sdk = sdk;
    }

    public PaginationLimitOffsetDefaultOffsetBodyRequestBuilder request(LimitOffsetConfigWithDefaults request) {
        Utils.checkNotNull(request, "request");
        this.request = request;
        return this;
    }
                
    public PaginationLimitOffsetDefaultOffsetBodyRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public PaginationLimitOffsetDefaultOffsetBodyRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = serverURL;
        return this;
    }

    public PaginationLimitOffsetDefaultOffsetBodyResponse call() throws Exception {

        return sdk.paginationLimitOffsetDefaultOffsetBody(
            request,
            serverURL);
    }
     ...
     **/  
    public Stream<PaginationLimitOffsetDefaultOffsetBodyResponse> callAsStream() {
