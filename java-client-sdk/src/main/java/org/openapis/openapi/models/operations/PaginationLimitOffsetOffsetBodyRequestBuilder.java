...
public class PaginationLimitOffsetOffsetBodyRequestBuilder {
    ...
    public PaginationLimitOffsetOffsetBodyRequestBuilder request(LimitOffsetConfig request) {
    ...
    public PaginationLimitOffsetOffsetBodyRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
