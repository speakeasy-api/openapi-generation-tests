...
public class PaginationLimitOffsetOffsetBodyRes {
    ...
    public PaginationLimitOffsetOffsetBodyRes withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public PaginationLimitOffsetOffsetBodyRes withResultArray(java.util.List<Long> resultArray) {
        Utils.checkNotNull(resultArray, "resultArray");
        this.resultArray = resultArray;
        return this;
    }
