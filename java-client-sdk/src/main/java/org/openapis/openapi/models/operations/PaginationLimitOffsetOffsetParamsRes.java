...
public class PaginationLimitOffsetOffsetParamsRes {
    ...
    public PaginationLimitOffsetOffsetParamsRes withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public PaginationLimitOffsetOffsetParamsRes withResultArray(List<Long> resultArray) {
        Utils.checkNotNull(resultArray, "resultArray");
        this.resultArray = resultArray;
        return this;
    }
