...
public class PaginationLimitOffsetPageParamsRes {
    ...
    public PaginationLimitOffsetPageParamsRes withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public PaginationLimitOffsetPageParamsRes withResultArray(List<Long> resultArray) {
        Utils.checkNotNull(resultArray, "resultArray");
        this.resultArray = resultArray;
        return this;
    }
