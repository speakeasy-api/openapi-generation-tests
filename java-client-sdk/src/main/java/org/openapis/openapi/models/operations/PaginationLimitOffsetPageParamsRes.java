...
public class PaginationLimitOffsetPageParamsRes {
    ...
    @JsonCreator
    public PaginationLimitOffsetPageParamsRes(
    ...
    public PaginationLimitOffsetPageParamsRes withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public PaginationLimitOffsetPageParamsRes withResultArray(java.util.List<Long> resultArray) {
        Utils.checkNotNull(resultArray, "resultArray");
        this.resultArray = resultArray;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PaginationLimitOffsetPageParamsRes other = (PaginationLimitOffsetPageParamsRes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PaginationLimitOffsetPageParamsRes.class,
                "next", next,
                "numPages", numPages,
    ...
    public final static class Builder {
        ...
        public PaginationLimitOffsetPageParamsRes build() {
            return new PaginationLimitOffsetPageParamsRes(
                next,
                numPages,
                resultArray);
        }
