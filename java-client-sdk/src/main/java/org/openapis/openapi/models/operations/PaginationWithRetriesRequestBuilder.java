...
public class PaginationWithRetriesRequestBuilder {
    ...
    private Optional<String> faultSettings = Utils.readDefaultOrConstValue(
                            "faultSettings",
                            "\"{\\\"error_code\\\": 503, \\\"error_count\\\": 3}\"",
                            new TypeReference<Optional<String>>() {});
    private Optional<String> requestId = Utils.readDefaultOrConstValue(
                            "requestId",
    ...
    public PaginationWithRetriesRequestBuilder cursor(java.lang.String cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = Optional.of(cursor);
        return this;
    }

    public PaginationWithRetriesRequestBuilder cursor(java.util.Optional<java.lang.String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
                
    public PaginationWithRetriesRequestBuilder faultSettings(java.lang.String faultSettings) {
        Utils.checkNotNull(faultSettings, "faultSettings");
        this.faultSettings = Optional.of(faultSettings);
        return this;
    }

    public PaginationWithRetriesRequestBuilder faultSettings(java.util.Optional<java.lang.String> faultSettings) {
        Utils.checkNotNull(faultSettings, "faultSettings");
        this.faultSettings = faultSettings;
        return this;
    }
                
    public PaginationWithRetriesRequestBuilder requestId(java.lang.String requestId) {
        Utils.checkNotNull(requestId, "requestId");
        this.requestId = Optional.of(requestId);
        return this;
    }

    public PaginationWithRetriesRequestBuilder requestId(java.util.Optional<java.lang.String> requestId) {
        Utils.checkNotNull(requestId, "requestId");
        this.requestId = requestId;
        return this;
    }
                
    public PaginationWithRetriesRequestBuilder serverURL(java.lang.String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public PaginationWithRetriesRequestBuilder serverURL(java.util.Optional<java.lang.String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
    ...
    public PaginationWithRetriesRequestBuilder retryConfig(java.util.Optional<org.openapis.openapi.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
     ...
     * @throws {@link SDKError} if HTTP status code >= 300 is encountered
     **/         
    public Stream<java.lang.String> callAsStreamUnwrapped() {
        return callAsStream()
            .flatMap(x -> x.res()
                           .stream()
