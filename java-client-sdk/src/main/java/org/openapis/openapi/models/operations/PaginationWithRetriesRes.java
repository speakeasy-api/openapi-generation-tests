...
public class PaginationWithRetriesRes {
    ...
    public PaginationWithRetriesRes withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public PaginationWithRetriesRes withResultArray(java.util.List<String> resultArray) {
        Utils.checkNotNull(resultArray, "resultArray");
        this.resultArray = resultArray;
        return this;
    }
