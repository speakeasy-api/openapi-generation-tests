...
public class PaginationWrappedOptionalBodyRes {
    ...
    @JsonCreator
    public PaginationWrappedOptionalBodyRes(
    ...
    public PaginationWrappedOptionalBodyRes withNext(String next) {
        Utils.checkNotNull(next, "next");
        this.next = Optional.ofNullable(next);
        return this;
    }

    public PaginationWrappedOptionalBodyRes withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public PaginationWrappedOptionalBodyRes withNumPages(long numPages) {
        Utils.checkNotNull(numPages, "numPages");
        this.numPages = numPages;
        return this;
    }

    public PaginationWrappedOptionalBodyRes withResultArray(List<Long> resultArray) {
        Utils.checkNotNull(resultArray, "resultArray");
        this.resultArray = resultArray;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PaginationWrappedOptionalBodyRes other = (PaginationWrappedOptionalBodyRes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PaginationWrappedOptionalBodyRes.class,
                "next", next,
                "numPages", numPages,
    ...
    public final static class Builder {
        ...
        public PaginationWrappedOptionalBodyRes build() {
            return new PaginationWrappedOptionalBodyRes(
                next,
                numPages,
                resultArray);
        }
