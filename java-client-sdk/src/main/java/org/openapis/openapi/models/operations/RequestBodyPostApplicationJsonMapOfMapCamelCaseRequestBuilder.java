...
public class RequestBodyPostApplicationJsonMapOfMapCamelCaseRequestBuilder {
    ...
    public RequestBodyPostApplicationJsonMapOfMapCamelCaseRequestBuilder request(Map<String, Map<String, SimpleObjectCamelCase>> request) {
    ...
    public RequestBodyPostApplicationJsonMapOfMapCamelCaseRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
