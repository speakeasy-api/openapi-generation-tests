...
public class RequestBodyPostMultipleContentTypesSplitJsonRes {
    ...
    public RequestBodyPostMultipleContentTypesSplitJsonRes withForm(java.util.Map<String, java.lang.Object> form) {
        Utils.checkNotNull(form, "form");
        this.form = Optional.ofNullable(form);
        return this;
    }

    public RequestBodyPostMultipleContentTypesSplitJsonRes withForm(Optional<? extends java.util.Map<String, java.lang.Object>> form) {
        Utils.checkNotNull(form, "form");
        this.form = form;
        return this;
    }

    public RequestBodyPostMultipleContentTypesSplitJsonRes withJson(java.util.Map<String, java.lang.Object> json) {
        Utils.checkNotNull(json, "json");
        this.json = JsonNullable.of(json);
        return this;
    }

    public RequestBodyPostMultipleContentTypesSplitJsonRes withJson(JsonNullable<? extends java.util.Map<String, java.lang.Object>> json) {
        Utils.checkNotNull(json, "json");
        this.json = json;
        return this;
    }
