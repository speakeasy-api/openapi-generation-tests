...
public class RequestBodyPutStringWithParamsRequestBuilder {
    ...
    public RequestBodyPutStringWithParamsRequestBuilder requestBody(String requestBody) {
        Utils.checkNotNull(requestBody, "requestBody");
        this.requestBody = requestBody;
        return this;
    }

    public RequestBodyPutStringWithParamsRequestBuilder queryStringParam(String queryStringParam) {
