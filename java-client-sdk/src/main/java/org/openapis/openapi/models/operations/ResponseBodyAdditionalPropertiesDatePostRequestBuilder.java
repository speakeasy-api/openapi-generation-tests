...
public class ResponseBodyAdditionalPropertiesDatePostRequestBuilder {
    ...
    private java.util.Map<String, LocalDate> request = new java.util.HashMap<>();
    ...
    public ResponseBodyAdditionalPropertiesDatePostRequestBuilder request(java.util.Map<String, LocalDate> request) {
