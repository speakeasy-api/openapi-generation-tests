...
public class ServerWithProtocolTemplateRequestBuilder {
    ...
    public ServerWithProtocolTemplateRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public ServerWithProtocolTemplateRequestBuilder serverURL(java.util.Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
