...
public class ArrObjValue {
    ...
    @JsonProperty("json")
    private Optional<? extends List<SimpleObject>> json;
    ...
    @JsonCreator
    public ArrObjValue(
            @JsonProperty("json") Optional<? extends List<SimpleObject>> json,
    ...
    @JsonIgnore
    public Optional<List<SimpleObject>> json() {
        return (Optional<List<SimpleObject>>) json;
    }
    ...
    public ArrObjValue withJson(List<SimpleObject> json) {
        Utils.checkNotNull(json, "json");
        this.json = Optional.ofNullable(json);
        return this;
    }

    public ArrObjValue withJson(Optional<? extends List<SimpleObject>> json) {
        Utils.checkNotNull(json, "json");
        this.json = json;
        return this;
    }
    ...
    public ArrObjValue withRequired(Optional<? extends Object> required) {
        Utils.checkNotNull(required, "required");
        this.required = required;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<SimpleObject>> json = Optional.empty();
        ...
        public Builder json(List<SimpleObject> json) {
            Utils.checkNotNull(json, "json");
            this.json = Optional.ofNullable(json);
            return this;
        }

        public Builder json(Optional<? extends List<SimpleObject>> json) {
            Utils.checkNotNull(json, "json");
            this.json = json;
            return this;
        }
