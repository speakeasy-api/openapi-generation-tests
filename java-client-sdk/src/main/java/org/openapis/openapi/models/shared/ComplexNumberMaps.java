...
public class ComplexNumberMaps {
    ...
    @JsonIgnore
    public Optional<java.util.Map<String, BigInteger>> bigintMap() {
        return (Optional<java.util.Map<String, BigInteger>>) bigintMap;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.Map<String, BigInteger>> bigintStrMap() {
        return (Optional<java.util.Map<String, BigInteger>>) bigintStrMap;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.Map<String, BigDecimal>> decimalMap() {
        return (Optional<java.util.Map<String, BigDecimal>>) decimalMap;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.Map<String, BigDecimal>> decimalStrMap() {
        return (Optional<java.util.Map<String, BigDecimal>>) decimalStrMap;
    }
