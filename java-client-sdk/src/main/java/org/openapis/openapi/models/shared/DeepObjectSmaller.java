...
public class DeepObjectSmaller {
    ...
    public DeepObjectSmaller withArr(java.util.List<SimpleObject> arr) {
        Utils.checkNotNull(arr, "arr");
        this.arr = arr;
        return this;
    }
    ...
    public DeepObjectSmaller withMap(java.util.Map<String, SimpleObject> map) {
    ...
    public DeepObjectSmaller withType(Optional<? extends String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
