...
public class DeepObjectWithType implements StronglyTypedOneOfObject {
    ...
    public DeepObjectWithType withArr(List<SimpleObject> arr) {
        Utils.checkNotNull(arr, "arr");
        this.arr = arr;
        return this;
    }
    ...
    public DeepObjectWithType withMap(Map<String, SimpleObject> map) {
    ...
    public DeepObjectWithType withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
