...
public class DefaultsAndConsts {
    ...
    public Optional<Boolean> defaultBool() {
        return (Optional<Boolean>) defaultBool;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<LocalDate> defaultDate() {
        return (Optional<LocalDate>) defaultDate;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<OffsetDateTime> defaultDateTime() {
        return (Optional<OffsetDateTime>) defaultDateTime;
    }
    ...
    public Optional<Long> defaultInt() {
        return (Optional<Long>) defaultInt;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<Double> defaultNum() {
        return (Optional<Double>) defaultNum;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<String> defaultStr() {
        return (Optional<String>) defaultStr;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<String> defaultStrDQuotes() {
        return (Optional<String>) defaultStrDQuotes;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<String> defaultStrNullable() {
        return (JsonNullable<String>) defaultStrNullable;
    }
    ...
    public Optional<String> defaultStrSQuotes() {
        return (Optional<String>) defaultStrSQuotes;
    }
