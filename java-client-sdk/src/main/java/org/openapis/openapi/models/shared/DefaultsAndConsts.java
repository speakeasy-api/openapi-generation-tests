...
public class DefaultsAndConsts {
    ...
    private Optional<String> constStrNull;
    ...
    private Optional<Boolean> defaultBool;

    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("defaultDate")
    private Optional<LocalDate> defaultDate;

    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("defaultDateTime")
    private Optional<OffsetDateTime> defaultDateTime;
    ...
    private Optional<Long> defaultInt;

    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("defaultNum")
    private Optional<Double> defaultNum;

    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("defaultStr")
    private Optional<String> defaultStr;

    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("defaultStrDQuotes")
    private Optional<String> defaultStrDQuotes;

    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("defaultStrNullable")
    private JsonNullable<String> defaultStrNullable;

    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("defaultStrOptional")
    private Optional<String> defaultStrOptional;

    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("defaultStrSQuotes")
    private Optional<String> defaultStrSQuotes;
    ...
    public DefaultsAndConsts(
            ...
            @JsonProperty("defaultBool") Optional<Boolean> defaultBool,
            @JsonProperty("defaultDate") Optional<LocalDate> defaultDate,
            @JsonProperty("defaultDateTime") Optional<OffsetDateTime> defaultDateTime,
            ...
            @JsonProperty("defaultInt") Optional<Long> defaultInt,
            @JsonProperty("defaultNum") Optional<Double> defaultNum,
            @JsonProperty("defaultStr") Optional<String> defaultStr,
            @JsonProperty("defaultStrDQuotes") Optional<String> defaultStrDQuotes,
            @JsonProperty("defaultStrNullable") JsonNullable<String> defaultStrNullable,
            @JsonProperty("defaultStrOptional") Optional<String> defaultStrOptional,
            @JsonProperty("defaultStrSQuotes") Optional<String> defaultStrSQuotes,
    ...
    public DefaultsAndConsts(
            String normalField) {
        this(Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), JsonNullable.undefined(), Optional.empty(), Optional.empty(), normalField);
    }
    ...
    @JsonIgnore
    public Optional<BigInteger> defaultBigInt() {
        return (Optional<BigInteger>) defaultBigInt;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<BigInteger> defaultBigIntStr() {
        return (Optional<BigInteger>) defaultBigIntStr;
    }

    @JsonIgnore
    public Optional<Boolean> defaultBool() {
        return defaultBool;
    }

    @JsonIgnore
    public Optional<LocalDate> defaultDate() {
        return defaultDate;
    }

    @JsonIgnore
    public Optional<OffsetDateTime> defaultDateTime() {
        return defaultDateTime;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<BigDecimal> defaultDecimal() {
        return (Optional<BigDecimal>) defaultDecimal;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<BigDecimal> defaultDecimalStr() {
        return (Optional<BigDecimal>) defaultDecimalStr;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<DefaultEnumInt> defaultEnumInt() {
        return (Optional<DefaultEnumInt>) defaultEnumInt;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<DefaultEnumStr> defaultEnumStr() {
        return (Optional<DefaultEnumStr>) defaultEnumStr;
    }

    @JsonIgnore
    public Optional<Long> defaultInt() {
        return defaultInt;
    }

    @JsonIgnore
    public Optional<Double> defaultNum() {
        return defaultNum;
    }

    @JsonIgnore
    public Optional<String> defaultStr() {
        return defaultStr;
    }

    @JsonIgnore
    public Optional<String> defaultStrDQuotes() {
        return defaultStrDQuotes;
    }

    @JsonIgnore
    public JsonNullable<String> defaultStrNullable() {
    ...
    @JsonIgnore
    public Optional<String> defaultStrSQuotes() {
    ...
    public DefaultsAndConsts withDefaultBool(Optional<Boolean> defaultBool) {
        Utils.checkNotNull(defaultBool, "defaultBool");
        this.defaultBool = defaultBool;
        return this;
    }
    ...
    public DefaultsAndConsts withDefaultDate(Optional<LocalDate> defaultDate) {
        Utils.checkNotNull(defaultDate, "defaultDate");
        this.defaultDate = defaultDate;
        return this;
    }
    ...
    public DefaultsAndConsts withDefaultDateTime(Optional<OffsetDateTime> defaultDateTime) {
        Utils.checkNotNull(defaultDateTime, "defaultDateTime");
        this.defaultDateTime = defaultDateTime;
        return this;
    }
    ...
    public DefaultsAndConsts withDefaultInt(Optional<Long> defaultInt) {
        Utils.checkNotNull(defaultInt, "defaultInt");
        this.defaultInt = defaultInt;
        return this;
    }
    ...
    public DefaultsAndConsts withDefaultNum(Optional<Double> defaultNum) {
        Utils.checkNotNull(defaultNum, "defaultNum");
        this.defaultNum = defaultNum;
        return this;
    }
    ...
    public DefaultsAndConsts withDefaultStr(Optional<String> defaultStr) {
        Utils.checkNotNull(defaultStr, "defaultStr");
        this.defaultStr = defaultStr;
        return this;
    }
    ...
    public DefaultsAndConsts withDefaultStrDQuotes(Optional<String> defaultStrDQuotes) {
        Utils.checkNotNull(defaultStrDQuotes, "defaultStrDQuotes");
        this.defaultStrDQuotes = defaultStrDQuotes;
        return this;
    }
    ...
    public DefaultsAndConsts withDefaultStrNullable(JsonNullable<String> defaultStrNullable) {
        Utils.checkNotNull(defaultStrNullable, "defaultStrNullable");
        this.defaultStrNullable = defaultStrNullable;
        return this;
    }
    ...
    public DefaultsAndConsts withDefaultStrOptional(Optional<String> defaultStrOptional) {
        Utils.checkNotNull(defaultStrOptional, "defaultStrOptional");
        this.defaultStrOptional = defaultStrOptional;
        return this;
    }
    ...
    public DefaultsAndConsts withDefaultStrSQuotes(Optional<String> defaultStrSQuotes) {
        Utils.checkNotNull(defaultStrSQuotes, "defaultStrSQuotes");
        this.defaultStrSQuotes = defaultStrSQuotes;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            Objects.deepEquals(this.constBigInt, other.constBigInt) &&
            Objects.deepEquals(this.constBigIntStr, other.constBigIntStr) &&
            Objects.deepEquals(this.constBool, other.constBool) &&
            Objects.deepEquals(this.constDate, other.constDate) &&
            Objects.deepEquals(this.constDateTime, other.constDateTime) &&
            Objects.deepEquals(this.constDecimal, other.constDecimal) &&
            Objects.deepEquals(this.constDecimalStr, other.constDecimalStr) &&
            Objects.deepEquals(this.constEnumInt, other.constEnumInt) &&
            Objects.deepEquals(this.constEnumStr, other.constEnumStr) &&
            Objects.deepEquals(this.constInt, other.constInt) &&
            Objects.deepEquals(this.constNum, other.constNum) &&
            Objects.deepEquals(this.constStr, other.constStr) &&
            Objects.deepEquals(this.constStrDQuotes, other.constStrDQuotes) &&
            Objects.deepEquals(this.constStrNull, other.constStrNull) &&
            Objects.deepEquals(this.constStrSQuotes, other.constStrSQuotes) &&
            Objects.deepEquals(this.defaultBigInt, other.defaultBigInt) &&
            Objects.deepEquals(this.defaultBigIntStr, other.defaultBigIntStr) &&
            Objects.deepEquals(this.defaultBool, other.defaultBool) &&
            Objects.deepEquals(this.defaultDate, other.defaultDate) &&
            Objects.deepEquals(this.defaultDateTime, other.defaultDateTime) &&
            Objects.deepEquals(this.defaultDecimal, other.defaultDecimal) &&
            Objects.deepEquals(this.defaultDecimalStr, other.defaultDecimalStr) &&
            Objects.deepEquals(this.defaultEnumInt, other.defaultEnumInt) &&
            Objects.deepEquals(this.defaultEnumStr, other.defaultEnumStr) &&
            Objects.deepEquals(this.defaultInt, other.defaultInt) &&
            Objects.deepEquals(this.defaultNum, other.defaultNum) &&
            Objects.deepEquals(this.defaultStr, other.defaultStr) &&
            Objects.deepEquals(this.defaultStrDQuotes, other.defaultStrDQuotes) &&
            Objects.deepEquals(this.defaultStrNullable, other.defaultStrNullable) &&
            Objects.deepEquals(this.defaultStrOptional, other.defaultStrOptional) &&
            Objects.deepEquals(this.defaultStrSQuotes, other.defaultStrSQuotes) &&
    ...
    public final static class Builder {
        ...
        public Builder defaultBool(Optional<Boolean> defaultBool) {
            Utils.checkNotNull(defaultBool, "defaultBool");
            this.defaultBool = defaultBool;
            return this;
        }
        ...
        public Builder defaultDate(Optional<LocalDate> defaultDate) {
            Utils.checkNotNull(defaultDate, "defaultDate");
            this.defaultDate = defaultDate;
            return this;
        }
        ...
        public Builder defaultDateTime(Optional<OffsetDateTime> defaultDateTime) {
            Utils.checkNotNull(defaultDateTime, "defaultDateTime");
            this.defaultDateTime = defaultDateTime;
            return this;
        }
        ...
        public Builder defaultInt(Optional<Long> defaultInt) {
            Utils.checkNotNull(defaultInt, "defaultInt");
            this.defaultInt = defaultInt;
            return this;
        }
        ...
        public Builder defaultNum(Optional<Double> defaultNum) {
            Utils.checkNotNull(defaultNum, "defaultNum");
            this.defaultNum = defaultNum;
            return this;
        }
        ...
        public Builder defaultStr(Optional<String> defaultStr) {
            Utils.checkNotNull(defaultStr, "defaultStr");
            this.defaultStr = defaultStr;
            return this;
        }
        ...
        public Builder defaultStrDQuotes(Optional<String> defaultStrDQuotes) {
            Utils.checkNotNull(defaultStrDQuotes, "defaultStrDQuotes");
            this.defaultStrDQuotes = defaultStrDQuotes;
            return this;
        }
        ...
        public Builder defaultStrNullable(JsonNullable<String> defaultStrNullable) {
            Utils.checkNotNull(defaultStrNullable, "defaultStrNullable");
            this.defaultStrNullable = defaultStrNullable;
            return this;
        }
        ...
        public Builder defaultStrOptional(Optional<String> defaultStrOptional) {
            Utils.checkNotNull(defaultStrOptional, "defaultStrOptional");
            this.defaultStrOptional = defaultStrOptional;
            return this;
        }
        ...
        public Builder defaultStrSQuotes(Optional<String> defaultStrSQuotes) {
            Utils.checkNotNull(defaultStrSQuotes, "defaultStrSQuotes");
            this.defaultStrSQuotes = defaultStrSQuotes;
            return this;
        }
        ...
        private static final LazySingletonValue<Optional<String>> _SINGLETON_VALUE_ConstStrNull =
                new LazySingletonValue<>(
                        "constStrNull",
                        "null",
        ...
        private static final LazySingletonValue<Optional<Boolean>> _SINGLETON_VALUE_DefaultBool =
                new LazySingletonValue<>(
                        "defaultBool",
                        "true",
                        new TypeReference<Optional<Boolean>>() {});

        private static final LazySingletonValue<Optional<LocalDate>> _SINGLETON_VALUE_DefaultDate =
                new LazySingletonValue<>(
                        "defaultDate",
                        "\"2020-01-01\"",
                        new TypeReference<Optional<LocalDate>>() {});

        private static final LazySingletonValue<Optional<OffsetDateTime>> _SINGLETON_VALUE_DefaultDateTime =
                new LazySingletonValue<>(
                        "defaultDateTime",
                        "\"2020-01-01T00:00:00Z\"",
        ...
        private static final LazySingletonValue<Optional<Long>> _SINGLETON_VALUE_DefaultInt =
                new LazySingletonValue<>(
                        "defaultInt",
                        "123",
                        new TypeReference<Optional<Long>>() {});

        private static final LazySingletonValue<Optional<Double>> _SINGLETON_VALUE_DefaultNum =
                new LazySingletonValue<>(
                        "defaultNum",
                        "123.456",
                        new TypeReference<Optional<Double>>() {});

        private static final LazySingletonValue<Optional<String>> _SINGLETON_VALUE_DefaultStr =
                new LazySingletonValue<>(
                        "defaultStr",
                        "\"default\"",
                        new TypeReference<Optional<String>>() {});

        private static final LazySingletonValue<Optional<String>> _SINGLETON_VALUE_DefaultStrDQuotes =
                new LazySingletonValue<>(
                        "defaultStrDQuotes",
                        "\"default with \\\"double quotes\\\"\"",
                        new TypeReference<Optional<String>>() {});

        private static final LazySingletonValue<JsonNullable<String>> _SINGLETON_VALUE_DefaultStrNullable =
                new LazySingletonValue<>(
                        "defaultStrNullable",
                        "null",
                        new TypeReference<JsonNullable<String>>() {});

        private static final LazySingletonValue<Optional<String>> _SINGLETON_VALUE_DefaultStrOptional =
                new LazySingletonValue<>(
                        "defaultStrOptional",
                        "\"default\"",
                        new TypeReference<Optional<String>>() {});

        private static final LazySingletonValue<Optional<String>> _SINGLETON_VALUE_DefaultStrSQuotes =
                new LazySingletonValue<>(
                        "defaultStrSQuotes",
