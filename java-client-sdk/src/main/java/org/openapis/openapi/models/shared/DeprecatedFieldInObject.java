...
public class DeprecatedFieldInObject {
    ...
    @Deprecated
    private Optional<String> deprecatedField;
    ...
    public DeprecatedFieldInObject(
            ...
            @JsonProperty("deprecatedField") Optional<String> deprecatedField,
            @JsonProperty("newField") Optional<String> newField) {
    ...
    @JsonIgnore
    public Optional<DeprecatedEnum> deprecatedEnum() {
        return (Optional<DeprecatedEnum>) deprecatedEnum;
    }
    ...
    @Deprecated
    @JsonIgnore
    public Optional<String> deprecatedField() {
        return deprecatedField;
    }

    @JsonIgnore
    public Optional<String> newField() {
        return newField;
    }
     ...
     */
    @Deprecated
    public DeprecatedFieldInObject withDeprecatedField(Optional<String> deprecatedField) {
        Utils.checkNotNull(deprecatedField, "deprecatedField");
        this.deprecatedField = deprecatedField;
        return this;
    }
    ...
    public DeprecatedFieldInObject withNewField(Optional<String> newField) {
        Utils.checkNotNull(newField, "newField");
        this.newField = newField;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            Objects.deepEquals(this.deprecatedEnum, other.deprecatedEnum) &&
            Objects.deepEquals(this.deprecatedField, other.deprecatedField) &&
            Objects.deepEquals(this.newField, other.newField);
    }
    ...
    public final static class Builder {
        ...
        @Deprecated
        private Optional<String> deprecatedField = Optional.empty();
 
        private Optional<String> newField = Optional.empty();  
         ...
         */
        @Deprecated
        public Builder deprecatedField(Optional<String> deprecatedField) {
            Utils.checkNotNull(deprecatedField, "deprecatedField");
            this.deprecatedField = deprecatedField;
            return this;
        }
        ...
        public Builder newField(Optional<String> newField) {
            Utils.checkNotNull(newField, "newField");
            this.newField = newField;
            return this;
        }
