...
public class ObjectWithNullEnums {
    ...
    private Optional<String> nullEnum;

    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("optNullEnum")
    private JsonNullable<String> optNullEnum;
    ...
    public final static class Builder {  
        ...
        private static final LazySingletonValue<Optional<String>> _SINGLETON_VALUE_NullEnum =
                new LazySingletonValue<>(
                        "nullEnum",
                        "null",
                        new TypeReference<Optional<String>>() {});

        private static final LazySingletonValue<JsonNullable<String>> _SINGLETON_VALUE_OptNullEnum =
                new LazySingletonValue<>(
                        "optNullEnum",
                        "null",
