...
public class SimpleObjectCamelCase {
    ...
    private Optional<Boolean> boolOptVal;
    ...
    private Optional<Long> intOptNullVal;
    ...
    private Optional<Double> numOptNullVal;
    ...
    private Optional<String> strOptVal;
    ...
    public SimpleObjectCamelCase(
            @JsonProperty("any_val") Object anyVal,
            ...
            @JsonProperty("bool_opt_val") Optional<Boolean> boolOptVal,
            ...
            @JsonProperty("int_opt_null_val") Optional<Long> intOptNullVal,
            @JsonProperty("int_val") long intVal,
            @JsonProperty("num_opt_null_val") Optional<Double> numOptNullVal,
            @JsonProperty("num_val") double numVal,
            @JsonProperty("str_opt_val") Optional<String> strOptVal,
    ...
    public SimpleObjectCamelCase(
            ...
            double numVal,
            String strVal) {
        this(anyVal, Optional.empty(), Optional.empty(), Optional.empty(), boolVal, dateTimeVal, dateVal, Optional.empty(), enumVal, float32Val, int32EnumVal, int32Val, intEnumVal, Optional.empty(), intVal, Optional.empty(), numVal, Optional.empty(), strVal);
    }
    ...
    @JsonIgnore
    public Optional<BigInteger> bigintStrVal() {
        return (Optional<BigInteger>) bigintStrVal;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<BigInteger> bigintVal() {
        return (Optional<BigInteger>) bigintVal;
    }
     ...
     */
    @JsonIgnore
    public Optional<Boolean> boolOptVal() {
        return boolOptVal;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<BigDecimal> decimalVal() {
        return (Optional<BigDecimal>) decimalVal;
    }
     ...
     */
    @JsonIgnore
    public Optional<Long> intOptNullVal() {
     ...
     */
    @JsonIgnore
    public Optional<Double> numOptNullVal() {
     ...
     */
    @JsonIgnore
    public Optional<String> strOptVal() {
        return strOptVal;
    }
     ...
     * An optional boolean property.
     */
    public SimpleObjectCamelCase withBoolOptVal(Optional<Boolean> boolOptVal) {
        Utils.checkNotNull(boolOptVal, "boolOptVal");
        this.boolOptVal = boolOptVal;
        return this;
    }
     ...
     * An optional integer property will be null for tests.
     */
    public SimpleObjectCamelCase withIntOptNullVal(Optional<Long> intOptNullVal) {
        Utils.checkNotNull(intOptNullVal, "intOptNullVal");
        this.intOptNullVal = intOptNullVal;
        return this;
    }
     ...
     * An optional number property will be null for tests.
     */
    public SimpleObjectCamelCase withNumOptNullVal(Optional<Double> numOptNullVal) {
        Utils.checkNotNull(numOptNullVal, "numOptNullVal");
        this.numOptNullVal = numOptNullVal;
        return this;
    }
     ...
     * An optional string property.
     */
    public SimpleObjectCamelCase withStrOptVal(Optional<String> strOptVal) {
        Utils.checkNotNull(strOptVal, "strOptVal");
        this.strOptVal = strOptVal;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Objects.deepEquals(this.bigintStrVal, other.bigintStrVal) &&
            Objects.deepEquals(this.bigintVal, other.bigintVal) &&
            Objects.deepEquals(this.boolOptVal, other.boolOptVal) &&
            Objects.deepEquals(this.boolVal, other.boolVal) &&
            Objects.deepEquals(this.dateTimeVal, other.dateTimeVal) &&
            Objects.deepEquals(this.dateVal, other.dateVal) &&
            Objects.deepEquals(this.decimalVal, other.decimalVal) &&
            Objects.deepEquals(this.enumVal, other.enumVal) &&
            Objects.deepEquals(this.float32Val, other.float32Val) &&
            Objects.deepEquals(this.int32EnumVal, other.int32EnumVal) &&
            Objects.deepEquals(this.int32Val, other.int32Val) &&
            Objects.deepEquals(this.intEnumVal, other.intEnumVal) &&
            Objects.deepEquals(this.intOptNullVal, other.intOptNullVal) &&
            Objects.deepEquals(this.intVal, other.intVal) &&
            Objects.deepEquals(this.numOptNullVal, other.numOptNullVal) &&
            Objects.deepEquals(this.numVal, other.numVal) &&
            Objects.deepEquals(this.strOptVal, other.strOptVal) &&
    ...
    public final static class Builder {
        ...
        private Optional<Boolean> boolOptVal = Optional.empty();
        ...
        private Optional<Long> intOptNullVal = Optional.empty();
 
        private Long intVal;
 
        private Optional<Double> numOptNullVal = Optional.empty();
 
        private Double numVal;
 
        private Optional<String> strOptVal = Optional.empty();
         ...
         * An any property.
         */
        public Builder anyVal(Object anyVal) {
            Utils.checkNotNull(anyVal, "anyVal");
            this.anyVal = anyVal;
            return this;
        }
         ...
         * An optional boolean property.
         */
        public Builder boolOptVal(Optional<Boolean> boolOptVal) {
            Utils.checkNotNull(boolOptVal, "boolOptVal");
            this.boolOptVal = boolOptVal;
            return this;
        }
         ...
         * An optional integer property will be null for tests.
         */
        public Builder intOptNullVal(Optional<Long> intOptNullVal) {
            Utils.checkNotNull(intOptNullVal, "intOptNullVal");
            this.intOptNullVal = intOptNullVal;
            return this;
        }
         ...
         * An optional number property will be null for tests.
         */
        public Builder numOptNullVal(Optional<Double> numOptNullVal) {
            Utils.checkNotNull(numOptNullVal, "numOptNullVal");
            this.numOptNullVal = numOptNullVal;
            return this;
        }
         ...
         * An optional string property.
         */
        public Builder strOptVal(Optional<String> strOptVal) {
            Utils.checkNotNull(strOptVal, "strOptVal");
            this.strOptVal = strOptVal;
            return this;
        }
