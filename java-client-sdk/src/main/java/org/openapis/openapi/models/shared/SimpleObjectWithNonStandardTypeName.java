...
public class SimpleObjectWithNonStandardTypeName implements StronglyTypedOneOfObjectWithNonStandardDiscriminatorName {
     ...
     * A float64 string
     */
    public SimpleObjectWithNonStandardTypeName withFloat64Str(Optional<? extends String> float64Str) {
        Utils.checkNotNull(float64Str, "float64Str");
        this.float64Str = float64Str;
        return this;
    }
     ...
     * An int64 string
     */
    public SimpleObjectWithNonStandardTypeName withInt64Str(Optional<? extends String> int64Str) {
        Utils.checkNotNull(int64Str, "int64Str");
        this.int64Str = int64Str;
        return this;
    }
