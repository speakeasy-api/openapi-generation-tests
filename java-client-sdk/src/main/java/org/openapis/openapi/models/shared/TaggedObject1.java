...
public class TaggedObject1 implements StronglyTypedOneOfDiscriminatedObject {

    @JsonProperty("imageURL")
    private String imageURL;

    @JsonProperty("tag")
    private TaggedObject1Tag tag;

    @JsonCreator
    public TaggedObject1(
            @JsonProperty("imageURL") String imageURL,
            @JsonProperty("tag") TaggedObject1Tag tag) {
    ...
    public TaggedObject1 withTag(TaggedObject1Tag tag) {
        Utils.checkNotNull(tag, "tag");
        this.tag = tag;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder tag(TaggedObject1Tag tag) {
            Utils.checkNotNull(tag, "tag");
            this.tag = tag;
            return this;
        }
