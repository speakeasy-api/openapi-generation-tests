...
public class ResponseBodiesTests { 
    ...
    public void testResponseBodies_ResponseBodyAdditionalPropertiesComplexNumbersPost() throws Exception {
        ...
        Map<String, BigInteger> req = Map.ofEntries(
                Map.entry("key", new BigInteger("592845")));
    ...
    public void testResponseBodies_ResponseBodyAdditionalPropertiesDatePost() throws Exception {
        ...
        Map<String, LocalDate> req = Map.ofEntries(
                Map.entry("key", LocalDate.parse("2024-07-14")));
        ...
        .json(Map.ofEntries(
            Map.entry("key", LocalDate.parse("2023-10-23"))))
        .build(),
            res.object().get());
    }
    ...
    public void testResponseBodies_ResponseBodyAdditionalPropertiesPost_String() throws Exception {
        ...
        .json(Map.ofEntries(
            Map.entry("key", "{key: 85794, key1: null, key2: \"<value>\"}")))
        .build(),
            res.object().get());
    }
    ...
    public void testResponseBodies_ResponseBodyDecimalStr() throws Exception {
        ...
        BigDecimal req = new BigDecimal("5448.83");
