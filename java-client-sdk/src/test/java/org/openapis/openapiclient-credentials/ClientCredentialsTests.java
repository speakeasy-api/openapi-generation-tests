...
public final class ClientCredentialsTests {
    ...
    public void testRequestUntouchedIfOauthScopesNotPresent() throws Exception {
        ...
        BeforeRequestContext c = new BeforeRequestContextImpl("operationId", Optional.empty(), Optional.empty());
    ...
    public void testRequestUntouchedIfSecuritySourceNotPresent() throws Exception {
        ...
        BeforeRequestContext c = new BeforeRequestContextImpl("operationId", Optional.of(Arrays.asList("read")), Optional.empty());
        assertEquals(request, hook.beforeRequest(c, request));
    }
