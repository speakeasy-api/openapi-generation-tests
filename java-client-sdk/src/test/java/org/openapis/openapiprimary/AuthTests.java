...
public class AuthTests {
    ...
    void testApiKeyAuthGlobal() throws Exception {
        ...
        ApiKeyAuthGlobalNewResponse res = s.authNew().apiKeyAuthGlobalNew()
                .request(
    ...
    void testOauth2Auth() throws Exception {
        ...
        Oauth2AuthNewResponse res = s.authNew()
                .oauth2AuthNew()
                .request(
                    AuthServiceRequestBody.builder()
                        .headerAuth(List.of(
    ...
    void testOpenIdConnectAuth() throws Exception {
        ...
        OpenIdConnectAuthNewResponse res = s.authNew()
                ...
                .request(
                    AuthServiceRequestBody.builder()
                        ...
                        .build())
                .security(
                    OpenIdConnectAuthNewSecurity.builder()
        ...
        MultipleSimpleSchemeAuthResponse res = s.authNew()
                ...
                .request(
                    AuthServiceRequestBody.builder()
                        ...
                        .build())
                .security(
                    MultipleSimpleSchemeAuthSecurity.builder()
                        .oauth2("Bearer testToken")
                        .apiKeyAuthNew("test_api_key")
                        .build())
                .call();
        ...
        MultipleMixedSchemeAuthResponse res = s.authNew()
                ...
                .request(
                    AuthServiceRequestBody.builder()
                        ...
                        .build())
                .security(
                    MultipleMixedSchemeAuthSecurity.builder()
        ...
        MultipleSimpleOptionsAuthResponse res = s.authNew()
                ...
                .request(
                    AuthServiceRequestBody.builder()
                        ...
                        .build())
                .security(
                    MultipleSimpleOptionsAuthSecurity.builder()
                        .apiKeyAuthNew("test_api_key")
                        .build())
                .call();
                ...
                .request(
                    AuthServiceRequestBody.builder()
                        .headerAuth(List.of(
                            ...
                            .build())
                .security(
                    MultipleMixedOptionsAuthSecurity.builder()
                        .apiKeyAuthNew("test_api_key")
                        .build())
                .call();
        ...
        MultipleOptionsWithSimpleSchemesAuthResponse res = s.authNew()
                ...
                .request(
                    AuthServiceRequestBody.builder()
                        ...
                        .build())
                .security(
                    MultipleOptionsWithSimpleSchemesAuthSecurity.builder()
    ...
    void testMultipleOptionsWithSimpleSchemesAuthSecondOption() throws Exception {
        ...
        MultipleOptionsWithSimpleSchemesAuthResponse res = s.authNew()
                ...
                .security(
                    MultipleOptionsWithSimpleSchemesAuthSecurity.builder()
                        .option2(
                            MultipleOptionsWithSimpleSchemesAuthSecurityOption2.builder()
                                .apiKeyAuthNew("test_api_key")
                                .openIdConnect("Bearer testToken")
                                .build())
                        .build())
        ...
        MultipleOptionsWithMixedSchemesAuthResponse res = s.authNew()
                ...
                .request(
                    AuthServiceRequestBody.builder()
                        ...
                        .build())
                .security(
                    MultipleOptionsWithMixedSchemesAuthSecurity.builder()
                        .option1(
                            MultipleOptionsWithMixedSchemesAuthSecurityOption1.builder()
                                .apiKeyAuthNew("test_api_key")
                                .oauth2("Bearer testToken")
                                .build())
                        .build())
    ...
    void testMultipleOptionsWithMixedSchemesAuthSecondOption() throws Exception {
        ...
        MultipleOptionsWithMixedSchemesAuthResponse res = s.authNew()
                ...
                .security(
                    MultipleOptionsWithMixedSchemesAuthSecurity.builder()
                        .option2(
                            MultipleOptionsWithMixedSchemesAuthSecurityOption2.builder()
                                .apiKeyAuthNew("test_api_key")
                                .basicAuth(SchemeBasicAuth.builder()
                                    .username("testUser")
                                    .password("testPass")
    ...
    @Test
    void testFunctionCallbacksForOAuthSupportOperationLevelSecurityOverrides() throws Exception {
        ...
        Oauth2AuthResponse res = s.auth().oauth2Auth()
        ...
        assertNotNull(res);
        assertEquals("local", res.token().get().token());
    }

    @Test
    void testFunctionCallbacksForOAuthSupportParamOverrides() throws Exception {
        ...
        Oauth2OverrideResponse res = s.auth().oauth2Override()
                .security(
                    Oauth2OverrideSecurity.builder()
                        .oauth2("Bearer overrideHeaders")
                        .build())
                .call();

        assertNotNull(res);
        assertEquals("overrideHeaders", res.token().get().token());
    }
