...
public class ErrorTests {
    ...
    void testStatusGetErrorDefaultErrorCodes() throws Exception {
        ...
        SDKError thrown = assertThrows(SDKError.class, () -> {
    ...
    void testStatusGetError300NonError() throws Exception {
        CommonHelpers.recordTest("errors-status-get-error-300-non-error");
    ...
    void testStatusGetXSpeakeasyErrors() throws Exception {
        ...
        SDKError thrown = assertThrows(SDKError.class, () -> {
            StatusGetXSpeakeasyErrorsResponse res = s.errors().statusGetXSpeakeasyErrors(400l, Optional.empty());
        });
        assertTrue(thrown.message().contains("API error occurred"));
        assertEquals(400, thrown.code());
        assertEquals(400, thrown.rawResponse().statusCode());

        thrown = assertThrows(SDKError.class, () -> {
            StatusGetXSpeakeasyErrorsResponse res = s.errors().statusGetXSpeakeasyErrors(401l, Optional.empty());
        });
        assertTrue(thrown.message().contains("API error occurred"));
        ...
        thrown = assertThrows(SDKError.class, () -> {
            StatusGetXSpeakeasyErrorsResponse res = s.errors().statusGetXSpeakeasyErrors(402l, Optional.empty());
        });
        assertTrue(thrown.message().contains("API error occurred"));
        assertEquals(402, thrown.code());
        assertEquals(402, thrown.rawResponse().statusCode());

        org.openapis.openapi.models.errors.Error eThrown = assertThrows(org.openapis.openapi.models.errors.Error.class,
                () -> {
                    StatusGetXSpeakeasyErrorsResponse res = s.errors().statusGetXSpeakeasyErrors(500l, Optional.empty());
                });
        assertTrue(eThrown.message().get().contains("an error occurred"));
        assertEquals("500", eThrown.code().get());

        org.openapis.openapi.models.errors.StatusGetXSpeakeasyErrorsResponseBody oThrown = assertThrows(
                org.openapis.openapi.models.errors.StatusGetXSpeakeasyErrorsResponseBody.class, () -> {
                    StatusGetXSpeakeasyErrorsResponse res = s.errors().statusGetXSpeakeasyErrors(501l, Optional.empty());
                });
