...
final class UnionTest extends TestCase
{
    ...
    // Skip until nullable support added.
    ...
    // TODO: handle top level Date/DateTime serialization
    ...
    //     $response = $sdk->unions->unionDateNull(request: new DateTime('2020-01-01'));
    //     $this->assertNotNull($response);
    //     $this->assertEquals(200, $response->httpMeta->response->getStatusCode());
