...
try {
    ...
    $response = $sdk->flattening->componentBodyAndParamConflict($simpleObject, 'South');
...
try {
    ...
    $response = $sdk->flattening->componentBodyAndParamNoConflict('laboriosam', $simpleObject);
...
try {
    ...
    $requestBody->str = 'Gastonia';

    $response = $sdk->flattening->inlineBodyAndParamConflict($requestBody, 'Chief');
...
try {
    ...
    $requestBody->bodyStr = 'withdrawal';

    $response = $sdk->flattening->inlineBodyAndParamNoConflict($requestBody, 'encryption');
