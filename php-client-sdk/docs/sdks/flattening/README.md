...
$request = new Shared\ObjWithOptionalProperties();

$response = $sdk->flattening->requiredBodyAllOptional(
    request: $request
);
...
**[?Operations\RequiredBodyAllOptionalResponse](../../Models/Operations/RequiredBodyAllOptionalResponse.md)**
