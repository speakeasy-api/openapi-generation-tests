...
$request = new Shared\LimitOffsetConfigWithDefaults();

$responses = $sdk->pagination->paginationLimitOffsetDefaultOffsetBody(
    request: $request
);
...
$responses = $sdk->pagination->paginationLimitOffsetDefaultOffsetParams(
    limit: 15,
    offset: 10
...
$responses = $sdk->pagination->paginationLimitOffsetOptionalPageParams(
    page: 624091
);
