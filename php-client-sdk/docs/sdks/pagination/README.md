...
try {
    ...
    $response = $sdk->pagination->paginationCursorParams(704415);
...
try {
    ...
    $response = $sdk->pagination->paginationLimitOffsetOffsetParams(164694, 500026);
...
try {
    ...
    $response = $sdk->pagination->paginationLimitOffsetPageParams(699098);
