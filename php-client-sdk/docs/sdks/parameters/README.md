...
$request = new Operations\HeaderParamsNilRequest(
    nullableHeader: '<value>',
);

$response = $sdk->parameters->headerParamsNil(
    request: $request
);
...
**[?Operations\HeaderParamsNilResponse](../../Models/Operations/HeaderParamsNilResponse.md)**
