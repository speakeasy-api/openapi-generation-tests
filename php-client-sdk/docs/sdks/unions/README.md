...
| ------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| `$request`                                                                | [array<Shared\SimpleObjectWithType\|Shared\DeepObjectWithType>](../../.md) | :heavy_check_mark:                                                        | The request object to use for the request.                                |
...
$request = LocalDate::parse('2024-11-25');
...
$request = Utils\Utils::parseDateTime('2023-10-13T05:48:39.528Z');
...
$request = Utils\Utils::parseDateTime('2024-04-12T05:53:48.181Z');
...
| Parameter                                                                                                  | Type                                                                                                       | Required                                                                                                   | Description                                                                                                |
| ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| `$request`                                                                                                 | [array<Shared\One>\|array<Shared\UnionOfArrays2>\|array<Shared\Three>](../../Models/Shared/UnionOfArrays.md) | :heavy_check_mark:                                                                                         | The request object to use for the request.                                                                 |
