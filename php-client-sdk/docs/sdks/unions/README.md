...
try {
    $request = new Shared\DeepObjectWithType(
        ...
        int: 1,
        map: [
            'surprisingly' => new Shared\SimpleObject,
        ],
        num: 1.1,
...
try {
    $request = new Shared\SimpleObjectWithNonStandardTypeName(
        ...
        int: 1,
        int32: 1,
        int32Enum: Shared\SimpleObjectWithNonStandardTypeNameInt32Enum::OneHundredAndEightyOne,
        intEnum: Shared\SimpleObjectWithNonStandardTypeNameIntEnum::Third,
        num: 1.1,
        objType: '<value>',
        str: 'test',
        bigint: 8821239038968084,
...
try {
    $request = Utils\Utils::parseDateTime('2022-06-19T22:09:58.311Z');
