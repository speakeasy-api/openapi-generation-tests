...
try {
    ...
    $request->nullableOneOfTwo = 152354;
...
try {
    ...
    $request->any = 'voluptas';
    $request->bigint = 604118;
    ...
    $request->decimal = 3828.08;
    $request->enum = Enum::Two;
    $request->float32 = 2.2222222;
    $request->int = 999999;
    $request->int32 = 1;
    $request->int32Enum = SimpleObjectWithTypeInt32Enum::OneHundredAndEightyOne;
    $request->intEnum = SimpleObjectWithTypeIntEnum::Third;
...
try {
    ...
    $request->any = 'sed';
    $request->bigint = 592231;
    $request->bigintStr = 'eius';
    $request->bool = true;
    $request->boolOpt = true;
    $request->date = DateTime::createFromFormat('Y-m-d', '2020-01-01');
    $request->dateTime = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2020-01-01T00:00:00Z');
    $request->decimal = 8967.62;
    $request->enum = Enum::Two;
    $request->float32 = 2.2222222;
    $request->int = 999999;
    $request->int32 = 1;
