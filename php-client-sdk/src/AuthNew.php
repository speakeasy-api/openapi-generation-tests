...
class AuthNew
{
    ...
    public function authGlobal(
        Shared\AuthServiceRequestBody $request,
    ...
    public function basicAuthNew(
        Shared\AuthServiceRequestBody $request,
        Operations\BasicAuthNewSecurity $security,
        ?string $serverURL = null,
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function customSchemeAppId(
        Operations\CustomSchemeAppIdSecurity $security,
        ?string $serverURL = null,
    ...
    public function multipleMixedOptionsAuth(
        Shared\AuthServiceRequestBody $request,
        Operations\MultipleMixedOptionsAuthSecurity $security,
        ?string $serverURL = null,
    ...
    public function multipleMixedSchemeAuth(
        Shared\AuthServiceRequestBody $request,
        Operations\MultipleMixedSchemeAuthSecurity $security,
        ?string $serverURL = null,
    ...
    public function multipleOptionsWithMixedSchemesAuth(
        Shared\AuthServiceRequestBody $request,
        Operations\MultipleOptionsWithMixedSchemesAuthSecurity $security,
        ?string $serverURL = null,
    ...
    public function multipleOptionsWithSimpleSchemesAuth(
        Shared\AuthServiceRequestBody $request,
        Operations\MultipleOptionsWithSimpleSchemesAuthSecurity $security,
        ?string $serverURL = null,
    ...
    public function multipleSimpleOptionsAuth(
        Shared\AuthServiceRequestBody $request,
        Operations\MultipleSimpleOptionsAuthSecurity $security,
        ?string $serverURL = null,
    ...
    public function multipleSimpleSchemeAuth(
        Shared\AuthServiceRequestBody $request,
        Operations\MultipleSimpleSchemeAuthSecurity $security,
        ?string $serverURL = null,
    ...
    public function openIdConnectAuthNew(
        Shared\AuthServiceRequestBody $request,
        Operations\OpenIdConnectAuthNewSecurity $security,
        ?string $serverURL = null,
