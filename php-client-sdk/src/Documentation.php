...
class Documentation
{
    ...
    public function getDocumentationPerLanguage(string $language): Operations\GetDocumentationPerLanguageResponse
    {
        ...
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(Operations\GetDocumentationPerLanguageRequest::class, $request, $this->sdkConfiguration->globals));
