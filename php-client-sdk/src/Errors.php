...
class Errors
{
    ...
    public const UNION_ERRORS_DISCRIMINATED_GET_SERVERS = [
     ...
     *
     * @param  \OpenAPI\OpenAPI\Models\Operations\ErrorTag  $errorTag
     * @param  string  $serverURL
     * @return \OpenAPI\OpenAPI\Models\Operations\UnionErrorsDiscriminatedGetResponse
     */
    public function unionErrorsDiscriminatedGet(
        \OpenAPI\OpenAPI\Models\Operations\ErrorTag $errorTag,
        ?string $serverURL = null,
    ): \OpenAPI\OpenAPI\Models\Operations\UnionErrorsDiscriminatedGetResponse {
        $request = new \OpenAPI\OpenAPI\Models\Operations\UnionErrorsDiscriminatedGetRequest();
        $request->errorTag = $errorTag;
        $baseUrl = Utils\Utils::templateUrl(Errors::UNION_ERRORS_DISCRIMINATED_GET_SERVERS[0], [
        ]);
        if (! empty($serverURL)) {
            $baseUrl = $serverURL;
        }
        $url = Utils\Utils::generateUrl($baseUrl, '/errors/unionErrorsDiscriminated');
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\UnionErrorsDiscriminatedGetRequest::class, $request, $this->sdkConfiguration->globals));
        $options['headers']['Accept'] = 'application/json';
        $options['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UnionErrorsDiscriminatedGetResponse();
        $response->statusCode = $statusCode;
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        if ($httpResponse->getStatusCode() === 200) {
