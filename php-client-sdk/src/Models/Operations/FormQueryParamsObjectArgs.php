...
class FormQueryParamsObjectArgs
{
     ...
     * @param  ?string  $strOpt
     */
    public function __construct(?string $any = null, ?string $bool = null, ?string $date = null, ?string $dateTime = null, ?string $enum = null, ?string $float32 = null, ?string $int = null, ?string $int32 = null, ?string $int32Enum = null, ?string $intEnum = null, ?string $num = null, ?string $objParam = null, ?string $str = null, ?string $bigint = null, ?string $bigintStr = null, ?string $boolOpt = null, ?string $decimal = null, ?string $decimalStr = null, ?string $float64Str = null, ?string $int64Str = null, ?string $intOptNull = null, ?string $numOptNull = null, ?string $strOpt = null)
    {
        $this->any = $any;
        $this->bool = $bool;
        $this->date = $date;
