...
class RequestBodyPostComplexNumberTypesRequest
{
     ...
     */
    public function __construct(Shared\ComplexNumberTypes $complexNumberTypes, int $pathBigInt, string $pathBigIntStr, float $pathDecimal, string $pathDecimalStr, int $queryBigInt, string $queryBigIntStr, float $queryDecimal, string $queryDecimalStr)
    {
