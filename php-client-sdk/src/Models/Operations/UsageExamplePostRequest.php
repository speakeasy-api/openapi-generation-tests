...
class UsageExamplePostRequest
{
     ...
     */
    public function __construct(?int $bigintParameter = null, ?string $bigintStrParameter = null, ?bool $boolParameter = null, ?LocalDate $dateParameter = null, ?\DateTime $dateTimeDefaultParameter = null, ?\DateTime $dateTimeParameter = null, ?float $decimalParameter = null, ?string $decimalStrParameter = null, ?float $doubleParameter = null, ?EnumParameter $enumParameter = null, ?float $falseyNumberParameter = null, ?float $float32Parameter = null, ?string $float64StringParameter = null, ?float $floatParameter = null, ?int $int64Parameter = null, ?string $int64StringParameter = null, ?int $intParameter = null, ?string $strParameter = null, ?UsageExamplePostRequestBody $requestBody = null, ?int $bigintParameterOptional = null, ?string $bigintStrParameterOptional = null, ?float $decimalParameterOptional = null, ?string $decimalStrParameterOptional = null, ?OptEnumParameter $optEnumParameter = null)
    {
