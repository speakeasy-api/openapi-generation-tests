...
class DeepObjectCamelCase
{
    ...
    /**
     * @param  SimpleObjectCamelCase|string|null  $anyVal
     ...
     * @param  ?string  $type
     */
    public function __construct(SimpleObjectCamelCase|string|null $anyVal = null, ?array $arrVal = null, ?bool $boolVal = null, ?int $intVal = null, ?array $mapVal = null, ?float $numVal = null, ?SimpleObjectCamelCase $objVal = null, ?string $strVal = null, ?string $type = null)
    {
        $this->anyVal = $anyVal;
        $this->arrVal = $arrVal;
