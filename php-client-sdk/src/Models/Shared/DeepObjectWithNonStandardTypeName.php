...
class DeepObjectWithNonStandardTypeName
{
     ...
     * @param  ?string  $type
     */
    public function __construct(SimpleObject|string|null $any = null, ?array $arr = null, ?bool $bool = null, ?int $int = null, ?array $map = null, ?float $num = null, ?SimpleObject $obj = null, ?string $str = null, ?string $objType = null, ?string $type = null)
    {
        $this->any = $any;
        $this->arr = $arr;
        $this->bool = $bool;
