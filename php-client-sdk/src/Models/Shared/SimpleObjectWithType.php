...
class SimpleObjectWithType
{
     ...
     * @param  ?string  $strOpt
     */
    public function __construct(mixed $any = null, ?bool $bool = null, ?LocalDate $date = null, ?\DateTime $dateTime = null, ?Enum $enum = null, ?float $float32 = null, ?int $int = null, ?int $int32 = null, ?SimpleObjectWithTypeInt32Enum $int32Enum = null, ?SimpleObjectWithTypeIntEnum $intEnum = null, ?float $num = null, ?string $str = null, ?string $type = null, ?int $bigint = null, ?string $bigintStr = null, ?bool $boolOpt = null, ?float $decimal = null, ?string $decimalStr = null, ?string $float64Str = null, ?string $int64Str = null, ?int $intOptNull = null, ?float $numOptNull = null, ?string $strOpt = null)
    {
        $this->any = $any;
        $this->bool = $bool;
        $this->date = $date;
