...
class Pagination
{
     ...
     */
    public function paginationAmbiguousInput(Operations\PaginationAmbiguousInputRequestBody $requestBody, ?int $cursor = null, ?string $serverURL = null): Operations\PaginationAmbiguousInputResponse
    {
        ...
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(Operations\PaginationAmbiguousInputRequest::class, $request, $this->sdkConfiguration->globals));
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize((string) $httpResponse->getBody(), '\OpenAPI\OpenAPI\Models\Operations\PaginationAmbiguousInputRes', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationBodyFlattenedOptionalSecurity(int $limit, int $offset, ?Operations\PaginationBodyFlattenedOptionalSecuritySecurity $security = null, ?string $serverURL = null): Operations\PaginationBodyFlattenedOptionalSecurityResponse
    {
        ...
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(Operations\PaginationBodyFlattenedOptionalSecurityRequest::class, $request, $this->sdkConfiguration->globals));
        $options['headers']['Accept'] = 'application/json';
        $options['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $obj = $serializer->deserialize((string) $httpResponse->getBody(), '\OpenAPI\OpenAPI\Models\Operations\PaginationBodyFlattenedOptionalSecurityRes', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationBodyFlattenedWithSecurity(Operations\PaginationBodyFlattenedWithSecuritySecurity $security, int $limit, int $offset, ?string $serverURL = null): Operations\PaginationBodyFlattenedWithSecurityResponse
    {
        ...
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(Operations\PaginationBodyFlattenedWithSecurityRequest::class, $request, $this->sdkConfiguration->globals));
        $options['headers']['Accept'] = 'application/json';
        $options['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $client = Utils\Utils::configureSecurityClient($this->sdkConfiguration->defaultClient, $security);
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $obj = $serializer->deserialize((string) $httpResponse->getBody(), '\OpenAPI\OpenAPI\Models\Operations\PaginationBodyFlattenedWithSecurityRes', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationBodyWrappedRequest(Operations\PaginationBodyWrappedRequestRequest $request, ?string $serverURL = null): Operations\PaginationBodyWrappedRequestResponse
    {
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $obj = $serializer->deserialize((string) $httpResponse->getBody(), '\OpenAPI\OpenAPI\Models\Operations\PaginationBodyWrappedRequestRes', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationCursorBody(Operations\PaginationCursorBodyRequestBody $request, ?string $serverURL = null): Operations\PaginationCursorBodyResponse
    {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationCursorNonNumeric(?string $cursor = null, ?string $serverURL = null): Operations\PaginationCursorNonNumericResponse
    {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationCursorParams(int $cursor, ?string $serverURL = null): Operations\PaginationCursorParamsResponse
    {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationLimitOffsetDeepOutputsPageBody(?Shared\LimitOffsetConfig $request = null, ?string $serverURL = null): Operations\PaginationLimitOffsetDeepOutputsPageBodyResponse
    {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationLimitOffsetOffsetBody(?Shared\LimitOffsetConfig $request = null, ?string $serverURL = null): Operations\PaginationLimitOffsetOffsetBodyResponse
    {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationLimitOffsetOffsetParams(?int $limit = null, ?int $offset = null, ?string $serverURL = null): Operations\PaginationLimitOffsetOffsetParamsResponse
    {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationLimitOffsetPageBody(?Shared\LimitOffsetConfig $request = null, ?string $serverURL = null): Operations\PaginationLimitOffsetPageBodyResponse
    {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationLimitOffsetPageParams(int $page, ?string $serverURL = null): Operations\PaginationLimitOffsetPageParamsResponse
    {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationURLParams(int $attempts, ?string $isReferencePath = null, ?string $serverURL = null): Operations\PaginationURLParamsResponse
    {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationWithRetries(?string $cursor = null, ?string $faultSettings = null, ?string $requestId = null, ?string $serverURL = null): Operations\PaginationWithRetriesResponse
    {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationWrappedOptionalBody(?Operations\PaginationWrappedOptionalBodyRequest $request = null, ?Operations\PaginationWrappedOptionalBodySecurity $security = null, ?string $serverURL = null): Operations\PaginationWrappedOptionalBodyResponse
    {
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $obj = $serializer->deserialize((string) $httpResponse->getBody(), '\OpenAPI\OpenAPI\Models\Operations\PaginationWrappedOptionalBodyRes', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
