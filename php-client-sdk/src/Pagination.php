...
class Pagination
{
    ...
    public const PAGINATION_ENCAPSULATED_PARAMETER_SERVERS = [
    ...
    public const PAGINATION_LIMIT_OFFSET_DEFAULT_OFFSET_BODY_SERVERS = [

        'http://localhost:35456',
    ];
    public const PAGINATION_LIMIT_OFFSET_DEFAULT_OFFSET_PARAMS_SERVERS = [
    ...
    public const PAGINATION_LIMIT_OFFSET_OPTIONAL_PAGE_PARAMS_SERVERS = [
     ...
     */
    private function paginationAmbiguousInputIndividual(Operations\PaginationAmbiguousInputRequestBody $requestBody, ?int $cursor = null, ?string $serverURL = null, ?Options $options = null): Operations\PaginationAmbiguousInputResponse
    {
        ...
        $hookContext = new HookContext('paginationAmbiguousInput', null, $this->sdkConfiguration->securitySource);
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationAmbiguousInput(Operations\PaginationAmbiguousInputRequestBody $requestBody, ?int $cursor = null, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationAmbiguousInputIndividual($requestBody, $cursor, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationBodyFlattenedOptionalSecurityIndividual(int $limit, int $offset, ?Operations\PaginationBodyFlattenedOptionalSecuritySecurity $security = null, ?string $serverURL = null, ?Options $options = null): Operations\PaginationBodyFlattenedOptionalSecurityResponse
    {
        ...
        $hookContext = new HookContext('paginationBodyFlattenedOptionalSecurity', null, fn () => $security);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationBodyFlattenedOptionalSecurity(int $limit, int $offset, ?Operations\PaginationBodyFlattenedOptionalSecuritySecurity $security = null, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationBodyFlattenedOptionalSecurityIndividual($limit, $offset, $security, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationBodyFlattenedWithSecurityIndividual(Operations\PaginationBodyFlattenedWithSecuritySecurity $security, int $limit, int $offset, ?string $serverURL = null, ?Options $options = null): Operations\PaginationBodyFlattenedWithSecurityResponse
    {
        ...
        $hookContext = new HookContext('paginationBodyFlattenedWithSecurity', null, fn () => $security);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationBodyFlattenedWithSecurity(Operations\PaginationBodyFlattenedWithSecuritySecurity $security, int $limit, int $offset, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationBodyFlattenedWithSecurityIndividual($security, $limit, $offset, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationBodyWrappedRequestIndividual(Operations\PaginationBodyWrappedRequestRequest $request, ?string $serverURL = null, ?Options $options = null): Operations\PaginationBodyWrappedRequestResponse
    {
        ...
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('PUT', $url);
        $hookContext = new HookContext('paginationBodyWrappedRequest', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationBodyWrappedRequest(Operations\PaginationBodyWrappedRequestRequest $request, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationBodyWrappedRequestIndividual($request, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationCursorBodyIndividual(Operations\PaginationCursorBodyRequestBody $request, ?string $serverURL = null, ?Options $options = null): Operations\PaginationCursorBodyResponse
    {
        ...
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('PUT', $url);
        $hookContext = new HookContext('paginationCursorBody', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationCursorBody(Operations\PaginationCursorBodyRequestBody $request, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationCursorBodyIndividual($request, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationCursorNonNumericIndividual(?string $cursor = null, ?string $serverURL = null, ?Options $options = null): Operations\PaginationCursorNonNumericResponse
    {
        ...
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext('paginationCursorNonNumeric', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationCursorNonNumeric(?string $cursor = null, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationCursorNonNumericIndividual($cursor, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationCursorParamsIndividual(int $cursor, ?string $serverURL = null, ?Options $options = null): Operations\PaginationCursorParamsResponse
    {
        ...
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext('paginationCursorParams', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationCursorParams(int $cursor, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationCursorParamsIndividual($cursor, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     *
     *
     * @param  ?Operations\PaginationEncapsulatedParameterRequest  $request
     * @param  ?string  $serverURL
     * @return Operations\PaginationEncapsulatedParameterResponse
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationEncapsulatedParameterIndividual(?Operations\PaginationEncapsulatedParameterRequest $request = null, ?string $serverURL = null, ?Options $options = null): Operations\PaginationEncapsulatedParameterResponse
    {
        $baseUrl = Utils\Utils::templateUrl(Pagination::PAGINATION_ENCAPSULATED_PARAMETER_SERVERS[0], [
        ]);
        if (! empty($serverURL)) {
            $baseUrl = $serverURL;
        }
        $url = Utils\Utils::generateUrl($baseUrl, '/pagination/cursor#encapsulatedParameter');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(Operations\PaginationEncapsulatedParameterRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        $httpOptions = array_merge_recursive($httpOptions, Utils\Utils::getHeaders($request, $this->sdkConfiguration->globals));
        if (! array_key_exists('headers', $httpOptions)) {
            $httpOptions['headers'] = [];
        }
        ...
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('PUT', $url);
        $hookContext = new HookContext('paginationEncapsulatedParameter', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\OpenAPI\OpenAPI\Models\Operations\PaginationEncapsulatedParameterRes', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\PaginationEncapsulatedParameterResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    res: $obj);
                ...
                $response->next = function () use ($sdk, $responseData, $request, $serverURL): ?Operations\PaginationEncapsulatedParameterResponse {
                    $jsonObject = new \JsonPath\JsonObject($responseData);
                    $nextCursor = $jsonObject->get('$.resultArray[-1:]');
                    if ($nextCursor == null) {
                        return null;
                    ...
                    return $sdk->paginationEncapsulatedParameterIndividual(
                        request: new Operations\PaginationEncapsulatedParameterRequest(
                            cursor: $nextCursor,
                            headerParam: $request != null ? $request->headerParam : null,
                        ),
                        serverURL: $serverURL,
                    );
                };
     ...
     * @param  ?Operations\PaginationEncapsulatedParameterRequest  $request
     * @param  ?string  $serverURL
     * @return \Generator<Operations\PaginationEncapsulatedParameterResponse>
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationEncapsulatedParameter(?Operations\PaginationEncapsulatedParameterRequest $request = null, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationEncapsulatedParameterIndividual($request, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationLimitOffsetDeepOutputsPageBodyIndividual(?Shared\LimitOffsetConfig $request = null, ?string $serverURL = null, ?Options $options = null): Operations\PaginationLimitOffsetDeepOutputsPageBodyResponse
    {
        ...
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('PUT', $url);
        $hookContext = new HookContext('paginationLimitOffsetDeepOutputsPageBody', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationLimitOffsetDeepOutputsPageBody(?Shared\LimitOffsetConfig $request = null, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationLimitOffsetDeepOutputsPageBodyIndividual($request, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     *
     * @param  ?Shared\LimitOffsetConfigWithDefaults  $request
     * @param  ?string  $serverURL
     * @return Operations\PaginationLimitOffsetDefaultOffsetBodyResponse
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationLimitOffsetDefaultOffsetBodyIndividual(?Shared\LimitOffsetConfigWithDefaults $request = null, ?string $serverURL = null, ?Options $options = null): Operations\PaginationLimitOffsetDefaultOffsetBodyResponse
    {
        $baseUrl = Utils\Utils::templateUrl(Pagination::PAGINATION_LIMIT_OFFSET_DEFAULT_OFFSET_BODY_SERVERS[0], [
        ]);
        if (! empty($serverURL)) {
            $baseUrl = $serverURL;
        }
        $url = Utils\Utils::generateUrl($baseUrl, '/pagination/limitoffset/offset#WithDefaults');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'request', 'json');
        if ($body !== null) {
        ...
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('PUT', $url);
        $hookContext = new HookContext('paginationLimitOffsetDefaultOffsetBody', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\OpenAPI\OpenAPI\Models\Operations\PaginationLimitOffsetDefaultOffsetBodyRes', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\PaginationLimitOffsetDefaultOffsetBodyResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    res: $obj);
                ...
                $response->next = function () use ($sdk, $request, $responseData, $serverURL): ?Operations\PaginationLimitOffsetDefaultOffsetBodyResponse {
                    $offset = $request != null ? $request->offset : 0;
                    if (! $responseData) {
                        return null;
                    }
                    ...
                    return $sdk->paginationLimitOffsetDefaultOffsetBodyIndividual(
     ...
     * @param  ?Shared\LimitOffsetConfigWithDefaults  $request
     * @param  ?string  $serverURL
     * @return \Generator<Operations\PaginationLimitOffsetDefaultOffsetBodyResponse>
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationLimitOffsetDefaultOffsetBody(?Shared\LimitOffsetConfigWithDefaults $request = null, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationLimitOffsetDefaultOffsetBodyIndividual($request, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @param  ?int  $offset
     * @param  ?string  $serverURL
     * @return Operations\PaginationLimitOffsetDefaultOffsetParamsResponse
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationLimitOffsetDefaultOffsetParamsIndividual(?int $limit = null, ?int $offset = null, ?string $serverURL = null, ?Options $options = null): Operations\PaginationLimitOffsetDefaultOffsetParamsResponse
    {
        $request = new Operations\PaginationLimitOffsetDefaultOffsetParamsRequest(
            limit: $limit,
            offset: $offset,
        );
        $baseUrl = Utils\Utils::templateUrl(Pagination::PAGINATION_LIMIT_OFFSET_DEFAULT_OFFSET_PARAMS_SERVERS[0], [
        ]);
        if (! empty($serverURL)) {
            $baseUrl = $serverURL;
        }
        ...
        $qp = Utils\Utils::getQueryParams(Operations\PaginationLimitOffsetDefaultOffsetParamsRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        $httpOptions['headers']['Accept'] = 'application/json';
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext('paginationLimitOffsetDefaultOffsetParams', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\OpenAPI\OpenAPI\Models\Operations\PaginationLimitOffsetDefaultOffsetParamsRes', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\PaginationLimitOffsetDefaultOffsetParamsResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    res: $obj);
                ...
                $response->next = function () use ($sdk, $request, $responseData, $limit, $serverURL): ?Operations\PaginationLimitOffsetDefaultOffsetParamsResponse {
                    $offset = $request != null ? $request->offset : 0;
                    if (! $responseData) {
                        return null;
                    }
                    ...
                    return $sdk->paginationLimitOffsetDefaultOffsetParamsIndividual(
                        limit: $limit,
                        offset: $nextOffset,
                        serverURL: $serverURL,
                    );
     ...
     * @param  ?int  $offset
     * @param  ?string  $serverURL
     * @return \Generator<Operations\PaginationLimitOffsetDefaultOffsetParamsResponse>
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationLimitOffsetDefaultOffsetParams(?int $limit = null, ?int $offset = null, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationLimitOffsetDefaultOffsetParamsIndividual($limit, $offset, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationLimitOffsetOffsetBodyIndividual(?Shared\LimitOffsetConfig $request = null, ?string $serverURL = null, ?Options $options = null): Operations\PaginationLimitOffsetOffsetBodyResponse
    {
        ...
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('PUT', $url);
        $hookContext = new HookContext('paginationLimitOffsetOffsetBody', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationLimitOffsetOffsetBody(?Shared\LimitOffsetConfig $request = null, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationLimitOffsetOffsetBodyIndividual($request, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationLimitOffsetOffsetParamsIndividual(?int $limit = null, ?int $offset = null, ?string $serverURL = null, ?Options $options = null): Operations\PaginationLimitOffsetOffsetParamsResponse
    {
        ...
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext('paginationLimitOffsetOffsetParams', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationLimitOffsetOffsetParams(?int $limit = null, ?int $offset = null, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationLimitOffsetOffsetParamsIndividual($limit, $offset, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @param  ?int  $page
     * @param  ?string  $serverURL
     * @return Operations\PaginationLimitOffsetOptionalPageParamsResponse
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationLimitOffsetOptionalPageParamsIndividual(?int $page = null, ?string $serverURL = null, ?Options $options = null): Operations\PaginationLimitOffsetOptionalPageParamsResponse
    {
        $request = new Operations\PaginationLimitOffsetOptionalPageParamsRequest(
            page: $page,
        );
        $baseUrl = Utils\Utils::templateUrl(Pagination::PAGINATION_LIMIT_OFFSET_OPTIONAL_PAGE_PARAMS_SERVERS[0], [
        ]);
        if (! empty($serverURL)) {
            $baseUrl = $serverURL;
        }
        $url = Utils\Utils::generateUrl($baseUrl, '/pagination/limitoffset/page#optionalPageParams');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(Operations\PaginationLimitOffsetOptionalPageParamsRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        $httpOptions['headers']['Accept'] = 'application/json';
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext('paginationLimitOffsetOptionalPageParams', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\OpenAPI\OpenAPI\Models\Operations\PaginationLimitOffsetOptionalPageParamsRes', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\PaginationLimitOffsetOptionalPageParamsResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    res: $obj);
                ...
                $response->next = function () use ($sdk, $request, $responseData, $serverURL): ?Operations\PaginationLimitOffsetOptionalPageParamsResponse {
                    $page = $request != null ? $request->page : 0;
                    $nextPage = $page + 1;
                    if (! $responseData) {
                        return null;
                    ...
                    return $sdk->paginationLimitOffsetOptionalPageParamsIndividual(
                        page: $nextPage,
                        serverURL: $serverURL,
                    );
                };
     ...
     * @param  ?int  $page
     * @param  ?string  $serverURL
     * @return \Generator<Operations\PaginationLimitOffsetOptionalPageParamsResponse>
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationLimitOffsetOptionalPageParams(?int $page = null, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationLimitOffsetOptionalPageParamsIndividual($page, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationLimitOffsetPageBodyIndividual(?Shared\LimitOffsetConfig $request = null, ?string $serverURL = null, ?Options $options = null): Operations\PaginationLimitOffsetPageBodyResponse
    {
        ...
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('PUT', $url);
        $hookContext = new HookContext('paginationLimitOffsetPageBody', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationLimitOffsetPageBody(?Shared\LimitOffsetConfig $request = null, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationLimitOffsetPageBodyIndividual($request, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationLimitOffsetPageParamsIndividual(int $page, ?string $serverURL = null, ?Options $options = null): Operations\PaginationLimitOffsetPageParamsResponse
    {
        ...
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext('paginationLimitOffsetPageParams', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationLimitOffsetPageParams(int $page, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationLimitOffsetPageParamsIndividual($page, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationURLParamsIndividual(int $attempts, ?string $isReferencePath = null, ?string $serverURL = null, ?string $urlOverride = null, ?Options $options = null): Operations\PaginationURLParamsResponse
    {
        ...
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext('paginationURLParams', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationURLParams(int $attempts, ?string $isReferencePath = null, ?string $serverURL = null, ?string $urlOverride = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationURLParamsIndividual($attempts, $isReferencePath, $serverURL, $urlOverride, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationWithRetriesIndividual(?string $cursor = null, ?string $faultSettings = null, ?string $requestId = null, ?string $serverURL = null, ?Options $options = null): Operations\PaginationWithRetriesResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext('paginationWithRetries', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationWithRetries(?string $cursor = null, ?string $faultSettings = null, ?string $requestId = null, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationWithRetriesIndividual($cursor, $faultSettings, $requestId, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    private function paginationWrappedOptionalBodyIndividual(?Operations\PaginationWrappedOptionalBodyRequest $request = null, ?Operations\PaginationWrappedOptionalBodySecurity $security = null, ?string $serverURL = null, ?Options $options = null): Operations\PaginationWrappedOptionalBodyResponse
    {
        ...
        $hookContext = new HookContext('paginationWrappedOptionalBody', null, fn () => $security);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function paginationWrappedOptionalBody(?Operations\PaginationWrappedOptionalBodyRequest $request = null, ?Operations\PaginationWrappedOptionalBodySecurity $security = null, ?string $serverURL = null, ?Options $options = null): \Generator
    {
        $res = $this->paginationWrappedOptionalBodyIndividual($request, $security, $serverURL, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
