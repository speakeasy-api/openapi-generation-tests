...
class Pagination
{
     ...
     * @param  string  $serverURL
     * @return \OpenAPI\OpenAPI\Models\Operations\PaginationLimitOffsetDeepOutputsPageBodyResponse
     */
    public function paginationLimitOffsetDeepOutputsPageBody(
        \OpenAPI\OpenAPI\Models\Shared\LimitOffsetConfig $request,
        ?string $serverURL = null,
    ): \OpenAPI\OpenAPI\Models\Operations\PaginationLimitOffsetDeepOutputsPageBodyResponse {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\PaginationLimitOffsetDeepOutputsPageBodyResponse();
        $response->statusCode = $statusCode;
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->res = $serializer->deserialize((string) $httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\PaginationLimitOffsetDeepOutputsPageBodyRes', 'json');
            }
        }
