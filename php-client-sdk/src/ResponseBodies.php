...
class ResponseBodies
{
     ...
     *
     * @param  \OpenAPI\OpenAPI\Models\Operations\OverriddenFieldNamesPostRequestBody  $request
     * @return \OpenAPI\OpenAPI\Models\Operations\OverriddenFieldNamesPostResponse
     */
    public function overriddenFieldNamesPost(
        \OpenAPI\OpenAPI\Models\Operations\OverriddenFieldNamesPostRequestBody $request,
    ): \OpenAPI\OpenAPI\Models\Operations\OverriddenFieldNamesPostResponse {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\OverriddenFieldNamesPostResponse();
        $response->statusCode = $statusCode;
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->object = $serializer->deserialize((string) $httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\OverriddenFieldNamesPostResponseBody', 'json');
            }
        }
     ...
     * @return \OpenAPI\OpenAPI\Models\Operations\ResponseBodyDecimalStrResponse
     */
    public function responseBodyDecimalStr(
        string $request,
        ?string $serverURL = null,
    ): \OpenAPI\OpenAPI\Models\Operations\ResponseBodyDecimalStrResponse {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ResponseBodyDecimalStrResponse();
        $response->statusCode = $statusCode;
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        if ($httpResponse->getStatusCode() === 200) {
