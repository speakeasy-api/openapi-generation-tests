...
class Retries
{
     ...
     *
     * @param  string  $requestId
     * @param  ?\OpenAPI\OpenAPI\Models\Operations\RetriesFlatEmptyResponsePostRequestBody  $requestBody
     * @param  ?int  $numRetries
     * @param  string  $serverURL
     * @return \OpenAPI\OpenAPI\Models\Operations\RetriesFlatEmptyResponsePostResponse
     */
    public function retriesFlatEmptyResponsePost(
        string $requestId,
        ?\OpenAPI\OpenAPI\Models\Operations\RetriesFlatEmptyResponsePostRequestBody $requestBody = null,
        ?int $numRetries = null,
        ?string $serverURL = null,
    ): \OpenAPI\OpenAPI\Models\Operations\RetriesFlatEmptyResponsePostResponse {
        $request = new \OpenAPI\OpenAPI\Models\Operations\RetriesFlatEmptyResponsePostRequest();
        $request->requestId = $requestId;
        ...
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\RetriesFlatEmptyResponsePostRequest::class, $request, $this->sdkConfiguration->globals));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\RetriesFlatEmptyResponsePostResponse();
        $response->statusCode = $statusCode;
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        if ($httpResponse->getStatusCode() === 200) {
