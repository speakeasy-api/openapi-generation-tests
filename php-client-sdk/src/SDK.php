...
class SDK
{
     ...
     */
    public function ambiguousQueryParam(
    ...
    public function authenticatedRequest(
        ?Operations\AuthenticatedRequestRequestBody $request,
        Operations\AuthenticatedRequestSecurity $security,
    ...
    public function conflictingEnum(
        ?Shared\ConflictingEnum $request,
    ...
    public function multilineExample(
        ?Operations\MultilineExampleRequestBody $request,
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function postAdditionalPropertiesWithNullableFields(
        array $request,
