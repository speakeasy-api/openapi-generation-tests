...
class SDK
{
     ...
     */
    public function ambiguousQueryParam(Operations\Console $console): Operations\AmbiguousQueryParamResponse
    {
        ...
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(Operations\AmbiguousQueryParamRequest::class, $request, $this->sdkConfiguration->globals));
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function authenticatedRequest(Operations\AuthenticatedRequestSecurity $security, ?Operations\AuthenticatedRequestRequestBody $request = null): Operations\AuthenticatedRequestResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function conflictingEnum(?Shared\ConflictingEnum $request = null): Operations\ConflictingEnumResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function ignoredGenerationPut(string $request): Operations\IgnoredGenerationPutResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize((string) $httpResponse->getBody(), '\OpenAPI\OpenAPI\Models\Operations\IgnoredGenerationPutResponseBody', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function multilineExample(?Operations\MultilineExampleRequestBody $request = null): Operations\MultilineExampleResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function postAdditionalPropertiesWithNullableFields(array $request): Operations\PostAdditionalPropertiesWithNullableFieldsResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $obj = $serializer->deserialize((string) $httpResponse->getBody(), '\OpenAPI\OpenAPI\Models\Operations\PostAdditionalPropertiesWithNullableFieldsResponseBody', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function responseBodyJsonGet(): Operations\ResponseBodyJsonGetResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
