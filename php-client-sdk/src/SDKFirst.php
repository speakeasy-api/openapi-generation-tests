...
class SDKFirst
{
     ...
     */
    public function get(?Options $options = null): Operations\NestFirstGetResponse
    {
        ...
        $hookContext = new HookContext('nestFirstGet', null, $this->sdkConfiguration->securitySource);
