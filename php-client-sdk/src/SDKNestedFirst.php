...
class SDKNestedFirst
{
     ...
     * get
     *
     * @return Operations\NestedFirstGetResponse
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function get(?Options $options = null): Operations\NestedFirstGetResponse
    {
        ...
        $hookContext = new HookContext('nestedFirstGet', null, $this->sdkConfiguration->securitySource);
        ...
        if ($statusCode == 200) {
            ...
            return new Operations\NestedFirstGetResponse(
