...
class SDKSecond
{
     ...
     * get
     *
     * @return Operations\NestedSecondGetResponse
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function get(?Options $options = null): Operations\NestedSecondGetResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        $url = Utils\Utils::generateUrl($baseUrl, '/anything/nested/second');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $httpOptions['headers']['Accept'] = '*/*';
        $httpOptions['headers']['x-speakeasy-user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext('nestedSecondGet', null, $this->sdkConfiguration->securitySource);
        ...
        if ($statusCode == 200) {
            ...
            return new Operations\NestedSecondGetResponse(
