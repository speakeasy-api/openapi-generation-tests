...
class Second
{
     ...
     * get
     *
     * @return Operations\GroupSecondGetResponse
     * @throws \OpenAPI\OpenAPI\Models\Errors\SDKException
     */
    public function get(?Options $options = null): Operations\GroupSecondGetResponse
    {
        ...
        $hookContext = new HookContext('groupSecondGet', null, $this->sdkConfiguration->securitySource);
        ...
        if ($statusCode == 200) {
            ...
            return new Operations\GroupSecondGetResponse(
