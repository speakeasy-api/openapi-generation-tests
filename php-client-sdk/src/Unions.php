...
class Unions
{
     ...
     *
     * @param  mixed  $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CollectionOneOfPostResponse
     */
    public function collectionOneOfPost(
        mixed $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CollectionOneOfPostResponse {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CollectionOneOfPostResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->res = $serializer->deserialize((string) $httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\CollectionOneOfPostRes', 'json');
            }
        }
     ...
     *
     * @param  mixed  $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ConstDiscriminatedOneOfResponse
     */
    public function constDiscriminatedOneOf(
        mixed $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ConstDiscriminatedOneOfResponse {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ConstDiscriminatedOneOfResponse();
        $response->statusCode = $statusCode;
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->res = $serializer->deserialize((string) $httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\ConstDiscriminatedOneOfRes', 'json');
            }
        }
     ...
     *
     * @param  mixed  $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DiscriminatedOneMultipleMembershipsResponse
     */
    public function discriminatedOneMultipleMemberships(
        mixed $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DiscriminatedOneMultipleMembershipsResponse {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DiscriminatedOneMultipleMembershipsResponse();
        $response->statusCode = $statusCode;
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->res = $serializer->deserialize((string) $httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\DiscriminatedOneMultipleMembershipsRes', 'json');
            }
        }
     ...
     *
     * @param  mixed  $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DiscriminatedOneMultipleMembershipsHasWheelsResponse
     */
    public function discriminatedOneMultipleMembershipsHasWheels(
        mixed $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DiscriminatedOneMultipleMembershipsHasWheelsResponse {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DiscriminatedOneMultipleMembershipsHasWheelsResponse();
        $response->statusCode = $statusCode;
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->res = $serializer->deserialize((string) $httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\DiscriminatedOneMultipleMembershipsHasWheelsRes', 'json');
            }
        }
     ...
     * infectedWithAny
     *
     * @param  \OpenAPI\OpenAPI\Models\Shared\InfectedWithAny  $request
     * @return \OpenAPI\OpenAPI\Models\Operations\InfectedWithAnyResponse
     */
    public function infectedWithAny(
        \OpenAPI\OpenAPI\Models\Shared\InfectedWithAny $request,
    ): \OpenAPI\OpenAPI\Models\Operations\InfectedWithAnyResponse {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\InfectedWithAnyResponse();
        $response->statusCode = $statusCode;
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->res = $serializer->deserialize((string) $httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\InfectedWithAnyRes', 'json');
            }
        }
     ...
     *
     * @param  \OpenAPI\OpenAPI\Models\Operations\OneOfOverlappingObjectsRequestBody  $request
     * @return \OpenAPI\OpenAPI\Models\Operations\OneOfOverlappingObjectsResponse
     */
    public function oneOfOverlappingObjects(
        \OpenAPI\OpenAPI\Models\Operations\OneOfOverlappingObjectsRequestBody $request,
    ): \OpenAPI\OpenAPI\Models\Operations\OneOfOverlappingObjectsResponse {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\OneOfOverlappingObjectsResponse();
        $response->statusCode = $statusCode;
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->res = $serializer->deserialize((string) $httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\OneOfOverlappingObjectsRes', 'json');
            }
        }
     ...
     * unionMap
     *
     * @param  \OpenAPI\OpenAPI\Models\Operations\UnionMapRequestBody  $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UnionMapResponse
     */
    public function unionMap(
        \OpenAPI\OpenAPI\Models\Operations\UnionMapRequestBody $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UnionMapResponse {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UnionMapResponse();
        $response->statusCode = $statusCode;
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->res = $serializer->deserialize((string) $httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\UnionMapRes', 'json');
            }
        }
     ...
     *
     * @param  mixed  $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UnionNestedEnumsFormResponse
     */
    public function unionNestedEnumsForm(
        mixed $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UnionNestedEnumsFormResponse {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UnionNestedEnumsFormResponse();
        $response->statusCode = $statusCode;
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        if ($httpResponse->getStatusCode() === 200) {
     ...
     *
     * @param  \OpenAPI\OpenAPI\Models\Operations\UnionNestedEnumsMultipartRequestBody  $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UnionNestedEnumsMultipartResponse
     */
    public function unionNestedEnumsMultipart(
        \OpenAPI\OpenAPI\Models\Operations\UnionNestedEnumsMultipartRequestBody $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UnionNestedEnumsMultipartResponse {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        $url = Utils\Utils::generateUrl($baseUrl, '/anything/union/forms/nestedEnums');
        $options = ['http_errors' => false];
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UnionNestedEnumsMultipartResponse();
        $response->statusCode = $statusCode;
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        if ($httpResponse->getStatusCode() === 200) {
