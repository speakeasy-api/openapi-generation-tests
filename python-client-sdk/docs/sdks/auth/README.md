...
with SDK(
    ...
    res = sdk.auth.basic_auth(security=operations.BasicAuthSecurity(
...
with SDK(
    ...
    res = sdk.auth.bearer_auth(security=operations.BearerAuthSecurity(
...
with SDK(
    ...
    res = sdk.auth.open_id_connect_auth(security=operations.OpenIDConnectAuthSecurity(
