...
s.auth_new.multiple_mixed_options_auth(request={}, security=operations.MultipleMixedOptionsAuthSecurity(
...
s.auth_new.multiple_options_with_mixed_schemes_auth(request={}, security=operations.MultipleOptionsWithMixedSchemesAuthSecurity(
...
s.auth_new.multiple_options_with_simple_schemes_auth(request={}, security=operations.MultipleOptionsWithSimpleSchemesAuthSecurity(
...
s.auth_new.multiple_simple_options_auth(request={}, security=operations.MultipleSimpleOptionsAuthSecurity(
    api_key_auth_new="Token <YOUR_API_KEY>",
))
