...
with SDK(
    ...
    sdk.auth_new.basic_auth_new(security=operations.BasicAuthNewSecurity(
...
with SDK(
    ...
    sdk.auth_new.custom_scheme_app_id(security=operations.CustomSchemeAppIDSecurity(
...
with SDK(
    ...
    sdk.auth_new.multiple_mixed_options_auth(security=operations.MultipleMixedOptionsAuthSecurity(
...
with SDK(
    ...
    sdk.auth_new.multiple_mixed_scheme_auth(security=operations.MultipleMixedSchemeAuthSecurity(
        api_key_auth_new="Token <YOUR_API_KEY>",
...
with SDK(
    ...
    sdk.auth_new.multiple_options_with_mixed_schemes_auth(security=operations.MultipleOptionsWithMixedSchemesAuthSecurity(
...
with SDK(
    ...
    sdk.auth_new.multiple_options_with_simple_schemes_auth(security=operations.MultipleOptionsWithSimpleSchemesAuthSecurity(
...
with SDK(
    ...
    sdk.auth_new.multiple_simple_options_auth(security=operations.MultipleSimpleOptionsAuthSecurity(
        api_key_auth_new="Token <YOUR_API_KEY>",
    ))
...
with SDK(
    ...
    sdk.auth_new.multiple_simple_scheme_auth(security=operations.MultipleSimpleSchemeAuthSecurity(
        api_key_auth_new="Token <YOUR_API_KEY>",
        oauth2="Bearer YOUR_OAUTH2_TOKEN",
    ))
...
with SDK(
    ...
    sdk.auth_new.open_id_connect_auth_new(security=operations.OpenIDConnectAuthNewSecurity(
