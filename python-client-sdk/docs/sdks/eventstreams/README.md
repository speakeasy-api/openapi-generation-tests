...
res = s.eventstreams.chat_skip_sentinel(request=operations.ChatSkipSentinelRequestBody(
    prompt='<value>',
))

if res.chat_completion_event is not None:
...
**[operations.ChatSkipSentinelResponse](../../models/operations/chatskipsentinelresponse.md)**
### Errors
