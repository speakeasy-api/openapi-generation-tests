...
res = s.pagination.pagination_ambiguous_input(request_body={
    "cursor": 872862,
})
...
res = s.pagination.pagination_body_flattened_optional_security(limit=252090, offset=434461)
...
res = s.pagination.pagination_body_flattened_with_security(security=operations.PaginationBodyFlattenedWithSecuritySecurity(
...
res = s.pagination.pagination_body_wrapped_request(request={
    "limit_offset_config": {},
})
...
res = s.pagination.pagination_cursor_body(request={
    "cursor": 868337,
})
...
res = s.pagination.pagination_url_params(attempts=778920)
