...
res = s.parameters.deep_object_query_params_deep_object(deep_obj=shared.DeepObjectQueryParams(
    arr=[
        'test1',
        'test2',
    ],
...
**[operations.DeepObjectQueryParamsDeepObjectResponse](../../models/operations/deepobjectqueryparamsdeepobjectresponse.md)**
### Errors
...
res = s.parameters.json_query_params_object_smaller(deep_obj_param=shared.DeepObjectSmaller(
    any=shared.SimpleObject(
        any='any',
        bool=True,
        date_=dateutil.parser.parse('2020-01-01').date(),
