...
req = shared.DeepObject(
    ...
    obj=shared.SimpleObject(
        ...
        int_opt_null=367327,
        num=1.1,
        num_opt_null=7980.49,
        str_='test',
        str_opt='testOptional',
    ),
    str_='test',
    type='energetically Global',
)
...
req = shared.DeepObject(
    ...
    obj=shared.SimpleObject(
        ...
        int_opt_null=929355,
        num=1.1,
        num_opt_null=9893.01,
        str_='test',
        str_opt='testOptional',
    ),
    str_='test',
    type='resect promptly Caldwell',
)
