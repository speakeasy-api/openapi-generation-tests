...
with SDK(
    ...
    res = sdk.response_bodies.flattened_envelope_pagination_response()
...
with SDK(
    ...
    res = sdk.response_bodies.flattened_envelope_response()
...
with SDK(
    ...
    res = sdk.response_bodies.flattened_envelope_union_response()
...
with SDK(
    ...
    res = sdk.response_bodies.flattened_union_response()
...
with SDK(
    ...
    res = sdk.response_bodies.overridden_field_names_post(request={
        "in_int": 1,
        "in_str": "test",
    })
...
with SDK(
    ...
    res = sdk.response_bodies.response_bodies2xx_json_object_all_optional_properties()
...
**[operations.ResponseBodies2xxJSONObjectAllOptionalPropertiesResponseBody](../../models/operations/responsebodies2xxjsonobjectalloptionalpropertiesresponsebody.md)**
...
with SDK(
    ...
    res = sdk.response_bodies.response_body_additional_properties_any_post(request=shared.ObjWithAnyAdditionalProperties(
        normal_field="normal",
        **{
            "key1": "value2",
            "key2": "<value>",
...
with SDK(
    ...
    res = sdk.response_bodies.response_body_additional_properties_complex_numbers_post(request=shared.ObjWithComplexNumbersAdditionalProperties(
        normal_field="normal",
        **{
            "key1": 1,
        },
...
with SDK(
    ...
    res = sdk.response_bodies.response_body_additional_properties_date_post(request=shared.ObjWithDateAdditionalProperties(
        normal_field="normal",
        **{
...
with SDK(
    ...
    res = sdk.response_bodies.response_body_additional_properties_object_post(request=shared.ObjWithObjAdditionalProperties(
...
with SDK(
    ...
    res = sdk.response_bodies.response_body_additional_properties_post(request=shared.ObjWithStringAdditionalProperties(
        normal_field="normal",
        **{
            "key1": "value1",
        },
...
with SDK(
    ...
    res = sdk.response_bodies.response_body_decimal_str(request=Decimal("3.141592653589793"))
...
with SDK(
    ...
    res = sdk.response_bodies.response_body_empty_with_headers(x_number_header=1751.81, x_string_header="<value>")
...
with SDK(
    ...
    sdk.response_bodies.response_body_missing2xx_or3xx_get()
...
with SDK(
    ...
    res = sdk.response_bodies.response_body_multiline_string_post(request={
        "array": [
            "BEGIN:VEVENT\n" +
...
**[operations.ResponseBodyMultilineStringPostResponseBody](../../models/operations/responsebodymultilinestringpostresponsebody.md)**
...
with SDK(
    ...
    res = sdk.response_bodies.response_body_optional_get()
