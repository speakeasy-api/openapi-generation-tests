...
res = s.response_bodies.response_body_additional_properties_object_post(request=shared.ObjWithObjAdditionalProperties(
    ...
    datetime=dateutil.parser.isoparse("2023-03-22T10:46:10.684Z"),
    **{
        "key": {
            "any": "any",
            "bool_": True,
...
res = s.response_bodies.response_body_decimal_str(request=Decimal("6437.63"))
...
res = s.response_bodies.response_body_multiline_string_post(request={
    "array": [
        "<value>",
    ],
})
