...
with SDK(
    ...
    res = sdk.retries.retries_after(request_id="<id>")
...
with SDK(
    ...
    res = sdk.retries.retries_connect_error_get()
...
with SDK(
    ...
    sdk.retries.retries_flat_empty_response_post(request_id="<id>")
...
with SDK(
    ...
    res = sdk.retries.retries_get(request_id="<id>")
...
with SDK(
    ...
    res = sdk.retries.retries_post(request_id="<id>")
