...
s.ambiguous_query_param(console=operations.Console.THREE)
...
res = s.post_additional_properties_with_nullable_fields(request=operations.PostAdditionalPropertiesWithNullableFieldsRequestBody(
    **{
        "foo": "bar",
    },
))
