...
res = s.unions.array_of_discriminated_unions(request=[
    {
        "any": "any",
        "bool_": True,
...
res = s.unions.array_of_discriminated_unions_map(request={
    "array_map": {
...
res = s.unions.mixed_type_one_of_post(request=984138)
...
res = s.unions.nested_array_of_discriminated_unions(request={
    "nested_array": [
        [
            {
                "any": {
...
res = s.unions.union_big_int_str_decimal(request=2045.57)
...
res = s.unions.union_date_time_big_int(request=dateutil.parser.isoparse("2022-10-13T05:48:39.528Z"))
...
res = s.unions.union_date_time_null(request=dateutil.parser.isoparse("2023-04-13T05:53:48.181Z"))
...
res = s.unions.union_map_optional()
