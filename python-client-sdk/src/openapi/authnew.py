...
class AuthNew(BaseSDK):
    ...
    def basic_auth_new(
        ...
        req = self.build_request(
            ...
            user_agent_header="x-speakeasy-user-agent",
            accept_header_value="*/*",
            security=utils.get_pydantic_model(security, operations.BasicAuthNewSecurity),
            get_serialized_body=lambda: utils.serialize_request_body(request, False, False, "json", shared.AuthServiceRequestBody),
            timeout_ms=timeout_ms,
        )
    ...
    def custom_scheme_app_id(
        self, *,
        security: Union[operations.CustomSchemeAppIDSecurity, operations.CustomSchemeAppIDSecurityTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ):
        ...
        req = self.build_request(
            ...
            user_agent_header="x-speakeasy-user-agent",
            accept_header_value="*/*",
            security=utils.get_pydantic_model(security, operations.CustomSchemeAppIDSecurity),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="customSchemeAppId", oauth2_scopes=[], security_source=security),
            request=req,
            error_status_codes=["401","4XX","5XX"],
            retry_config=retry_config
        )
    ...
    def multiple_mixed_options_auth(
        self, *,
        security: Union[operations.MultipleMixedOptionsAuthSecurity, operations.MultipleMixedOptionsAuthSecurityTypedDict],
        request: Union[shared.AuthServiceRequestBody, shared.AuthServiceRequestBodyTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self.build_request(
            ...
            user_agent_header="x-speakeasy-user-agent",
            accept_header_value="*/*",
            security=utils.get_pydantic_model(security, operations.MultipleMixedOptionsAuthSecurity),
            get_serialized_body=lambda: utils.serialize_request_body(request, False, False, "json", shared.AuthServiceRequestBody),
            timeout_ms=timeout_ms,
        )
    ...
    def multiple_mixed_scheme_auth(
        ...
        req = self.build_request(
            ...
            user_agent_header="x-speakeasy-user-agent",
            accept_header_value="*/*",
            security=utils.get_pydantic_model(security, operations.MultipleMixedSchemeAuthSecurity),
            get_serialized_body=lambda: utils.serialize_request_body(request, False, False, "json", shared.AuthServiceRequestBody),
            timeout_ms=timeout_ms,
        )
    ...
    def multiple_options_with_mixed_schemes_auth(
        self, *,
        security: Union[operations.MultipleOptionsWithMixedSchemesAuthSecurity, operations.MultipleOptionsWithMixedSchemesAuthSecurityTypedDict],
        request: Union[shared.AuthServiceRequestBody, shared.AuthServiceRequestBodyTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self.build_request(
            ...
            user_agent_header="x-speakeasy-user-agent",
            accept_header_value="*/*",
            security=utils.get_pydantic_model(security, operations.MultipleOptionsWithMixedSchemesAuthSecurity),
            get_serialized_body=lambda: utils.serialize_request_body(request, False, False, "json", shared.AuthServiceRequestBody),
            timeout_ms=timeout_ms,
        )
    ...
    def multiple_options_with_simple_schemes_auth(
        self, *,
        security: Union[operations.MultipleOptionsWithSimpleSchemesAuthSecurity, operations.MultipleOptionsWithSimpleSchemesAuthSecurityTypedDict],
        request: Union[shared.AuthServiceRequestBody, shared.AuthServiceRequestBodyTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self.build_request(
            ...
            user_agent_header="x-speakeasy-user-agent",
            accept_header_value="*/*",
            security=utils.get_pydantic_model(security, operations.MultipleOptionsWithSimpleSchemesAuthSecurity),
            get_serialized_body=lambda: utils.serialize_request_body(request, False, False, "json", shared.AuthServiceRequestBody),
            timeout_ms=timeout_ms,
        )
    ...
    def multiple_simple_options_auth(
        self, *,
        security: Union[operations.MultipleSimpleOptionsAuthSecurity, operations.MultipleSimpleOptionsAuthSecurityTypedDict],
        request: Union[shared.AuthServiceRequestBody, shared.AuthServiceRequestBodyTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self.build_request(
            ...
            user_agent_header="x-speakeasy-user-agent",
            accept_header_value="*/*",
            security=utils.get_pydantic_model(security, operations.MultipleSimpleOptionsAuthSecurity),
            get_serialized_body=lambda: utils.serialize_request_body(request, False, False, "json", shared.AuthServiceRequestBody),
            timeout_ms=timeout_ms,
        )
    ...
    def multiple_simple_scheme_auth(
        ...
        req = self.build_request(
            ...
            user_agent_header="x-speakeasy-user-agent",
            accept_header_value="*/*",
            security=utils.get_pydantic_model(security, operations.MultipleSimpleSchemeAuthSecurity),
            get_serialized_body=lambda: utils.serialize_request_body(request, False, False, "json", shared.AuthServiceRequestBody),
            timeout_ms=timeout_ms,
        )
    ...
    def open_id_connect_auth_new(
        ...
        req = self.build_request(
            ...
            user_agent_header="x-speakeasy-user-agent",
            accept_header_value="*/*",
            security=utils.get_pydantic_model(security, operations.OpenIDConnectAuthNewSecurity),
            get_serialized_body=lambda: utils.serialize_request_body(request, False, False, "json", shared.AuthServiceRequestBody),
            timeout_ms=timeout_ms,
        )
