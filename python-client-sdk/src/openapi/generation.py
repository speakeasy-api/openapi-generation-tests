...
class Generation(BaseSDK):
    ...
    def empty_object_get(
        ...
        request = operations.EmptyObjectGetRequest(
            empty_object=utils.get_pydantic_model(empty_object, shared.EmptyObjectParam),
        )
    ...
    def ignores_post(
        ...
        request = operations.IgnoresPostRequest(
            ...
            request_body=utils.get_pydantic_model(request_body, operations.IgnoresPostRequestBody),
        )
    ...
    def usage_example_post(
        ...
        req = self.build_request(
            ...
            user_agent_header="x-speakeasy-user-agent",
            accept_header_value="application/json",
            security=utils.get_pydantic_model(security, operations.UsageExamplePostSecurity),
