...
class Generation(BaseSDK):
    ...
    @deprecated("""warning: ** DEPRECATED ** - This operation is deprecated.
Its deprecation message has newlines.
. Use simple_path_parameter_objects instead.""")
    def deprecated_operation_with_multiline_comment_get(
        self,
        *,
        deprecated_parameter: Optional[str] = None,
        new_parameter: Optional[str] = None,
        ...
        r"""This is an endpoint setup to test deprecation with multiline comments
        ...
        req = self._build_request(
            method="GET",
            path="/anything/deprecatedOperationWithMultilineComment",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="deprecatedOperationWithMultilineCommentGet",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
...
Its deprecation message has newlines.
. Use simple_path_parameter_objects instead.""")
    async def deprecated_operation_with_multiline_comment_get_async(
        self,
        *,
        deprecated_parameter: Optional[str] = None,
        new_parameter: Optional[str] = None,
