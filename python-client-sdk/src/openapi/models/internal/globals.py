...
class Globals(BaseModel):
    global_header_param: Annotated[Optional[bool], pydantic.Field(alias="globalHeaderParam"), FieldMetadata(header=HeaderMetadata(style="simple", explode=False))] = None
