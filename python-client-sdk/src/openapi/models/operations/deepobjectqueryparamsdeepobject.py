...
class DeepObjectQueryParamsDeepObjectRequest(BaseModel):
    deep_obj: Annotated[shared_deepobjectqueryparams.DeepObjectQueryParams, pydantic.Field(alias="deepObj"), FieldMetadata(query=QueryParamMetadata(style="deepObject", explode=True))]
    r"""deepObject style query parameter serialization is undefined for arrays or nested objects by the specification:
    https://github.com/OAI/OpenAPI-Specification/issues/1706
    This schema covers the intended implementation cases rather than the fully complex deepObject schema.
...
class DeepObjectQueryParamsDeepObjectArgs(BaseModel):
    ...
    deep_obj_map_testkey1: Annotated[str, pydantic.Field(alias="deepObj[map][testkey1]")]
    deep_obj_map_testkey2: Annotated[str, pydantic.Field(alias="deepObj[map][testkey2]")]
    ...
    deep_obj_obj_bigint_str: Annotated[str, pydantic.Field(alias="deepObj[obj][bigintStr]")]
    ...
    deep_obj_obj_date_time: Annotated[str, pydantic.Field(alias="deepObj[obj][dateTime]")]
    deep_obj_obj_date: Annotated[str, pydantic.Field(alias="deepObj[obj][date]")]
    deep_obj_obj_decimal_str: Annotated[str, pydantic.Field(alias="deepObj[obj][decimalStr]")]
    ...
    deep_obj_obj_int32_enum: Annotated[str, pydantic.Field(alias="deepObj[obj][int32Enum]")]
    ...
    deep_obj_obj_float64_str: Annotated[Optional[str], pydantic.Field(alias="deepObj[obj][float64Str]")] = None
    deep_obj_obj_int64_str: Annotated[Optional[str], pydantic.Field(alias="deepObj[obj][int64Str]")] = None
