...
class DeepObjectQueryParamsMapRequest(BaseModel):
    map_param: Annotated[Dict[str, str], pydantic.Field(alias="mapParam"), FieldMetadata(query=QueryParamMetadata(style="deepObject", explode=True))]
    map_arr_param: Annotated[Optional[Dict[str, List[str]]], pydantic.Field(alias="mapArrParam"), FieldMetadata(query=QueryParamMetadata(style="deepObject", explode=True))] = None
