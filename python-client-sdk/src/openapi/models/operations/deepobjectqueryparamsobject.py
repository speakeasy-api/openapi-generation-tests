...
class DeepObjectQueryParamsObjectRequest(BaseModel):
    obj_param: Annotated[
        ...
        pydantic.Field(alias="objParam"),
        FieldMetadata(query=QueryParamMetadata(style="deepObject", explode=True)),
    ]
    r"""A simple object that uses all our supported primitive types and enums and has optional properties."""

    obj_arr_param: Annotated[
        Optional[ObjArrParam],
        pydantic.Field(alias="objArrParam"),
        FieldMetadata(query=QueryParamMetadata(style="deepObject", explode=True)),
    ] = None
...
class DeepObjectQueryParamsObjectArgs(BaseModel):
    ...
    obj_param_bigint_str: Annotated[
        Optional[str], pydantic.Field(alias="objParam[bigintStr]")
    ] = None

    obj_param_bigint: Annotated[
        Optional[str], pydantic.Field(alias="objParam[bigint]")
    ] = None

    obj_param_decimal_str: Annotated[
        Optional[str], pydantic.Field(alias="objParam[decimalStr]")
    ] = None

    obj_param_decimal: Annotated[
        Optional[str], pydantic.Field(alias="objParam[decimal]")
    ] = None

    obj_param_float64_str: Annotated[
        Optional[str], pydantic.Field(alias="objParam[float64Str]")
    ] = None

    obj_param_int64_str: Annotated[
        Optional[str], pydantic.Field(alias="objParam[int64Str]")
    ] = None
