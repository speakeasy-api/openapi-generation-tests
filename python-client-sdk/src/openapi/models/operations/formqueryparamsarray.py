...
class FormQueryParamsArrayRequest(BaseModel):
    arr_param: Annotated[Optional[List[str]], pydantic.Field(alias="arrParam"), FieldMetadata(query=QueryParamMetadata(style="form", explode=False))] = None
    arr_param_exploded: Annotated[Optional[List[int]], pydantic.Field(alias="arrParamExploded"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = None
