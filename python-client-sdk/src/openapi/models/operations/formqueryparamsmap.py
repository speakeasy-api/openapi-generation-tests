...
class FormQueryParamsMapRequest(BaseModel):
    map_param: Annotated[Optional[Dict[str, str]], pydantic.Field(alias="mapParam"), FieldMetadata(query=QueryParamMetadata(style="form", explode=False))] = None
    map_param_exploded: Annotated[Optional[Dict[str, int]], pydantic.Field(alias="mapParamExploded"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = None
