...
class FormQueryParamsPrimitiveRequest(BaseModel):
    bool_param: Annotated[bool, pydantic.Field(alias="boolParam"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))]
    int_param: Annotated[int, pydantic.Field(alias="intParam"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))]
    num_param: Annotated[float, pydantic.Field(alias="numParam"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))]
    str_param: Annotated[str, pydantic.Field(alias="strParam"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))]
