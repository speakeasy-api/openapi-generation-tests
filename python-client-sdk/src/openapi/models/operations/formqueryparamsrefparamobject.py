...
from openapi.models.shared import (
    refqueryparamobj as shared_refqueryparamobj,
    refqueryparamobjexploded as shared_refqueryparamobjexploded,
)
...
class FormQueryParamsRefParamObjectRequestTypedDict(TypedDict):
    ...
    ref_obj_param_exploded: NotRequired[
        shared_refqueryparamobjexploded.RefQueryParamObjExplodedTypedDict
    ]


class FormQueryParamsRefParamObjectRequest(BaseModel):
    ref_obj_param: Annotated[
        Optional[shared_refqueryparamobj.RefQueryParamObj],
        pydantic.Field(alias="refObjParam"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=False)),
    ] = None

    ref_obj_param_exploded: Annotated[
        Optional[shared_refqueryparamobjexploded.RefQueryParamObjExploded],
        pydantic.Field(alias="refObjParamExploded"),
