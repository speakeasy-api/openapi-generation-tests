...
class HeaderParamsObjectRequest(BaseModel):
    x_header_obj: Annotated[
        shared_simpleobject.SimpleObject,
        pydantic.Field(alias="X-Header-Obj"),
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ]
    r"""A simple object that uses all our supported primitive types and enums and has optional properties."""

    x_header_obj_explode: Annotated[
        shared_simpleobject.SimpleObject,
        pydantic.Field(alias="X-Header-Obj-Explode"),
        FieldMetadata(header=HeaderMetadata(style="simple", explode=True)),
    ]
    r"""A simple object that uses all our supported primitive types and enums and has optional properties."""
