...
class HeaderParamsPrimitiveRequest(BaseModel):
    x_header_boolean: Annotated[bool, pydantic.Field(alias="X-Header-Boolean"), FieldMetadata(header=HeaderMetadata(style="simple", explode=False))]
    x_header_integer: Annotated[int, pydantic.Field(alias="X-Header-Integer"), FieldMetadata(header=HeaderMetadata(style="simple", explode=False))]
    x_header_number: Annotated[float, pydantic.Field(alias="X-Header-Number"), FieldMetadata(header=HeaderMetadata(style="simple", explode=False))]
    x_header_string: Annotated[str, pydantic.Field(alias="X-Header-String"), FieldMetadata(header=HeaderMetadata(style="simple", explode=False))]
