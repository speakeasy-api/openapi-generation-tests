...
from openapi.models.shared import deepobject as shared_deepobject, simpleobject as shared_simpleobject
...
class JSONQueryParamsObjectRequest(BaseModel):
    deep_obj_param: Annotated[shared_deepobject.DeepObject, pydantic.Field(alias="deepObjParam"), FieldMetadata(query=QueryParamMetadata(serialization="json"))]
