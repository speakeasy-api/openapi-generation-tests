...
from openapi.models.shared import deepobjectsmaller as shared_deepobjectsmaller, simpleobject as shared_simpleobject
...
class JSONQueryParamsObjectSmallerRequest(BaseModel):
    deep_obj_param: Annotated[shared_deepobjectsmaller.DeepObjectSmaller, pydantic.Field(alias="deepObjParam"), FieldMetadata(query=QueryParamMetadata(serialization="json"))]
    simple_obj_param: Annotated[shared_simpleobject.SimpleObject, pydantic.Field(alias="simpleObjParam"), FieldMetadata(query=QueryParamMetadata(serialization="json"))]
    r"""A simple object that uses all our supported primitive types and enums and has optional properties."""
