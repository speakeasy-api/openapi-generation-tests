...
class NameOverrideGetRequest(BaseModel):
    test_enum_query_param: Annotated[
        EnumNameOverride,
        pydantic.Field(alias="enumNameOverride"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ]
    r"""An enum type"""

    test_query_param: Annotated[
        str,
        pydantic.Field(alias="nameOverride"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ]
...
class NameOverrideGetOverriddenResponse(BaseModel):
    ...
    deep_overridden_all_of: Annotated[
        Optional[DeepOverriddenAllOf], pydantic.Field(alias="deepAllOf")
    ] = None

    json_: Annotated[
        Optional[shared_simpleobject.SimpleObject], pydantic.Field(alias="json")
    ] = None
    r"""A simple object that uses all our supported primitive types and enums and has optional properties.
    https://speakeasy.com/docs - A link to the external docs.
    """

    overridden_all_of: Annotated[
        Optional[OverriddenAllOf], pydantic.Field(alias="allOf")
    ] = None

    overridden_normal: Annotated[
        Optional[OverriddenNormal], pydantic.Field(alias="normal")
    ] = None
