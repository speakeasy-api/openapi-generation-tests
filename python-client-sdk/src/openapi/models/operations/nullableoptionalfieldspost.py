...
class NullableOptionalFieldsPostRequestBody(BaseModel):
    nullable_required: Annotated[
        Nullable[str], pydantic.Field(alias="nullableRequired")
    ]

    nullable_optional: Annotated[
        OptionalNullable[str], pydantic.Field(alias="nullableOptional")
    ] = UNSET
