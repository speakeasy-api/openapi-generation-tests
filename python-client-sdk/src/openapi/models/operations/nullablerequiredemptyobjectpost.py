...
class NullableRequiredEmptyObjectPostRequestBody(BaseModel):
    nullable_required_obj: Annotated[
        Nullable[NullableRequiredObj], pydantic.Field(alias="NullableRequiredObj")
    ]

    required_obj: Annotated[RequiredObj, pydantic.Field(alias="RequiredObj")]

    nullable_optional_obj: Annotated[
        OptionalNullable[NullableOptionalObj],
        pydantic.Field(alias="NullableOptionalObj"),
    ] = UNSET
...
class NullableRequiredEmptyObjectPostJSONTypedDict(TypedDict):
    nullable_required_obj: Nullable[
    ...
    nullable_optional_obj: NotRequired[
        Nullable[NullableRequiredEmptyObjectPostNullableOptionalObjTypedDict]
    ]


class NullableRequiredEmptyObjectPostJSON(BaseModel):
    nullable_required_obj: Annotated[
        Nullable[NullableRequiredEmptyObjectPostNullableRequiredObj],
        pydantic.Field(alias="NullableRequiredObj"),
    ]

    required_obj: Annotated[
        NullableRequiredEmptyObjectPostRequiredObj, pydantic.Field(alias="RequiredObj")
    ]

    nullable_optional_obj: Annotated[
        OptionalNullable[NullableRequiredEmptyObjectPostNullableOptionalObj],
        pydantic.Field(alias="NullableOptionalObj"),
    ] = UNSET
...
class NullableRequiredEmptyObjectPostResponseBody(BaseModel):
    ...
    json_: Annotated[
        Optional[NullableRequiredEmptyObjectPostJSON], pydantic.Field(alias="json")
    ] = None
