...
from openapi.models.shared import (
    nullableobject as shared_nullableobject,
    nullableoptionalobject as shared_nullableoptionalobject,
)
...
class NullableRequiredSharedObjectPostRequestBodyTypedDict(TypedDict):
    ...
    nullable_optional_obj: NotRequired[
        Nullable[shared_nullableoptionalobject.NullableOptionalObjectTypedDict]
    ]


class NullableRequiredSharedObjectPostRequestBody(BaseModel):
    nullable_required_obj: Annotated[
        Nullable[shared_nullableobject.NullableObject],
        pydantic.Field(alias="NullableRequiredObj"),
    ]

    nullable_optional_obj: Annotated[
        OptionalNullable[shared_nullableoptionalobject.NullableOptionalObject],
...
class NullableRequiredSharedObjectPostResponseBody(BaseModel):
    ...
    json_: Annotated[
        Optional[NullableRequiredSharedObjectPostJSON], pydantic.Field(alias="json")
    ] = None
