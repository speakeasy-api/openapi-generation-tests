...
class PaginationURLParamsRequest(BaseModel):
    attempts: Annotated[int, FieldMetadata(query=QueryParamMetadata(style="form", explode=True))]
    is_reference_path: Annotated[Optional[str], pydantic.Field(alias="is-reference-path"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = None
