...
class PaginationWithRetriesRequest(BaseModel):
    ...
    r"""The page token used to request a specific page of the search results"""
    fault_settings: Annotated[Optional[str], pydantic.Field(alias="fault-settings"), FieldMetadata(header=HeaderMetadata(style="simple", explode=False))] = "{\"error_code\": 503, \"error_count\": 3}"
    request_id: Annotated[Optional[str], pydantic.Field(alias="request-id"), FieldMetadata(header=HeaderMetadata(style="simple", explode=False))] = "paginationWithRetries"
