...
class RequestBodyPostEmptyObjectRequestBody(BaseModel):
    ...
    empty_with_empty_properties: Annotated[Optional[EmptyWithEmptyProperties], pydantic.Field(alias="emptyWithEmptyProperties")] = None
...
class RequestBodyPostEmptyObjectResponseBody(BaseModel):
    ...
    empty_resp_with_empty_properies: Annotated[Optional[EmptyRespWithEmptyProperies], pydantic.Field(alias="emptyRespWithEmptyProperies")] = None
