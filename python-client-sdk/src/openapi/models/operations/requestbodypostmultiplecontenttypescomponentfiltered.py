...
class RequestBodyPostMultipleContentTypesComponentFilteredResTypedDict(TypedDict):
    r"""OK"""
...
class RequestBodyPostMultipleContentTypesComponentFilteredRes(BaseModel):
    r"""OK"""
