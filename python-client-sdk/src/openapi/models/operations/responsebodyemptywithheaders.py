...
class ResponseBodyEmptyWithHeadersRequest(BaseModel):
    x_number_header: Annotated[float, pydantic.Field(alias="X-Number-Header"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))]
    x_string_header: Annotated[str, pydantic.Field(alias="X-String-Header"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))]
