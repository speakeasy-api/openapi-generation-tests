...
class TestHooksRequest(BaseModel):
    ...
    some_param: Annotated[str, pydantic.Field(alias="someParam"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))]
...
class Headers(BaseModel):
    client_level_header: Annotated[Optional[str], pydantic.Field(alias="Client-Level-Header")] = None
    idempotency_key: Annotated[Optional[str], pydantic.Field(alias="Idempotency-Key")] = None
