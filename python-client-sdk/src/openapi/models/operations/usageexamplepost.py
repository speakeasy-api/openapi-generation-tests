...
from openapi.models.shared import (
    fakercamelcasepropertynamestrings as shared_fakercamelcasepropertynamestrings,
    fakerformattedstrings as shared_fakerformattedstrings,
    fakerkebobcasepropertynamestrings as shared_fakerkebobcasepropertynamestrings,
    fakerpascalcasepropertynamestrings as shared_fakerpascalcasepropertynamestrings,
    fakersnakecasepropertynamestrings as shared_fakersnakecasepropertynamestrings,
...
class UsageExamplePostRequestBodyTypedDict(TypedDict):
    ...
    faker_camel_case_property_name_strings: shared_fakercamelcasepropertynamestrings.FakerCamelCasePropertyNameStringsTypedDict
    r"""A set of strings with camel case fieldnames that lead to relevant examples being generated for them"""
    faker_formatted_strings: shared_fakerformattedstrings.FakerFormattedStringsTypedDict
    r"""A set of strings with format values that lead to relevant examples being generated for them"""
    faker_kebob_case_property_name_strings: shared_fakerkebobcasepropertynamestrings.FakerKebobCasePropertyNameStringsTypedDict
    r"""A set of strings with kebob case fieldnames that lead to relevant examples being generated for them"""
    faker_pascal_case_property_name_strings: shared_fakerpascalcasepropertynamestrings.FakerPascalCasePropertyNameStringsTypedDict
    r"""A set of strings with pascal case fieldnames that lead to relevant examples being generated for them"""
    faker_snake_case_property_name_strings: shared_fakersnakecasepropertynamestrings.FakerSnakeCasePropertyNameStringsTypedDict
...
class UsageExamplePostRequestBody(BaseModel):
    ...
    faker_camel_case_property_name_strings: Annotated[
        shared_fakercamelcasepropertynamestrings.FakerCamelCasePropertyNameStrings,
        pydantic.Field(alias="fakerCamelCasePropertyNameStrings"),
    ]
    r"""A set of strings with camel case fieldnames that lead to relevant examples being generated for them"""

    faker_formatted_strings: Annotated[
        shared_fakerformattedstrings.FakerFormattedStrings,
        pydantic.Field(alias="fakerFormattedStrings"),
    ]
    r"""A set of strings with format values that lead to relevant examples being generated for them"""

    faker_kebob_case_property_name_strings: Annotated[
        shared_fakerkebobcasepropertynamestrings.FakerKebobCasePropertyNameStrings,
        pydantic.Field(alias="fakerKebobCasePropertyNameStrings"),
    ]
    r"""A set of strings with kebob case fieldnames that lead to relevant examples being generated for them"""

    faker_pascal_case_property_name_strings: Annotated[
        shared_fakerpascalcasepropertynamestrings.FakerPascalCasePropertyNameStrings,
        pydantic.Field(alias="fakerPascalCasePropertyNameStrings"),
    ]
    r"""A set of strings with pascal case fieldnames that lead to relevant examples being generated for them"""

    faker_snake_case_property_name_strings: Annotated[
        shared_fakersnakecasepropertynamestrings.FakerSnakeCasePropertyNameStrings,
        pydantic.Field(alias="fakerSnakeCasePropertyNameStrings"),
    ]
    r"""A set of strings with snake case fieldnames that lead to relevant examples being generated for them"""

    simple_object: Annotated[
        shared_simpleobject.SimpleObject, pydantic.Field(alias="simpleObject")
    ]
    r"""A simple object that uses all our supported primitive types and enums and has optional properties.
    https://speakeasy.com/docs - A link to the external docs.
    """
