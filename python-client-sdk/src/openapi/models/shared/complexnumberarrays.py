...
class ComplexNumberArrays(BaseModel):
    bigint_array: Annotated[
        Optional[List[Annotated[int, BeforeValidator(validate_int)]]],
        pydantic.Field(alias="bigintArray"),
    ] = None

    bigint_str_array: Annotated[
        Optional[
            List[
                Annotated[
                    int,
        ...
        pydantic.Field(alias="bigintStrArray"),
    ] = None

    decimal_array: Annotated[
        Optional[
            List[
                Annotated[
                    Decimal,
        ...
        pydantic.Field(alias="decimalArray"),
    ] = None

    decimal_str_array: Annotated[
        Optional[
            List[
                Annotated[
                    Decimal,
        ...
        pydantic.Field(alias="decimalStrArray"),
    ] = None
