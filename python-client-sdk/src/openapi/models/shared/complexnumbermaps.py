...
class ComplexNumberMaps(BaseModel):
    bigint_map: Annotated[
        Optional[Dict[str, Annotated[int, BeforeValidator(validate_int)]]],
        pydantic.Field(alias="bigintMap"),
    ] = None

    bigint_str_map: Annotated[
        Optional[
            Dict[
                str,
                Annotated[
        ...
        pydantic.Field(alias="bigintStrMap"),
    ] = None

    decimal_map: Annotated[
        Optional[
            Dict[
                str,
                Annotated[
        ...
        pydantic.Field(alias="decimalMap"),
    ] = None

    decimal_str_map: Annotated[
        Optional[
            Dict[
                str,
                Annotated[
        ...
        pydantic.Field(alias="decimalStrMap"),
    ] = None
