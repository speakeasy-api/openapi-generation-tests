...
class DeepObject(BaseModel):
    ...
    bool_: Annotated[
        bool, pydantic.Field(alias="bool"), FieldMetadata(form=True, multipart=True)
    ]

    int_: Annotated[
        int, pydantic.Field(alias="int"), FieldMetadata(form=True, multipart=True)
    ]

    map: Annotated[
        Dict[str, SimpleObject],
        FieldMetadata(
            form=FormMetadata(json=True), multipart=MultipartFormMetadata(json=True)
        ),
    ]
    ...
    str_: Annotated[
        str, pydantic.Field(alias="str"), FieldMetadata(form=True, multipart=True)
    ]
