...
OneofTypedDict = TypeAliasType("OneofTypedDict", Union[str, int])


Oneof = TypeAliasType("Oneof", Union[str, int])


class TwoTypedDict(TypedDict):
    nested: NotRequired[str]


class Two(BaseModel):
    nested: Annotated[Optional[str], FieldMetadata(query=True)] = None


OneofnestedobjectTypedDict = TypeAliasType(
    "OneofnestedobjectTypedDict", Union[TwoTypedDict, str]
)


Oneofnestedobject = TypeAliasType("Oneofnestedobject", Union[Two, str])
...
class DeepObjectQueryParamsTypedDict(TypedDict):
    ...
    """
    str_: str
    oneof: NotRequired[OneofTypedDict]
    oneofnestedobject: NotRequired[OneofnestedobjectTypedDict]
...
class DeepObjectQueryParams(BaseModel):
    ...
    oneof: Annotated[Optional[Oneof], FieldMetadata(query=True)] = None

    oneofnestedobject: Annotated[
        Optional[Oneofnestedobject], FieldMetadata(query=True)
    ] = None
