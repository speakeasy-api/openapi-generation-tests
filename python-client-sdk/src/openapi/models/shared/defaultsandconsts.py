...
class DefaultsAndConsts(BaseModel):
    ...
    default_big_int: Annotated[Annotated[Optional[int], BeforeValidator(validate_int)], pydantic.Field(alias="defaultBigInt")] = 9007199254740991
    default_big_int_str: Annotated[Annotated[Optional[int], BeforeValidator(validate_int), PlainSerializer(serialize_int(True))], pydantic.Field(alias="defaultBigIntStr")] = 9223372036854775807
    default_bool: Annotated[Optional[bool], pydantic.Field(alias="defaultBool")] = True
    default_date: Annotated[Optional[date], pydantic.Field(alias="defaultDate")] = dateutil.parser.parse("2020-01-01").date()
    default_date_time: Annotated[Optional[datetime], pydantic.Field(alias="defaultDateTime")] = dateutil.parser.isoparse("2020-01-01T00:00:00Z")
    default_decimal: Annotated[Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))], pydantic.Field(alias="defaultDecimal")] = Decimal("3.141592653589793")
    default_decimal_str: Annotated[Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(True))], pydantic.Field(alias="defaultDecimalStr")] = Decimal("3.141592653589793238462643383279")
    default_enum_int: Annotated[Optional[DefaultEnumInt], pydantic.Field(alias="defaultEnumInt")] = DefaultEnumInt.TWO
    default_enum_str: Annotated[Optional[DefaultEnumStr], pydantic.Field(alias="defaultEnumStr")] = DefaultEnumStr.TWO
    default_int: Annotated[Optional[int], pydantic.Field(alias="defaultInt")] = 123
    default_num: Annotated[Optional[float], pydantic.Field(alias="defaultNum")] = 123.456
    default_str: Annotated[Optional[str], pydantic.Field(alias="defaultStr")] = "default"
    default_str_d_quotes: Annotated[Optional[str], pydantic.Field(alias="defaultStrDQuotes")] = "default with \"double quotes\""
    default_str_nullable: Annotated[OptionalNullable[str], pydantic.Field(alias="defaultStrNullable")] = None
    default_str_optional: Annotated[Optional[str], pydantic.Field(alias="defaultStrOptional")] = "default"
    default_str_s_quotes: Annotated[Optional[str], pydantic.Field(alias="defaultStrSQuotes")] = "default with 'single quotes'"
    
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = ["defaultBigInt", "defaultBigIntStr", "defaultBool", "defaultDate", "defaultDateTime", "defaultDecimal", "defaultDecimalStr", "defaultEnumInt", "defaultEnumStr", "defaultInt", "defaultNum", "defaultStr", "defaultStrDQuotes", "defaultStrNullable", "defaultStrOptional", "defaultStrSQuotes"]
