...
class DeprecatedFieldInObject(BaseModel):
    deprecated_enum: Annotated[
        Optional[DeprecatedEnum],
        pydantic.Field(
            deprecated="warning: ** DEPRECATED ** - This enum is deprecated.",
            alias="deprecatedEnum",
        ),
    ] = None
    ...
    deprecated_field: Annotated[
        Optional[str],
        pydantic.Field(
            deprecated="warning: ** DEPRECATED ** - This will be removed in a future release, please migrate away from it as soon as possible. Use new_field instead.",
            alias="deprecatedField",
        ),
    ] = None
