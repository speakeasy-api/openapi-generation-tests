...
class ExampleResource(BaseModel):
    ...
    array_of_number: Annotated[
        Optional[List[float]], pydantic.Field(alias="arrayOfNumber")
    ] = None

    array_of_string: Annotated[
        Optional[List[str]], pydantic.Field(alias="arrayOfString")
    ] = None

    created_at: Annotated[Optional[datetime], pydantic.Field(alias="createdAt")] = None

    enum_number: Annotated[Optional[EnumNumber], pydantic.Field(alias="enumNumber")] = (
        None
    )
    ...
    inline_object: Annotated[
        Optional[InlineObject], pydantic.Field(alias="inlineObject")
    ] = None

    map_of_integer: Annotated[
        Optional[Dict[str, int]], pydantic.Field(alias="mapOfInteger")
    ] = None

    map_of_string: Annotated[
        Optional[Dict[str, str]], pydantic.Field(alias="mapOfString")
    ] = None
