...
NullableOneOfTwoTypedDict = TypeAliasType(
    "NullableOneOfTwoTypedDict", Union[TypedObject1TypedDict, TypedObject2TypedDict]
)


NullableOneOfTwo = TypeAliasType("NullableOneOfTwo", Union[TypedObject1, TypedObject2])
...
class NullableOneOfRefInObject(BaseModel):
    nullable_one_of_one: Annotated[
        Nullable[TypedObject1], pydantic.Field(alias="NullableOneOfOne")
    ]

    nullable_one_of_two: Annotated[
        Nullable[NullableOneOfTwo], pydantic.Field(alias="NullableOneOfTwo")
    ]
