...
class SimpleObject(BaseModel):
    ...
    r"""A boolean property."""
    date_: Annotated[date, pydantic.Field(alias="date"), FieldMetadata(header=True, path=True, query=True, form=True, multipart=True)]
    r"""A date property."""
    ...
    decimal_nullable_opt: Annotated[Annotated[OptionalNullable[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))], pydantic.Field(alias="decimalNullableOpt"), FieldMetadata(header=True, path=True, query=True, form=True, multipart=True)] = UNSET
