...
class Pagination(BaseSDK):
    ...
    def pagination_encapsulated_parameter(
        self,
        *,
        request: Union[
            operations.PaginationEncapsulatedParameterRequest,
            operations.PaginationEncapsulatedParameterRequestTypedDict,
        ] = operations.PaginationEncapsulatedParameterRequest(),
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[operations.PaginationEncapsulatedParameterResponse]:
        r"""This is a paginated operation where the input is a query parameter
        ...
        if server_url is not None:
            ...
            base_url = operations.PAGINATION_ENCAPSULATED_PARAMETER_SERVERS[0]

        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, operations.PaginationEncapsulatedParameterRequest
            )
        request = cast(operations.PaginationEncapsulatedParameterRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="paginationEncapsulatedParameter",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        def next_func() -> Optional[operations.PaginationEncapsulatedParameterResponse]:
            body = utils.unmarshal_json(http_res.text, Dict[Any, Any])
            next_cursor = JSONPath("$.resultArray[-1:]").parse(body)
            ...
            return self.pagination_encapsulated_parameter(
                request=operations.PaginationEncapsulatedParameterRequest(
                    cursor=next_cursor,
                    header_param=request.header_param,
                ),
                retries=retries,
                server_url=server_url,
            )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.PaginationEncapsulatedParameterResponse(
                result=utils.unmarshal_json(
                    http_res.text,
                    Optional[operations.PaginationEncapsulatedParameterRes],
                ),
                next=next_func,
            )
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
    ...
    async def pagination_encapsulated_parameter_async(
        self,
        *,
        request: Union[
            operations.PaginationEncapsulatedParameterRequest,
    ...
    def pagination_limit_offset_default_offset_body(
        self,
        *,
        request: Union[
            shared.LimitOffsetConfigWithDefaults,
            shared.LimitOffsetConfigWithDefaultsTypedDict,
        ] = shared.LimitOffsetConfigWithDefaults(),
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[operations.PaginationLimitOffsetDefaultOffsetBodyResponse]:
        r"""
        :param request: The request object to send.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        ...
        if server_url is not None:
            ...
            base_url = operations.PAGINATION_LIMIT_OFFSET_DEFAULT_OFFSET_BODY_SERVERS[0]

        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, shared.LimitOffsetConfigWithDefaults)
        request = cast(shared.LimitOffsetConfigWithDefaults, request)
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[shared.LimitOffsetConfigWithDefaults],
            ),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="paginationLimitOffsetDefaultOffsetBody",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        def next_func() -> (
            ...
            body = utils.unmarshal_json(http_res.text, Dict[Any, Any])
            offset = request.offset if not request.offset is None else 10
            ...
            if len(results) == 0 or len(results[0]) == 0:
                return None
            limit = request.limit if not request.limit is None else 15
            if len(results[0]) < limit:
                return None
            next_offset = offset + len(results[0])

            return self.pagination_limit_offset_default_offset_body(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.PaginationLimitOffsetDefaultOffsetBodyResponse(
                result=utils.unmarshal_json(
                    http_res.text,
                    Optional[operations.PaginationLimitOffsetDefaultOffsetBodyRes],
                ),
                next=next_func,
            )
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
    ...
    async def pagination_limit_offset_default_offset_body_async(
        self,
        *,
        request: Union[
            shared.LimitOffsetConfigWithDefaults,
    ...
    def pagination_limit_offset_default_offset_params(
        self,
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[operations.PaginationLimitOffsetDefaultOffsetParamsResponse]:
        r"""
        :param limit:
        :param offset:
        :param retries: Override the default retry configuration for this method
        ...
        if server_url is not None:
            ...
            base_url = operations.PAGINATION_LIMIT_OFFSET_DEFAULT_OFFSET_PARAMS_SERVERS[
                0
            ]
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="paginationLimitOffsetDefaultOffsetParams",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        def next_func() -> (
            ...
            return self.pagination_limit_offset_default_offset_params(
                limit=limit,
                offset=next_offset,
                retries=retries,
                server_url=server_url,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.PaginationLimitOffsetDefaultOffsetParamsResponse(
                result=utils.unmarshal_json(
                    http_res.text,
                    Optional[operations.PaginationLimitOffsetDefaultOffsetParamsRes],
                ),
                next=next_func,
            )
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
    ...
    async def pagination_limit_offset_default_offset_params_async(
        self,
        *,
        limit: Optional[int] = 15,
        offset: Optional[int] = 10,
    ...
    def pagination_limit_offset_optional_page_params(
        self,
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[operations.PaginationLimitOffsetOptionalPageParamsResponse]:
        r"""
        :param page:
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        ...
        if server_url is not None:
            ...
            base_url = operations.PAGINATION_LIMIT_OFFSET_OPTIONAL_PAGE_PARAMS_SERVERS[
                0
            ]
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="paginationLimitOffsetOptionalPageParams",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        def next_func() -> (
            ...
            return self.pagination_limit_offset_optional_page_params(
                page=next_page,
                retries=retries,
                server_url=server_url,
            )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.PaginationLimitOffsetOptionalPageParamsResponse(
                result=utils.unmarshal_json(
                    http_res.text,
                    Optional[operations.PaginationLimitOffsetOptionalPageParamsRes],
                ),
                next=next_func,
            )
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
    ...
    async def pagination_limit_offset_optional_page_params_async(
        self,
        *,
        page: Optional[int] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
