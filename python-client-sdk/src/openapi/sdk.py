...
class SDK(BaseSDK):
    ...
    def __init__(
        ...
        _globals = internal.Globals(
            global_header_param=utils.get_global_from_env(global_header_param, "GLOBAL_HEADER_PARAM", bool),
            global_hidden_header_param=utils.get_global_from_env(global_hidden_header_param, "GLOBAL_HIDDEN_HEADER_PARAM", str),
            global_hidden_path_param=utils.get_global_from_env(global_hidden_path_param, "GLOBAL_HIDDEN_PATH_PARAM", str),
            global_hidden_query_param=utils.get_global_from_env(global_hidden_query_param, "GLOBAL_HIDDEN_QUERY_PARAM", str),
            global_path_param=utils.get_global_from_env(global_path_param, "GLOBAL_PATH_PARAM", int),
            global_query_param=utils.get_global_from_env(global_query_param, "GLOBAL_QUERY_PARAM", str),
        )
    ...
    def ambiguous_query_param(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="ambiguousQueryParam", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
    ...
    def authenticated_request(
        self, *,
        security: Union[operations.AuthenticatedRequestSecurity, operations.AuthenticatedRequestSecurityTypedDict],
        request: Optional[Union[operations.AuthenticatedRequestRequestBody, operations.AuthenticatedRequestRequestBodyTypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ):
        ...
        if not isinstance(request, BaseModel) and request is not None:
            request = utils.unmarshal(request, operations.AuthenticatedRequestRequestBody)
        request = cast(operations.AuthenticatedRequestRequestBody, request)
        ...
        req = self.build_request(
            ...
            user_agent_header="x-speakeasy-user-agent",
            accept_header_value="*/*",
            security=utils.get_pydantic_model(security, operations.AuthenticatedRequestSecurity),
            get_serialized_body=lambda: utils.serialize_request_body(request, False, True, "json", Optional[operations.AuthenticatedRequestRequestBody]),
            timeout_ms=timeout_ms,
        )
    ...
    def conflicting_enum(
        self, *,
        request: Optional[Union[shared.ConflictingEnum, shared.ConflictingEnumTypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ):
        ...
        if not isinstance(request, BaseModel) and request is not None:
            request = utils.unmarshal(request, shared.ConflictingEnum)
        request = cast(shared.ConflictingEnum, request)
        ...
        req = self.build_request(
            ...
            accept_header_value="*/*",
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(request, False, True, "json", Optional[shared.ConflictingEnum]),
            timeout_ms=timeout_ms,
        )
    ...
    def ignored_generation_put(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[operations.IgnoredGenerationPutResponseBody])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise errors.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
    ...
    def multiline_example(
        self, *,
        request: Optional[Union[operations.MultilineExampleRequestBody, operations.MultilineExampleRequestBodyTypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ):
        ...
        if not isinstance(request, BaseModel) and request is not None:
            request = utils.unmarshal(request, operations.MultilineExampleRequestBody)
        request = cast(operations.MultilineExampleRequestBody, request)
        ...
        req = self.build_request(
            ...
            accept_header_value="*/*",
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(request, False, True, "json", Optional[operations.MultilineExampleRequestBody]),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="multilineExample", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
    ...
    def post_additional_properties_with_nullable_fields(
        self, *,
        request: Union[operations.PostAdditionalPropertiesWithNullableFieldsRequestBody, operations.PostAdditionalPropertiesWithNullableFieldsRequestBodyTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.PostAdditionalPropertiesWithNullableFieldsRequestBody)
        request = cast(operations.PostAdditionalPropertiesWithNullableFieldsRequestBody, request)
        ...
        req = self.build_request(
            ...
            accept_header_value="application/json",
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(request, False, False, "json", operations.PostAdditionalPropertiesWithNullableFieldsRequestBody),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="postAdditionalPropertiesWithNullableFields", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[operations.PostAdditionalPropertiesWithNullableFieldsResponseBody])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise errors.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
