...
class Documentation:
    ...
    def get_documentation_per_language(self, language: str) -> operations.GetDocumentationPerLanguageResponse:
        ...
        res = operations.GetDocumentationPerLanguageResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
