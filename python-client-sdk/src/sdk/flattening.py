...
class Flattening:
    ...
    def component_body_and_param_conflict(self, simple_object: shared.SimpleObject, str_: str) -> operations.ComponentBodyAndParamConflictResponse:
        ...
        query_params = { **utils.get_query_params(operations.ComponentBodyAndParamConflictRequest, request, self.sdk_configuration.globals), **query_params }
        ...
        res = operations.ComponentBodyAndParamConflictResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def component_body_and_param_no_conflict(self, param_str: str, simple_object: shared.SimpleObject) -> operations.ComponentBodyAndParamNoConflictResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = { **utils.get_query_params(operations.ComponentBodyAndParamNoConflictRequest, request, self.sdk_configuration.globals), **query_params }
        headers['Accept'] = 'application/json'
        headers['x-speakeasy-user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.ComponentBodyAndParamNoConflictResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def conflicting_params(self, str_path_parameter: str, str_query_parameter: str) -> operations.ConflictingParamsResponse:
        ...
        query_params = { **utils.get_query_params(operations.ConflictingParamsRequest, request, self.sdk_configuration.globals), **query_params }
        headers['Accept'] = 'application/json'
        headers['x-speakeasy-user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.ConflictingParamsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def inline_body_and_param_conflict(self, request_body: operations.InlineBodyAndParamConflictRequestBody, str_: str) -> operations.InlineBodyAndParamConflictResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = { **utils.get_query_params(operations.InlineBodyAndParamConflictRequest, request, self.sdk_configuration.globals), **query_params }
        headers['Accept'] = 'application/json'
        headers['x-speakeasy-user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.InlineBodyAndParamConflictResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def inline_body_and_param_no_conflict(self, request_body: operations.InlineBodyAndParamNoConflictRequestBody, param_str: str) -> operations.InlineBodyAndParamNoConflictResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = { **utils.get_query_params(operations.InlineBodyAndParamNoConflictRequest, request, self.sdk_configuration.globals), **query_params }
        headers['Accept'] = 'application/json'
        headers['x-speakeasy-user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.InlineBodyAndParamNoConflictResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
