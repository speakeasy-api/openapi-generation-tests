...
class TaggedError2RequestBody:
    ...
    tagged_error2_message: Optional[TaggedError2Message] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error'), 'exclude': lambda f: f is None }})
