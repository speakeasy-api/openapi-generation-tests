...
class RequestBodyPostComplexNumberTypesRequest:
    ...
    path_big_int_str: str = dataclasses.field(metadata={'path_param': { 'field_name': 'pathBigIntStr', 'style': 'simple', 'explode': False }})
    path_decimal: float = dataclasses.field(metadata={'path_param': { 'field_name': 'pathDecimal', 'style': 'simple', 'explode': False }})
    path_decimal_str: str = dataclasses.field(metadata={'path_param': { 'field_name': 'pathDecimalStr', 'style': 'simple', 'explode': False }})
    query_big_int: int = dataclasses.field(metadata={'query_param': { 'field_name': 'queryBigInt', 'style': 'form', 'explode': True }})
    query_big_int_str: str = dataclasses.field(metadata={'query_param': { 'field_name': 'queryBigIntStr', 'style': 'form', 'explode': True }})
    query_decimal: float = dataclasses.field(metadata={'query_param': { 'field_name': 'queryDecimal', 'style': 'form', 'explode': True }})
    query_decimal_str: str = dataclasses.field(metadata={'query_param': { 'field_name': 'queryDecimalStr', 'style': 'form', 'explode': True }})
