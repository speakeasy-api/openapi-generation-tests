...
class RequestBodyPostJSONDataTypesDateTimeResponse:
    ...
    request_body_post_json_data_types_date_time_200_application_json_object: Optional[RequestBodyPostJSONDataTypesDateTime200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""
