...
class RequestBodyPostMultipleContentTypesSplitFormRes:
    ...
    json: Optional[Dict[str, Any]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('json'), 'exclude': lambda f: f is RequestBodyPostMultipleContentTypesSplitFormRes.UNSET }})
