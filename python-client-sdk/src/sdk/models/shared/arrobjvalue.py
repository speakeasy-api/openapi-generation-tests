...
class ArrObjValue:
    json: Optional[list[shared_simpleobject.SimpleObject]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('json'), 'exclude': lambda f: f is None }})
