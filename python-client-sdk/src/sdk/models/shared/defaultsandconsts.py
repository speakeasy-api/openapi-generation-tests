...
class DefaultsAndConsts:
    ...
    default_enum_int: DefaultsAndConstsDefaultEnumInt = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('defaultEnumInt') }})
    default_enum_str: DefaultsAndConstsDefaultEnumStr = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('defaultEnumStr') }})
