...
class SimpleObject:
    ...
    decimal: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('decimal'), 'exclude': lambda f: f is None }, 'header': { 'field_name': 'decimal' }, 'path_param': { 'field_name': 'decimal' }, 'query_param': { 'field_name': 'decimal' }, 'form': { 'field_name': 'decimal' }, 'multipart_form': { 'field_name': 'decimal' }})
