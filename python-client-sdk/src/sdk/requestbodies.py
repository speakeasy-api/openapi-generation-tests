...
class RequestBodies:
    ...
    def null_enum_post(self, request: shared.ObjectWithNullEnums) -> operations.NullEnumPostResponse:
        ...
        res = operations.NullEnumPostResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_body_post_complex_number_types(self, request: operations.RequestBodyPostComplexNumberTypesRequest) -> operations.RequestBodyPostComplexNumberTypesResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.RequestBodyPostComplexNumberTypesRequest, request, self.sdk_configuration.globals)
        headers['Accept'] = 'application/json'
        headers['x-speakeasy-user-agent'] = self.sdk_configuration.user_agent
    ...
    def request_body_post_json_data_types_complex_number_arrays(self, request: shared.ComplexNumberArrays) -> operations.RequestBodyPostJSONDataTypesComplexNumberArraysResponse:
        ...
        res = operations.RequestBodyPostJSONDataTypesComplexNumberArraysResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_body_post_json_data_types_complex_number_maps(self, request: shared.ComplexNumberMaps) -> operations.RequestBodyPostJSONDataTypesComplexNumberMapsResponse:
        ...
        res = operations.RequestBodyPostJSONDataTypesComplexNumberMapsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
