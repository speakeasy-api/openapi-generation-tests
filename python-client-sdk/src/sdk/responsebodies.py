...
class ResponseBodies:
    ...
    def response_body_additional_properties_complex_numbers_post(self, request: shared.ObjWithComplexNumbersAdditionlProperties) -> operations.ResponseBodyAdditionalPropertiesComplexNumbersPostResponse:
    ...
    def response_body_additional_properties_date_post(self, request: shared.ObjWithDateAdditionlProperties) -> operations.ResponseBodyAdditionalPropertiesDatePostResponse:
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def response_body_additional_properties_post(self, request: shared.ObjWithStringAdditionlProperties) -> operations.ResponseBodyAdditionalPropertiesPostResponse:
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
