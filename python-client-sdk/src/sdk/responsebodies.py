...
class ResponseBodies:
    ...
    def response_body_additional_properties_complex_numbers_post(self, request: dict[str, int]) -> operations.ResponseBodyAdditionalPropertiesComplexNumbersPostResponse:
    ...
    def response_body_additional_properties_date_post(self, request: dict[str, date]) -> operations.ResponseBodyAdditionalPropertiesDatePostResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "request", False, False, 'json', utils.map_encoder(False, utils.dateisoformat(False)))
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def response_body_additional_properties_post(self, request: dict[str, str]) -> operations.ResponseBodyAdditionalPropertiesPostResponse:
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
