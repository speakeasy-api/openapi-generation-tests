...
class ResponseBodies:
    ...
    def response_body_additional_properties_any_post(self, request: shared.ObjWithAnyAdditionalProperties) -> operations.ResponseBodyAdditionalPropertiesAnyPostResponse:
        ...
        res = operations.ResponseBodyAdditionalPropertiesAnyPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def response_body_additional_properties_complex_numbers_post(self, request: shared.ObjWithComplexNumbersAdditionalProperties) -> operations.ResponseBodyAdditionalPropertiesComplexNumbersPostResponse:
        ...
        res = operations.ResponseBodyAdditionalPropertiesComplexNumbersPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def response_body_additional_properties_date_post(self, request: shared.ObjWithDateAdditionalProperties) -> operations.ResponseBodyAdditionalPropertiesDatePostResponse:
        ...
        res = operations.ResponseBodyAdditionalPropertiesDatePostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def response_body_additional_properties_object_post(self, request: shared.ObjWithObjAdditionalProperties) -> operations.ResponseBodyAdditionalPropertiesObjectPostResponse:
        ...
        res = operations.ResponseBodyAdditionalPropertiesObjectPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def response_body_additional_properties_post(self, request: shared.ObjWithStringAdditionalProperties) -> operations.ResponseBodyAdditionalPropertiesPostResponse:
        ...
        res = operations.ResponseBodyAdditionalPropertiesPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def response_body_bytes_get(self) -> operations.ResponseBodyBytesGetResponse:
        ...
        res = operations.ResponseBodyBytesGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def response_body_empty_with_headers(self, x_number_header: float, x_string_header: str) -> operations.ResponseBodyEmptyWithHeadersResponse:
        ...
        query_params = { **utils.get_query_params(operations.ResponseBodyEmptyWithHeadersRequest, request, self.sdk_configuration.globals), **query_params }
        headers['Accept'] = '*/*'
        headers['x-speakeasy-user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.ResponseBodyEmptyWithHeadersResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res, headers=None)
    ...
    def response_body_missing2xx_or3xx_get(self) -> operations.ResponseBodyMissing2xxOr3xxGetResponse:
        ...
        res = operations.ResponseBodyMissing2xxOr3xxGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def response_body_optional_get(self, server_url: Optional[str] = None, accept_header_override: Optional[ResponseBodyOptionalGetAcceptEnum] = None) -> operations.ResponseBodyOptionalGetResponse:
        ...
        res = operations.ResponseBodyOptionalGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(http_res.headers.get('Content-Type'), 'application/json'):                
                out = utils.unmarshal_json(http_res.text, Optional[shared.TypedObject1])
                res.typed_object1 = out
            elif utils.match_content_type(http_res.headers.get('Content-Type'), 'text/plain'):                
    ...
    def response_body_read_only(self, server_url: Optional[str] = None) -> operations.ResponseBodyReadOnlyResponse:
        ...
        res = operations.ResponseBodyReadOnlyResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def response_body_string_get(self) -> operations.ResponseBodyStringGetResponse:
        ...
        res = operations.ResponseBodyStringGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(http_res.headers.get('Content-Type'), 'text/html'):                
    ...
    def response_body_xml_get(self) -> operations.ResponseBodyXMLGetResponse:
        ...
        res = operations.ResponseBodyXMLGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(http_res.headers.get('Content-Type'), 'application/xml'):                
    ...
    def response_body_zero_value_complex_type_ptrs_post(self, request: shared.ObjWithZeroValueComplexTypePtrs) -> operations.ResponseBodyZeroValueComplexTypePtrsPostResponse:
        ...
        res = operations.ResponseBodyZeroValueComplexTypePtrsPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
