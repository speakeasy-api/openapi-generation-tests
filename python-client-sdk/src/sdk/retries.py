...
class Retries:
    ...
    def retries_after(self, request_id: str, num_retries: Optional[int] = None, retry_after_val: Optional[int] = None, retries: Optional[utils.RetryConfig] = None, server_url: Optional[str] = None) -> operations.RetriesAfterResponse:
        ...
        if retry_config is None:
            if global_retry_config:
                ...
                retry_config = utils.RetryConfig('backoff', utils.BackoffStrategy(10, 200, 1.5, 1000), False)
        ...
        res = operations.RetriesAfterResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def retries_connect_error_get(self, retries: Optional[utils.RetryConfig] = None, server_url: Optional[str] = None) -> operations.RetriesConnectErrorGetResponse:
        ...
        if retry_config is None:
            if global_retry_config:
                ...
                retry_config = utils.RetryConfig('backoff', utils.BackoffStrategy(500, 60000, 1.5, 3600000), False)
        ...
        res = operations.RetriesConnectErrorGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def retries_flat_empty_response_post(self, request_id: str, request_body: Optional[operations.RetriesFlatEmptyResponsePostRequestBody] = None, num_retries: Optional[int] = None, retries: Optional[utils.RetryConfig] = None, server_url: Optional[str] = None) -> operations.RetriesFlatEmptyResponsePostResponse:
        ...
        base_url = utils.template_url(operations.RETRIES_FLAT_EMPTY_RESPONSE_POST_SERVERS[0], {
        })
        if server_url is not None:
            base_url = server_url
        
        url = base_url + '/retriesFlatEmptyResponse'
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.RetriesFlatEmptyResponsePostRequest, "request_body", False, True, 'json')
        ...
        res = operations.RetriesFlatEmptyResponsePostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def retries_get(self, request_id: str, num_retries: Optional[int] = None, retries: Optional[utils.RetryConfig] = None, server_url: Optional[str] = None) -> operations.RetriesGetResponse:
        ...
        res = operations.RetriesGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def retries_post(self, request_id: str, request_body: Optional[operations.RetriesPostRequestBody] = None, num_retries: Optional[int] = None, retries: Optional[utils.RetryConfig] = None, server_url: Optional[str] = None) -> operations.RetriesPostResponse:
        ...
        res = operations.RetriesPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
