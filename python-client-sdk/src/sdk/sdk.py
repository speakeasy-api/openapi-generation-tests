...
class SDK:
    ...
    def authenticated_request(self, request: Optional[operations.AuthenticatedRequestRequestBody] = None, security: operations.AuthenticatedRequestSecurity) -> operations.AuthenticatedRequestResponse:
