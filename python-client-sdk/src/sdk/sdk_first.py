...
class SDKFirst:
    ...
    def get(self) -> operations.NestFirstGetResponse:
        hook_ctx = HookContext(operation_id='nestFirstGet', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.NestFirstGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
