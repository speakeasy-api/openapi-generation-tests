...
class SDKSecond:
    ...
    def get(self) -> operations.NestedSecondGetResponse:
        hook_ctx = HookContext(operation_id='nestedSecondGet', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.NestedSecondGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
