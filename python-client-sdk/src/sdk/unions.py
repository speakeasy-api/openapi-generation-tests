...
class Unions:
    ...
    def flattened_typed_object_post(self, request: Union[shared.TypedObject1]) -> operations.FlattenedTypedObjectPostResponse:
        ...
        res = operations.FlattenedTypedObjectPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def mixed_type_one_of_post(self, request: Union[str, int, shared.SimpleObject]) -> operations.MixedTypeOneOfPostResponse:
        ...
        res = operations.MixedTypeOneOfPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def nullable_one_of_ref_in_object_post(self, request: shared.NullableOneOfRefInObject) -> operations.NullableOneOfRefInObjectPostResponse:
        ...
        res = operations.NullableOneOfRefInObjectPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def nullable_one_of_schema_post(self, request: Optional[Union[shared.TypedObject1, shared.TypedObject2]]) -> operations.NullableOneOfSchemaPostResponse:
        ...
        res = operations.NullableOneOfSchemaPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def nullable_one_of_type_in_object_post(self, request: shared.NullableOneOfTypeInObject) -> operations.NullableOneOfTypeInObjectPostResponse:
        ...
        res = operations.NullableOneOfTypeInObjectPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def nullable_typed_object_post(self, request: Optional[shared.TypedObject1]) -> operations.NullableTypedObjectPostResponse:
        ...
        res = operations.NullableTypedObjectPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def primitive_type_one_of_post(self, request: Union[str, int, float, bool]) -> operations.PrimitiveTypeOneOfPostResponse:
        ...
        res = operations.PrimitiveTypeOneOfPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def strongly_typed_one_of_discriminated_post(self, request: Union[shared.TaggedObject1, shared.TaggedObject2, shared.TaggedObject3]) -> operations.StronglyTypedOneOfDiscriminatedPostResponse:
        ...
        res = operations.StronglyTypedOneOfDiscriminatedPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def strongly_typed_one_of_post(self, request: Union[shared.SimpleObjectWithType, shared.DeepObjectWithType]) -> operations.StronglyTypedOneOfPostResponse:
        ...
        res = operations.StronglyTypedOneOfPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def strongly_typed_one_of_post_with_non_standard_discriminator_name(self, request: Union[shared.SimpleObjectWithNonStandardTypeName, shared.DeepObjectWithNonStandardTypeName]) -> operations.StronglyTypedOneOfPostWithNonStandardDiscriminatorNameResponse:
        ...
        res = operations.StronglyTypedOneOfPostWithNonStandardDiscriminatorNameResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def typed_object_nullable_one_of_post(self, request: Optional[Union[shared.TypedObject1, shared.TypedObject2]]) -> operations.TypedObjectNullableOneOfPostResponse:
        ...
        res = operations.TypedObjectNullableOneOfPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def typed_object_one_of_post(self, request: Union[shared.TypedObject1, shared.TypedObject2, shared.TypedObject3]) -> operations.TypedObjectOneOfPostResponse:
        ...
        res = operations.TypedObjectOneOfPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def union_big_int_str_decimal(self, request: Union[int, Decimal]) -> operations.UnionBigIntStrDecimalResponse:
        ...
        res = operations.UnionBigIntStrDecimalResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def union_date_null(self, request: Optional[date]) -> operations.UnionDateNullResponse:
        ...
        res = operations.UnionDateNullResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def union_date_time_big_int(self, request: Union[datetime, int]) -> operations.UnionDateTimeBigIntResponse:
        ...
        res = operations.UnionDateTimeBigIntResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def union_date_time_null(self, request: Optional[datetime]) -> operations.UnionDateTimeNullResponse:
        ...
        res = operations.UnionDateTimeNullResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def weakly_typed_one_of_null_enum_post(self, request: Union[shared.SimpleObject, shared.DeepObject]) -> operations.WeaklyTypedOneOfNullEnumPostResponse:
        ...
        res = operations.WeaklyTypedOneOfNullEnumPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def weakly_typed_one_of_post(self, request: Union[shared.SimpleObject, shared.DeepObject]) -> operations.WeaklyTypedOneOfPostResponse:
        ...
        res = operations.WeaklyTypedOneOfPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
