...
def test_component_body_and_param_no_conflict():
    ...
    res = s.flattening.component_body_and_param_no_conflict(param_str='param test', simple_object=obj)
...
def test_component_body_and_param_conflict():
    ...
    res = s.flattening.component_body_and_param_conflict(str_='param test', simple_object=obj)
...
def test_conflicting_params():
    ...
    res = s.flattening.conflicting_params(str_path_parameter='pathParam', str_query_parameter='queryParam')
