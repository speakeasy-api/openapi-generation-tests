...
def test_parameters_deep_object_query_params_object():
    ...
    assert res.status_code == 200
    assert res.res.args == operations.DeepObjectQueryParamsObjectArgs(
            obj_arr_param_arr=[
                'test',
                'test2',
            ],
            ...
            obj_param_bool='true',
            obj_param_date_time='2020-01-01T00:00:00.000001Z',
...
def test_parameters_json_query_params_object():
    ...
    assert res.status_code == 200
    assert res.res == operations.JSONQueryParamsObjectRes(
...
def test_parameters_path_parameter_json():
    ...
    assert res.status_code == 200
    assert res.res == operations.PathParameterJSONRes(
