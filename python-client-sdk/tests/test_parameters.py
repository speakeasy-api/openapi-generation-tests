...
def test_parameters_deep_object_query_params_deep_object():
    ...
    assert sanitize_timestamp(res.res.args) == operations.DeepObjectQueryParamsDeepObjectArgs(
            deep_obj_arr=[
                'test1',
                'test2',
            ],
...
def test_parameters_deep_object_query_params_object():
    ...
    assert res is not None
    assert res.status_code == 200
    assert sanitize_timestamp(res.res.args) == operations.DeepObjectQueryParamsObjectArgs(
            obj_arr_param_arr=[
                'test',
                'test2',
            ],
...
def test_parameters_form_query_params_array():
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.res.args == operations.FormQueryParamsArrayArgs(
    ...
    assert sort_query_parameters(res.res.url) == 'http://localhost:35123/anything/queryParams/form/array?arrParam=test%2Ctest2&arrParamExploded=1&arrParamExploded=2'
...
def test_parameters_form_query_params_camel_object():
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.res.args == operations.FormQueryParamsCamelObjectArgs(
            item_count='10',
            search_term='foo',
        )
...
def test_parameters_form_query_params_map():
    ...
    assert sort_serialized_maps(sort_query_parameters(res.res.url), r'.*?\?mapParam=(.*?)&(.*)', '%2C') == 'http://localhost:35123/anything/queryParams/form/map?mapParam=test%2Cvalue%2Ctest2%2Cvalue2&test=1&test2=2'
...
def test_parameters_form_query_params_object():
    ...
    assert sanitize_timestamp(res.res.args.date_time) == '2020-01-01T00:00:00.001Z'
...
def test_parameters_form_query_params_primitive():
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.res.args == operations.FormQueryParamsPrimitiveArgs(
            bool_param='true',
            int_param='1',
            num_param='1.1',
            str_param='test',
        )
    assert sort_query_parameters(res.res.url) == 'http://localhost:35123/anything/queryParams/form/primitive?boolParam=true&intParam=1&numParam=1.1&strParam=test'
...
def test_parameters_form_query_params_ref_param_object():
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.res.args == operations.FormQueryParamsRefParamObjectArgs(
            bool='true',
            int='1',
            num='1.1',
...
def test_parameters_header_params_array():
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.res == operations.HeaderParamsArrayRes(
...
def test_parameters_header_params_object():
    ...
    assert res is not None
    assert res.status_code == 200
    assert sanitize_timestamp(sort_serialized_maps(res.res.headers.x_header_obj, r'(.*)', ',')) == 'any,any,bigint,8821239038968084,bigintStr,9223372036854775808,bool,true,boolOpt,true,date,2020-01-01,dateTime,2020-01-01T00:00:00.001Z,decimal,3.141592653589793,decimalStr,3.14159265358979344719667586,enum,one,float32,1.1,float64Str,1.1,int,1,int32,1,int32Enum,55,int64Str,100,intEnum,2,num,1.1,str,test,strOpt,testOptional'
    assert sanitize_timestamp(sort_serialized_maps(res.res.headers.x_header_obj_explode, r'(.*)', ',')) == 'any=any,bigint=8821239038968084,bigintStr=9223372036854775808,bool=true,boolOpt=true,date=2020-01-01,dateTime=2020-01-01T00:00:00.001Z,decimal=3.141592653589793,decimalStr=3.14159265358979344719667586,enum=one,float32=1.1,float64Str=1.1,int=1,int32=1,int32Enum=55,int64Str=100,intEnum=2,num=1.1,str=test,strOpt=testOptional'
...
def test_parameters_header_params_primitive():
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.res == operations.HeaderParamsPrimitiveRes(
...
def test_parameters_mixed_parameters_camel_case():
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.res == operations.MixedParametersCamelCaseRes(
...
def test_parameters_mixed_parameters_primitives():
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.res == operations.MixedParametersPrimitivesRes(
...
def test_parameters_path_parameter_json():
    ...
    assert res is not None
    assert res.status_code == 200
    assert sanitize_timestamp(res.res.url) == 'http://localhost:35123/anything/pathParams/json/{"any":"any","bigint":8821239038968084,"bigintStr":"9223372036854775808","bool":true,"boolOpt":true,"date":"2020-01-01","dateTime":"2020-01-01T00:00:00.001Z","decimal":3.141592653589793,"decimalStr":"3.14159265358979344719667586","enum":"one","float32":1.1,"float64Str":"1.1","int":1,"int32":1,"int32Enum":55,"int64Str":"100","intEnum":2,"num":1.1,"str":"test","strOpt":"testOptional"}'
...
def test_parameters_pipe_delimited_query_params_array():
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.res.args == operations.PipeDelimitedQueryParamsArrayArgs(
            arr_param='test|test2',
            arr_param_exploded=[
                '1',
                '2',
...
def test_parameters_simple_path_parameter_arrays():
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.res == operations.SimplePathParameterArraysRes(
...
def test_parameters_simple_path_parameter_primitives():
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.res == operations.SimplePathParameterPrimitivesRes(
