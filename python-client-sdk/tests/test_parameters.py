...
def test_parameters_deep_object_query_params_deep_object():
    ...
    with SDK(
        ...
        client=create_test_http_client("deepObjectQueryParamsDeepObject"),
    ) as sdk:
        assert sdk is not None

        res = sdk.parameters.deep_object_query_params_deep_object(
            deep_obj={
                "arr": [
                    "test1",
                    "test2",
        ...
        assert sanitize_timestamp(
            res.args
        ) == operations.DeepObjectQueryParamsDeepObjectArgs(
            deep_obj_arr=[
                "test1",
                "test2",
            ],
        ...
        assert (
            sanitize_timestamp(sort_query_parameters(res.url))
...
def test_parameters_deep_object_query_params_map():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("deepObjectQueryParamsMap"),
    ) as sdk:
        assert sdk is not None
...
def test_parameters_deep_object_query_params_object():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("deepObjectQueryParamsObject"),
    ) as sdk:
        assert sdk is not None
...
def test_parameters_form_query_params_array():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("formQueryParamsArray"),
    ) as sdk:
        assert sdk is not None

        res = sdk.parameters.form_query_params_array(
            arr_param=[
                "test",
                "test2",
            ],
...
def test_parameters_form_query_params_camel_object():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("formQueryParamsCamelObject"),
    ) as sdk:
        assert sdk is not None

        res = sdk.parameters.form_query_params_camel_object(
            obj_param_exploded={
                "item_count": "10",
                "search_term": "foo",
            },
...
def test_parameters_form_query_params_map():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("formQueryParamsMap"),
    ) as sdk:
        assert sdk is not None
        ...
        assert (
            sort_serialized_maps(
                sort_query_parameters(res.url), r".*?\?mapParam=(.*?)&(.*)", "%2C"
            )
...
def test_parameters_form_query_params_object():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("formQueryParamsObject"),
    ) as sdk:
        assert sdk is not None
        ...
        assert res.args.date_ == "2020-01-01"
        ...
        assert (
            sanitize_timestamp(sort_serialized_maps(res.args.obj_param, r"(.*)", ","))
        ...
        assert (
            sanitize_timestamp(
                sort_serialized_maps(
                    sort_query_parameters(res.url), r"objParam=(.*?)&", "%2C"
                )
            )
...
def test_parameters_form_query_params_primitive():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("formQueryParamsPrimitive"),
    ) as sdk:
        assert sdk is not None

        res = sdk.parameters.form_query_params_primitive(
            bool_param=True, int_param=1, num_param=1.1, str_param="test"
        )
        assert res is not None
...
def test_parameters_form_query_params_ref_param_object():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("formQueryParamsRefParamObject"),
    ) as sdk:
        assert sdk is not None
...
def test_parameters_header_params_array():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("headerParamsArray"),
    ) as sdk:
        assert sdk is not None

        res = sdk.parameters.header_params_array(
            x_header_array=[
                "test1",
                "test2",
            ]
...
def test_parameters_header_params_map():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("headerParamsMap"),
    ) as sdk:
        assert sdk is not None
        ...
        assert res is not None
        assert (
            sort_serialized_maps(res.headers.x_header_map, r"(.*)", ",")
            == "key1,value1,key2,value2"
        )
        assert (
            sort_serialized_maps(res.headers.x_header_map_explode, r"(.*)", ",")
...
def test_parameters_header_params_object():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("headerParamsObject"),
    ) as sdk:
        assert sdk is not None

        res = sdk.parameters.header_params_object(
            x_header_obj={
                "any": "any",
                "bigint": 8821239038968084,
                "bigint_str": 9223372036854775808,
        ...
        assert (
            sanitize_timestamp(
                sort_serialized_maps(res.headers.x_header_obj, r"(.*)", ",")
            )
            == "any,any,bigint,8821239038968084,bigintStr,9223372036854775808,bool,true,boolOpt,true,date,2020-01-01,dateTime,2020-01-01T00:00:00.001Z,decimal,3.141592653589793,decimalStr,3.14159265358979344719667586,enum,one,float32,1.1,float64Str,1.1,int,1,int32,1,int32Enum,55,int64Str,100,intEnum,2,num,1.1,str,test,strOpt,testOptional"
        )
        assert (
            sanitize_timestamp(
                sort_serialized_maps(res.headers.x_header_obj_explode, r"(.*)", ",")
            )
            == "any=any,bigint=8821239038968084,bigintStr=9223372036854775808,bool=true,boolOpt=true,date=2020-01-01,dateTime=2020-01-01T00:00:00.001Z,decimal=3.141592653589793,decimalStr=3.14159265358979344719667586,enum=one,float32=1.1,float64Str=1.1,int=1,int32=1,int32Enum=55,int64Str=100,intEnum=2,num=1.1,str=test,strOpt=testOptional"
        )
...
def test_parameters_header_params_primitive():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("headerParamsPrimitive"),
    ) as sdk:
        assert sdk is not None

        res = sdk.parameters.header_params_primitive(
...
def test_parameters_json_query_params_object_smaller():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("jsonQueryParamsObjectSmaller"),
    ) as sdk:
        assert sdk is not None

        res = sdk.parameters.json_query_params_object_smaller(
        ...
        assert res is not None
        assert (
            sanitize_timestamp(res.args.deep_obj_param)
...
def test_parameters_mixed_parameters_camel_case():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("mixedParametersCamelCase"),
    ) as sdk:
        assert sdk is not None

        res = sdk.parameters.mixed_parameters_camel_case(
...
def test_parameters_mixed_parameters_primitives():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("mixedParametersPrimitives"),
    ) as sdk:
        assert sdk is not None

        res = sdk.parameters.mixed_parameters_primitives(
            header_param="headerValue",
            path_param="pathValue",
            query_string_param="queryValue",
        )
...
def test_parameters_mixed_query_params():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("mixedQueryParams"),
    ) as sdk:
        assert sdk is not None

        res = sdk.parameters.mixed_query_params(
            deep_object_param={
                "any": "any",
                "bigint": 8821239038968084,
                "bigint_str": 9223372036854775808,
...
def test_parameters_path_parameter_json():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("pathParameterJson"),
    ) as sdk:
        assert sdk is not None

        res = sdk.parameters.path_parameter_json(
            json_obj={
                "any": "any",
                "bigint": 8821239038968084,
                "bigint_str": 9223372036854775808,
...
def test_parameters_pipe_delimited_query_params_array():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("pipeDelimitedQueryParamsArray"),
    ) as sdk:
        assert sdk is not None
...
def test_parameters_simple_path_parameter_arrays():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("simplePathParameterArrays"),
    ) as sdk:
        assert sdk is not None
...
def test_parameters_simple_path_parameter_maps():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("simplePathParameterMaps"),
    ) as sdk:
        assert sdk is not None
        ...
        assert res is not None
        assert (
            sort_serialized_maps(res.url, r".*?\/map\/(.*?)\/mapExploded\/(.*)", ",")
...
def test_parameters_simple_path_parameter_objects():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("simplePathParameterObjects"),
    ) as sdk:
        assert sdk is not None
...
def test_parameters_simple_path_parameter_primitives():
    ...
    with SDK(
        server_url=os.getenv("TEST_SERVER_URL", "http://localhost:18080"),
        client=create_test_http_client("simplePathParameterPrimitives"),
    ) as sdk:
        assert sdk is not None

        res = sdk.parameters.simple_path_parameter_primitives(
            bool_param=True, int_param=1, num_param=1.1, str_param="test"
        )
        assert res is not None
