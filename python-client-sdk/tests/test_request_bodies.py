...
def test_request_body_post_application_json_simple():
    ...
    res = s.request_bodies.request_body_post_application_json_simple(request=obj)
...
def test_request_body_post_application_json_array():
    ...
    res = s.request_bodies.request_body_post_application_json_array(request=[obj])
...
def test_request_body_post_application_json_array_of_array():
    ...
    res = s.request_bodies.request_body_post_application_json_array_of_array(request=[[obj], [obj]])
...
def test_request_body_post_application_json_array_of_primitive():
    ...
    res = s.request_bodies.request_body_post_application_json_array_of_primitive(request=['hello', 'world'])
