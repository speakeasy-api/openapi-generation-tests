...
def test_request_bodies_nullable_required_property_post():
    ...
    assert res.status_code == 200
    assert sanitize_timestamp(res.object.data) == '{"NullableOptionalInt":0,"NullableRequiredArray":null,"NullableRequiredBigIntStr":"9223372036854775807","NullableRequiredDateTime":"2024-03-02T01:02:03.001Z","NullableRequiredDecimalStr":"3.14159265358979344719667586","NullableRequiredEnum":"second","NullableRequiredInt":null}'
