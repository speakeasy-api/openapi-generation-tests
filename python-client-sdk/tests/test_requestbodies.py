...
def test_request_bodies_nullable_required_empty_object_post():
    s = sdk.SDK(
        security=shared.Security(
            api_key_auth="Token YOUR_API_KEY",
        ),
    ...
    assert res.status_code == 200
    assert res.object == operations.NullableRequiredEmptyObjectPostResponseBody(
            data='{"NullableOptionalObj":{},"NullableRequiredObj":null,"RequiredObj":{}}',
        )

def test_request_bodies_nullable_required_property_post():
    s = sdk.SDK(
        security=shared.Security(
            api_key_auth="Token YOUR_API_KEY",
        ),
    ...
    assert res.status_code == 200
    assert res.object == operations.NullableRequiredPropertyPostResponseBody(
...
def test_request_bodies_nullable_required_shared_object_post():
    s = sdk.SDK(
        security=shared.Security(
            api_key_auth="Token YOUR_API_KEY",
        ),
    ...
    assert res.status_code == 200
    assert res.object == operations.NullableRequiredSharedObjectPostResponseBody(
...
def test_request_bodies_request_body_post_complex_number_types():
    ...
    assert res.status_code == 200
    assert res.object == operations.RequestBodyPostComplexNumberTypesResponseBody(
...
def test_request_bodies_request_body_post_form_deep():
    ...
    assert res.status_code == 200
    assert res.res == operations.RequestBodyPostFormDeepRes(
...
def test_request_bodies_request_body_post_form_simple():
    ...
    assert res.status_code == 200
    assert res.res.form == operations.RequestBodyPostFormSimpleForm(
            any='any',
            bigint='8821239038968084',
            bigint_str='9223372036854775808',
            bool='true',
            bool_opt='true',
            date_='2020-01-01',
            date_time='2020-01-01T00:00:00.000001Z',
...
def test_request_bodies_request_body_post_json_data_types_date_time():
    ...
    assert res.status_code == 200
    assert res.object == operations.RequestBodyPostJSONDataTypesDateTimeResponseBody(
            data='"2020-01-01T00:00:00Z"',
            json=dateutil.parser.isoparse('2020-01-01T00:00:00Z'),
        )
...
def test_request_bodies_request_body_post_json_data_types_map_date_time():
    ...
    assert res.status_code == 200
    assert res.object == operations.RequestBodyPostJSONDataTypesMapDateTimeResponseBody(
...
def test_request_bodies_request_body_put_multipart_deep():
    ...
    assert res.status_code == 200
    assert res.res == operations.RequestBodyPutMultipartDeepRes(
...
def test_request_bodies_request_body_put_multipart_simple():
    ...
    assert res.status_code == 200
    assert res.res.form == operations.RequestBodyPutMultipartSimpleForm(
            any='any',
            bigint='8821239038968084',
            bigint_str='9223372036854775808',
            bool='true',
...
def test_request_bodies_request_body_write_only_union():
