...
def test_requestbodies_request_body_deprecated_request_body_ref_post():
    ...
    with SDK(
        ...
        res = s.request_bodies.request_body_deprecated_request_body_ref_post(
            request={
                "str_": "testvalue",
            }
        )
...
def test_requestbodies_request_body_post_multiple_content_types_component_filtered_default_test():
    with SDK(
        ...
        res = s.request_bodies.request_body_post_multiple_content_types_component_filtered_default_test(
            request={
                "any": "any",
                "bigint": 8821239038968084,
                "bigint_str": 9223372036854775808,
