...
def test_typed_object_one_of_post_obj1():
    ...
    obj = shared.TypedObject1(type=shared.TypedObject1Type.OBJ1, value="obj1")
...
def test_typed_object_one_of_post_obj2():
    ...
    obj = shared.TypedObject2(type=shared.TypedObject2Type.OBJ2, value="obj2")
...
def test_typed_object_one_of_post_obj3():
    ...
    obj = shared.TypedObject3(type=shared.TypedObject3Type.OBJ3, value="obj3")
...
def test_typed_object_nullable_one_of_post_obj1():
    ...
    obj = shared.TypedObject1(type=shared.TypedObject1Type.OBJ1, value="one")
...
def test_typed_object_nullable_one_of_post_obj2():
    ...
    obj = shared.TypedObject1(type=shared.TypedObject2Type.OBJ2, value="two")
...
def test_nullable_one_of_schema_post_obj2():
    ...
    obj = shared.TypedObject2(type=shared.TypedObject2Type.OBJ2, value="two")
...
#             obj: shared.NullableOneOfTypeInObject(one_of_one=True),
...
#             obj: shared.NullableOneOfTypeInObject(nullable_one_of_one=True, nullable_one_of_two=2, one_of_one=True),
...
#     s = SDK()
#     for tt in tests:
#         req = utils.serialize_request_body(tt.obj, "Request", "json")
...
#         {
#             name: "Non-nullable field set only",
#             obj: shared.NullableOneOfRefInObject(one_of_one=shared.TypedObject1(type=shared.TypedObject1Type.OBJ1, value="one")),
#             want_json: "{\"NullableOneOfOne\":null,\"NullableOneOfTwo\":null,\"OneOfOne\":{\"type\":\"obj1\",\"value\":\"one\"}}"
#         },
#         {
#             name: "Nullable fields set to null",
#             obj: shared.NullableOneOfRefInObject(nullable_one_of_one=None, nullable_one_of_two=None, one_of_one=shared.TypedObject1(type=shared.TypedObject1Type.OBJ1, value="one")),
#             want_json: "{\"NullableOneOfOne\":null,\"NullableOneOfTwo\":null,\"OneOfOne\":{\"type\":\"obj1\",\"value\":\"one\"}}",
#         },
#         {
#             name: "All fields set to non-null values",
#             obj: shared.NullableOneOfTypeInObject(nullable_one_of_one=shared.TypedObject1(type=shared.TypedObject1Type.OBJ1, value="one"),
#                 nullable_one_of_two=shared.TypedObject2(type=shared.TypedObject2Type.OBJ2, value="two"),
#                 one_of_one=shared.TypedObject1(type=shared.TypedObject1Type.OBJ1)),
