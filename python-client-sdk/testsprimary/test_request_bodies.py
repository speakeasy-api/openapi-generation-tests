...
def test_request_body_post_application_json_array():
    ...
    assert res.status_code == 200
    assert res.res is not None
    compare_simple_object(res.res[0], obj)
...
def test_request_body_post_application_json_array_of_array():
    ...
    assert res.status_code == 200
    assert res.res is not None
    compare_simple_object(res.res[0][0], obj)
    compare_simple_object(res.res[1][0], obj)
...
def test_request_body_post_application_json_array_of_map():
    ...
    assert res.status_code == 200
    assert res.res is not None
    compare_simple_object(res.res[0]['mapElem1'], obj)
    compare_simple_object(res.res[0]['mapElem2'], obj)
    compare_simple_object(res.res[1]['mapElem1'], obj)
    compare_simple_object(res.res[1]['mapElem2'], obj)
...
def test_request_body_post_multiple_content_types_inline_filtered():
    ...
    res = s.request_bodies.request_body_post_multiple_content_types_inline_filtered(request=RequestBodyPostMultipleContentTypesInlineFilteredRequestBody(
        bool=True,
        num=1.1,
        str_='test'
    ))
...
def test_request_body_post_multiple_content_types_split_json():
    ...
    res = s.request_bodies.request_body_post_multiple_content_types_split_json(request=RequestBodyPostMultipleContentTypesSplitJSONRequestBody(
        bool=True,
        num=1.1,
        str_='test'
    ))
...
def test_request_body_post_multiple_content_types_split_form():
    ...
    res = s.request_bodies.request_body_post_multiple_content_types_split_form(request=RequestBodyPostMultipleContentTypesSplitFormRequestBody(
        bool3=True,
        num3=1.1,
        str3='test'
    ))
...
def test_request_body_put_multipart_deep():
    ...
    assert res.status_code == 200
    assert res.res is not None
    assert res.res.form.arr == utils.marshal_json(obj.arr, type(obj.arr))
    assert res.res.form.bool == 'true'
    assert res.res.form.int == '1'
    assert res.res.form.map == utils.marshal_json(obj.map, type(obj.map))
    assert res.res.form.num == '1.1'
    assert res.res.form.obj == utils.marshal_json(obj.obj, type(obj.obj))
    assert res.res.form.str_ == 'test'
...
def test_request_body_put_multipart_file():
    ...
    f = open(os.path.dirname(__file__) + '/testUpload.json')
    data = f.read()
...
def test_request_body_read_only_union():
    record_test('request-bodies-read-only-union')

    s = SDK()
    assert s is not None

    res = s.request_bodies.request_body_read_only_union(
        ReadOnlyObjectInput()
    )

    assert res is not None
    assert res.status_code == 200
    assert res.weakly_typed_one_of_read_only_object is not None
    assert isinstance(res.weakly_typed_one_of_read_only_object,
                      ReadOnlyObject) == True
    assert res.weakly_typed_one_of_read_only_object.num == 1.0
    assert res.weakly_typed_one_of_read_only_object.string == 'hello'
    assert res.weakly_typed_one_of_read_only_object.bool == True


def test_request_body_write_only_union():
    record_test('request-bodies-write-only-union')

    s = SDK()
    assert s is not None

    res = s.request_bodies.request_body_write_only_union(
        WriteOnlyObject(
            bool=True,
            num=1.0,
            string='hello'
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.weakly_typed_one_of_write_only_object is not None
    assert isinstance(res.weakly_typed_one_of_write_only_object,
                      WriteOnlyObjectOutput) == True
    assert res.weakly_typed_one_of_write_only_object == WriteOnlyObjectOutput()


def test_request_body_read_write_only_union():
    record_test('request-bodies-read-write-only-union')

    s = SDK()
    assert s is not None

    res = s.request_bodies.request_body_read_write_only_union(
        ReadWriteObject(
            num1=1,
            num2=2,
            num3=4
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.weakly_typed_one_of_read_write_object is not None
    assert isinstance(res.weakly_typed_one_of_read_write_object,
                      ReadWriteObjectOutput) == True
    assert res.weakly_typed_one_of_read_write_object.num3 == 4
    assert res.weakly_typed_one_of_read_write_object.sum == 7
...
def test_request_body_post_defaults_and_consts():
    ...
    assert res.object.json.normal_field == 'normal'

    assert res.object.json.const_big_int == 9007199254740991
    assert res.object.json.const_big_int_str == 9223372036854775807
    assert res.object.json.const_bool == True
    assert res.object.json.const_date == date(
        2020, 1, 1)
    assert res.object.json.const_date_time == datetime(
        2020, 1, 1, 0, 0, 0, 0, tzutc())
    assert res.object.json.const_decimal == Decimal(
        '3.141592653589793')
    assert res.object.json.const_decimal_str == Decimal(
        '3.141592653589793238462643383279')
    assert res.object.json.const_enum_int == shared.ConstEnumInt.TWO
    assert res.object.json.const_enum_str == shared.ConstEnumStr.TWO
    assert res.object.json.const_int == 123
    assert res.object.json.const_num == 123.456
    assert res.object.json.const_str == 'const'
    assert res.object.json.const_str_null is None

    assert res.object.json.default_big_int == 9007199254740991
    assert res.object.json.default_big_int_str == 9223372036854775807
    assert res.object.json.default_bool == True
    assert res.object.json.default_date == date(
        2020, 1, 1)
    assert res.object.json.default_date_time == datetime(
        2020, 1, 1, 0, 0, 0, 0, tzutc())
    assert res.object.json.default_decimal == Decimal(
        '3.141592653589793')
    assert res.object.json.default_decimal_str == Decimal(
        '3.141592653589793238462643383279')
    assert res.object.json.default_enum_int == shared.DefaultEnumInt.TWO
    assert res.object.json.default_enum_str == shared.DefaultEnumStr.TWO
    assert res.object.json.default_int == 123
    assert res.object.json.default_num == 123.456
    assert res.object.json.default_str == 'not default'
    assert res.object.json.default_str_nullable is None
    assert res.object.json.default_str_optional == 'default'
...
def test_request_body_post_json_data_types_decimal():
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.object.json == Decimal(
        '1.1')
...
def test_request_body_post_json_data_types_date_time():
    ...
    assert res is not None
    assert res.status_code == 200
    assert res.object.json == datetime(
        2020, 1, 1, 0, 0, 0, 0, tzutc())
...
def test_request_body_post_json_data_types_array_date():
    ...
    assert res.status_code == 200
    assert res.object.json == req
    assert res.object.data == '["2020-01-01"]'
...
def test_request_body_post_json_data_types_array_decimal_str():
    ...
    assert res.status_code == 200
    assert res.object.json == req
    assert res.object.data == '["3.141592653589793438462643383279"]'
