...
def test_servers_override_global_server_url():
    ...
    assert (
        ...
        == "http://localhost:35123/anything/ping#serversOverrideGlobalServerURL"
    )
    assert res.http_meta.response is not None
    assert res.http_meta.response.status_code == 200
    ...
    assert (
        res.http_meta.request.url
        == "http://localhost:35456/ping#serversOverrideGlobalServerURL"
    )
    assert res.http_meta.response is not None
    assert res.http_meta.response.status_code == 200
...
def test_servers_override_operation_server_url():
    ...
    assert (
        res.http_meta.request.url
        == "http://localhost:35123/anything/ping#serversOverrideOperationServerURL"
    )
    assert res.http_meta.response is not None
    assert res.http_meta.response.status_code == 200
    ...
    assert (
        res.http_meta.request.url
        == "http://localhost:35456/ping#serversOverrideOperationServerURL"
    )
    assert res.http_meta.response is not None
    assert res.http_meta.response.status_code == 200
