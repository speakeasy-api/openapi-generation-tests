...
def test_nullable_one_of_type_in_object_post():
    ...
    s = SDK()
    for tt in tests:
        body = utils.serialize_request_body(
            tt.obj, False, False, "json", tt.typ)
...
def test_union_map():
    ...
    res = s.unions.union_map(input_={"str": "test", "bool": True})
    assert res is not None
    assert res.http_meta is not None
    assert res.http_meta.response is not None
    assert res.http_meta.response.status_code == 200
...
def test_bigint_str_decimal_union():
    ...
    res = s.unions.union_big_int_str_decimal(
...
def test_array_of_discriminated_unions():
    ...
    res = s.unions.array_of_discriminated_unions(
        request=[simpleObject, deepObject])
...
def test_array_of_discriminated_unions_map():
    ...
    res = s.unions.array_of_discriminated_unions_map(array_map={
...
def test_nested_array_of_discriminated_unions():
    ...
    res = s.unions.nested_array_of_discriminated_unions(nested_array=[
        [simpleObject],
    ...
    compare_simple_object_with_type(
        res.res.json_.nested_array[0][0], simpleObject)
    ...
    compare_simple_object_with_type(
        res.res.json_.nested_array[1][1], simpleObject)
