...
def test_globals_query_parameter_get_uses_global():
    ...
    s = SDK(api_key_auth="token", global_query_param="test")
...
def test_global_path_parameter_get_uses_global():
    ...
    s = SDK(api_key_auth="token", global_path_param=1)
    assert s is not None
...
def test_global_header_get_uses_global():
    ...
    s = SDK(api_key_auth="token", global_header_param=True)
    assert s is not None
...
def test_global_header_keeps_custom_client_headers():
    ...
    s = SDK(api_key_auth="token", global_header_param=True, client=http_client)
    assert s is not None
