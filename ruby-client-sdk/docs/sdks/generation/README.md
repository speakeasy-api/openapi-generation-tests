...
res = s.generation.date_param_with_default(date_input=Date.parse("2021-06-22"))
...
res = s.generation.date_time_param_with_default(date_time_input=DateTime.iso8601('2021-07-22T13:18:37.045Z'))
...
res = s.generation.typed_parameter_generation_get(bigint=960186, date=Date.parse("2022-01-02"), decimal=4778.06, obj=Operations::Obj.new(
    bool=false,
    num=8948.31,
    str_="string",
  ))
