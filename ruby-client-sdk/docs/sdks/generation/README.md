...
res = s.generation.date_time_param_with_default(date_time_input=DateTime.iso8601('2024-02-10T14:45:50.302Z'))
...
res = s.generation.ignores_post(request_body=::OpenApiSDK::Operations::IgnoresPostRequestBody.new(), test_param="string")
...
res = s.generation.typed_parameter_generation_get(bigint=879275, date=Date.parse("2024-11-18"), decimal=3346.96, obj=::OpenApiSDK::Operations::Obj.new(
    bool: false,
    num: 4778.06,
    str_: "string",
  ))
...
| `obj`                                                                        | [::OpenApiSDK::Operations::Obj](../../models/operations/obj.md)              | :heavy_minus_sign:                                                           | N/A                                                                          |
...
req = ::OpenApiSDK::Operations::UsageExamplePostRequest.new(
  request_body: ::OpenApiSDK::Operations::UsageExamplePostRequestBody.new(
    ...
    faker_strings: ::OpenApiSDK::Shared::FakerStrings.new(),
