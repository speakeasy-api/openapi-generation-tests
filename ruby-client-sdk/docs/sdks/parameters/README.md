...
* [header_params_nil](#header_params_nil)
...
req = ::OpenApiSDK::Operations::HeaderParamsNilRequest.new(
  nullable_header: "<value>",
)
    
res = s.parameters.header_params_nil(req)
...
| Parameter                                                                                             | Type                                                                                                  | Required                                                                                              | Description                                                                                           |
| ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| `request`                                                                                             | [::OpenApiSDK::Operations::HeaderParamsNilRequest](../../models/operations/headerparamsnilrequest.md) | :heavy_check_mark:                                                                                    | The request object to use for the request.                                                            |

### Response

**[T.nilable(::OpenApiSDK::Operations::HeaderParamsNilResponse)](../../models/operations/headerparamsnilresponse.md)**
