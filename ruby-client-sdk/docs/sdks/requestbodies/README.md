...
* [request_body_post_wildcard](#request_body_post_wildcard)
...
req = ::OpenApiSDK::Operations::NullableRequiredPropertyPostRequestBody.new(
  ...
  nullable_required_date_time: DateTime.iso8601('2023-02-25T02:12:38.779Z'),
  nullable_required_decimal_str: "<value>",
  nullable_required_enum: ::OpenApiSDK::Operations::NullableRequiredEnum::NULL,
  nullable_required_int: 883933,
)
...
**[T.nilable(::OpenApiSDK::Operations::RequestBodyDeprecatedRequestBodyRefPostResponse)](../../models/operations/requestbodydeprecatedrequestbodyrefpostresponse.md)**
...
req = ::OpenApiSDK::Operations::RequestBodyGetInferredOptionalRequestWrapperRequest.new()
    
res = s.request_bodies.request_body_get_inferred_optional_request_wrapper(req)
...
| Parameter                                                                                                                                                       | Type                                                                                                                                                            | Required                                                                                                                                                        | Description                                                                                                                                                     |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `request`                                                                                                                                                       | [::OpenApiSDK::Operations::RequestBodyGetInferredOptionalRequestWrapperRequest](../../models/operations/requestbodygetinferredoptionalrequestwrapperrequest.md) | :heavy_check_mark:                                                                                                                                              | The request object to use for the request.                                                                                                                      |
| `server_url`                                                                                                                                                    | *String*                                                                                                                                                        | :heavy_minus_sign:                                                                                                                                              | An optional server URL to use.                                                                                                                                  |

### Response

**[T.nilable(::OpenApiSDK::Operations::RequestBodyGetInferredOptionalRequestWrapperResponse)](../../models/operations/requestbodygetinferredoptionalrequestwrapperresponse.md)**
...
req = ::OpenApiSDK::Shared::DefaultsAndConsts.new(
  ...
  const_bool: false,
  const_date: Date.parse("2024-12-14"),
  const_date_time: DateTime.iso8601('2023-05-03T19:35:20.586Z'),
  const_decimal: 2995.45,
  const_decimal_str: "<value>",
  const_enum_int: ::OpenApiSDK::Shared::ConstEnumInt::TWO,
  const_enum_str: ::OpenApiSDK::Shared::ConstEnumStr::ONE,
  const_int: 611959,
  const_num: 7885.16,
  const_str: "<value>",
  ...
  default_bool: false,
  default_date: Date.parse("2025-08-02"),
  default_date_time: DateTime.iso8601('2024-09-04T05:29:52.190Z'),
  default_decimal: 1857.00,
  default_decimal_str: "<value>",
  default_enum_int: ::OpenApiSDK::Shared::DefaultEnumInt::THREE,
  default_enum_str: ::OpenApiSDK::Shared::DefaultEnumStr::TWO,
  default_int: 305048,
  default_num: 1456.20,
  default_str: "<value>",
...
req = DateTime.iso8601('2020-01-01T00:00:00.001Z')
...
req = {
  "test": DateTime.iso8601('2020-01-01T00:00:00.001Z'),
}
...
res = s.request_bodies.request_body_post_multiple_content_types_component_filtered_default_test(req)
...
**[T.nilable(::OpenApiSDK::Operations::RequestBodyPostMultipleContentTypesComponentFilteredDefaultTestResponse)](../../models/operations/requestbodypostmultiplecontenttypescomponentfiltereddefaulttestresponse.md)**
...
req = "0xDFED6bCc5A".encode()
    
res = s.request_bodies.request_body_post_wildcard(req)
...
**[T.nilable(::OpenApiSDK::Operations::RequestBodyPostWildcardResponse)](../../models/operations/requestbodypostwildcardresponse.md)**
...
res = s.request_bodies.request_body_put_bytes_with_params(request_body="0xCBc4b0D930".encode(), query_string_param="<value>")
...
req = ::OpenApiSDK::Operations::RequestBodyPutMultipartFileRefRequestBody.new()
    
res = s.request_bodies.request_body_put_multipart_file_ref(req)
...
| Parameter                                                                                                                                   | Type                                                                                                                                        | Required                                                                                                                                    | Description                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| `request`                                                                                                                                   | [::OpenApiSDK::Operations::RequestBodyPutMultipartFileRefRequestBody](../../models/operations/requestbodyputmultipartfilerefrequestbody.md) | :heavy_check_mark:                                                                                                                          | The request object to use for the request.                                                                                                  |

### Response

**[T.nilable(::OpenApiSDK::Operations::RequestBodyPutMultipartFileRefResponse)](../../models/operations/requestbodyputmultipartfilerefresponse.md)**
