...
res = s.retries.retries_after(request_id="<id>", num_retries=282943, retry_after_val=502771)
...
res = s.retries.retries_flat_empty_response_post(request_id="<id>", request_body=::OpenApiSDK::Operations::RetriesFlatEmptyResponsePostRequestBody.new(
  field_one: "<value>",
), num_retries=923715)
...
res = s.retries.retries_get(request_id="<id>", num_retries=75342)
...
res = s.retries.retries_post(request_id="<id>", request_body=::OpenApiSDK::Operations::RetriesPostRequestBody.new(
  field_one: "<value>",
), num_retries=138258)
