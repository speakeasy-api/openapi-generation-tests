...
module OpenApiSDK
  ...
  class Flattening
    ...
    sig { params(simple_object: ::OpenApiSDK::Shared::SimpleObject, str_: ::String).returns(Utils::FieldAugmented) }
    ...
    sig { params(param_str: ::String, simple_object: ::OpenApiSDK::Shared::SimpleObject).returns(Utils::FieldAugmented) }
    ...
    sig { params(request_body: ::OpenApiSDK::Operations::InlineBodyAndParamConflictRequestBody, str_: ::String).returns(Utils::FieldAugmented) }
    ...
    sig { params(request_body: ::OpenApiSDK::Operations::InlineBodyAndParamNoConflictRequestBody, param_str: ::String).returns(Utils::FieldAugmented) }
