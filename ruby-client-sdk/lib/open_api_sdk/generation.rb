...
module OpenApiSDK
  ...
  class Generation
    ...
    sig { params(request: ::OpenApiSDK::Shared::DeprecatedFieldInObject).returns(Utils::FieldAugmented) }
    ...
    sig { params(empty_object: ::OpenApiSDK::Shared::EmptyObjectParam).returns(Utils::FieldAugmented) }
    ...
    sig { params(request: T.nilable(::OpenApiSDK::Shared::SimpleObject)).returns(Utils::FieldAugmented) }
    ...
    sig { params(request_body: ::OpenApiSDK::Operations::IgnoresPostRequestBody, test_param: T.nilable(::String)).returns(Utils::FieldAugmented) }
    ...
    sig { params(test_enum_query_param: ::OpenApiSDK::Operations::EnumNameOverride, test_query_param: ::String).returns(Utils::FieldAugmented) }
    ...
    sig { params(bigint: T.nilable(::Integer), date: T.nilable(::Date), decimal: T.nilable(::Float), obj: T.nilable(::OpenApiSDK::Operations::Obj)).returns(Utils::FieldAugmented) }
    ...
    sig { params(request: T.nilable(::OpenApiSDK::Operations::UsageExamplePostRequest), security: ::OpenApiSDK::Operations::UsageExamplePostSecurity).returns(Utils::FieldAugmented) }
