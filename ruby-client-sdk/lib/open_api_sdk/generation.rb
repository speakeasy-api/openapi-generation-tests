...
module OpenApiSDK
  ...
  class Generation
    ...
    sig { params(request: T.nilable(::OpenApiSDK::Shared::FigmaComponentNode)).returns(::OpenApiSDK::Operations::CircularReferenceOneDegreeResponse) }
    def circular_reference_one_degree(request)
      # circular_reference_one_degree - A reference cycle that spans three models separated by one degree
      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/anything/circularReferenceOneDegree"
      headers = {}
      ...
      res = ::OpenApiSDK::Operations::CircularReferenceOneDegreeResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::CircularReferenceOneDegreeResponseBody)
          res.object = out
        end
      end
    ...
    sig { params(deprecated_parameter: T.nilable(::String), new_parameter: T.nilable(::String)).returns(::OpenApiSDK::Operations::DeprecatedOperationWithMultilineCommentGetResponse) }
    def deprecated_operation_with_multiline_comment_get(deprecated_parameter = nil, new_parameter = nil)
      # deprecated_operation_with_multiline_comment_get - This is an endpoint setup to test deprecation with multiline comments
      # 
      ...
      request = ::OpenApiSDK::Operations::DeprecatedOperationWithMultilineCommentGetRequest.new(
      ...
      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/anything/deprecatedOperationWithMultilineComment"
      headers = {}
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::DeprecatedOperationWithMultilineCommentGetRequest, request, @sdk_configuration.globals)
      headers['Accept'] = '*/*'
      headers['x-speakeasy-user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::DeprecatedOperationWithMultilineCommentGetResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
    ...
    sig { params(page: ::Integer).returns(::OpenApiSDK::Operations::ReactHookCombinedOptionsResponse) }
    def react_hook_combined_options(page)

      request = ::OpenApiSDK::Operations::ReactHookCombinedOptionsRequest.new(
        
        page: page
      )
      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/anything/reactHookCombinedOptions"
      headers = {}
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::ReactHookCombinedOptionsRequest, request, @sdk_configuration.globals)
      headers['Accept'] = 'application/json'
      headers['x-speakeasy-user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::ReactHookCombinedOptionsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
    ...
    sig { returns(::OpenApiSDK::Operations::ReactHookDisabledResponse) }
    def react_hook_disabled

      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/anything/reactHookDisabled"
      headers = {}
      headers['Accept'] = 'application/json'
      headers['x-speakeasy-user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::ReactHookDisabledResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
    ...
    sig { returns(::OpenApiSDK::Operations::ReactHookGetAsMutationResponse) }
    def react_hook_get_as_mutation

      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/anything/reactHookGetAsMutation"
      headers = {}
      ...
      res = ::OpenApiSDK::Operations::ReactHookGetAsMutationResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
    ...
    sig { returns(::OpenApiSDK::Operations::ReactHookPostAsQueryResponse) }
    def react_hook_post_as_query

      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/anything/reactHookPostAsQuery"
      headers = {}
      headers['Accept'] = 'text/plain'
      headers['x-speakeasy-user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::ReactHookPostAsQueryResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        res.res = r.env.response_body if Utils.match_content_type(content_type, 'text/plain')
    ...
    sig { returns(::OpenApiSDK::Operations::ReactHookRenamedResponse) }
    def react_hook_renamed

      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/anything/reactHookRenamed"
      headers = {}
      headers['Accept'] = 'application/json'
      headers['x-speakeasy-user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::ReactHookRenamedResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
