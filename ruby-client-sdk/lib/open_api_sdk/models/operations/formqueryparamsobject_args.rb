...
module OpenApiSDK
  module Operations
    ...
    class FormQueryParamsObjectArgs < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :float64_str, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('float64Str') } }

      field :int64_str, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('int64Str') } }
      ...
      sig { params(any: ::String, bool: ::String, date: ::String, date_time: ::String, enum: ::String, float32: ::String, int: ::String, int32: ::String, int32_enum: ::String, int_enum: ::String, num: ::String, obj_param: ::String, str_: ::String, bigint: T.nilable(::String), bigint_str: T.nilable(::String), bool_opt: T.nilable(::String), decimal: T.nilable(::String), decimal_str: T.nilable(::String), float64_str: T.nilable(::String), int64_str: T.nilable(::String), int_opt_null: T.nilable(::String), num_opt_null: T.nilable(::String), str_opt: T.nilable(::String)).void }
      def initialize(any: nil, bool: nil, date: nil, date_time: nil, enum: nil, float32: nil, int: nil, int32: nil, int32_enum: nil, int_enum: nil, num: nil, obj_param: nil, str_: nil, bigint: nil, bigint_str: nil, bool_opt: nil, decimal: nil, decimal_str: nil, float64_str: nil, int64_str: nil, int_opt_null: nil, num_opt_null: nil, str_opt: nil)
        @any = any
        @bool = bool
        @date = date
        @date_time = date_time
