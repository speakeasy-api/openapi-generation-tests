...
module OpenApiSDK
  module Operations
    ...
    class InlineBodyAndParamConflictRes < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :json, ::OpenApiSDK::Operations::Json, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('json') } }


      sig { params(args: T::Hash[Symbol, ::String], json: ::OpenApiSDK::Operations::Json).void }
