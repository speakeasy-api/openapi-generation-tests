...
module OpenApiSDK
  module Operations
    ...
    class RequestBodyPostFormSimpleForm < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(any: ::String, bool: ::String, date: ::String, date_time: ::String, enum: ::String, float32: ::String, int: ::String, int32: ::String, int32_enum: ::String, int_enum: ::String, num: ::String, str_: ::String, bigint: T.nilable(::String), bigint_str: T.nilable(::String), bool_opt: T.nilable(::String), decimal: T.nilable(::String), decimal_str: T.nilable(::String), int_opt_null: T.nilable(::String), num_opt_null: T.nilable(::String), str_opt: T.nilable(::String)).void }
