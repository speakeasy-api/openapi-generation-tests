...
module OpenApiSDK
  module Operations
    ...
    class UsageExamplePostRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(bigint_parameter: ::Integer, bigint_str_parameter: ::String, bool_parameter: T::Boolean, date_parameter: ::Date, date_time_default_parameter: ::DateTime, date_time_parameter: ::DateTime, decimal_parameter: ::Float, decimal_str_parameter: ::String, double_parameter: ::Float, enum_parameter: ::OpenApiSDK::Operations::EnumParameter, falsey_number_parameter: ::Float, float32_parameter: ::Float, float_parameter: ::Float, int64_parameter: ::Integer, int_parameter: ::Integer, str_parameter: ::String, bigint_parameter_optional: T.nilable(::Integer), bigint_str_parameter_optional: T.nilable(::String), decimal_parameter_optional: T.nilable(::Float), decimal_str_parameter_optional: T.nilable(::String), opt_enum_parameter: T.nilable(::OpenApiSDK::Operations::OptEnumParameter), request_body: T.nilable(::OpenApiSDK::Operations::UsageExamplePostRequestBody)).void }
