...
module OpenApiSDK
  module Shared
    ...
    class DefaultsAndConstsOutput < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :const_enum_int, ::OpenApiSDK::Shared::DefaultsAndConstsOutputConstEnumInt, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('constEnumInt'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::DefaultsAndConstsOutputConstEnumInt, false) } }

      field :const_enum_str, ::OpenApiSDK::Shared::DefaultsAndConstsOutputConstEnumStr, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('constEnumStr'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::DefaultsAndConstsOutputConstEnumStr, false) } }
      ...
      field :const_str_d_quotes, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('constStrDQuotes') } }

      field :const_str_null, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('constStrNull') } }

      field :const_str_s_quotes, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('constStrSQuotes') } }
      ...
      field :default_enum_int, ::OpenApiSDK::Shared::DefaultsAndConstsOutputDefaultEnumInt, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('defaultEnumInt'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::DefaultsAndConstsOutputDefaultEnumInt, false) } }

      field :default_enum_str, ::OpenApiSDK::Shared::DefaultsAndConstsOutputDefaultEnumStr, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('defaultEnumStr'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::DefaultsAndConstsOutputDefaultEnumStr, false) } }
      ...
      field :default_str_d_quotes, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('defaultStrDQuotes') } }

      field :default_str_nullable, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('defaultStrNullable') } }

      field :default_str_s_quotes, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('defaultStrSQuotes') } }
      ...
      sig { params(const_big_int: ::Integer, const_big_int_str: ::String, const_bool: T::Boolean, const_date: ::Date, const_date_time: ::DateTime, const_decimal: ::Float, const_decimal_str: ::String, const_enum_int: ::OpenApiSDK::Shared::DefaultsAndConstsOutputConstEnumInt, const_enum_str: ::OpenApiSDK::Shared::DefaultsAndConstsOutputConstEnumStr, const_int: ::Integer, const_num: ::Float, const_str: ::String, const_str_d_quotes: ::String, const_str_null: ::String, const_str_s_quotes: ::String, default_big_int: ::Integer, default_big_int_str: ::String, default_bool: T::Boolean, default_date: ::Date, default_date_time: ::DateTime, default_decimal: ::Float, default_decimal_str: ::String, default_enum_int: ::OpenApiSDK::Shared::DefaultsAndConstsOutputDefaultEnumInt, default_enum_str: ::OpenApiSDK::Shared::DefaultsAndConstsOutputDefaultEnumStr, default_int: ::Integer, default_num: ::Float, default_str: ::String, default_str_d_quotes: ::String, default_str_nullable: ::String, default_str_s_quotes: ::String, normal_field: ::String, default_str_optional: T.nilable(::String)).void }
      def initialize(const_big_int: nil, const_big_int_str: nil, const_bool: nil, const_date: nil, const_date_time: nil, const_decimal: nil, const_decimal_str: nil, const_enum_int: nil, const_enum_str: nil, const_int: nil, const_num: nil, const_str: nil, const_str_d_quotes: nil, const_str_null: nil, const_str_s_quotes: nil, default_big_int: nil, default_big_int_str: nil, default_bool: nil, default_date: nil, default_date_time: nil, default_decimal: nil, default_decimal_str: nil, default_enum_int: nil, default_enum_str: nil, default_int: nil, default_num: nil, default_str: nil, default_str_d_quotes: nil, default_str_nullable: nil, default_str_s_quotes: nil, normal_field: nil, default_str_optional: nil)
        ...
        @const_num = const_num
        @const_str = const_str
        @const_str_d_quotes = const_str_d_quotes
        @const_str_null = const_str_null
        @const_str_s_quotes = const_str_s_quotes
        ...
        @default_str_d_quotes = default_str_d_quotes
        @default_str_nullable = default_str_nullable
        @default_str_s_quotes = default_str_s_quotes
