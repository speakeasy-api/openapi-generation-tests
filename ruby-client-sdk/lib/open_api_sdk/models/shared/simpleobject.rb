...
module OpenApiSDK
  module Shared
    ...
    class SimpleObject < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :decimal_nullable_opt, T.nilable(::Float), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('decimalNullableOpt') }, 'header': { 'field_name': 'decimalNullableOpt' }, 'path_param': { 'field_name': 'decimalNullableOpt' }, 'query_param': { 'field_name': 'decimalNullableOpt' }, 'form': { 'field_name': 'decimalNullableOpt' }, 'multipart_form': { 'field_name': 'decimalNullableOpt' } }
      ...
      def initialize(any: nil, bool: nil, date: nil, date_time: nil, enum: nil, float32: nil, int: nil, int32: nil, int32_enum: nil, int_enum: nil, num: nil, str_: nil, bigint: nil, bigint_str: nil, bool_opt: nil, decimal: nil, decimal_nullable_opt: nil, decimal_str: nil, float64_str: nil, int64_str: nil, int_opt_null: nil, num_opt_null: nil, str_opt: nil)
        ...
        @bool_opt = bool_opt
        @decimal = decimal
        @decimal_nullable_opt = decimal_nullable_opt
