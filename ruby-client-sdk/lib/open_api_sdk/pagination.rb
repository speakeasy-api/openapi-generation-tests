...
module OpenApiSDK
  ...
  class Pagination
    ...
    sig { params(request: ::OpenApiSDK::Operations::PaginationCursorBodyRequestBody, server_url: T.nilable(String)).returns(Utils::FieldAugmented) }
    ...
    sig { params(request: ::OpenApiSDK::Shared::LimitOffsetConfig, server_url: T.nilable(String)).returns(Utils::FieldAugmented) }
    ...
    sig { params(attempts: ::Integer, is_reference_path: T.nilable(::String), server_url: T.nilable(String)).returns(Utils::FieldAugmented) }
