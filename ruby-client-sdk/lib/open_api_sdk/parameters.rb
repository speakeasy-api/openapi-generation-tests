...
module OpenApiSDK
  ...
  class Parameters
    ...
    sig { params(param1: ::String, param2: ::String).returns(::OpenApiSDK::Operations::PathEncodingResponse) }
    def path_encoding(param1, param2)

      request = ::OpenApiSDK::Operations::PathEncodingRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::PathEncodingRequest,
        base_url,
      ...
      res = ::OpenApiSDK::Operations::PathEncodingResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
