...
module OpenApiSDK
  ...
  class Parameters
    ...
    sig { params(obj_param: ::OpenApiSDK::Shared::SimpleObject, obj_arr_param: T.nilable(::OpenApiSDK::Operations::ObjArrParam)).returns(Utils::FieldAugmented) }
    ...
    sig { params(obj_param_exploded: ::OpenApiSDK::Operations::ObjParamExploded, obj_param: T.nilable(::OpenApiSDK::Operations::ObjParam)).returns(Utils::FieldAugmented) }
    ...
    sig { params(obj_param_exploded: ::OpenApiSDK::Shared::SimpleObject, obj_param: T.nilable(::OpenApiSDK::Shared::SimpleObject)).returns(Utils::FieldAugmented) }
    ...
    sig { params(ref_obj_param: T.nilable(::OpenApiSDK::Shared::RefQueryParamObj), ref_obj_param_exploded: T.nilable(::OpenApiSDK::Shared::RefQueryParamObjExploded)).returns(Utils::FieldAugmented) }
    ...
    sig { params(x_header_obj: ::OpenApiSDK::Shared::SimpleObject, x_header_obj_explode: ::OpenApiSDK::Shared::SimpleObject).returns(Utils::FieldAugmented) }
    ...
    sig { params(deep_obj_param: ::OpenApiSDK::Shared::DeepObject, simple_obj_param: ::OpenApiSDK::Shared::SimpleObject).returns(Utils::FieldAugmented) }
    ...
    sig { params(deep_object_param: ::OpenApiSDK::Shared::SimpleObject, form_param: ::OpenApiSDK::Shared::SimpleObject, json_param: ::OpenApiSDK::Shared::SimpleObject).returns(Utils::FieldAugmented) }
    ...
    sig { params(json_obj: ::OpenApiSDK::Shared::SimpleObject).returns(Utils::FieldAugmented) }
    ...
    sig { params(arr_param: T.nilable(T::Array[::String]), arr_param_exploded: T.nilable(T::Array[::Integer]), map_param: T.nilable(T::Hash[Symbol, ::String]), obj_param: T.nilable(::OpenApiSDK::Shared::SimpleObject)).returns(Utils::FieldAugmented) }
    ...
    sig { params(obj_param: ::OpenApiSDK::Shared::SimpleObject, obj_param_exploded: ::OpenApiSDK::Shared::SimpleObject).returns(Utils::FieldAugmented) }
