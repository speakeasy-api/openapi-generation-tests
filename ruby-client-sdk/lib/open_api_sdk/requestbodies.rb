...
module OpenApiSDK
  ...
  class RequestBodies
    ...
    sig { params(request: ::OpenApiSDK::Shared::ComplexNumberArrays).returns(Utils::FieldAugmented) }
    ...
    sig { params(request: ::OpenApiSDK::Shared::ComplexNumberMaps).returns(Utils::FieldAugmented) }
