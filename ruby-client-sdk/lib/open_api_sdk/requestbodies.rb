...
module OpenApiSDK
  ...
  class RequestBodies
    ...
    sig { params(request: ::OpenApiSDK::Shared::ObjectWithNullEnums).returns(::OpenApiSDK::Operations::NullEnumPostResponse) }
    def null_enum_post(request)
      ...
      res = ::OpenApiSDK::Operations::NullEnumPostResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::NullEnumPostRes)
          res.res = out
        end
      end
    ...
    sig { params(request: ::OpenApiSDK::Operations::NullableOptionalFieldsPostRequestBody).returns(::OpenApiSDK::Operations::NullableOptionalFieldsPostResponse) }
    def nullable_optional_fields_post(request)
      ...
      res = ::OpenApiSDK::Operations::NullableOptionalFieldsPostResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::NullableOptionalFieldsPostResponseBody)
          res.object = out
        end
      end
    ...
    sig { params(request: ::OpenApiSDK::Shared::DeprecatedObjectWithExample).returns(::OpenApiSDK::Operations::RequestBodyDeprecatedRequestBodyRefPostResponse) }
    def request_body_deprecated_request_body_ref_post(request)

      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/anything/requestBodies/deprecatedRequestBodyRef"
      headers = {}
      req_content_type, data, form = Utils.serialize_request_body(request, :request, :json)
      headers['content-type'] = req_content_type
      raise StandardError, 'request body is required' if data.nil? && form.nil?
      ...
      res = ::OpenApiSDK::Operations::RequestBodyDeprecatedRequestBodyRefPostResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::RequestBodyDeprecatedRequestBodyRefPostResponseBody)
          res.object = out
        end
      end
    ...
    sig { params(keyword: T.nilable(::String), limit: T.nilable(::Integer), offset: T.nilable(::Integer), server_url: T.nilable(String)).returns(::OpenApiSDK::Operations::RequestBodyGetInferredOptionalRequestWrapperResponse) }
    def request_body_get_inferred_optional_request_wrapper(keyword = nil, limit = nil, offset = nil, server_url = nil)

      request = ::OpenApiSDK::Operations::RequestBodyGetInferredOptionalRequestWrapperRequest.new(
        
        keyword: keyword,
        limit: limit,
        offset: offset
      )
      base_url = Utils.template_url(REQUEST_BODY_GET_INFERRED_OPTIONAL_REQUEST_WRAPPER_SERVERS[0], {
      })
      base_url = server_url if !server_url.nil?
      url = "#{base_url}/anything/inferredOptionalRequestWrapper"
      headers = {}
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::RequestBodyGetInferredOptionalRequestWrapperRequest, request, @sdk_configuration.globals)
      headers['Accept'] = 'application/json'
      headers['x-speakeasy-user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::RequestBodyGetInferredOptionalRequestWrapperResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::RequestBodyGetInferredOptionalRequestWrapperResponseBody)
          res.object = out
        end
      end
    ...
    sig { params(request: ::OpenApiSDK::Operations::RequestBodyPostApplicationJsonArrayOfUnionsRequestBody, server_url: T.nilable(String)).returns(::OpenApiSDK::Operations::RequestBodyPostApplicationJsonArrayOfUnionsResponse) }
    def request_body_post_application_json_array_of_unions(request, server_url = nil)

      base_url = Utils.template_url(REQUEST_BODY_POST_APPLICATION_JSON_ARRAY_OF_UNIONS_SERVERS[0], {
      })
      base_url = server_url if !server_url.nil?
      url = "#{base_url}/requestbody#arrayOfUnions"
      headers = {}
      req_content_type, data, form = Utils.serialize_request_body(request, :request, :json)
      headers['content-type'] = req_content_type
      raise StandardError, 'request body is required' if data.nil? && form.nil?
      ...
      res = ::OpenApiSDK::Operations::RequestBodyPostApplicationJsonArrayOfUnionsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
    ...
    sig { params(request: T.nilable(::OpenApiSDK::Operations::RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsRequestBody)).returns(::OpenApiSDK::Operations::RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponse) }
    def request_body_post_empty_body_retained_with_all_optional_fields(request)

      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/anything/requestBodies/post/empty-body-retained-with-all-optional-fields"
      headers = {}
      req_content_type, data, form = Utils.serialize_request_body(request, :request, :json)
      headers['content-type'] = req_content_type
      headers['Accept'] = 'application/json'
      ...
      res = ::OpenApiSDK::Operations::RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponseBody)
          res.object = out
        end
      end
    ...
    sig { params(request: ::OpenApiSDK::Shared::SimpleObject).returns(::OpenApiSDK::Operations::RequestBodyPostMultipleContentTypesComponentFilteredDefaultTestResponse) }
    def request_body_post_multiple_content_types_component_filtered_default_test(request)

      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/anything/requestBodies/post/multiple/contentTypes/component/filtered#defaultTest"
      headers = {}
      req_content_type, data, form = Utils.serialize_request_body(request, :request, :json)
      headers['content-type'] = req_content_type
      raise StandardError, 'request body is required' if data.nil? && form.nil?
      ...
      res = ::OpenApiSDK::Operations::RequestBodyPostMultipleContentTypesComponentFilteredDefaultTestResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::RequestBodyPostMultipleContentTypesComponentFilteredDefaultTestRes)
          res.res = out
        end
      end
    ...
    sig { params(request: T.nilable(::String)).returns(::OpenApiSDK::Operations::RequestBodyPostWildcardResponse) }
    def request_body_post_wildcard(request)

      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/anything/requestBodies/post/wildcard"
      headers = {}
      ...
      res = ::OpenApiSDK::Operations::RequestBodyPostWildcardResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::RequestBodyPostWildcardRes)
          res.res = out
        end
      end
    ...
    sig { params(request: ::OpenApiSDK::Operations::RequestBodyPutMultipartFileRefRequestBody).returns(::OpenApiSDK::Operations::RequestBodyPutMultipartFileRefResponse) }
    def request_body_put_multipart_file_ref(request)

      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/anything/requestBodies/put/multipart/fileRef"
      headers = {}
      req_content_type, data, form = Utils.serialize_request_body(request, :request, :multipart)
      headers['content-type'] = req_content_type
      raise StandardError, 'request body is required' if data.nil? && form.nil?
      ...
      res = ::OpenApiSDK::Operations::RequestBodyPutMultipartFileRefResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::RequestBodyPutMultipartFileRefRes)
          res.res = out
        end
      end
