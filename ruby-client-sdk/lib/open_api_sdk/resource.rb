...
module OpenApiSDK
  ...
  class Resource
    ...
    sig { params(request: ::OpenApiSDK::Operations::CreateFileRequestBody).returns(Utils::FieldAugmented) }
    ...
    sig { params(request: ::OpenApiSDK::Shared::ExampleResource).returns(Utils::FieldAugmented) }
