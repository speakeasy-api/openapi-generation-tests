...
module OpenApiSDK
  ...
  class ResponseBodies
    ...
    sig { params(cursor: T.nilable(::String)).returns(::OpenApiSDK::Operations::FlattenedEnvelopePaginationResponseResponse) }
    def flattened_envelope_pagination_response(cursor = nil)

      request = ::OpenApiSDK::Operations::FlattenedEnvelopePaginationResponseRequest.new(
      ...
      headers = {}
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::FlattenedEnvelopePaginationResponseRequest, request, @sdk_configuration.globals)
      ...
      res = ::OpenApiSDK::Operations::FlattenedEnvelopePaginationResponseResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::FlattenedEnvelopePaginationResponseRes)
          res.res = out
        end
      end
    ...
    sig { returns(::OpenApiSDK::Operations::FlattenedEnvelopeResponseResponse) }
    def flattened_envelope_response
      ...
      res = ::OpenApiSDK::Operations::FlattenedEnvelopeResponseResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      ...
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::FlattenedEnvelopeResponseResponseBody)
          res.object = out
        end
      end
    ...
    sig { returns(::OpenApiSDK::Operations::FlattenedEnvelopeUnionResponseResponse) }
    def flattened_envelope_union_response
      ...
      res = ::OpenApiSDK::Operations::FlattenedEnvelopeUnionResponseResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        res.headers = r.headers
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::FlattenedEnvelopeUnionResponseResponseBody)
          res.two_hundred_application_json_object = out
        end
      elsif r.status == 201
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::FlattenedEnvelopeUnionResponseResponseBodiesResponseBody)
    ...
    sig { returns(::OpenApiSDK::Operations::FlattenedUnionResponseResponse) }
    def flattened_union_response
      ...
      res = ::OpenApiSDK::Operations::FlattenedUnionResponseResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::FlattenedUnionResponseResponseBody)
          res.two_hundred_application_json_object = out
        end
      elsif r.status == 201
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::FlattenedUnionResponseResponseBodiesResponseBody)
          res.two_hundred_and_one_application_json_object = out
        end
      end
    ...
    sig { params(request: ::OpenApiSDK::Operations::OverriddenFieldNamesPostRequestBody).returns(::OpenApiSDK::Operations::OverriddenFieldNamesPostResponse) }
    def overridden_field_names_post(request)
      ...
      res = ::OpenApiSDK::Operations::OverriddenFieldNamesPostResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::OverriddenFieldNamesPostResponseBody)
          res.object = out
        end
      end
    ...
    sig { returns(::OpenApiSDK::Operations::ResponseBodies2xxJSONObjectAllOptionalPropertiesResponse) }
    def response_bodies2xx_json_object_all_optional_properties

      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/anything/responseBodies/2xxJSONObjectAllOptionalProperties"
      headers = {}
      headers['Accept'] = 'application/json'
      headers['x-speakeasy-user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::ResponseBodies2xxJSONObjectAllOptionalPropertiesResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status >= 200 && r.status < 300
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::ResponseBodies2xxJSONObjectAllOptionalPropertiesResponseBody)
          res.object = out
        end
      end
    ...
    sig { params(seed: T.nilable(::Integer)).returns(::OpenApiSDK::Operations::ResponseBodyBytesGetResponse) }
    def response_body_bytes_get(seed = nil)

      request = ::OpenApiSDK::Operations::ResponseBodyBytesGetRequest.new(
      ...
      headers = {}
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::ResponseBodyBytesGetRequest, request, @sdk_configuration.globals)
    ...
    sig { params(request: ::String, server_url: T.nilable(String)).returns(::OpenApiSDK::Operations::ResponseBodyDecimalStrResponse) }
    def response_body_decimal_str(request, server_url = nil)

      base_url = Utils.template_url(RESPONSE_BODY_DECIMAL_STR_SERVERS[0], {
      })
      ...
      res = ::OpenApiSDK::Operations::ResponseBodyDecimalStrResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
    ...
    sig { returns(::OpenApiSDK::Operations::ResponseBodyMissing2xxOr3xxGetResponse) }
    def response_body_missing2xx_or3xx_get
      ...
      res = ::OpenApiSDK::Operations::ResponseBodyMissing2xxOr3xxGetResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 500
    ...
    sig { params(request: ::OpenApiSDK::Operations::ResponseBodyMultilineStringPostRequestBody).returns(::OpenApiSDK::Operations::ResponseBodyMultilineStringPostResponse) }
    def response_body_multiline_string_post(request)

      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/anything/responseBodies/multilineString"
      headers = {}
      req_content_type, data, form = Utils.serialize_request_body(request, :request, :json)
      headers['content-type'] = req_content_type
      raise StandardError, 'request body is required' if data.nil? && form.nil?
      ...
      res = ::OpenApiSDK::Operations::ResponseBodyMultilineStringPostResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::ResponseBodyMultilineStringPostResponseBody)
          res.object = out
        end
      end
