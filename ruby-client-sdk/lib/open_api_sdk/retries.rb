...
module OpenApiSDK
  ...
  class Retries
    ...
    sig { params(request_id: ::String, request_body: T.nilable(::OpenApiSDK::Operations::RetriesFlatEmptyResponsePostRequestBody), num_retries: T.nilable(::Integer), server_url: T.nilable(String)).returns(::OpenApiSDK::Operations::RetriesFlatEmptyResponsePostResponse) }
    def retries_flat_empty_response_post(request_id, request_body = nil, num_retries = nil, server_url = nil)

      request = ::OpenApiSDK::Operations::RetriesFlatEmptyResponsePostRequest.new(
        
        request_id: request_id,
        request_body: request_body,
        num_retries: num_retries
      )
      base_url = Utils.template_url(RETRIES_FLAT_EMPTY_RESPONSE_POST_SERVERS[0], {
      })
      base_url = server_url if !server_url.nil?
      ...
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::RetriesFlatEmptyResponsePostRequest, request, @sdk_configuration.globals)
      headers['Accept'] = '*/*'
      headers['x-speakeasy-user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::RetriesFlatEmptyResponsePostResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
