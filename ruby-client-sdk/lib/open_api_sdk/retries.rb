...
module OpenApiSDK
  ...
  class Retries
    ...
    sig { params(request_id: ::String, num_retries: T.nilable(::Integer), retry_after_val: T.nilable(::Integer), server_url: T.nilable(String)).returns(Utils::FieldAugmented) }
    ...
    sig { params(request_id: ::String, request_body: T.nilable(::OpenApiSDK::Operations::RetriesPostRequestBody), num_retries: T.nilable(::Integer), server_url: T.nilable(String)).returns(Utils::FieldAugmented) }
