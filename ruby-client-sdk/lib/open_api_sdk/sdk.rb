...
module OpenApiSDK
  ...
  class SDK
    ...
    attr_accessor :generation, :unions, :errors, :custom_client, :response_bodies, :flattening, :globals, :parameters, :hooks, :request_bodies, :nest_first, :nested, :nested_first, :nested_second, :auth, :open_enums, :servers, :telemetry, :auth_new, :resource, :documentation, :first, :second, :methods, :pagination, :retries, :status_code
