...
module OpenApiSDK
  ...
  class SDK
    ...
    attr_accessor :generation, :unions, :errors, :custom_client, :response_bodies, :flattening, :globals, :parameters, :hooks, :nest_first, :nested, :nested_first, :nested_second, :auth, :open_enums, :request_bodies, :servers, :telemetry, :auth_new, :resource, :documentation, :first, :second, :methods, :pagination, :retries
