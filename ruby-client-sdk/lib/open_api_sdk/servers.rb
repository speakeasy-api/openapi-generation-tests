...
module OpenApiSDK
  ...
  class Servers
    ...
    SERVERS_OVERRIDE_OPERATION_SERVER_URL_SERVERS_MAIN = :main
    ...
    SERVERS_OVERRIDE_OPERATION_SERVER_URL_SERVERS = {
      main: '{protocol}://{hostname}:{port}/{base_path}',
    }.freeze
    ...
    sig { returns(::OpenApiSDK::Operations::ServersOverrideGlobalServerURLResponse) }
    def servers_override_global_server_url

      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/ping#serversOverrideGlobalServerURL"
      headers = {}
      headers['Accept'] = '*/*'
      headers['x-speakeasy-user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::ServersOverrideGlobalServerURLResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
    ...
    sig { params(server_url: T.nilable(String)).returns(::OpenApiSDK::Operations::ServersOverrideOperationServerURLResponse) }
    def servers_override_operation_server_url(server_url = nil)

      base_url = Utils.template_url(SERVERS_OVERRIDE_OPERATION_SERVER_URL_SERVERS[SERVERS_OVERRIDE_OPERATION_SERVER_URL_SERVERS_MAIN], {
      ...
      base_url = server_url if !server_url.nil?
      url = "#{base_url}/ping#serversOverrideOperationServerURL"
      headers = {}
      headers['Accept'] = '*/*'
      headers['x-speakeasy-user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::ServersOverrideOperationServerURLResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
