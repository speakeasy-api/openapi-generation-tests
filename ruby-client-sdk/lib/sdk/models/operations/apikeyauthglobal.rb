...
module OpenApiSDK
  module Operations
    ...
    class ApiKeyAuthGlobalToken < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ApiKeyAuthGlobalResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # Successful authentication.
      field :token, T.nilable(Operations::ApiKeyAuthGlobalToken)


      sig { params(content_type: String, status_code: Integer, raw_response: T.nilable(Faraday::Response), token: T.nilable(Operations::ApiKeyAuthGlobalToken)).void }
