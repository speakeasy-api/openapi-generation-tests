...
module OpenApiSDK
  module Operations
    ...
    # OK
    class PaginationLimitOffsetOffsetBodyRes < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class PaginationLimitOffsetOffsetBodyResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # OK
      field :res, T.nilable(Operations::PaginationLimitOffsetOffsetBodyRes)


      sig { params(content_type: String, status_code: Integer, raw_response: T.nilable(Faraday::Response), res: T.nilable(Operations::PaginationLimitOffsetOffsetBodyRes)).void }
