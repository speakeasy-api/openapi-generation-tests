...
module OpenApiSDK
  module Operations
    ...
    class PaginationLimitOffsetPageBodyResponse < OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(content_type: String, status_code: Integer, raw_response: T.nilable(Faraday::Response), res: T.nilable(Operations::PaginationLimitOffsetPageBodyRes)).void }
