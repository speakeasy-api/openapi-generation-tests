...
module OpenApiSDK
  module Operations
    ...
    class RequestBodyPostApplicationJsonArrayOfMapCamelCaseResponse < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, res: T.nilable(T::Array[T::Hash[Symbol, Shared::SimpleObjectCamelCase]])).void }
