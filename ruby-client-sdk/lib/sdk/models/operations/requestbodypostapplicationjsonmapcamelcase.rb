...
module OpenApiSDK
  module Operations
    ...
    class RequestBodyPostApplicationJsonMapCamelCaseResponse < OpenApiSDK::Utils::FieldAugmented
      ...
      # OK
      field :res, T.nilable(T::Hash[Symbol, Shared::SimpleObjectCamelCase])


      sig { params(content_type: String, status_code: Integer, raw_response: T.nilable(Faraday::Response), res: T.nilable(T::Hash[Symbol, Shared::SimpleObjectCamelCase])).void }
