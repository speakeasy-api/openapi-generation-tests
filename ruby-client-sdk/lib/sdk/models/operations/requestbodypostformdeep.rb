...
module OpenApiSDK
  module Operations
    ...
    class RequestBodyPostFormDeepResForm < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class RequestBodyPostFormDeepRes < OpenApiSDK::Utils::FieldAugmented
      ...
      field :form, Operations::RequestBodyPostFormDeepResForm, { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('form') } }


      sig { params(form: Operations::RequestBodyPostFormDeepResForm).void }
    ...
    class RequestBodyPostFormDeepResponse < OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(content_type: String, status_code: Integer, raw_response: T.nilable(Faraday::Response), res: T.nilable(Operations::RequestBodyPostFormDeepRes)).void }
