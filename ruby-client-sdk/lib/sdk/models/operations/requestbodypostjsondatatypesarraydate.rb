...
module OpenApiSDK
  module Operations
    ...
    class RequestBodyPostJsonDataTypesArrayDateResponse < OpenApiSDK::Utils::FieldAugmented
      ...
      # OK
      field :object, T.nilable(Operations::RequestBodyPostJsonDataTypesArrayDateResponseBody)
      # Raw HTTP response; suitable for custom response parsing
      field :raw_response, T.nilable(Faraday::Response)


      sig { params(content_type: String, status_code: Integer, object: T.nilable(Operations::RequestBodyPostJsonDataTypesArrayDateResponseBody), raw_response: T.nilable(Faraday::Response)).void }
