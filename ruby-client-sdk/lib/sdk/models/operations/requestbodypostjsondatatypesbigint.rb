...
module OpenApiSDK
  module Operations
    ...
    class RequestBodyPostJsonDataTypesBigIntResponse < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, object: T.nilable(Operations::RequestBodyPostJsonDataTypesBigIntResponseBody)).void }
