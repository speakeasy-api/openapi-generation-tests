...
module OpenApiSDK
  module Operations
    ...
    class RequestBodyPostJsonDataTypesBigIntResponse < OpenApiSDK::Utils::FieldAugmented
      ...
      # OK
      field :object, T.nilable(Operations::RequestBodyPostJsonDataTypesBigIntResponseBody)
      # Raw HTTP response; suitable for custom response parsing
      field :raw_response, T.nilable(Faraday::Response)


      sig { params(content_type: String, status_code: Integer, object: T.nilable(Operations::RequestBodyPostJsonDataTypesBigIntResponseBody), raw_response: T.nilable(Faraday::Response)).void }
