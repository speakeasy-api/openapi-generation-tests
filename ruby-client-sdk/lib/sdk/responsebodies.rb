...
module OpenApiSDK
  ...
  class ResponseBodies
    ...
    sig { params(request: T::Hash[Symbol, Object]).returns(Utils::FieldAugmented) }
    def response_body_additional_properties_any_post(request)
      ...
      res = Operations::ResponseBodyAdditionalPropertiesAnyPostResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, Operations::ResponseBodyAdditionalPropertiesAnyPostResponseBody)
          res.object = out
        end
      end
      res
