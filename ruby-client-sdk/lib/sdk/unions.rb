...
module OpenApiSDK
  ...
  class Unions
    ...
    def strongly_typed_one_of_discriminated_post(request)
      ...
      res = Operations::StronglyTypedOneOfDiscriminatedPostResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, Operations::StronglyTypedOneOfDiscriminatedPostRes)
          res.res = out
        end
      end
      res
    ...
    def union_big_int_decimal(request)
      ...
      res = Operations::UnionBigIntDecimalResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, Operations::UnionBigIntDecimalRes)
          res.res = out
        end
      end
      res
    ...
    def union_date_time_big_int(request)
      ...
      res = Operations::UnionDateTimeBigIntResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, Operations::UnionDateTimeBigIntRes)
          res.res = out
        end
      end
      res
