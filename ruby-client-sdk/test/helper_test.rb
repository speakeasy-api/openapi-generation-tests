...
def create_simple_object
  OpenApiSDK::Shared::SimpleObject.new(
    ...
    int: 1,
    int32: 1,
    int32_enum: OpenApiSDK::Shared::SimpleObjectInt32EnumEnum::FIFTY_FIVE,
    int_enum: OpenApiSDK::Shared::SimpleObjectIntEnumEnum::SECOND,
    num: 1.1,
    float32: 1.1,
    enum: OpenApiSDK::Shared::EnumEnum::ONE,
    any: 'any',
