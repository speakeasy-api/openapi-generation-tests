...
/// - ``circularReferenceOneDegree(request:)``
...
/// - ``deprecatedOperationWithMultilineCommentGet(request:)``
...
/// - ``reactHookCombinedOptions(request:)``
/// - ``reactHookDisabled()``
...
public protocol GenerationAPI {
    ...
    /// 
    /// - Parameter request: A ``Shared/FigmaComponentNode`` object describing the input to the API operation
    /// - Returns: A ``Operations/CircularReferenceOneDegreeResponse`` object describing the result of the API operation
    /// - Throws: An error of type ``OpenAPIError``
    func circularReferenceOneDegree(request: Shared.FigmaComponentNode) async throws -> Response<Operations.CircularReferenceOneDegreeResponse>
    ...
    /// 
    /// - Parameter request: A ``Operations/DeprecatedOperationWithMultilineCommentGetRequest`` object describing the input to the API operation
    /// - Returns: A ``Operations/DeprecatedOperationWithMultilineCommentGetResponse`` object describing the result of the API operation
    /// - Throws: An error of type ``OpenAPIError``
    @available(*, deprecated, renamed: "simplePathParameterObjects", message: "This operation is deprecated.
Its deprecation message has newlines.
")
    func deprecatedOperationWithMultilineCommentGet(request: Operations.DeprecatedOperationWithMultilineCommentGetRequest) async throws -> Response<Operations.DeprecatedOperationWithMultilineCommentGetResponse>
    ...
    func reactHookCombinedOptions(request: Operations.ReactHookCombinedOptionsRequest) async throws -> Response<Operations.ReactHookCombinedOptionsResponse>

    func reactHookDisabled() async throws -> Response<Operations.ReactHookDisabledResponse>

    func reactHookGetAsMutation() async throws -> Response<Operations.ReactHookGetAsMutationResponse>

    func reactHookPostAsQuery() async throws -> Response<Operations.ReactHookPostAsQueryResponse>

    func reactHookRenamed() async throws -> Response<Operations.ReactHookRenamedResponse>
...
/// ### API calls
///
/// - ``arrayOfDiscriminatedUnions(request:)``
/// - ``arrayOfDiscriminatedUnionsMap(request:)``
...
/// - ``nestedArrayOfDiscriminatedUnions(request:)``
...
public protocol UnionsAPI {
    func arrayOfDiscriminatedUnions(request: [Shared.StronglyTypedOneOfObject]) async throws -> Response<Operations.ArrayOfDiscriminatedUnionsResponse>

    func arrayOfDiscriminatedUnionsMap(request: Shared.ArrayOfDiscriminatedUnionsMap) async throws -> Response<Operations.ArrayOfDiscriminatedUnionsMapResponse>
    ...
    func nestedArrayOfDiscriminatedUnions(request: Shared.NestedArrayOfDiscriminatedUnions) async throws -> Response<Operations.NestedArrayOfDiscriminatedUnionsResponse>
...
public protocol ResponseBodiesAPI {
    ...
    func responseBodies2xxJSONObjectAllOptionalProperties() async throws -> Response<Operations.ResponseBodies2xxJSONObjectAllOptionalPropertiesResponse>
...
/// - ``requiredBodyAllOptional(request:)``
///
public protocol FlatteningAPI {
    ...
    func requiredBodyAllOptional(request: Shared.ObjWithOptionalProperties) async throws -> Response<Operations.RequiredBodyAllOptionalResponse>
}
...
/// - ``globalsOptionalHiddenPathParameterOperationRequired(request:)``
/// - ``globalsOptionalHiddenPathParameterPathRequired(request:)``
/// - ``globalsOptionalPathParameterOperationRequired(request:)``
/// - ``globalsOptionalPathParameterPathRequired(request:)``
...
public protocol GlobalsAPI {
    ...
    /// 
    /// 
    /// - Parameter request: A ``Operations/GlobalsOptionalHiddenPathParameterOperationRequiredRequest`` object describing the input to the API operation
    /// - Returns: A ``Operations/GlobalsOptionalHiddenPathParameterOperationRequiredResponse`` object describing the result of the API operation
    /// - Throws: An error of type ``OpenAPIError``
    func globalsOptionalHiddenPathParameterOperationRequired(request: Operations.GlobalsOptionalHiddenPathParameterOperationRequiredRequest) async throws -> Response<Operations.GlobalsOptionalHiddenPathParameterOperationRequiredResponse>
    ...
    /// 
    /// 
    /// - Parameter request: A ``Operations/GlobalsOptionalHiddenPathParameterPathRequiredRequest`` object describing the input to the API operation
    /// - Returns: A ``Operations/GlobalsOptionalHiddenPathParameterPathRequiredResponse`` object describing the result of the API operation
    /// - Throws: An error of type ``OpenAPIError``
    func globalsOptionalHiddenPathParameterPathRequired(request: Operations.GlobalsOptionalHiddenPathParameterPathRequiredRequest) async throws -> Response<Operations.GlobalsOptionalHiddenPathParameterPathRequiredResponse>
    ...
    /// 
    /// 
    /// - Parameter request: A ``Operations/GlobalsOptionalPathParameterOperationRequiredRequest`` object describing the input to the API operation
    /// - Returns: A ``Operations/GlobalsOptionalPathParameterOperationRequiredResponse`` object describing the result of the API operation
    /// - Throws: An error of type ``OpenAPIError``
    func globalsOptionalPathParameterOperationRequired(request: Operations.GlobalsOptionalPathParameterOperationRequiredRequest) async throws -> Response<Operations.GlobalsOptionalPathParameterOperationRequiredResponse>
    ...
    /// 
    /// 
    /// - Parameter request: A ``Operations/GlobalsOptionalPathParameterPathRequiredRequest`` object describing the input to the API operation
    /// - Returns: A ``Operations/GlobalsOptionalPathParameterPathRequiredResponse`` object describing the result of the API operation
    /// - Throws: An error of type ``OpenAPIError``
    func globalsOptionalPathParameterPathRequired(request: Operations.GlobalsOptionalPathParameterPathRequiredRequest) async throws -> Response<Operations.GlobalsOptionalPathParameterPathRequiredResponse>
...
public protocol ParametersAPI {
    ...
    func headerParamsNil(request: Operations.HeaderParamsNilRequest) async throws -> Response<Operations.HeaderParamsNilResponse>
...
/// Describes the available servers that can be used when making 'requestBodyGetInferredOptionalRequestWrapper' requests.
///
/// Use this type when making calls to ``RequestBodiesAPI/requestBodyGetInferredOptionalRequestWrapper(request:server:)`` to customize the server which is used.
    public enum RequestBodyGetInferredOptionalRequestWrapper: Servers, ServerConvertible {
        /// Supported server value.
        ///
        ...
        static func `default`() throws -> Server {
            return try RequestBodiesServers.RequestBodyGetInferredOptionalRequestWrapper.server1.server()
        }
...
/// - ``requestBodyGetInferredOptionalRequestWrapper(request:server:)``
...
/// - ``requestBodyPostWildcard(request:)``
...
/// - ``requestBodyPutMultipartFileRef(request:)``
...
public protocol RequestBodiesAPI {
    ...
    func requestBodyGetInferredOptionalRequestWrapper(request: Operations.RequestBodyGetInferredOptionalRequestWrapperRequest, server: RequestBodiesServers.RequestBodyGetInferredOptionalRequestWrapper?) async throws -> Response<Operations.RequestBodyGetInferredOptionalRequestWrapperResponse>
    ...
    func requestBodyPostWildcard(request: Data) async throws -> Response<Operations.RequestBodyPostWildcardResponse>
    ...
    func requestBodyPutMultipartFileRef(request: Operations.RequestBodyPutMultipartFileRefRequestBody) async throws -> Response<Operations.RequestBodyPutMultipartFileRefResponse>
...
/// Describes the available servers that can be used when making 'serversOverrideOperationServerURL' requests.
///
/// Use this type when making calls to ``ServersAPI/serversOverrideOperationServerURL(server:)`` to customize the server which is used.
    public enum ServersOverrideOperationServerURL: Servers, ServerConvertible {
        /// Supported server value with substituted variables
        ///
        /// Corresponds to `{protocol}://{hostname}:{port}/{base_path}`
        case main(basePath: String = "/status/404", hostname: String = "localhost", port: String = "35123", `protocol`: String = "https")
        ...
        static func `default`() throws -> Server {
            return try ServersServers.ServersOverrideOperationServerURL.main().server()
        }

        func server() throws -> Server {
            switch self {
            case .main(let basePath, let hostname, let port, let `protocol`):
                return try type(of: self).server(at: 0, substituting: ["base_path": basePath, "hostname": hostname, "port": port, "protocol": `protocol`])
            }
        }
    }
}
...
/// - ``serversOverrideOperationServerURL(server:)``
///
public protocol ServersAPI {
    ...
    func serversOverrideGlobalServerURL() async throws -> Response<Operations.ServersOverrideGlobalServerURLResponse>

    func serversOverrideOperationServerURL(server: ServersServers.ServersOverrideOperationServerURL?) async throws -> Response<Operations.ServersOverrideOperationServerURLResponse>
}
...
/// Describes the available servers that can be used when making 'paginationAmbiguousInput' requests.
///
/// Use this type when making calls to ``PaginationAPI/paginationAmbiguousInput(request:server:)`` to customize the server which is used.
    public enum PaginationAmbiguousInput: Servers, ServerConvertible {
        /// Supported server value.
        ///
        /// Corresponds to `http://localhost:35456`
        case server1
        ...
        static func `default`() throws -> Server {
            return try PaginationServers.PaginationAmbiguousInput.server1.server()
        }
...
/// Describes the available servers that can be used when making 'paginationBodyFlattenedOptionalSecurity' requests.
///
/// Use this type when making calls to ``PaginationAPI/paginationBodyFlattenedOptionalSecurity(security:limit:offset:server:)`` to customize the server which is used.
    public enum PaginationBodyFlattenedOptionalSecurity: Servers, ServerConvertible {
        /// Supported server value.
        ///
        /// Corresponds to `http://localhost:35456`
        case server1
        ...
        static func `default`() throws -> Server {
            return try PaginationServers.PaginationBodyFlattenedOptionalSecurity.server1.server()
        }
...
/// Describes the available servers that can be used when making 'paginationBodyFlattenedWithSecurity' requests.
///
/// Use this type when making calls to ``PaginationAPI/paginationBodyFlattenedWithSecurity(security:limit:offset:server:)`` to customize the server which is used.
    public enum PaginationBodyFlattenedWithSecurity: Servers, ServerConvertible {
        /// Supported server value.
        ///
        /// Corresponds to `http://localhost:35456`
        case server1
        ...
        static func `default`() throws -> Server {
            return try PaginationServers.PaginationBodyFlattenedWithSecurity.server1.server()
        }
...
/// Describes the available servers that can be used when making 'paginationBodyWrappedRequest' requests.
///
/// Use this type when making calls to ``PaginationAPI/paginationBodyWrappedRequest(request:server:)`` to customize the server which is used.
    public enum PaginationBodyWrappedRequest: Servers, ServerConvertible {
        /// Supported server value.
        ///
        /// Corresponds to `http://localhost:35456`
        case server1
        ...
        static func `default`() throws -> Server {
            return try PaginationServers.PaginationBodyWrappedRequest.server1.server()
        }
...
/// Describes the available servers that can be used when making 'paginationEncapsulatedParameter' requests.
///
/// Use this type when making calls to ``PaginationAPI/paginationEncapsulatedParameter(request:server:)`` to customize the server which is used.
    public enum PaginationEncapsulatedParameter: Servers, ServerConvertible {
        /// Supported server value.
        ///
        /// Corresponds to `http://localhost:35456`
        case server1
        ...
        static func `default`() throws -> Server {
            return try PaginationServers.PaginationEncapsulatedParameter.server1.server()
        }
...
/// Describes the available servers that can be used when making 'paginationLimitOffsetDefaultOffsetBody' requests.
///
/// Use this type when making calls to ``PaginationAPI/paginationLimitOffsetDefaultOffsetBody(request:server:)`` to customize the server which is used.
    public enum PaginationLimitOffsetDefaultOffsetBody: Servers, ServerConvertible {
        /// Supported server value.
        ///
        /// Corresponds to `http://localhost:35456`
        case server1
        ...
        static func `default`() throws -> Server {
            return try PaginationServers.PaginationLimitOffsetDefaultOffsetBody.server1.server()
        }
...
/// Describes the available servers that can be used when making 'paginationLimitOffsetDefaultOffsetParams' requests.
///
/// Use this type when making calls to ``PaginationAPI/paginationLimitOffsetDefaultOffsetParams(request:server:)`` to customize the server which is used.
    public enum PaginationLimitOffsetDefaultOffsetParams: Servers, ServerConvertible {
        /// Supported server value.
        ///
        /// Corresponds to `http://localhost:35456`
        case server1
        ...
        static func `default`() throws -> Server {
            return try PaginationServers.PaginationLimitOffsetDefaultOffsetParams.server1.server()
        }
...
/// Describes the available servers that can be used when making 'paginationLimitOffsetOptionalPageParams' requests.
///
/// Use this type when making calls to ``PaginationAPI/paginationLimitOffsetOptionalPageParams(request:server:)`` to customize the server which is used.
    public enum PaginationLimitOffsetOptionalPageParams: Servers, ServerConvertible {
        /// Supported server value.
        ///
        /// Corresponds to `http://localhost:35456`
        case server1
        ...
        static func `default`() throws -> Server {
            return try PaginationServers.PaginationLimitOffsetOptionalPageParams.server1.server()
        }
...
/// Describes the available servers that can be used when making 'paginationWrappedOptionalBody' requests.
///
/// Use this type when making calls to ``PaginationAPI/paginationWrappedOptionalBody(request:security:server:)`` to customize the server which is used.
    public enum PaginationWrappedOptionalBody: Servers, ServerConvertible {
        /// Supported server value.
        ///
        /// Corresponds to `http://localhost:35456`
        case server1
        ...
        static func `default`() throws -> Server {
            return try PaginationServers.PaginationWrappedOptionalBody.server1.server()
        }
...
/// ### API calls
///
/// - ``paginationAmbiguousInput(request:server:)``
/// - ``paginationBodyFlattenedOptionalSecurity(security:limit:offset:server:)``
/// - ``paginationBodyFlattenedWithSecurity(security:limit:offset:server:)``
/// - ``paginationBodyWrappedRequest(request:server:)``
/// - ``paginationCursorBody(request:server:)``
/// - ``paginationCursorNonNumeric(request:server:)``
/// - ``paginationCursorParams(request:server:)``
/// - ``paginationEncapsulatedParameter(request:server:)``
/// - ``paginationLimitOffsetDeepOutputsPageBody(request:server:)``
/// - ``paginationLimitOffsetDefaultOffsetBody(request:server:)``
/// - ``paginationLimitOffsetDefaultOffsetParams(request:server:)``
/// - ``paginationLimitOffsetOffsetBody(request:server:)``
/// - ``paginationLimitOffsetOffsetParams(request:server:)``
/// - ``paginationLimitOffsetOptionalPageParams(request:server:)``
...
/// - ``paginationWrappedOptionalBody(request:security:server:)``
///
public protocol PaginationAPI {
    ...
    /// 
    /// 
    /// - Parameter request: A ``Operations/PaginationAmbiguousInputRequest`` object describing the input to the API operation
    /// - Parameter server: An optional server override to use for this operation
    /// - Returns: A ``Operations/PaginationAmbiguousInputResponse`` object describing the result of the API operation
    /// - Throws: An error of type ``OpenAPIError``
    func paginationAmbiguousInput(request: Operations.PaginationAmbiguousInputRequest, server: PaginationServers.PaginationAmbiguousInput?) async throws -> Response<Operations.PaginationAmbiguousInputResponse>

    func paginationBodyFlattenedOptionalSecurity(security: Operations.PaginationBodyFlattenedOptionalSecuritySecurity, limit: Int, offset: Int, server: PaginationServers.PaginationBodyFlattenedOptionalSecurity?) async throws -> Response<Operations.PaginationBodyFlattenedOptionalSecurityResponse>

    func paginationBodyFlattenedWithSecurity(security: Operations.PaginationBodyFlattenedWithSecuritySecurity, limit: Int, offset: Int, server: PaginationServers.PaginationBodyFlattenedWithSecurity?) async throws -> Response<Operations.PaginationBodyFlattenedWithSecurityResponse>
    ...
    /// 
    /// 
    /// - Parameter request: A ``Operations/PaginationBodyWrappedRequestRequest`` object describing the input to the API operation
    /// - Parameter server: An optional server override to use for this operation
    /// - Returns: A ``Operations/PaginationBodyWrappedRequestResponse`` object describing the result of the API operation
    /// - Throws: An error of type ``OpenAPIError``
    func paginationBodyWrappedRequest(request: Operations.PaginationBodyWrappedRequestRequest, server: PaginationServers.PaginationBodyWrappedRequest?) async throws -> Response<Operations.PaginationBodyWrappedRequestResponse>
    ...
    /// 
    /// 
    /// - Parameter request: A ``Operations/PaginationEncapsulatedParameterRequest`` object describing the input to the API operation
    /// - Parameter server: An optional server override to use for this operation
    /// - Returns: A ``Operations/PaginationEncapsulatedParameterResponse`` object describing the result of the API operation
    /// - Throws: An error of type ``OpenAPIError``
    func paginationEncapsulatedParameter(request: Operations.PaginationEncapsulatedParameterRequest, server: PaginationServers.PaginationEncapsulatedParameter?) async throws -> Response<Operations.PaginationEncapsulatedParameterResponse>
    ...
    func paginationLimitOffsetDefaultOffsetBody(request: Shared.LimitOffsetConfigWithDefaults, server: PaginationServers.PaginationLimitOffsetDefaultOffsetBody?) async throws -> Response<Operations.PaginationLimitOffsetDefaultOffsetBodyResponse>

    func paginationLimitOffsetDefaultOffsetParams(request: Operations.PaginationLimitOffsetDefaultOffsetParamsRequest, server: PaginationServers.PaginationLimitOffsetDefaultOffsetParams?) async throws -> Response<Operations.PaginationLimitOffsetDefaultOffsetParamsResponse>
    ...
    func paginationLimitOffsetOptionalPageParams(request: Operations.PaginationLimitOffsetOptionalPageParamsRequest, server: PaginationServers.PaginationLimitOffsetOptionalPageParams?) async throws -> Response<Operations.PaginationLimitOffsetOptionalPageParamsResponse>
    ...
    func paginationWrappedOptionalBody(request: Operations.PaginationWrappedOptionalBodyRequest, security: Operations.PaginationWrappedOptionalBodySecurity, server: PaginationServers.PaginationWrappedOptionalBody?) async throws -> Response<Operations.PaginationWrappedOptionalBodyResponse>
}

// MARK: - HealthAPI
public enum HealthServers {

/// Describes the available servers that can be used when making 'check' requests.
///
/// Use this type when making calls to ``HealthAPI/check(server:)`` to customize the server which is used.
    public enum Check: Servers, ServerConvertible {
        /// Supported server value.
        ///
        /// Corresponds to `http://localhost:35456`
        case server1
        ...
        static func `default`() throws -> Server {
            return try HealthServers.Check.server1.server()
        }
...
public protocol HealthAPI {
    func check(server: HealthServers.Check?) async throws -> Response<Operations.CheckResponse>
}
...
/// - ``statusCodeDefault()``
///
public protocol StatusCodeAPI {
    func statusCode2XX() async throws -> Response<Operations.StatusCode2XXResponse>

    func statusCode4XX() async throws -> Response<Operations.StatusCode4XXResponse>

    func statusCode5XX() async throws -> Response<Operations.StatusCode5XXResponse>

    func statusCodeDefault() async throws -> Response<Operations.StatusCodeDefaultResponse>
}
