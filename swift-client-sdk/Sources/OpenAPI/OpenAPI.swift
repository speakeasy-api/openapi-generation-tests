...
/// Describes the available servers that can be used when making 'unionErrorsDiscriminatedGet' requests.
///
/// Use this type when making calls to ``ErrorsAPI/unionErrorsDiscriminatedGet(request:server:)`` to customize the server which is used.
    public enum UnionErrorsDiscriminatedGet: Servers, ServerConvertible {
        /// Supported server value.
        ///
        /// Corresponds to `http://localhost:35456`
        case server1
        ...
        static func `default`() throws -> Server {
            return try ErrorsServers.UnionErrorsDiscriminatedGet.server1.server()
        }
...
/// - ``unionErrorsDiscriminatedGet(request:server:)``
...
public protocol ErrorsAPI {
    ...
    func unionErrorsDiscriminatedGet(request: Operations.UnionErrorsDiscriminatedGetRequest, server: ErrorsServers.UnionErrorsDiscriminatedGet?) async throws -> Response<Operations.UnionErrorsDiscriminatedGetResponse>
