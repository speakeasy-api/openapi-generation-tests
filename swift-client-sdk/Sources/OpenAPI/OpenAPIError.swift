...
///
/// ``OpenAPIError`` describes problems which occur through the lifecycle of making a request to the API, from constructing the underlying network request, through making the network request and handling the resulting response.
///
/// Most of the error values have associated failure reasons:
/// - ``OpenAPIError/failedToConstructRequestURL(_:)``
/// - ``OpenAPIError/failedToSerializeRequestParameters(_:)``
/// - ``OpenAPIError/failedToConstructRequest(_:)``
/// - ``OpenAPIError/failedToHandleResponse(_:)``
///
/// which provide more information about why the error occurred.
///
/// If a network error occurs when making an API request, ``OpenAPIError/failedToMakeNetworkRequest(error:)`` has an associated [`Error`](https://developer.apple.com/documentation/swift/error) value which describes more information about why the network error occurred.
///
/// In exceptional circumstances there may be an internal error which occurs in the implementation of ``OpenAPI`` or in the underlying system frameworks. Where this occurs, ``OpenAPIError/internalError(error:)`` provides this information, with additional context if it is available.
///
/// ### Getting an error description
///
/// ``OpenAPIError`` conforms to the [`LocalizedError`](https://developer.apple.com/documentation/foundation/localizederror) protocol. As such a readable description of the error is provided through the [`errorDescription`](https://developer.apple.com/documentation/foundation/localizederror/2946895-errordescription) property.
///
/// ## Topics
///
/// ### Errors
...
/// - ``OpenAPIError/failedToSerializeRequestParameters(_:)``
/// - ``OpenAPIError/failedToConstructRequest(_:)``
/// - ``OpenAPIError/failedToMakeNetworkRequest(error:)``
/// - ``OpenAPIError/failedToHandleResponse(_:)``
/// - ``OpenAPIError/internalError(error:)``
///
/// ### Error failure information
/// - ``OpenAPIError/RequestURLConstructionFailureReason``
/// - ``OpenAPIError/ParameterSerializationFailureReason``
/// - ``OpenAPIError/RequestConstructionFailureReason``
/// - ``OpenAPIError/ResponseHandlingFailureReason``
///
/// ### Convenience properties
/// - ``OpenAPIError/underlyingError``
public enum OpenAPIError: Swift.Error {
    /// Failure reasons for ``OpenAPIError/failedToConstructRequestURL(_:)`` errors
    ...
    /// Failure reasons for ``OpenAPIError/failedToSerializeRequestParameters(_:)`` errors
    ...
    /// Failure reasons for ``OpenAPIError/failedToConstructRequest(_:)`` errors
    ...
    /// Failure reasons for ``OpenAPIError/failedToHandleResponse(_:)`` errors
...
extension OpenAPIError: LocalizedError {
...
extension OpenAPIError.RequestURLConstructionFailureReason {
...
extension OpenAPIError.ParameterSerializationFailureReason {
    public var localizedDescription: String {
        switch self {
...
extension OpenAPIError.RequestConstructionFailureReason {
    public var localizedDescription: String {
        switch self {
        case .missingRequiredRequestBody:
...
extension OpenAPIError.ResponseHandlingFailureReason {
    public var localizedDescription: String {
        switch self {
        case .failedToDecodeResponse:
