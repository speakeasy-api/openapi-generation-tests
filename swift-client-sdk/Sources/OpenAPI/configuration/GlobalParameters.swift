...
public struct GlobalParameters {
    ...
    ///
    /// - Parameter globalOptionalHiddenPathParam: An optional and hidden global path parameter. Some paths and operations
    ...
    /// 
    /// - Parameter globalOptionalPathParam: An optional global path parameter. Some paths and operations will
    ...
    public init(
        ...
        globalOptionalHiddenPathParam: String? = nil,
        globalOptionalPathParam: String? = nil,
...
extension GlobalParameters: ParameterDefaults {
    public func defaultSerializedPathParameter(for key: String) throws -> String? {
        ...
        case "globalOptionalHiddenPathParam": return try globalOptionalHiddenPathParam?.serialize(with: .path(explode: false))
        case "globalOptionalPathParam": return try globalOptionalPathParam?.serialize(with: .path(explode: false))
