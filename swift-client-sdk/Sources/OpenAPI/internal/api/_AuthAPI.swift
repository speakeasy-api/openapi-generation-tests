...
class _AuthAPI: AuthAPI {
    ...
    public func oauth2Override(request: Operations.Oauth2OverrideRequest) async throws -> Response<Operations.Oauth2OverrideResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureOauth2OverrideRequest(with: configuration, request: request)
            },
...
private func configureOauth2OverrideRequest(with configuration: URLRequestConfiguration, request: Operations.Oauth2OverrideRequest) throws {
