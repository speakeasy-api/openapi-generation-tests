...
class _GenerationAPI: GenerationAPI {
    ...
    public func circularReferenceOneDegree(request: Shared.FigmaComponentNode) async throws -> Response<Operations.CircularReferenceOneDegreeResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureCircularReferenceOneDegreeRequest(with: configuration, request: request)
            },
            handleResponse: handleCircularReferenceOneDegreeResponse
        )
    }
    ...
    public func deprecatedOperationWithMultilineCommentGet(request: Operations.DeprecatedOperationWithMultilineCommentGetRequest) async throws -> Response<Operations.DeprecatedOperationWithMultilineCommentGetResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureDeprecatedOperationWithMultilineCommentGetRequest(with: configuration, request: request)
            },
            handleResponse: handleDeprecatedOperationWithMultilineCommentGetResponse
        )
    }
    ...
    public func reactHookCombinedOptions(request: Operations.ReactHookCombinedOptionsRequest) async throws -> Response<Operations.ReactHookCombinedOptionsResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureReactHookCombinedOptionsRequest(with: configuration, request: request)
            },
            handleResponse: handleReactHookCombinedOptionsResponse
        )
    }
    
    public func reactHookDisabled() async throws -> Response<Operations.ReactHookDisabledResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureReactHookDisabledRequest(with: configuration)
            },
            handleResponse: handleReactHookDisabledResponse
        )
    }
    
    public func reactHookGetAsMutation() async throws -> Response<Operations.ReactHookGetAsMutationResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureReactHookGetAsMutationRequest(with: configuration)
            },
            handleResponse: handleReactHookGetAsMutationResponse
        )
    }
    
    public func reactHookPostAsQuery() async throws -> Response<Operations.ReactHookPostAsQueryResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureReactHookPostAsQueryRequest(with: configuration)
            },
            handleResponse: handleReactHookPostAsQueryResponse
        )
    }
    
    public func reactHookRenamed() async throws -> Response<Operations.ReactHookRenamedResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureReactHookRenamedRequest(with: configuration)
            },
            handleResponse: handleReactHookRenamedResponse
        )
    }
...
private func configureCircularReferenceOneDegreeRequest(with configuration: URLRequestConfiguration, request: Shared.FigmaComponentNode) throws {
    configuration.path = "/anything/circularReferenceOneDegree"
...
private func configureDeprecatedOperationWithMultilineCommentGetRequest(with configuration: URLRequestConfiguration, request: Operations.DeprecatedOperationWithMultilineCommentGetRequest) throws {
    configuration.path = "/anything/deprecatedOperationWithMultilineComment"
    configuration.method = .get
    configuration.queryParameterSerializable = request
    configuration.telemetryHeader = .speakeasyUserAgent
}
...
private func configureReactHookCombinedOptionsRequest(with configuration: URLRequestConfiguration, request: Operations.ReactHookCombinedOptionsRequest) throws {
    configuration.path = "/anything/reactHookCombinedOptions"
    configuration.method = .post
    configuration.queryParameterSerializable = request
    configuration.telemetryHeader = .speakeasyUserAgent
}

private func configureReactHookDisabledRequest(with configuration: URLRequestConfiguration) throws {
    configuration.path = "/anything/reactHookDisabled"
    configuration.method = .post
    configuration.telemetryHeader = .speakeasyUserAgent
}

private func configureReactHookGetAsMutationRequest(with configuration: URLRequestConfiguration) throws {
    configuration.path = "/anything/reactHookGetAsMutation"
    configuration.method = .get
    configuration.telemetryHeader = .speakeasyUserAgent
}

private func configureReactHookPostAsQueryRequest(with configuration: URLRequestConfiguration) throws {
    configuration.path = "/anything/reactHookPostAsQuery"
    configuration.method = .get
    configuration.telemetryHeader = .speakeasyUserAgent
}

private func configureReactHookRenamedRequest(with configuration: URLRequestConfiguration) throws {
    configuration.path = "/anything/reactHookRenamed"
    configuration.method = .post
    configuration.telemetryHeader = .speakeasyUserAgent
}
...
private func handleCircularReferenceOneDegreeResponse(response: Client.APIResponse) throws -> Operations.CircularReferenceOneDegreeResponse {
    let httpResponse = response.httpResponse
    
    if httpResponse.statusCode == 200 { 
        if httpResponse.contentType.matchContentType(pattern: "application/json"), let data = response.data {
            do {
                return .object(try JSONDecoder().decode(Operations.CircularReferenceOneDegreeResponseBody.self, from: data))
            } catch {
                throw ResponseHandlerError.failedToDecodeJSON(error)
            }
        }
...
private func handleDeprecatedOperationWithMultilineCommentGetResponse(response: Client.APIResponse) throws -> Operations.DeprecatedOperationWithMultilineCommentGetResponse {
    let httpResponse = response.httpResponse
...
private func handleReactHookCombinedOptionsResponse(response: Client.APIResponse) throws -> Operations.ReactHookCombinedOptionsResponse {
    let httpResponse = response.httpResponse
    
    if httpResponse.statusCode == 200 { 
        if httpResponse.contentType.matchContentType(pattern: "application/json"), let data = response.data {
            do {
                return .object(try JSONDecoder().decode([String: AnyValue].self, from: data))
            } catch {
                throw ResponseHandlerError.failedToDecodeJSON(error)
            }
        }
...
private func handleReactHookDisabledResponse(response: Client.APIResponse) throws -> Operations.ReactHookDisabledResponse {
    let httpResponse = response.httpResponse
...
private func handleReactHookGetAsMutationResponse(response: Client.APIResponse) throws -> Operations.ReactHookGetAsMutationResponse {
    let httpResponse = response.httpResponse
...
private func handleReactHookPostAsQueryResponse(response: Client.APIResponse) throws -> Operations.ReactHookPostAsQueryResponse {
    let httpResponse = response.httpResponse
...
private func handleReactHookRenamedResponse(response: Client.APIResponse) throws -> Operations.ReactHookRenamedResponse {
    let httpResponse = response.httpResponse
