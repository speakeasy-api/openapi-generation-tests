...
class _HooksAPI: HooksAPI {
    ...
    public func authorizationHeaderModification(security: Operations.AuthorizationHeaderModificationSecurity) async throws -> Response<Operations.AuthorizationHeaderModificationResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureAuthorizationHeaderModificationRequest(with: configuration, security: security)
            },
...
private func configureAuthorizationHeaderModificationRequest(with configuration: URLRequestConfiguration, security: Operations.AuthorizationHeaderModificationSecurity) throws {
