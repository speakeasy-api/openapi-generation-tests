...
class _PaginationAPI: PaginationAPI {
    ...
    public func paginationEncapsulatedParameter(request: Operations.PaginationEncapsulatedParameterRequest, server: PaginationServers.PaginationEncapsulatedParameter?) async throws -> Response<Operations.PaginationEncapsulatedParameterResponse> {
        return try await client.makeRequest(
            with: try server?.server() ?? PaginationServers.PaginationEncapsulatedParameter.default(),
            configureRequest: { configuration in
                try configurePaginationEncapsulatedParameterRequest(with: configuration, request: request)
            },
            handleResponse: handlePaginationEncapsulatedParameterResponse
        )
    }
    ...
    public func paginationLimitOffsetDefaultOffsetBody(request: Shared.LimitOffsetConfigWithDefaults, server: PaginationServers.PaginationLimitOffsetDefaultOffsetBody?) async throws -> Response<Operations.PaginationLimitOffsetDefaultOffsetBodyResponse> {
        return try await client.makeRequest(
            with: try server?.server() ?? PaginationServers.PaginationLimitOffsetDefaultOffsetBody.default(),
            configureRequest: { configuration in
                try configurePaginationLimitOffsetDefaultOffsetBodyRequest(with: configuration, request: request)
            },
            handleResponse: handlePaginationLimitOffsetDefaultOffsetBodyResponse
        )
    }
    
    public func paginationLimitOffsetDefaultOffsetParams(request: Operations.PaginationLimitOffsetDefaultOffsetParamsRequest, server: PaginationServers.PaginationLimitOffsetDefaultOffsetParams?) async throws -> Response<Operations.PaginationLimitOffsetDefaultOffsetParamsResponse> {
        return try await client.makeRequest(
            with: try server?.server() ?? PaginationServers.PaginationLimitOffsetDefaultOffsetParams.default(),
            configureRequest: { configuration in
                try configurePaginationLimitOffsetDefaultOffsetParamsRequest(with: configuration, request: request)
            },
            handleResponse: handlePaginationLimitOffsetDefaultOffsetParamsResponse
        )
    }
    ...
    public func paginationLimitOffsetOptionalPageParams(request: Operations.PaginationLimitOffsetOptionalPageParamsRequest, server: PaginationServers.PaginationLimitOffsetOptionalPageParams?) async throws -> Response<Operations.PaginationLimitOffsetOptionalPageParamsResponse> {
        return try await client.makeRequest(
            with: try server?.server() ?? PaginationServers.PaginationLimitOffsetOptionalPageParams.default(),
            configureRequest: { configuration in
                try configurePaginationLimitOffsetOptionalPageParamsRequest(with: configuration, request: request)
            },
            handleResponse: handlePaginationLimitOffsetOptionalPageParamsResponse
        )
    }
...
private func configurePaginationEncapsulatedParameterRequest(with configuration: URLRequestConfiguration, request: Operations.PaginationEncapsulatedParameterRequest) throws {
    configuration.path = "/pagination/cursor#encapsulatedParameter"
    configuration.method = .put
    configuration.queryParameterSerializable = request
    configuration.headerParameterSerializable = request
    configuration.telemetryHeader = .speakeasyUserAgent
...
private func configurePaginationLimitOffsetDefaultOffsetBodyRequest(with configuration: URLRequestConfiguration, request: Shared.LimitOffsetConfigWithDefaults) throws {
    configuration.path = "/pagination/limitoffset/offset#WithDefaults"
    configuration.method = .put
    configuration.contentType = "application/json"
    configuration.body = try jsonEncoder().encode(request)
    if configuration.body == nil {
...
private func configurePaginationLimitOffsetDefaultOffsetParamsRequest(with configuration: URLRequestConfiguration, request: Operations.PaginationLimitOffsetDefaultOffsetParamsRequest) throws {
    configuration.path = "/pagination/limitoffset/offset#WithDefaults"
    configuration.method = .get
    configuration.queryParameterSerializable = request
    configuration.telemetryHeader = .speakeasyUserAgent
...
private func configurePaginationLimitOffsetOptionalPageParamsRequest(with configuration: URLRequestConfiguration, request: Operations.PaginationLimitOffsetOptionalPageParamsRequest) throws {
    configuration.path = "/pagination/limitoffset/page#optionalPageParams"
    configuration.method = .get
    configuration.queryParameterSerializable = request
    configuration.telemetryHeader = .speakeasyUserAgent
}
...
private func handlePaginationEncapsulatedParameterResponse(response: Client.APIResponse) throws -> Operations.PaginationEncapsulatedParameterResponse {
    let httpResponse = response.httpResponse
    
    if httpResponse.statusCode == 200 { 
        if httpResponse.contentType.matchContentType(pattern: "application/json"), let data = response.data {
            do {
                return .res(try JSONDecoder().decode(Operations.PaginationEncapsulatedParameterRes.self, from: data))
            } catch {
                throw ResponseHandlerError.failedToDecodeJSON(error)
            }
        }
...
private func handlePaginationLimitOffsetDefaultOffsetBodyResponse(response: Client.APIResponse) throws -> Operations.PaginationLimitOffsetDefaultOffsetBodyResponse {
    let httpResponse = response.httpResponse
    
    if httpResponse.statusCode == 200 { 
        if httpResponse.contentType.matchContentType(pattern: "application/json"), let data = response.data {
            do {
                return .res(try JSONDecoder().decode(Operations.PaginationLimitOffsetDefaultOffsetBodyRes.self, from: data))
            } catch {
                throw ResponseHandlerError.failedToDecodeJSON(error)
            }
        }
...
private func handlePaginationLimitOffsetDefaultOffsetParamsResponse(response: Client.APIResponse) throws -> Operations.PaginationLimitOffsetDefaultOffsetParamsResponse {
    let httpResponse = response.httpResponse
    
    if httpResponse.statusCode == 200 { 
        if httpResponse.contentType.matchContentType(pattern: "application/json"), let data = response.data {
            do {
                return .res(try JSONDecoder().decode(Operations.PaginationLimitOffsetDefaultOffsetParamsRes.self, from: data))
            } catch {
                throw ResponseHandlerError.failedToDecodeJSON(error)
            }
        }
...
private func handlePaginationLimitOffsetOptionalPageParamsResponse(response: Client.APIResponse) throws -> Operations.PaginationLimitOffsetOptionalPageParamsResponse {
    let httpResponse = response.httpResponse
    
    if httpResponse.statusCode == 200 { 
        if httpResponse.contentType.matchContentType(pattern: "application/json"), let data = response.data {
            do {
                return .res(try JSONDecoder().decode(Operations.PaginationLimitOffsetOptionalPageParamsRes.self, from: data))
            } catch {
                throw ResponseHandlerError.failedToDecodeJSON(error)
            }
        }
