...
class _RequestBodiesAPI: RequestBodiesAPI {
    ...
    public func nullEnumPost(request: Shared.ObjectWithNullEnums) async throws -> Response<Operations.NullEnumPostResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureNullEnumPostRequest(with: configuration, request: request)
            },
            handleResponse: handleNullEnumPostResponse
        )
    }
    ...
    public func nullableOptionalFieldsPost(request: Operations.NullableOptionalFieldsPostRequestBody) async throws -> Response<Operations.NullableOptionalFieldsPostResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureNullableOptionalFieldsPostRequest(with: configuration, request: request)
            },
            handleResponse: handleNullableOptionalFieldsPostResponse
        )
    }
    ...
    public func requestBodyDeprecatedRequestBodyRefPost(request: Shared.DeprecatedObjectWithExample) async throws -> Response<Operations.RequestBodyDeprecatedRequestBodyRefPostResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureRequestBodyDeprecatedRequestBodyRefPostRequest(with: configuration, request: request)
            },
            handleResponse: handleRequestBodyDeprecatedRequestBodyRefPostResponse
        )
    }
    
    public func requestBodyGetInferredOptionalRequestWrapper(request: Operations.RequestBodyGetInferredOptionalRequestWrapperRequest, server: RequestBodiesServers.RequestBodyGetInferredOptionalRequestWrapper?) async throws -> Response<Operations.RequestBodyGetInferredOptionalRequestWrapperResponse> {
        return try await client.makeRequest(
            with: try server?.server() ?? RequestBodiesServers.RequestBodyGetInferredOptionalRequestWrapper.default(),
            configureRequest: { configuration in
                try configureRequestBodyGetInferredOptionalRequestWrapperRequest(with: configuration, request: request)
            },
            handleResponse: handleRequestBodyGetInferredOptionalRequestWrapperResponse
        )
    }
    ...
    public func requestBodyPostApplicationJsonArrayOfUnions(request: Operations.RequestBodyPostApplicationJsonArrayOfUnionsRequestBody, server: RequestBodiesServers.RequestBodyPostApplicationJsonArrayOfUnions?) async throws -> Response<Operations.RequestBodyPostApplicationJsonArrayOfUnionsResponse> {
        return try await client.makeRequest(
            with: try server?.server() ?? RequestBodiesServers.RequestBodyPostApplicationJsonArrayOfUnions.default(),
            configureRequest: { configuration in
                try configureRequestBodyPostApplicationJsonArrayOfUnionsRequest(with: configuration, request: request)
            },
            handleResponse: handleRequestBodyPostApplicationJsonArrayOfUnionsResponse
        )
    }
    ...
    public func requestBodyPostEmptyBodyRetainedWithAllOptionalFields(request: Operations.RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsRequestBody) async throws -> Response<Operations.RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureRequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsRequest(with: configuration, request: request)
            },
            handleResponse: handleRequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponse
        )
    }
    ...
    public func requestBodyPostMultipleContentTypesComponentFilteredDefaultTest(request: Shared.SimpleObject) async throws -> Response<Operations.RequestBodyPostMultipleContentTypesComponentFilteredDefaultTestResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureRequestBodyPostMultipleContentTypesComponentFilteredDefaultTestRequest(with: configuration, request: request)
            },
            handleResponse: handleRequestBodyPostMultipleContentTypesComponentFilteredDefaultTestResponse
        )
    }
    ...
    public func requestBodyPostWildcard(request: Data) async throws -> Response<Operations.RequestBodyPostWildcardResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureRequestBodyPostWildcardRequest(with: configuration, request: request)
            },
            handleResponse: handleRequestBodyPostWildcardResponse
        )
    }
    ...
    public func requestBodyPutMultipartFileRef(request: Operations.RequestBodyPutMultipartFileRefRequestBody) async throws -> Response<Operations.RequestBodyPutMultipartFileRefResponse> {
        return try await client.makeRequest(
            configureRequest: { configuration in
                try configureRequestBodyPutMultipartFileRefRequest(with: configuration, request: request)
            },
            handleResponse: handleRequestBodyPutMultipartFileRefResponse
        )
    }
...
private func configureNullEnumPostRequest(with configuration: URLRequestConfiguration, request: Shared.ObjectWithNullEnums) throws {
    configuration.path = "/anything/requestBodies/post/nullEnum"
...
private func configureNullableOptionalFieldsPostRequest(with configuration: URLRequestConfiguration, request: Operations.NullableOptionalFieldsPostRequestBody) throws {
    configuration.path = "/anything/requestBodies/post/nullableOptionalFields"
    configuration.method = .post
    configuration.contentType = "application/json"
    configuration.body = try jsonEncoder().encode(request)
    if configuration.body == nil {
...
private func configureRequestBodyDeprecatedRequestBodyRefPostRequest(with configuration: URLRequestConfiguration, request: Shared.DeprecatedObjectWithExample) throws {
    configuration.path = "/anything/requestBodies/deprecatedRequestBodyRef"
    configuration.method = .post
    configuration.contentType = "application/json"
    configuration.body = try jsonEncoder().encode(request)
    if configuration.body == nil {
...
private func configureRequestBodyGetInferredOptionalRequestWrapperRequest(with configuration: URLRequestConfiguration, request: Operations.RequestBodyGetInferredOptionalRequestWrapperRequest) throws {
    configuration.path = "/anything/inferredOptionalRequestWrapper"
...
private func configureRequestBodyPostApplicationJsonArrayOfUnionsRequest(with configuration: URLRequestConfiguration, request: Operations.RequestBodyPostApplicationJsonArrayOfUnionsRequestBody) throws {
    configuration.path = "/requestbody#arrayOfUnions"
    configuration.method = .post
    configuration.contentType = "application/json"
    configuration.body = try jsonEncoder().encode(request)
    if configuration.body == nil {
...
private func configureRequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsRequest(with configuration: URLRequestConfiguration, request: Operations.RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsRequestBody) throws {
    configuration.path = "/anything/requestBodies/post/empty-body-retained-with-all-optional-fields"
    configuration.method = .post
    configuration.contentType = "application/json"
    configuration.body = try jsonEncoder().encode(request)
    configuration.telemetryHeader = .speakeasyUserAgent
...
private func configureRequestBodyPostMultipleContentTypesComponentFilteredDefaultTestRequest(with configuration: URLRequestConfiguration, request: Shared.SimpleObject) throws {
    configuration.path = "/anything/requestBodies/post/multiple/contentTypes/component/filtered#defaultTest"
    configuration.method = .post
    configuration.contentType = "application/json"
    configuration.body = try jsonEncoder().encode(request)
    if configuration.body == nil {
...
private func configureRequestBodyPostWildcardRequest(with configuration: URLRequestConfiguration, request: Data) throws {
    configuration.path = "/anything/requestBodies/post/wildcard"
    configuration.method = .post
...
private func configureRequestBodyPutMultipartFileRefRequest(with configuration: URLRequestConfiguration, request: Operations.RequestBodyPutMultipartFileRefRequestBody) throws {
    configuration.path = "/anything/requestBodies/put/multipart/fileRef"
    configuration.method = .put
    let (boundary, formData) = try serializeMultipartFormData(with: request)
    configuration.contentType = multipartContentType(with: boundary)
    configuration.body = formData
...
private func handleNullEnumPostResponse(response: Client.APIResponse) throws -> Operations.NullEnumPostResponse {
    let httpResponse = response.httpResponse
    
    if httpResponse.statusCode == 200 { 
        if httpResponse.contentType.matchContentType(pattern: "application/json"), let data = response.data {
            do {
                return .res(try JSONDecoder().decode(Operations.NullEnumPostRes.self, from: data))
            } catch {
...
private func handleNullableOptionalFieldsPostResponse(response: Client.APIResponse) throws -> Operations.NullableOptionalFieldsPostResponse {
    let httpResponse = response.httpResponse
    
    if httpResponse.statusCode == 200 { 
        if httpResponse.contentType.matchContentType(pattern: "application/json"), let data = response.data {
            do {
                return .object(try JSONDecoder().decode(Operations.NullableOptionalFieldsPostResponseBody.self, from: data))
            } catch {
                throw ResponseHandlerError.failedToDecodeJSON(error)
            }
        }
...
private func handleRequestBodyDeprecatedRequestBodyRefPostResponse(response: Client.APIResponse) throws -> Operations.RequestBodyDeprecatedRequestBodyRefPostResponse {
    let httpResponse = response.httpResponse
    
    if httpResponse.statusCode == 200 { 
        if httpResponse.contentType.matchContentType(pattern: "application/json"), let data = response.data {
            do {
                return .object(try JSONDecoder().decode(Operations.RequestBodyDeprecatedRequestBodyRefPostResponseBody.self, from: data))
            } catch {
                throw ResponseHandlerError.failedToDecodeJSON(error)
            }
        }
...
private func handleRequestBodyGetInferredOptionalRequestWrapperResponse(response: Client.APIResponse) throws -> Operations.RequestBodyGetInferredOptionalRequestWrapperResponse {
    let httpResponse = response.httpResponse
    
    if httpResponse.statusCode == 200 { 
        if httpResponse.contentType.matchContentType(pattern: "application/json"), let data = response.data {
            do {
                return .object(try JSONDecoder().decode(Operations.RequestBodyGetInferredOptionalRequestWrapperResponseBody.self, from: data))
            } catch {
                throw ResponseHandlerError.failedToDecodeJSON(error)
            }
        }
...
private func handleRequestBodyPostApplicationJsonArrayOfUnionsResponse(response: Client.APIResponse) throws -> Operations.RequestBodyPostApplicationJsonArrayOfUnionsResponse {
    let httpResponse = response.httpResponse
...
private func handleRequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponse(response: Client.APIResponse) throws -> Operations.RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponse {
    let httpResponse = response.httpResponse
    
    if httpResponse.statusCode == 200 { 
        if httpResponse.contentType.matchContentType(pattern: "application/json"), let data = response.data {
            do {
                return .object(try JSONDecoder().decode(Operations.RequestBodyPostEmptyBodyRetainedWithAllOptionalFieldsResponseBody.self, from: data))
            } catch {
                throw ResponseHandlerError.failedToDecodeJSON(error)
            }
        }
...
private func handleRequestBodyPostMultipleContentTypesComponentFilteredDefaultTestResponse(response: Client.APIResponse) throws -> Operations.RequestBodyPostMultipleContentTypesComponentFilteredDefaultTestResponse {
    let httpResponse = response.httpResponse
    
    if httpResponse.statusCode == 200 { 
        if httpResponse.contentType.matchContentType(pattern: "application/json"), let data = response.data {
            do {
                return .res(try JSONDecoder().decode(Operations.RequestBodyPostMultipleContentTypesComponentFilteredDefaultTestRes.self, from: data))
            } catch {
                throw ResponseHandlerError.failedToDecodeJSON(error)
            }
        }
...
private func handleRequestBodyPostWildcardResponse(response: Client.APIResponse) throws -> Operations.RequestBodyPostWildcardResponse {
    let httpResponse = response.httpResponse
    
    if httpResponse.statusCode == 200 { 
        if httpResponse.contentType.matchContentType(pattern: "application/json"), let data = response.data {
            do {
                return .res(try JSONDecoder().decode(Operations.RequestBodyPostWildcardRes.self, from: data))
            } catch {
                throw ResponseHandlerError.failedToDecodeJSON(error)
            }
        }
...
private func handleRequestBodyPutMultipartFileRefResponse(response: Client.APIResponse) throws -> Operations.RequestBodyPutMultipartFileRefResponse {
    let httpResponse = response.httpResponse
    
    if httpResponse.statusCode == 200 { 
        if httpResponse.contentType.matchContentType(pattern: "application/json"), let data = response.data {
            do {
                return .res(try JSONDecoder().decode(Operations.RequestBodyPutMultipartFileRefRes.self, from: data))
            } catch {
                throw ResponseHandlerError.failedToDecodeJSON(error)
            }
        }
