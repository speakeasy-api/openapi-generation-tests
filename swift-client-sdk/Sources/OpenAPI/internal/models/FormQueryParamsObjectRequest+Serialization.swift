...
extension Operations.FormQueryParamsObjectRequest: Serializable {
    func serialize(with format: SerializableFormat) throws -> String {
        switch format {
        case .query:
            return try serializeQueryParameterSerializable(self, with: format)
        case .path, .header, .multipart, .form:
            throw SerializationError.invalidSerializationParameter(type: "Operations.FormQueryParamsObjectRequest", format: format.formatDescription)
        }
    }
...
extension Operations.FormQueryParamsObjectRequest: QueryParameterSerializable {
