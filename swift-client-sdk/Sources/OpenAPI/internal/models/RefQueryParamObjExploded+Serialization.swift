...
extension Shared.RefQueryParamObjExploded: Serializable {
    func serialize(with format: SerializableFormat) throws -> String {
        switch format {
        case .query:
            return try serializeQueryParameterSerializable(self, with: format)
        case .path, .header, .multipart, .form:
            throw SerializationError.invalidSerializationParameter(type: "Shared.RefQueryParamObjExploded", format: format.formatDescription)
        }
    }
...
extension Shared.RefQueryParamObjExploded: QueryParameterSerializable {
