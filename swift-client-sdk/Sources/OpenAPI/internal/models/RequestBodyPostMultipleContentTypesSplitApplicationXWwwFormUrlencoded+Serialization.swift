...
extension Operations.RequestBodyPostMultipleContentTypesSplitApplicationXWwwFormUrlencoded: Serializable {
    func serialize(with format: SerializableFormat) throws -> String {
        ...
        case .path, .query, .header, .multipart:
            throw SerializationError.invalidSerializationParameter(type: "Operations.RequestBodyPostMultipleContentTypesSplitApplicationXWwwFormUrlencoded", format: format.formatDescription)
        }
    }
}

extension Operations.RequestBodyPostMultipleContentTypesSplitApplicationXWwwFormUrlencoded: FormBodySerializable {
