...
extension Operations.RequestBodyPostMultipleContentTypesSplitParamApplicationXWwwFormUrlencoded: Serializable {
    func serialize(with format: SerializableFormat) throws -> String {
        ...
        case .path, .query, .header, .multipart:
            throw SerializationError.invalidSerializationParameter(type: "Operations.RequestBodyPostMultipleContentTypesSplitParamApplicationXWwwFormUrlencoded", format: format.formatDescription)
        }
    }
}

extension Operations.RequestBodyPostMultipleContentTypesSplitParamApplicationXWwwFormUrlencoded: FormBodySerializable {
