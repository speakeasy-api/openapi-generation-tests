...
extension Operations.ResponseBodyEmptyWithHeadersRequest: Serializable {
    func serialize(with format: SerializableFormat) throws -> String {
        switch format {
        case .query:
            return try serializeQueryParameterSerializable(self, with: format)
        case .path, .header, .multipart, .form:
            throw SerializationError.invalidSerializationParameter(type: "Operations.ResponseBodyEmptyWithHeadersRequest", format: format.formatDescription)
        }
    }
...
extension Operations.ResponseBodyEmptyWithHeadersRequest: QueryParameterSerializable {
