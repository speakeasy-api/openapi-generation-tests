...
extension Shared.SimpleObject: PathParameterSerializable {
    func serializedPathParameters(formatOverride: SerializableFormat?) throws -> [String: String] {
        return [
            ...
            "decimalNullableOpt": try decimalNullableOpt != nil ? decimalNullableOptWrapper.serialize(with: formatOverride ?? .path(explode: false)) : nil,
            ...
            "float64Str": try float64Str?.serialize(with: formatOverride ?? .path(explode: false)),
            ...
            "int64Str": try int64Str?.serialize(with: formatOverride ?? .path(explode: false)),
...
extension Shared.SimpleObject: QueryParameterSerializable {
    func serializedQueryParameters(with parameterDefaults: ParameterDefaults?, formatOverride: SerializableFormat?) throws -> [QueryParameter] {
        ...
        if decimalNullableOpt != nil {
            try builder.addQueryParameters(from: decimalNullableOptWrapper, named: "decimalNullableOpt", format: formatOverride ?? .query(style: .form, explode: false), parameterDefaults: parameterDefaults)
        }
        ...
        try builder.addQueryParameters(from: float64Str, named: "float64Str", format: formatOverride ?? .query(style: .form, explode: false), parameterDefaults: parameterDefaults)
        try builder.addQueryParameters(from: int64Str, named: "int64Str", format: formatOverride ?? .query(style: .form, explode: false), parameterDefaults: parameterDefaults)
...
extension Shared.SimpleObject: HeaderParameterSerializable {
    func serializedHeaderParameters() throws -> [SerializedParameter] {
        return [
            ...
            SerializedParameter(name: "decimalNullableOpt", serialized: try decimalNullableOpt != nil ? decimalNullableOptWrapper.serialize(with: .header(explode: false)) : nil),
            SerializedParameter(name: "decimalStr", serialized: try decimalStr?.serialize(with: .header(explode: false))),
            SerializedParameter(name: "float64Str", serialized: try float64Str?.serialize(with: .header(explode: false))),
            SerializedParameter(name: "int64Str", serialized: try int64Str?.serialize(with: .header(explode: false))),
...
extension Shared.SimpleObject: MultipartFormBodySerializable {
    func serializedMultipartFormParameters(formatOverride: SerializableFormat?) throws -> [MultipartFormParameter] {
        return [
            ...
            .value(name: "decimalNullableOpt", serialized: try decimalNullableOpt != nil ? decimalNullableOptWrapper.serialize(with: .multipart) : nil),
            .value(name: "decimalStr", serialized: try decimalStr?.serialize(with: .multipart)),
            .value(name: "float64Str", serialized: try float64Str?.serialize(with: .multipart)),
            .value(name: "int64Str", serialized: try int64Str?.serialize(with: .multipart)),
...
extension Shared.SimpleObject: FormBodySerializable {
    func serializedFormParameters(formatOverride: SerializableFormat?) throws -> [SerializedParameter] {
        return [
            ...
            SerializedParameter(name: "decimalNullableOpt", serialized: try decimalNullableOpt != nil ? decimalNullableOptWrapper.serialize(with: .form(explode: true)) : nil),
            SerializedParameter(name: "decimalStr", serialized: try decimalStr?.serialize(with: .form(explode: true))),
            SerializedParameter(name: "float64Str", serialized: try float64Str?.serialize(with: .form(explode: true))),
            SerializedParameter(name: "int64Str", serialized: try int64Str?.serialize(with: .form(explode: true))),
