...
extension Operations.UsageExamplePostRequest: QueryParameterSerializable {
    func serializedQueryParameters(with parameterDefaults: ParameterDefaults?, formatOverride: SerializableFormat?) throws -> [QueryParameter] {
        ...
        try builder.addQueryParameters(from: float64StringParameter, named: "float64StringParameter", format: formatOverride ?? .query(style: .form, explode: true), parameterDefaults: parameterDefaults)
        ...
        try builder.addQueryParameters(from: int64StringParameter, named: "int64StringParameter", format: formatOverride ?? .query(style: .form, explode: true), parameterDefaults: parameterDefaults)
