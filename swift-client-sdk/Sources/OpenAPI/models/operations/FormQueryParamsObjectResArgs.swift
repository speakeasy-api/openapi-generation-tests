...
extension Operations {
    /// A model object
    public struct FormQueryParamsObjectResArgs {
        ...
        ///
        ///
        public init(any: String, bool: String, date: String, dateTime: String, `enum`: String, float32: String, int: String, int32: String, int32Enum: String, intEnum: String, num: String, objParam: String, str: String, bigint: String? = nil, bigintStr: String? = nil, boolOpt: String? = nil, decimal: String? = nil, decimalStr: String? = nil, intOptNull: String? = nil, numOptNull: String? = nil, strOpt: String? = nil) {
            self.any = any
            self.bool = bool
            self.date = date
...
extension Operations.FormQueryParamsObjectResArgs: Codable {
