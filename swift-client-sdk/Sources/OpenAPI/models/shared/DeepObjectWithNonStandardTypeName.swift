...
extension Shared {
    /// A model object
    public struct DeepObjectWithNonStandardTypeName {
        public let any: Shared.DeepObjectWithNonStandardTypeNameAny
        ...
        public let objType: String? = "deepObjectWithNonStandardTypeName"
        ...
        ///
        public init(any: Shared.DeepObjectWithNonStandardTypeNameAny, arr: [Shared.SimpleObject], bool: Bool, int: Int, map: [String: Shared.SimpleObject], num: Double, obj: Shared.SimpleObject, str: String, type: String? = nil) {
            self.any = any
            self.arr = arr
            self.bool = bool
            self.int = int
...
extension Shared.DeepObjectWithNonStandardTypeName: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.any = try container.decode(Shared.DeepObjectWithNonStandardTypeNameAny.self, forKey: .any)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.objType, forKey: .objType)
        try container.encodeIfPresent(self.type, forKey: .type)
    }
}

extension Shared.DeepObjectWithNonStandardTypeName {
