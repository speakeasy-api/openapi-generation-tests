...
extension Shared {
    ...
    public struct DefaultsAndConsts {
        ...
        ///
        ///
        public init(constBigInt: Int, constBigIntStr: String, constBool: Bool, constDate: Date, constDateTime: Date, constDecimal: Double, constDecimalStr: String, constEnumInt: Shared.ConstEnumInt, constEnumStr: Shared.ConstEnumStr, constInt: Int, constNum: Double, constStr: String, constStrDQuotes: String, constStrNull: String, constStrSQuotes: String, defaultBigInt: Int, defaultBigIntStr: String, defaultBool: Bool, defaultDate: Date, defaultDateTime: Date, defaultDecimal: Double, defaultDecimalStr: String, defaultEnumInt: Shared.DefaultEnumInt, defaultEnumStr: Shared.DefaultEnumStr, defaultInt: Int, defaultNum: Double, defaultStr: String, defaultStrDQuotes: String, defaultStrNullable: String, defaultStrSQuotes: String, normalField: String, defaultStrOptional: String? = nil) {
...
extension Shared.DefaultsAndConsts: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.defaultEnumInt = try container.decode(Shared.DefaultEnumInt.self, forKey: .defaultEnumInt)
        self.defaultEnumStr = try container.decode(Shared.DefaultEnumStr.self, forKey: .defaultEnumStr)
