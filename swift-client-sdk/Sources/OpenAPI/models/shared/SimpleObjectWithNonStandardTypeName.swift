...
extension Shared {
    ...
    public struct SimpleObjectWithNonStandardTypeName {
        ...
        ///
        public init(any: AnyValue, bool: Bool, date: Date, dateTime: Date, `enum`: Shared.Enum, float32: Double, int: Int, int32: Int, int32Enum: Shared.SimpleObjectWithNonStandardTypeNameInt32Enum, intEnum: Shared.SimpleObjectWithNonStandardTypeNameIntEnum, num: Double, str: String, bigint: Int? = nil, bigintStr: String? = nil, boolOpt: Bool? = nil, decimal: Double? = nil, decimalStr: String? = nil, intOptNull: Int? = nil, numOptNull: Double? = nil, strOpt: String? = nil) {
            self.any = any
            self.bool = bool
