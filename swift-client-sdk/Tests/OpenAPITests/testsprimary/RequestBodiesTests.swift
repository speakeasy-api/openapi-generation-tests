...
class RequestBodiesTests: XCTestCase {
    ...
    func testRequestBodyPostMultipleContentTypesComponentFiltered() async throws {
        try recordTest(named: "request-bodies-post-multiple-content-types-component-filtered-application-json")
        try recordTest(named: "request-bodies-post-multiple-content-types-component-filtered-multipart-form-data")
    ...
    func testRequestBodyPutMultipartFileRef() async throws {
        try recordTest(named: "request-bodies-put-multipart-file-ref")
        ...
        if let data {
            let response = try await client.requestBodies.requestBodyPutMultipartFileRef(
                request: .init(
                    file: .init(
                        content: data,
                        fileName: fileContents
