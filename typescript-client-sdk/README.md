  ...
  const result = await sdk.generation.usageExamplePost({
    ...
    requestBody: {
      ...
      fakerPascalCasePropertyNameStrings: {
        ...
        expiredAt: "1726774538999",
        expires: "<value>",
        expiresAt: "1762619487735",
        extension: "mp4v",
      ...
      fakerSnakeCasePropertyNameStrings: {
        countryCode: "FJ",
        createdAt: "1732927764688",
        expiredAt: "1723405841143",
        updatedAt: "1737851488399",
      },
      simpleObject: {
        bool: true,
        date: new RFCDate("2020-01-01"),
