  ...
  const result = await sdk.generation.usageExamplePost({
    ...
    requestBody: {
      ...
      fakerPascalCasePropertyNameStrings: {
        ...
        expiredAt: "1725737707850",
        expires: "<value>",
        expiresAt: "1761582656586",
        extension: "mp4v",
      ...
      fakerSnakeCasePropertyNameStrings: {
        countryCode: "FJ",
        createdAt: "1731890933564",
        expiredAt: "1722369010019",
        updatedAt: "1736814657275",
      },
      simpleObject: {
        bool: true,
        date: new RFCDate("2020-01-01"),
