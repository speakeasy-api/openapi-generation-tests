  ...
  const result = await sdk.generation.usageExamplePost({
    ...
    requestBody: {
      ...
      fakerPascalCasePropertyNameStrings: {
        ...
        expiredAt: "1726342531648",
        expires: "<value>",
        expiresAt: "1762187480384",
        extension: "mp4v",
      ...
      fakerSnakeCasePropertyNameStrings: {
        countryCode: "FJ",
        createdAt: "1732495757333",
        expiredAt: "1722973833788",
        updatedAt: "1737419481044",
      },
      simpleObject: {
        bool: true,
        date: new RFCDate("2020-01-01"),
