  ...
  const result = await sdk.generation.usageExamplePost({
    ...
    requestBody: {
      ...
      fakerPascalCasePropertyNameStrings: {
        ...
        expiredAt: "1726515413676",
        expires: "<value>",
        expiresAt: "1762360362412",
        extension: "mp4v",
      ...
      fakerSnakeCasePropertyNameStrings: {
        countryCode: "FJ",
        createdAt: "1732668639361",
        expiredAt: "1723146715817",
        updatedAt: "1737592363073",
      },
      simpleObject: {
        bool: true,
        date: new RFCDate("2020-01-01"),
...
- [`documentationGetDocumentationPerLanguage`](docs/sdks/documentation/README.md#getdocumentationperlanguage) - Gets documentation for some language, I guess.
...
- [`flatteningRequiredBodyAllOptional`](docs/sdks/flattening/README.md#requiredbodyalloptional)
...
- [`generationCircularReferenceOneDegree`](docs/sdks/generation/README.md#circularreferenceonedegree) - A reference cycle that spans three models separated by one degree
...
- [`generationReactHookCombinedOptions`](docs/sdks/generation/README.md#reacthookcombinedoptions)
- [`generationReactHookDisabled`](docs/sdks/generation/README.md#reacthookdisabled)
- [`generationReactHookGetAsMutation`](docs/sdks/generation/README.md#reacthookgetasmutation)
- [`generationReactHookPostAsQuery`](docs/sdks/generation/README.md#reacthookpostasquery)
- [`generationReactHookRenamed`](docs/sdks/generation/README.md#reacthookrenamed)
- [`generationTypedParameterGenerationGet`](docs/sdks/generation/README.md#typedparametergenerationget)
- [`generationUsageExamplePost`](docs/sdks/generation/README.md#usageexamplepost) - An operation used for testing usage examples
...
- [`globalsGlobalsOptionalHiddenPathParameterOperationRequired`](docs/sdks/globals/README.md#globalsoptionalhiddenpathparameteroperationrequired) - This operation requires a globally optional hidden path parameter. A
failing test with 404 likely indicates that the path parameter value is
not being templated into the client (.../hidden//...).

- [`globalsGlobalsOptionalHiddenPathParameterPathRequired`](docs/sdks/globals/README.md#globalsoptionalhiddenpathparameterpathrequired) - This path requires a globally optional hidden path parameter. A failing
test with 404 likely indicates that the path parameter value is not
being templated into the client (.../hidden//...).

- [`globalsGlobalsOptionalPathParameterOperationRequired`](docs/sdks/globals/README.md#globalsoptionalpathparameteroperationrequired) - This operation requires a globally optional path parameter. A failing
test with 404 likely indicates that the path parameter value is not
being templated into the operation request (.../globals//...).

- [`globalsGlobalsOptionalPathParameterPathRequired`](docs/sdks/globals/README.md#globalsoptionalpathparameterpathrequired) - This path requires a globally optional path parameter. A failing
test with 404 likely indicates that the path parameter value is not
being templated into the operation request (.../globals//...).

- [`globalsGlobalsQueryParameterGet`](docs/sdks/globals/README.md#globalsqueryparameterget)
- [`healthCheck`](docs/sdks/health/README.md#check)
...
- [`paginationPaginationAmbiguousInput`](docs/sdks/pagination/README.md#paginationambiguousinput) - This is a paginated operation where there is both a query parameter and
request body field called "cursor". This ambiguity is used to test that
the generator only updates the appropriate field in the pagination code
"next()" function.

- [`paginationPaginationBodyFlattenedOptionalSecurity`](docs/sdks/pagination/README.md#paginationbodyflattenedoptionalsecurity)
- [`paginationPaginationBodyFlattenedWithSecurity`](docs/sdks/pagination/README.md#paginationbodyflattenedwithsecurity)
- [`paginationPaginationBodyWrappedRequest`](docs/sdks/pagination/README.md#paginationbodywrappedrequest) - This operation has a request wrapper type that encapsulates the
parameters and request body. The pagination inputs are meant to go in
the request body and we want to test that the generator correctly
generates the next() function call preserving everything from the
original request and interpolating the next pagination inputs.
...
- [`paginationPaginationEncapsulatedParameter`](docs/sdks/pagination/README.md#paginationencapsulatedparameter) - This is a paginated operation where the input is a query parameter
but the number of arguments exceeds maxMethodParams so it ends up
being encapsulated into a request object.
...
- [`paginationPaginationLimitOffsetDefaultOffsetBody`](docs/sdks/pagination/README.md#paginationlimitoffsetdefaultoffsetbody)
- [`paginationPaginationLimitOffsetDefaultOffsetParams`](docs/sdks/pagination/README.md#paginationlimitoffsetdefaultoffsetparams)
...
- [`paginationPaginationLimitOffsetOptionalPageParams`](docs/sdks/pagination/README.md#paginationlimitoffsetoptionalpageparams)
...
- [`paginationPaginationWrappedOptionalBody`](docs/sdks/pagination/README.md#paginationwrappedoptionalbody)
...
- [`parametersHeaderParamsNil`](docs/sdks/parameters/README.md#headerparamsnil)
...
- [`requestBodiesRequestBodyGetInferredOptionalRequestWrapper`](docs/sdks/requestbodies/README.md#requestbodygetinferredoptionalrequestwrapper)
...
- [`requestBodiesRequestBodyPostWildcard`](docs/sdks/requestbodies/README.md#requestbodypostwildcard)
...
- [`requestBodiesRequestBodyPutMultipartFileRef`](docs/sdks/requestbodies/README.md#requestbodyputmultipartfileref)
...
- [`responseBodiesResponseBodies2xxJSONObjectAllOptionalProperties`](docs/sdks/responsebodies/README.md#responsebodies2xxjsonobjectalloptionalproperties)
...
- [`retriesRetriesConnectErrorGet`](docs/sdks/retries/README.md#retriesconnecterrorget) - A request to a non-valid port to test connection errors
...
- [`serversSelectServerWithID`](docs/sdks/servers/README.md#selectserverwithid) - Select a server by ID.
- [`serversServersByIDWithTemplates`](docs/sdks/servers/README.md#serversbyidwithtemplates)
- [`serversServersOverrideGlobalServerURL`](docs/sdks/servers/README.md#serversoverrideglobalserverurl)
- [`serversServersOverrideOperationServerURL`](docs/sdks/servers/README.md#serversoverrideoperationserverurl)
...
- [`statusCodeStatusCode2XX`](docs/sdks/statuscode/README.md#statuscode2xx)
- [`statusCodeStatusCode4XX`](docs/sdks/statuscode/README.md#statuscode4xx)
- [`statusCodeStatusCode5XX`](docs/sdks/statuscode/README.md#statuscode5xx)
- [`statusCodeStatusCodeDefault`](docs/sdks/statuscode/README.md#statuscodedefault)
...
- [`unionsArrayOfDiscriminatedUnions`](docs/sdks/unions/README.md#arrayofdiscriminatedunions)
- [`unionsArrayOfDiscriminatedUnionsMap`](docs/sdks/unions/README.md#arrayofdiscriminatedunionsmap)
...
- [`unionsNestedArrayOfDiscriminatedUnions`](docs/sdks/unions/README.md#nestedarrayofdiscriminatedunions)
...
- [`webhooksSendWebhookUserCreated`](docs/sdks/webhooks/README.md#sendwebhookusercreated)
- [`webhooksSendWebhookUserUpdated`](docs/sdks/webhooks/README.md#sendwebhookuserupdated)
- ~~[`generationDeprecatedOperationNoCommentsGet`](docs/sdks/generation/README.md#deprecatedoperationnocommentsget)~~ - :warning: **Deprecated**
- ~~[`generationDeprecatedOperationWithCommentsGet`](docs/sdks/generation/README.md#deprecatedoperationwithcommentsget)~~ - This is an endpoint setup to test deprecation with comments :warning: **Deprecated** Use [`parametersSimplePathParameterObjects`](docs/sdks/parameters/README.md#simplepathparameterobjects) instead.
- ~~[`generationDeprecatedOperationWithMultilineCommentGet`](docs/sdks/generation/README.md#deprecatedoperationwithmultilinecommentget)~~ - This is an endpoint setup to test deprecation with multiline comments :warning: **Deprecated** Use [`parametersSimplePathParameterObjects`](docs/sdks/parameters/README.md#simplepathparameterobjects) instead.
...
async function run() {
  const result = await sdk.requestBodies.requestBodyPostWildcard();
