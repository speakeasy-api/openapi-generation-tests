  ...
  const result = await sdk.generation.usageExamplePost({
    ...
    requestBody: {
      ...
      fakerPascalCasePropertyNameStrings: {
        ...
        expiredAt: "1725996900061",
        expires: "<value>",
        expiresAt: "1761841848797",
        extension: "mp4v",
      ...
      fakerSnakeCasePropertyNameStrings: {
        countryCode: "FJ",
        createdAt: "1732150125746",
        expiredAt: "1722628202201",
        updatedAt: "1737073849457",
      },
      simpleObject: {
        bool: true,
        date: new RFCDate("2020-01-01"),
