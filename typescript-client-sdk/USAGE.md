  ...
  const result = await sdk.generation.usageExamplePost({
    ...
    requestBody: {
      ...
      fakerPascalCasePropertyNameStrings: {
        ...
        expiredAt: "1723837078743",
        expires: "<value>",
        expiresAt: "1759682027480",
        extension: "mp4v",
      ...
      fakerSnakeCasePropertyNameStrings: {
        countryCode: "FJ",
        createdAt: "1729990304461",
        expiredAt: "1720468380916",
        updatedAt: "1734914028172",
      },
      simpleObject: {
        bool: true,
        date: new RFCDate("2020-01-01"),
