  ...
  const result = await sdk.generation.usageExamplePost({
    ...
    requestBody: {
      ...
      fakerPascalCasePropertyNameStrings: {
        ...
        expiredAt: "1725305920329",
        expires: "<value>",
        expiresAt: "1761150869065",
        extension: "mp4v",
      ...
      fakerSnakeCasePropertyNameStrings: {
        countryCode: "FJ",
        createdAt: "1731459146014",
        expiredAt: "1721937222469",
        updatedAt: "1736382869725",
      },
      simpleObject: {
        bool: true,
        date: new RFCDate("2020-01-01"),
