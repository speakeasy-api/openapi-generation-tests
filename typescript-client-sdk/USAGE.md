  ...
  const result = await sdk.generation.usageExamplePost({
    ...
    requestBody: {
      ...
      fakerPascalCasePropertyNameStrings: {
        ...
        expiredAt: "1725392148700",
        expires: "<value>",
        expiresAt: "1761237097436",
        extension: "mp4v",
      ...
      fakerSnakeCasePropertyNameStrings: {
        countryCode: "FJ",
        createdAt: "1731545374386",
        expiredAt: "1722023450841",
        updatedAt: "1736469098097",
      },
      simpleObject: {
        bool: true,
        date: new RFCDate("2020-01-01"),
