  ...
  const result = await sdk.generation.usageExamplePost({
    ...
    requestBody: {
      ...
      fakerPascalCasePropertyNameStrings: {
        ...
        expiredAt: "1725219580696",
        expires: "<value>",
        expiresAt: "1761064529433",
        extension: "mp4v",
      ...
      fakerSnakeCasePropertyNameStrings: {
        countryCode: "FJ",
        createdAt: "1731372806382",
        expiredAt: "1721850882837",
        updatedAt: "1736296530093",
      },
      simpleObject: {
        bool: true,
        date: new RFCDate("2020-01-01"),
