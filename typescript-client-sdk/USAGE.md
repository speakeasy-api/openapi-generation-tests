  ...
  const result = await sdk.generation.usageExamplePost({
    ...
    requestBody: {
      ...
      fakerPascalCasePropertyNameStrings: {
        ...
        expiredAt: "1724269269121",
        expires: "<value>",
        expiresAt: "1760114217858",
        extension: "mp4v",
      ...
      fakerSnakeCasePropertyNameStrings: {
        countryCode: "FJ",
        createdAt: "1730422494843",
        expiredAt: "1720900571298",
        updatedAt: "1735346218554",
      },
      simpleObject: {
        bool: true,
        date: new RFCDate("2020-01-01"),
