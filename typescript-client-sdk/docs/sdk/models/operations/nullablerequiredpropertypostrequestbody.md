...
let value: NullableRequiredPropertyPostRequestBody = {
  ...
  nullableRequiredBigIntStr: BigInt("468651"),
  nullableRequiredDateTime: new Date("2023-07-13T13:09:34.110Z"),
  nullableRequiredDecimalStr: new Decimal("9767.62"),
  nullableRequiredEnum: "first",
  nullableRequiredInt: 604846,
};
```
