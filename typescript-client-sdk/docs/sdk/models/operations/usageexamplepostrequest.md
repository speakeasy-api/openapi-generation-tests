...
let value: UsageExamplePostRequest = {
  requestBody: {
    ...
    fakerFormattedStrings: {
      ...
      dateFormat: new RFCDate("2024-05-11"),
      datetimeFormat: new Date("2024-06-25T09:04:00.715Z"),
    ...
    fakerPascalCasePropertyNameStrings: {
      ...
      expiredAt: "1725962433292",
      expires: "<value>",
      expiresAt: "1753752431188",
      extension: "png",
    ...
    fakerSnakeCasePropertyNameStrings: {
      countryCode: "SC",
      createdAt: "1711123589711",
      expiredAt: "1717592774458",
      updatedAt: "1737281686087",
    },
    simpleObject: {
      bool: true,
  ...
  boolParameter: false,
  dateParameter: new RFCDate("2023-11-29"),
  dateTimeDefaultParameter: new Date("2024-01-26T01:18:29.965Z"),
  dateTimeParameter: new Date("2025-06-07T02:11:09.431Z"),
  decimalParameter: new Decimal("5775.9"),
  decimalStrParameter: new Decimal("752.77"),
  doubleParameter: 782.46,
  enumParameter: "value2",
  falseyNumberParameter: 0,
  float32Parameter: 7665.91,
  float64StringParameter: 6886.84,
  floatParameter: 7079.83,
