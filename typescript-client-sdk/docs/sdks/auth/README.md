...
import { ApiKeyAuthSecurity } from "openapi/sdk/models/operations";
...
async function run() {
  ...
  const result = await sdk.auth.apiKeyAuth(operationSecurity);
...
async function run() {
  ...
  const result = await sdk.auth.basicAuth(operationSecurity, passwd, user);
...
async function run() {
  ...
  const result = await sdk.auth.bearerAuth(operationSecurity);
...
async function run() {
  ...
  const result = await sdk.auth.noAuth();
...
```typescript
import { SDK } from "openapi";
import { Oauth2AuthSecurity } from "openapi/sdk/models/operations";
...
async function run() {
  ...
  const result = await sdk.auth.oauth2Auth(operationSecurity);
...
```typescript
import { SDK } from "openapi";
import { Oauth2OverrideSecurity } from "openapi/sdk/models/operations";
...
async function run() {
  ...
  const result = await sdk.auth.oauth2Override(operationSecurity);
...
async function run() {
  ...
  const result = await sdk.auth.openIdConnectAuth(operationSecurity);
