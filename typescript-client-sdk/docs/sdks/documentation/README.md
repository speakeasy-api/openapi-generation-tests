...
async function run() {
  await sdk.documentation.getDocumentationPerLanguage("<value>");
}
...
import { documentationGetDocumentationPerLanguage } from "openapi/funcs/documentationGetDocumentationPerLanguage.js";
...
async function run() {
  const res = await documentationGetDocumentationPerLanguage(sdk, "<value>");
