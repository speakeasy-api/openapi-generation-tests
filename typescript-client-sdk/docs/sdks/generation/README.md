  ...
  const result = await sdk.generation.usageExamplePost({
    ...
    requestBody: {
      ...
      fakerPascalCasePropertyNameStrings: {
        ...
        expiredAt: "1724182677372",
        expires: "<value>",
        expiresAt: "1760027626108",
        extension: "mp4v",
      ...
      fakerSnakeCasePropertyNameStrings: {
        countryCode: "FJ",
        createdAt: "1730335903061",
        expiredAt: "1720813979516",
        updatedAt: "1735259626773",
      },
      simpleObject: {
        bool: true,
        date: new RFCDate("2020-01-01"),
