  ...
  const result = await sdk.generation.usageExamplePost({
    ...
    requestBody: {
      ...
      fakerPascalCasePropertyNameStrings: {
        ...
        expiredAt: "1724441785584",
        expires: "<value>",
        expiresAt: "1760286734320",
        extension: "mp4v",
      ...
      fakerSnakeCasePropertyNameStrings: {
        countryCode: "FJ",
        createdAt: "1730595011272",
        expiredAt: "1721073087728",
        updatedAt: "1735518734984",
      },
      simpleObject: {
        bool: true,
        date: new RFCDate("2020-01-01"),
