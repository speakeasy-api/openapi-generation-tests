...
async function run() {
  await sdk.generation.deprecatedOperationNoCommentsGet("<value>");
...
async function run() {
  await sdk.generation.deprecatedOperationWithCommentsGet("<value>", "<value>");
...
async function run() {
  await sdk.generation.typedParameterGenerationGet(BigInt("879275"), new RFCDate("2024-11-18"), new Decimal("3346.96"), {
    bool: false,
    num: 4778.06,
    str: "<value>",
  });
