...
async function run() {
  ...
  const dateInput = new RFCDate("2023-10-13");
...
async function run() {
  ...
  const dateTimeInput = new Date("2023-10-13T12:42:42.999+00:00");
...
async function run() {
  ...
  const decimalInput = new Decimal("903275809834567300000");
...
async function run() {
  ...
  const deprecatedParameter = "<value>";
