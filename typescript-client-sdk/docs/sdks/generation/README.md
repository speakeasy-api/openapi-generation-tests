  ...
  const result = await sdk.generation.usageExamplePost({
    ...
    requestBody: {
      ...
      fakerPascalCasePropertyNameStrings: {
        ...
        expiredAt: "1725647763620",
        expires: "<value>",
        expiresAt: "1761492712356",
        extension: "mp4v",
      ...
      fakerSnakeCasePropertyNameStrings: {
        countryCode: "FJ",
        createdAt: "1731800989305",
        expiredAt: "1722279065760",
        updatedAt: "1736724713016",
      },
      simpleObject: {
        bool: true,
        date: new RFCDate("2020-01-01"),
