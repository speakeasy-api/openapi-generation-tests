...
async function run() {
  const res = await generationUsageExamplePost(sdk, {
    ...
    bigintParameter: BigInt("165441"),
    bigintStrParameter: BigInt("99332"),
    boolParameter: false,
    dateParameter: new RFCDate("2024-10-30"),
    dateTimeDefaultParameter: new Date("2022-08-17T20:43:43.017Z"),
    dateTimeParameter: new Date("2023-02-24T10:13:03.328Z"),
    decimalParameter: new Decimal("6766.56"),
    decimalStrParameter: new Decimal("5977.9"),
    doubleParameter: 7983.11,
    enumParameter: "value1",
    falseyNumberParameter: 0,
    float32Parameter: 3158.77,
    float64StringParameter: 4901.56,
    floatParameter: 6730.42,
    int64Parameter: 456752,
    int64StringParameter: 123469,
    intParameter: 707371,
    optEnumParameter: "value3",
