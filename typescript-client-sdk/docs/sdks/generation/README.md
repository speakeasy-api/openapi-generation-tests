  ...
  const result = await sdk.generation.usageExamplePost({
    ...
    requestBody: {
      ...
      fakerPascalCasePropertyNameStrings: {
        ...
        expiredAt: "1724874067315",
        expires: "<value>",
        expiresAt: "1760719016051",
        extension: "mp4v",
      ...
      fakerSnakeCasePropertyNameStrings: {
        countryCode: "FJ",
        createdAt: "1731027293000",
        expiredAt: "1721505369455",
        updatedAt: "1735951016712",
      },
      simpleObject: {
        bool: true,
        date: new RFCDate("2020-01-01"),
