...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostComplexNumberTypes({
    ...
    pathBigInt: 8821239038968084n,
    pathBigIntStr: 9223372036854775808n,
    pathDecimal: new Decimal("3.141592653589793"),
    pathDecimalStr: new Decimal("3.14159265358979344719667586"),
    queryBigInt: 8821239038968084n,
    queryBigIntStr: 9223372036854775808n,
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesBigInt(1n);
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesBigIntStr(1n);
...
**Promise<[operations.RequestBodyPostJsonDataTypesComplexNumberArraysResponse](../../sdk/models/operations/requestbodypostjsondatatypescomplexnumberarraysresponse.md)>**
### Errors
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesComplexNumberMaps({
    ...
    decimalMap: {
      "key": new Decimal("7703.92"),
    },
    decimalStrMap: {
      "key": new Decimal("5046.5"),
    },
  });
...
**Promise<[operations.RequestBodyPostJsonDataTypesComplexNumberMapsResponse](../../sdk/models/operations/requestbodypostjsondatatypescomplexnumbermapsresponse.md)>**
### Errors
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesDateTime(new Date("2020-01-01T00:00:00Z"));
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesMapDateTime({
    "test": new Date("2020-01-01T00:00:00.000001Z"),
  });
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostNotNullableNotRequiredStringBody(null);
...
async function run() {
  ...
  const queryStringParam = "test param";
