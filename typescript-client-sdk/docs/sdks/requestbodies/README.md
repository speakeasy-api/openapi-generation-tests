...
async function run() {
  const res = await requestBodiesRequestBodyPostMultipleContentTypesSplitParamForm(sdk, {
    bool3: false,
    num3: 3466.17,
    str3: "<value>",
  }, "<value>");
...
async function run() {
  const res = await requestBodiesRequestBodyPostMultipleContentTypesSplitParamJson(sdk, {
    bool: false,
    num: 961.4,
    str: "<value>",
  }, "<value>");
...
async function run() {
  const res = await requestBodiesRequestBodyPostMultipleContentTypesSplitParamMultipart(sdk, {
    bool2: false,
    num2: 2154.06,
    str2: "<value>",
  }, "<value>");
...
async function run() {
  const result = await sdk.requestBodies.requestBodyPutBytes(files.toStream("example.file"));
...
async function run() {
  const res = await requestBodiesRequestBodyPutBytes(sdk, files.toStream("example.file"));
...
async function run() {
  const result = await sdk.requestBodies.requestBodyPutBytesWithParams(files.toStream("example.file"), "<value>");
...
async function run() {
  const res = await requestBodiesRequestBodyPutBytesWithParams(sdk, files.toStream("example.file"), "<value>");
...
async function run() {
  const res = await requestBodiesRequestBodyPutStringWithParams(sdk, "Hello world", "test param");
