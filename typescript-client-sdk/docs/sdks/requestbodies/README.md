...
async function run() {
  ...
  const result = await sdk.requestBodies.nullableObjectPost({
    required: 302382,
  });
...
```typescript
import { SDK } from "openapi";
import { Enum, Int32EnumVal, IntEnumVal } from "openapi/sdk/models/shared";
import { Decimal, RFCDate } from "openapi/sdk/types";
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostComplexNumberTypes({
    complexNumberTypes: {
      bigint: 765757n,
      bigintStr: 934487n,
      decimal: new Decimal("2505.14"),
      decimalStr: new Decimal("6831.11"),
    },
    pathBigInt: 500580n,
    pathBigIntStr: 741903n,
    pathDecimal: new Decimal("8228.52"),
    pathDecimalStr: new Decimal("5491.78"),
    queryBigInt: 937395n,
    queryBigIntStr: 178906n,
    queryDecimal: new Decimal("8260.68"),
    queryDecimalStr: new Decimal("8253.58"),
  });
...
```typescript
import { SDK } from "openapi";
import { ConstEnumInt, ConstEnumStr, DefaultEnumInt, DefaultEnumStr } from "openapi/sdk/models/shared";
import { Decimal, RFCDate } from "openapi/sdk/types";
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesBigInt(687617n);
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesBigIntStr(649473n);
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesBoolean(false);
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesDate(new RFCDate("2023-03-04"));
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesDateTime(new Date("2024-03-03T18:54:52.196Z"));
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesDecimal(new Decimal("1107.81"));
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesDecimalStr(new Decimal("5432.92"));
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesFloat32(4464.34);
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesInt32(22155);
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesInteger(273673);
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [Record<string, BigInt>](../../models/.md)                                                                                                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [Record<string, Decimal>](../../models/.md)                                                                                                                                    | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesNumber(2193.66);
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostJsonDataTypesString("string");
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostMultipleContentTypesSplitParamForm(requestBody, paramStr);
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostMultipleContentTypesSplitParamJson(requestBody, paramStr);
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostMultipleContentTypesSplitParamMultipart(requestBody, paramStr);
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostNotNullableNotRequiredStringBody("string");
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostNullArray([
    "string",
  ]);
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostNullableNotRequiredStringBody("string");
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPostNullableRequiredStringBody("string");
...
async function run() {
  ...
  const requestBody = new TextEncoder().encode("0xC1B9cA4eb5");
  const queryStringParam = "string";
  
  const result = await sdk.requestBodies.requestBodyPutBytesWithParams(requestBody, queryStringParam);
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPutMultipartDifferentFileName({
    differentFileName: await openAsBlob("./sample-file"),
  });
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPutMultipartOptionalRequestBody({
    sampleFile: await openAsBlob("./sample-file"),
  });
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPutString("string");
...
async function run() {
  ...
  const result = await sdk.requestBodies.requestBodyPutStringWithParams(requestBody, queryStringParam);
