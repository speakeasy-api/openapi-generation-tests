...
async function run() {
  const result = await sdk.responseBodies.responseBodies2xxJSONObjectAllOptionalProperties();
...
```typescript
import { SDKCore } from "openapi/core.js";
import { responseBodiesResponseBodies2xxJSONObjectAllOptionalProperties } from "openapi/funcs/responseBodiesResponseBodies2xxJSONObjectAllOptionalProperties.js";
...
async function run() {
  const res = await responseBodiesResponseBodies2xxJSONObjectAllOptionalProperties(sdk);
...
**Promise\<[operations.ResponseBodies2xxJSONObjectAllOptionalPropertiesResponseBody](../../sdk/models/operations/responsebodies2xxjsonobjectalloptionalpropertiesresponsebody.md)\>**
...
async function run() {
  const result = await sdk.responseBodies.responseBodyEmptyWithHeaders(1751.8, "<value>");
...
async function run() {
  const res = await responseBodiesResponseBodyEmptyWithHeaders(sdk, 1751.8, "<value>");
