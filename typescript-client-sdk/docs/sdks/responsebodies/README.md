...
async function run() {
  const result = await sdk.responseBodies.responseBodyAdditionalPropertiesObjectPost({
    ...
    datetime: new Date("2023-03-22T10:46:10.684Z"),
...
async function run() {
  const res = await responseBodiesResponseBodyAdditionalPropertiesObjectPost(sdk, {
    ...
    datetime: new Date("2024-11-14T23:47:42.100Z"),
    additionalPropertiesT: {
      "key": {
        bool: true,
        date: new RFCDate("2020-01-01"),
...
async function run() {
  const result = await sdk.responseBodies.responseBodyDecimalStr(new Decimal("6437.63"));
...
async function run() {
  const res = await responseBodiesResponseBodyDecimalStr(sdk, new Decimal("5630.83"));
...
async function run() {
  const res = await responseBodiesResponseBodyEmptyWithHeaders(sdk, 8980.75, "<value>");
