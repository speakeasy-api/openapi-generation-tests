...
async function run() {
  const result = await sdk.retries.retriesAfter("<id>");
...
async function run() {
  const res = await retriesRetriesAfter(sdk, "<id>");
...
async function run() {
  await sdk.retries.retriesFlatEmptyResponsePost("<id>");
...
async function run() {
  const res = await retriesRetriesFlatEmptyResponsePost(sdk, "<id>");
...
async function run() {
  const result = await sdk.retries.retriesGet("<id>");
...
async function run() {
  const res = await retriesRetriesGet(sdk, "<id>");
...
async function run() {
  const result = await sdk.retries.retriesPost("<id>");
...
async function run() {
  const res = await retriesRetriesPost(sdk, "<id>");
