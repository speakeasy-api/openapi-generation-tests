...
sdk.unions.mixedTypeOneOfPost("blanditiis").then((res: MixedTypeOneOfPostResponse) => {
...
sdk.unions.primitiveTypeOneOfPost(296242).then((res: PrimitiveTypeOneOfPostResponse) => {
  if (res.statusCode == 200) {
    // handle response
  }
});
...
sdk.unions.stronglyTypedOneOfPost({
  ...
  int: 999999,
  int32: 1,
  int32Enum: SimpleObjectWithTypeInt32Enum.OneHundredAndEightyOne,
