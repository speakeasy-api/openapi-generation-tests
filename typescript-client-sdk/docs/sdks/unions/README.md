...
async function run() {
  const result = await sdk.unions.arrayOfDiscriminatedUnions([
...
import { unionsArrayOfDiscriminatedUnions } from "openapi/funcs/unionsArrayOfDiscriminatedUnions.js";
...
async function run() {
  const res = await unionsArrayOfDiscriminatedUnions(sdk, [
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [shared.StronglyTypedOneOfObject[]](../../models/.md)                                                                                                                          | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.ArrayOfDiscriminatedUnionsRes](../../sdk/models/operations/arrayofdiscriminatedunionsres.md)\>**
...
async function run() {
  const result = await sdk.unions.arrayOfDiscriminatedUnionsMap({
    arrayMap: {
...
```typescript
import { SDKCore } from "openapi/core.js";
import { unionsArrayOfDiscriminatedUnionsMap } from "openapi/funcs/unionsArrayOfDiscriminatedUnionsMap.js";
...
async function run() {
  const res = await unionsArrayOfDiscriminatedUnionsMap(sdk, {
    arrayMap: {
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [shared.ArrayOfDiscriminatedUnionsMap](../../sdk/models/shared/arrayofdiscriminatedunionsmap.md)                                                                               | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.ArrayOfDiscriminatedUnionsMapRes](../../sdk/models/operations/arrayofdiscriminatedunionsmapres.md)\>**
...
async function run() {
  const result = await sdk.unions.mixedTypeOneOfPost(984138);
...
async function run() {
  const res = await unionsMixedTypeOneOfPost(sdk, 984138);
...
async function run() {
  const result = await sdk.unions.mixedUnionTypes({
    colour: "<value>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { unionsMixedUnionTypes } from "openapi/funcs/unionsMixedUnionTypes.js";
...
async function run() {
  const res = await unionsMixedUnionTypes(sdk, [
    {
      colour: "<value>",
    },
  ]);
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [shared.MixedUnionTypes](../../sdk/models/shared/mixeduniontypes.md)                                                                                                           | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.MixedUnionTypesRes](../../sdk/models/operations/mixeduniontypesres.md)\>**
...
```typescript
import { SDK } from "openapi";
import { IntEnum, SimpleObjectWithTypeIntEnum } from "openapi/sdk/models/shared";
...
async function run() {
  const result = await sdk.unions.nestedArrayOfDiscriminatedUnions({
    nestedArray: [
      [
        {
          any: {
...
```typescript
import { SDKCore } from "openapi/core.js";
import { unionsNestedArrayOfDiscriminatedUnions } from "openapi/funcs/unionsNestedArrayOfDiscriminatedUnions.js";
import { IntEnum, SimpleObjectWithTypeIntEnum } from "openapi/sdk/models/shared";
import { Decimal, RFCDate } from "openapi/sdk/types";
...
async function run() {
  const res = await unionsNestedArrayOfDiscriminatedUnions(sdk, {
    nestedArray: [
      [
        {
          any: {
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [shared.NestedArrayOfDiscriminatedUnions](../../sdk/models/shared/nestedarrayofdiscriminatedunions.md)                                                                         | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.NestedArrayOfDiscriminatedUnionsRes](../../sdk/models/operations/nestedarrayofdiscriminatedunionsres.md)\>**
...
async function run() {
  const result = await sdk.unions.unionBigIntStrDecimal(new Decimal("2045.56"));
...
async function run() {
  const res = await unionsUnionBigIntStrDecimal(sdk, new Decimal("2045.56"));
...
async function run() {
  const result = await sdk.unions.unionDateNull(new RFCDate("2024-11-25"));
...
async function run() {
  const res = await unionsUnionDateNull(sdk, new RFCDate("2024-11-25"));
...
async function run() {
  const result = await sdk.unions.unionDateTimeBigInt(new Date("2023-10-13T05:48:39.528Z"));
...
async function run() {
  const res = await unionsUnionDateTimeBigInt(sdk, new Date("2023-10-13T05:48:39.528Z"));
...
async function run() {
  const result = await sdk.unions.unionDateTimeNull(new Date("2024-04-12T05:53:48.181Z"));
...
async function run() {
  const res = await unionsUnionDateTimeNull(sdk, new Date("2024-04-12T05:53:48.181Z"));
...
async function run() {
  const result = await sdk.unions.unionMapOptional({});
...
```typescript
import { SDKCore } from "openapi/core.js";
import { unionsUnionMapOptional } from "openapi/funcs/unionsUnionMapOptional.js";
...
async function run() {
  const res = await unionsUnionMapOptional(sdk, {});
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.UnionMapOptionalRequestBody](../../sdk/models/operations/unionmapoptionalrequestbody.md)                                                                           | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.UnionMapOptionalRes](../../sdk/models/operations/unionmapoptionalres.md)\>**
