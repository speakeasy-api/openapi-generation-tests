...
sdk.unions.mixedTypeOneOfPost(709036).then((res: MixedTypeOneOfPostResponse) => {
...
sdk.unions.primitiveTypeOneOfPost(9543.34).then((res: PrimitiveTypeOneOfPostResponse) => {
  if (res.statusCode == 200) {
    // handle response
  }
});
