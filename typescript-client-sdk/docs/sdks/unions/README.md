...
async function run() {
  const result = await sdk.unions.unionDateTimeBigInt(new Date("2022-10-13T05:48:39.528Z"));
...
async function run() {
  const res = await unionsUnionDateTimeBigInt(sdk, new Date("2022-10-13T05:48:39.528Z"));
...
async function run() {
  const result = await sdk.unions.unionDateTimeNull(new Date("2023-04-13T05:53:48.181Z"));
...
async function run() {
  const res = await unionsUnionDateTimeNull(sdk, new Date("2023-04-13T05:53:48.181Z"));
