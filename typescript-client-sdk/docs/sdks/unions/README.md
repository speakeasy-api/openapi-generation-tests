...
sdk.unions.mixedTypeOneOfPost("culpa").then((res: MixedTypeOneOfPostResponse) => {
...
sdk.unions.primitiveTypeOneOfPost(2996.43).then((res: PrimitiveTypeOneOfPostResponse) => {
  if (res.statusCode == 200) {
    // handle response
  }
});
