...
async function run() {
  ...
  const res = await sdk.unions.stronglyTypedOneOfDiscriminatedPost("string");
...
async function run() {
  ...
  const res = await sdk.unions.unionDateNull(new RFCDate("2023-11-26"));
...
async function run() {
  ...
  const res = await sdk.unions.unionDateTimeNull(new Date("2023-04-13T05:53:47.874Z"));
