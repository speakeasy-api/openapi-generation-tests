...
import { SDK } from "..";
import { NullableRequiredEnum } from "../sdk/models/operations";
import {
...
import { sortJSONObjectKeys } from "./helpers";
...
test("Request Bodies Nullable Required Empty Object Post", async () => {
    const sdk = new SDK({
        security: {
            apiKeyAuth: "Token YOUR_API_KEY",
        },
...
test("Request Bodies Nullable Required Property Post", async () => {
    const sdk = new SDK({
        security: {
            apiKeyAuth: "Token YOUR_API_KEY",
        },
    ...
    expect(result.object?.data).toEqual(
        '{"NullableOptionalInt":0,"NullableRequiredArray":null,"NullableRequiredBigIntStr":"9223372036854775807","NullableRequiredDateTime":"2024-03-02T01:02:03.001Z","NullableRequiredDecimalStr":"3.14159265358979344719667586","NullableRequiredEnum":"second","NullableRequiredInt":null}'
    );
});

test("Request Bodies Nullable Required Shared Object Post", async () => {
    const sdk = new SDK({
        security: {
            apiKeyAuth: "Token YOUR_API_KEY",
        },
...
test("Request Bodies Request Body Post Application Json Array Obj", async () => {
    ...
    expect(result.statusCode).toBe(200);
    expect(result.arrObjValue).toEqual({
        json: [
            {
                bool: true,
                date: new RFCDate("2020-01-01"),
...
test("Request Bodies Request Body Post Application Json Array Obj Camel Case", async () => {
    ...
    expect(result.statusCode).toBe(200);
    expect(result.arrObjValueCamelCase).toEqual({
        json: [
            {
                anyVal: "any example",
                boolOptVal: true,
...
test("Request Bodies Request Body Post Application Json Array Of Primitive", async () => {
    ...
    expect(result.statusCode).toBe(200);
    expect(result.res).toEqual(["hello", "world"]);
});
...
test("Request Bodies Request Body Post Application Json Map Obj", async () => {
    ...
    expect(result.statusCode).toBe(200);
    expect(result.mapObjValue).toEqual({
        json: {
            mapElem1: {
                bool: true,
                date: new RFCDate("2020-01-01"),
...
test("Request Bodies Request Body Post Application Json Map Obj Camel Case", async () => {
    ...
    expect(result.statusCode).toBe(200);
    expect(result.mapObjValueCamelCase).toEqual({
        json: {
            mapElem1: {
                anyVal: "any example",
                boolOptVal: true,
...
test("Request Bodies Request Body Post Form Deep", async () => {
    ...
    expect(result.statusCode).toBe(200);
    expect(sortJSONObjectKeys(result.res?.form.arr, [])).toEqual(
    ...
    expect(result.res?.form.bool).toEqual("true");
    expect(result.res?.form.int).toEqual("1");
    expect(sortJSONObjectKeys(result.res?.form.map, [])).toEqual(
        '{"key":{"any":"any","bigint":8821239038968084,"bigintStr":"9223372036854775808","bool":true,"boolOpt":true,"date":"2020-01-01","dateTime":"2020-01-01T00:00:00.001Z","decimal":3.141592653589793,"decimalStr":"3.14159265358979344719667586","enum":"one","float32":1.1,"float64Str":"1.1","int":1,"int32":1,"int32Enum":55,"int64Str":"100","intEnum":2,"num":1.1,"str":"test","strOpt":"testOptional"},"key2":{"any":"any","bigint":8821239038968084,"bigintStr":"9223372036854775808","bool":true,"boolOpt":true,"date":"2020-01-01","dateTime":"2020-01-01T00:00:00.001Z","decimal":3.141592653589793,"decimalStr":"3.14159265358979344719667586","enum":"one","float32":1.1,"float64Str":"1.1","int":1,"int32":1,"int32Enum":55,"int64Str":"100","intEnum":2,"num":1.1,"str":"test","strOpt":"testOptional"}}'
    );
    expect(result.res?.form.num).toEqual("1.1");
    expect(sortJSONObjectKeys(result.res?.form.obj, [])).toEqual(
        '{"any":"any","bigint":8821239038968084,"bigintStr":"9223372036854775808","bool":true,"boolOpt":true,"date":"2020-01-01","dateTime":"2020-01-01T00:00:00.001Z","decimal":3.141592653589793,"decimalStr":"3.14159265358979344719667586","enum":"one","float32":1.1,"float64Str":"1.1","int":1,"int32":1,"int32Enum":55,"int64Str":"100","intEnum":2,"num":1.1,"str":"test","strOpt":"testOptional"}'
    );
    expect(result.res?.form.str).toEqual("test");
});
...
test("Request Bodies Request Body Post Form Simple", async () => {
    ...
    expect(result.statusCode).toBe(200);
    expect(result.res?.form.any).toEqual("any");
    expect(result.res?.form.bigint).toEqual("8821239038968084");
    expect(result.res?.form.bigintStr).toEqual("9223372036854775808");
    expect(result.res?.form.bool).toEqual("true");
    expect(result.res?.form.boolOpt).toEqual("true");
    expect(result.res?.form.date).toEqual("2020-01-01");
    expect(result.res?.form.dateTime).toEqual("2020-01-01T00:00:00.001Z");
    expect(result.res?.form.decimal).toEqual("3.141592653589793");
    expect(result.res?.form.decimalStr).toEqual("3.14159265358979344719667586");
    expect(result.res?.form.enum).toEqual("one");
    expect(result.res?.form.float32).toEqual("1.1");
    expect(result.res?.form.int).toEqual("1");
    expect(result.res?.form.int32).toEqual("1");
    expect(result.res?.form.int32Enum).toEqual("55");
    expect(result.res?.form.intEnum).toEqual("2");
    expect(result.res?.form.intOptNull).toBeUndefined();
    expect(result.res?.form.num).toEqual("1.1");
    expect(result.res?.form.numOptNull).toBeUndefined();
    expect(result.res?.form.str).toEqual("test");
    expect(result.res?.form.strOpt).toEqual("testOptional");
});
...
test("Request Bodies Request Body Post Json Data Types Date Time", async () => {
    ...
    expect(result.statusCode).toBe(200);
    expect(result.object?.data).toEqual('"2020-01-01T00:00:00.001Z"');
    expect(result.object?.json).toEqual(new Date("2020-01-01T00:00:00.001Z"));
});
...
test("Request Bodies Request Body Post Json Data Types Map Date Time", async () => {
    ...
    expect(result.statusCode).toBe(200);
    expect(result.object?.data).toEqual('{"test":"2020-01-01T00:00:00.001Z"}');
...
test("Request Bodies Request Body Read And Write", async () => {
    ...
    expect(result.statusCode).toBe(200);
    expect(result.readWriteObject).toEqual({
        num3: 4,
        sum: 7,
    });
});
...
test("Request Bodies Request Body Read Only Input", async () => {
    ...
    expect(result.statusCode).toBe(200);
    expect(result.readOnlyObject).toEqual({
        bool: true,
        num: 1,
        string: "hello",
    });
...
test("Request Bodies Request Body Read Only Union", async () => {
    ...
    expect(result.statusCode).toBe(200);
    expect(result.weaklyTypedOneOfReadOnlyObject).toEqual({
        bool: true,
        num: 1,
        string: "hello",
    });
...
test("Request Bodies Request Body Write Only Output", async () => {
    ...
    expect(result.statusCode).toBe(200);
    expect(result.writeOnlyObject).toEqual({});
});
