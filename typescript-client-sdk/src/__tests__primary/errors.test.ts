...
test("Test Status Get Error Default Error Codes", async () => {
  ...
  await sdk.errors.statusGetError(400).then(
    ...
    (err) => {
      ...
      expect(`${err}`).toBe(
        "APIError: API error occurred: Status 400 Content-Type text/html; charset=utf-8",
      );
    },
  );
  ...
  await sdk.errors.statusGetError(500).then(
    ...
    (err) => {
      expect(err).toBeInstanceOf(APIError);
      expect(`${err}`).toBe(
        "APIError: API error occurred: Status 500 Content-Type text/html; charset=utf-8",
      );
    },
  );
});
...
test("Test Status Get Error X-Speakeasy-Errors", async () => {
  ...
  await sdk.errors.statusGetXSpeakeasyErrors(400).then(
    ...
    (err) => {
      ...
      expect(`${err}`).toBe(
        "APIError: API error occurred: Status 400 Content-Type application/json",
      );
    },
  );
  ...
  await sdk.errors.statusGetXSpeakeasyErrors(401).then(
    ...
    (err) => {
      ...
      expect(`${err}`).toBe(
        "APIError: API error occurred: Status 401 Content-Type application/json",
      );
    },
  );
  ...
  await sdk.errors.statusGetXSpeakeasyErrors(402).then(
    ...
    (err) => {
      ...
      expect(`${err}`).toBe(
        "APIError: API error occurred: Status 402 Content-Type application/json",
      );
    },
  );
