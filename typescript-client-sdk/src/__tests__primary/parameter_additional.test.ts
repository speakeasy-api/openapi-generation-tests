...
test("Test Mixed Query Params", async () => {
  ...
  expect(res.httpMeta.response.status).toBe(200);
  expect(res.res?.url).toBe(
    'http://localhost:35123/anything/queryParams/mixed?deepObjectParam[bool]=true&deepObjectParam[date]=2020-01-01&deepObjectParam[dateTime]=2020-01-01T00%3A00%3A00.001Z&deepObjectParam[enum]=one&deepObjectParam[float32]=1.1&deepObjectParam[int]=1&deepObjectParam[int32]=1&deepObjectParam[int32Enum]=55&deepObjectParam[intEnum]=2&deepObjectParam[num]=1.1&deepObjectParam[str]=test&deepObjectParam[any]=any&deepObjectParam[boolOpt]=true&deepObjectParam[strOpt]=testOptional&bool=true&date=2020-01-01&dateTime=2020-01-01T00%3A00%3A00.001Z&enum=one&float32=1.1&int=1&int32=1&int32Enum=55&intEnum=2&num=1.1&str=test&any=any&boolOpt=true&strOpt=testOptional&jsonParam={"bool"%3Atrue%2C"date"%3A"2020-01-01"%2C"dateTime"%3A"2020-01-01T00%3A00%3A00.001Z"%2C"enum"%3A"one"%2C"float32"%3A1.1%2C"int"%3A1%2C"int32"%3A1%2C"int32Enum"%3A55%2C"intEnum"%3A2%2C"num"%3A1.1%2C"str"%3A"test"%2C"any"%3A"any"%2C"boolOpt"%3Atrue%2C"strOpt"%3A"testOptional"}',
  );
