...
import { NullableRequiredEmptyObjectPostRequestBody } from "../sdk/models/operations/nullablerequiredemptyobjectpost.js";
import { NullableRequiredSharedObjectPostRequestBody } from "../sdk/models/operations/nullablerequiredsharedobjectpost.js";
import {
  NullableRequiredEnum,
  NullableRequiredPropertyPostRequestBody,
} from "../sdk/models/operations/nullablerequiredpropertypost.js";
  ...
  const testCases: Array<{
    ...
    },
    {
      ...
      input: {
        ...
        nullableRequiredDateTime: new Date("2020-01-01T00:00:00.001Z"),
        nullableRequiredBigIntStr: BigInt("9223372036854775807"),
        nullableRequiredDecimalStr: new Decimal(
      ...
      expected: {
        ...
        NullableRequiredDateTime: "2020-01-01T00:00:00.001Z",
