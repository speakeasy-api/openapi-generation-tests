...
test("Response Body Override Accept Header", async () => {
  ...
  expect(res.httpMeta.response.status).toBe(200);
  expect(res.httpMeta.response.headers.get("content-type")).toContain(
    "text/plain",
  );
