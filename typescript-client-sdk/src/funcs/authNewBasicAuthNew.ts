...
import { BasicAuthNewServerList } from "../sdk/models/operations/basicauthnew.js";
import * as operations from "../sdk/models/operations/index.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";
import * as z from "zod";

export async function authNewBasicAuthNew(
    client$: SDKCore,
...
> {
    ...
    const baseURL$ =
        options?.serverURL || pathToFunc(BasicAuthNewServerList[0], { charEncoding: "percent" })();
    ...
    const context = { operationID: "basicAuthNew", oAuth2Scopes: [], securitySource: security };
