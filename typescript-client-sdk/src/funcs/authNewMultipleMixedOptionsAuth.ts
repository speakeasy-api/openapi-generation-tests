...
import { MultipleMixedOptionsAuthServerList } from "../sdk/models/operations/multiplemixedoptionsauth.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";

export async function authNewMultipleMixedOptionsAuth(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(MultipleMixedOptionsAuthServerList[0], {
