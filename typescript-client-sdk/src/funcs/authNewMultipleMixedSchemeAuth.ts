...
import { MultipleMixedSchemeAuthServerList } from "../sdk/models/operations/multiplemixedschemeauth.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";

export async function authNewMultipleMixedSchemeAuth(
  client$: SDKCore,
...
> {
  ...
  const baseURL$ = options?.serverURL
    || pathToFunc(MultipleMixedSchemeAuthServerList[0], {
