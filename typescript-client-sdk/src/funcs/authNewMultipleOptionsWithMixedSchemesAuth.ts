...
import { MultipleOptionsWithMixedSchemesAuthServerList } from "../sdk/models/operations/multipleoptionswithmixedschemesauth.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";
import * as z from "zod";

export async function authNewMultipleOptionsWithMixedSchemesAuth(
    client$: SDKCore,
...
> {
    ...
    const baseURL$ =
        options?.serverURL ||
        pathToFunc(MultipleOptionsWithMixedSchemesAuthServerList[0], { charEncoding: "percent" })();
