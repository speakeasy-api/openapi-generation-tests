...
import { MultipleSimpleSchemeAuthServerList } from "../sdk/models/operations/multiplesimpleschemeauth.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";

export async function authNewMultipleSimpleSchemeAuth(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(MultipleSimpleSchemeAuthServerList[0], {
