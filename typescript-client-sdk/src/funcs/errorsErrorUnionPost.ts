...
import { ErrorUnionPostServerList } from "../sdk/models/operations/errorunionpost.js";
import * as operations from "../sdk/models/operations/index.js";
import { Result } from "../sdk/types/fp.js";

export async function errorsErrorUnionPost(
  client$: SDKCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.ErrorUnionPostRequestBody$outboundSchema.parse(value$),
