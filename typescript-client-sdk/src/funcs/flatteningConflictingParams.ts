...
export async function flatteningConflictingParams(
  client$: SDKCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.ConflictingParamsRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/anything/flattening/conflictingParams/{str}")(
    pathParams$,
  );
