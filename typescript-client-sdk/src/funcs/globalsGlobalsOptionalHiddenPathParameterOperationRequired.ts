 ...
 */
export async function globalsGlobalsOptionalHiddenPathParameterOperationRequired(
  client: SDKCore,
  _request:
...
> {
  const pathParams = {
    globalOptionalHiddenPathParam: encodeSimple(
      "globalOptionalHiddenPathParam",
      client._options.globalOptionalHiddenPathParam,
