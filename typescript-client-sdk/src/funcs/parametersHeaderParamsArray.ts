...
export async function parametersHeaderParamsArray(
  client$: SDKCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.HeaderParamsArrayRequest$outboundSchema.parse(value$),
  ...
  const headers$ = new Headers({
    ...
    "X-Header-Array": encodeSimple$(
      "X-Header-Array",
      payload$["X-Header-Array"],
