...
export async function parametersMixedParametersPrimitives(
  client$: SDKCore,
  headerParam: string,
  pathParam: string,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.MixedParametersPrimitivesRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/anything/mixedParams/path/{pathParam}")(
    pathParams$,
  );
