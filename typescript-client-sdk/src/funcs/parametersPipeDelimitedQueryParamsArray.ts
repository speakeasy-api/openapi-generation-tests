...
import { encodePipeDelimitedQuery, queryJoin } from "../lib/encodings.js";
...
export async function parametersPipeDelimitedQueryParamsArray(
  client: SDKCore,
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.PipeDelimitedQueryParamsArrayRequest$outboundSchema.parse(
        value,
      ),
