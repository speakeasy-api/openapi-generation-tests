...
export async function parametersSimplePathParameterMaps(
  client$: SDKCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.SimplePathParameterMapsRequest$outboundSchema.parse(value$),
  ...
  const pathParams$ = {
    ...
    mapParamExploded: encodeSimple$(
      "mapParamExploded",
      payload$.mapParamExploded,
