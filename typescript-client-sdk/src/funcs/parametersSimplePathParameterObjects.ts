...
export async function parametersSimplePathParameterObjects(
  client: SDKCore,
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SimplePathParameterObjectsRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    objParamExploded: encodeSimple(
      "objParamExploded",
      payload.objParamExploded,
