...
export async function requestBodiesNullableRequiredEmptyObjectPost(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.NullableRequiredEmptyObjectPostRequestBody$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.NullableRequiredEmptyObjectPostResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
  )(response);
  if (!result.ok) {
