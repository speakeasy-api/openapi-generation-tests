...
export async function requestBodiesNullableRequiredSharedObjectPost(
  client: SDKCore,
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.NullableRequiredSharedObjectPostRequestBody$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.NullableRequiredSharedObjectPostResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
  )(response);
  if (!result.ok) {
