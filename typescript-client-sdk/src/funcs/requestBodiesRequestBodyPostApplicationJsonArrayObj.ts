...
export async function requestBodiesRequestBodyPostApplicationJsonArrayObj(
    client$: SDKCore,
...
> {
    ...
    const path$ = pathToFunc("/anything/requestBodies/post/application/json/array/objResponse")();
