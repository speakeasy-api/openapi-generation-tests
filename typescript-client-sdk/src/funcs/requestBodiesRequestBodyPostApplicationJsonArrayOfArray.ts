...
import { RequestBodyPostApplicationJsonArrayOfArrayServerList } from "../sdk/models/operations/requestbodypostapplicationjsonarrayofarray.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";

export async function requestBodiesRequestBodyPostApplicationJsonArrayOfArray(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.array(z.array(shared.SimpleObject$outboundSchema)).parse(value),
