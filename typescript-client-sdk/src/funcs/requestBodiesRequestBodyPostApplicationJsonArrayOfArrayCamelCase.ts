...
import { RequestBodyPostApplicationJsonArrayOfArrayCamelCaseServerList } from "../sdk/models/operations/requestbodypostapplicationjsonarrayofarraycamelcase.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";

export async function requestBodiesRequestBodyPostApplicationJsonArrayOfArrayCamelCase(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.array(z.array(shared.SimpleObjectCamelCase$outboundSchema)).parse(
        value,
      ),
