...
import { RequestBodyPostApplicationJsonArrayOfMapCamelCaseServerList } from "../sdk/models/operations/requestbodypostapplicationjsonarrayofmapcamelcase.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";
import * as z from "zod";

export async function requestBodiesRequestBodyPostApplicationJsonArrayOfMapCamelCase(
    client$: SDKCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => z.array(z.record(shared.SimpleObjectCamelCase$outboundSchema)).parse(value$),
