...
import { RequestBodyPostApplicationJsonMapServerList } from "../sdk/models/operations/requestbodypostapplicationjsonmap.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";
import * as z from "zod";

export async function requestBodiesRequestBodyPostApplicationJsonMap(
    client$: SDKCore,
...
> {
    ...
    const baseURL$ =
        options?.serverURL ||
        pathToFunc(RequestBodyPostApplicationJsonMapServerList[0], { charEncoding: "percent" })();
