...
import { RequestBodyPostApplicationJsonMapCamelCaseServerList } from "../sdk/models/operations/requestbodypostapplicationjsonmapcamelcase.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";

export async function requestBodiesRequestBodyPostApplicationJsonMapCamelCase(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.record(shared.SimpleObjectCamelCase$outboundSchema).parse(value),
