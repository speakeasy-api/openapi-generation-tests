...
import { RequestBodyPostApplicationJsonMapOfArrayServerList } from "../sdk/models/operations/requestbodypostapplicationjsonmapofarray.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";

export async function requestBodiesRequestBodyPostApplicationJsonMapOfArray(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.record(z.array(shared.SimpleObject$outboundSchema)).parse(value),
