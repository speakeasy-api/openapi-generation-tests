...
import { RequestBodyPostApplicationJsonMapOfArrayCamelCaseServerList } from "../sdk/models/operations/requestbodypostapplicationjsonmapofarraycamelcase.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";
import * as z from "zod";

export async function requestBodiesRequestBodyPostApplicationJsonMapOfArrayCamelCase(
    client$: SDKCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => z.record(z.array(shared.SimpleObjectCamelCase$outboundSchema)).parse(value$),
