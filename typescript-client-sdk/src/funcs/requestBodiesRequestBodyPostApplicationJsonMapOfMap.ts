...
import { RequestBodyPostApplicationJsonMapOfMapServerList } from "../sdk/models/operations/requestbodypostapplicationjsonmapofmap.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";

export async function requestBodiesRequestBodyPostApplicationJsonMapOfMap(
  client$: SDKCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      z.record(z.record(shared.SimpleObject$outboundSchema)).parse(value$),
