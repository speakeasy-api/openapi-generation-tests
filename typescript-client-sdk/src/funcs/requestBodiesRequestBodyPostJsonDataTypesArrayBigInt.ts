...
export async function requestBodiesRequestBodyPostJsonDataTypesArrayBigInt(
    client$: SDKCore,
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.RequestBodyPostJsonDataTypesArrayBigIntResponseBody$inboundSchema),
        m$.fail(["4XX", "5XX"])
    )(response);
    if (!result$.ok) {
        return result$;
