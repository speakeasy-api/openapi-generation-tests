...
export async function requestBodiesRequestBodyPostMultipleContentTypesComponentFilteredDefaultTest(
    client$: SDKCore,
...
> {
    ...
    >(
        m$.json(
            200,
            operations.RequestBodyPostMultipleContentTypesComponentFilteredDefaultTestRes$inboundSchema
        ),
        m$.fail(["4XX", "5XX"])
    )(response);
    if (!result$.ok) {
