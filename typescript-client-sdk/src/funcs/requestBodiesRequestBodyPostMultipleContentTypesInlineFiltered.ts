...
export async function requestBodiesRequestBodyPostMultipleContentTypesInlineFiltered(
    client$: SDKCore,
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.RequestBodyPostMultipleContentTypesInlineFilteredRes$inboundSchema),
        m$.fail(["4XX", "5XX"])
    )(response);
    if (!result$.ok) {
        return result$;
