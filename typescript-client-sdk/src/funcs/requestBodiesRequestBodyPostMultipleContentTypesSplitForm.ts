...
export async function requestBodiesRequestBodyPostMultipleContentTypesSplitForm(
  client: SDKCore,
...
> {
  ...
  >(
    M.json(
      200,
      operations.RequestBodyPostMultipleContentTypesSplitFormRes$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
  )(response);
  if (!result.ok) {
