...
export async function requestBodiesRequestBodyPostMultipleContentTypesSplitJson(
  client: SDKCore,
...
> {
  ...
  >(
    M.json(
      200,
      operations.RequestBodyPostMultipleContentTypesSplitJsonRes$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response);
