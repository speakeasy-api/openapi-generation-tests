...
export async function requestBodiesRequestBodyPostMultipleContentTypesSplitMultipart(
  client: SDKCore,
  request:
...
> {
  ...
  appendForm(body, "bool2", payload.bool2);
  appendForm(body, "num2", payload.num2);
  appendForm(body, "str2", payload.str2);
