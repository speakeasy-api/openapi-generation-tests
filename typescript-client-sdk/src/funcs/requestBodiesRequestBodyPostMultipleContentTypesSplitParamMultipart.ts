...
export async function requestBodiesRequestBodyPostMultipleContentTypesSplitParamMultipart(
  client: SDKCore,
  paramStr: string,
  requestBody:
...
> {
  ...
  appendForm(body, "bool2", payload.RequestBody.bool2);
  appendForm(body, "num2", payload.RequestBody.num2);
  appendForm(body, "str2", payload.RequestBody.str2);
