...
import { RequestBodyReadAndWriteServerList } from "../sdk/models/operations/requestbodyreadandwrite.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";

export async function requestBodiesRequestBodyReadAndWrite(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(RequestBodyReadAndWriteServerList[0], {
