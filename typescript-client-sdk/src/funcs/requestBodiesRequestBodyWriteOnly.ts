...
import { RequestBodyWriteOnlyServerList } from "../sdk/models/operations/requestbodywriteonly.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";

export async function requestBodiesRequestBodyWriteOnly(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(RequestBodyWriteOnlyServerList[0], {
