...
import { RequestBodyWriteOnlyOutputServerList } from "../sdk/models/operations/requestbodywriteonlyoutput.js";
import * as shared from "../sdk/models/shared/index.js";
import { Result } from "../sdk/types/fp.js";

export async function requestBodiesRequestBodyWriteOnlyOutput(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(RequestBodyWriteOnlyOutputServerList[0], {
