...
export async function responseBodiesResponseBodyAdditionalPropertiesComplexNumbersPost(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.ObjWithComplexNumbersAdditionalProperties$outboundSchema.parse(
        value,
      ),
