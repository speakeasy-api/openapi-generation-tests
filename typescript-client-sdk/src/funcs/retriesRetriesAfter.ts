...
import { RetriesAfterServerList } from "../sdk/models/operations/retriesafter.js";
import { Result } from "../sdk/types/fp.js";

export async function retriesRetriesAfter(
    client$: SDKCore,
    requestId: string,
...
> {
    ...
    const baseURL$ =
        options?.serverURL || pathToFunc(RetriesAfterServerList[0], { charEncoding: "percent" })();
