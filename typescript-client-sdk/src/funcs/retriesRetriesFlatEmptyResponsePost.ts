...
import { RetriesFlatEmptyResponsePostServerList } from "../sdk/models/operations/retriesflatemptyresponsepost.js";
import { Result } from "../sdk/types/fp.js";

export async function retriesRetriesFlatEmptyResponsePost(
  client: SDKCore,
  requestId: string,
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.RetriesFlatEmptyResponsePostRequest$outboundSchema.parse(
        value,
      ),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(RetriesFlatEmptyResponsePostServerList[0], {
