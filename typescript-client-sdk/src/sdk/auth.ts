...
export class Auth extends ClientSDK {
  ...
  ): Promise<operations.ApiKeyAuthToken> {
    return unwrapAsync(authApiKeyAuth(
      this,
      options,
    ));
  }
  ...
  async apiKeyAuthGlobal(
    options?: RequestOptions,
  ): Promise<operations.ApiKeyAuthGlobalToken> {
    return unwrapAsync(authApiKeyAuthGlobal(
      this,
      options,
    ));
  }
  ...
  async basicAuth(
    ...
    return unwrapAsync(authBasicAuth(
      this,
      security,
      passwd,
      user,
  ...
  async bearerAuth(
    ...
    return unwrapAsync(authBearerAuth(
      this,
      security,
      options,
    ));
  ...
  async globalBearerAuth(
    options?: RequestOptions,
  ): Promise<operations.GlobalBearerAuthToken> {
    return unwrapAsync(authGlobalBearerAuth(
      this,
      options,
    ));
  }
  ...
  async oauth2Auth(
    options?: RequestOptions,
  ): Promise<operations.Oauth2AuthToken> {
    return unwrapAsync(authOauth2Auth(
      this,
      options,
    ));
  }
  ...
  async oauth2Override(
    options?: RequestOptions,
  ): Promise<operations.Oauth2OverrideToken> {
    return unwrapAsync(authOauth2Override(
      this,
      options,
    ));
  }
  ...
  async openIdConnectAuth(
    ...
    return unwrapAsync(authOpenIdConnectAuth(
      this,
      security,
      options,
    ));
