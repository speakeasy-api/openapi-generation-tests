...
export class AuthNew extends ClientSDK {
    async authGlobal(
        ...
        return unwrapAsync(authNewAuthGlobal(this, request, options));
    }
    ...
    async basicAuthNew(
        ...
        return unwrapAsync(authNewBasicAuthNew(this, request, security, options));
    }
    ...
    async customSchemeAppId(
        ...
        return unwrapAsync(authNewCustomSchemeAppId(this, security, options));
    }
    ...
    async multipleMixedOptionsAuth(
        ...
        return unwrapAsync(authNewMultipleMixedOptionsAuth(this, request, security, options));
    }
    ...
    async multipleMixedSchemeAuth(
        ...
        return unwrapAsync(authNewMultipleMixedSchemeAuth(this, request, security, options));
    }
    ...
    async multipleOptionsWithMixedSchemesAuth(
        ...
        return unwrapAsync(
            authNewMultipleOptionsWithMixedSchemesAuth(this, request, security, options)
        );
    }
    ...
    async multipleOptionsWithSimpleSchemesAuth(
        ...
        return unwrapAsync(
            authNewMultipleOptionsWithSimpleSchemesAuth(this, request, security, options)
        );
    }
    ...
    async multipleSimpleOptionsAuth(
        ...
        return unwrapAsync(authNewMultipleSimpleOptionsAuth(this, request, security, options));
    }
    ...
    async multipleSimpleSchemeAuth(
        ...
        return unwrapAsync(authNewMultipleSimpleSchemeAuth(this, request, security, options));
    }
    ...
    async oauth2AuthNew(
        ...
        return unwrapAsync(authNewOauth2AuthNew(this, request, options));
    }
    ...
    async openIdConnectAuthNew(
        ...
        return unwrapAsync(authNewOpenIdConnectAuthNew(this, request, security, options));
    }
}
