...
export class Errors extends ClientSDK {
    ...
    async connectionErrorGet(
        ...
        const [result$] = await this.matcher<operations.ConnectionErrorGetResponse>()
            .void(200, operations.ConnectionErrorGetResponse$)
            .fail(["4XX", "5XX"])
    ...
    async statusGetError(
        ...
        const [result$] = await this.matcher<operations.StatusGetErrorResponse>()
            .void([200, 300], operations.StatusGetErrorResponse$)
    ...
    async statusGetXSpeakeasyErrors(
        ...
        const [result$] = await this.matcher<operations.StatusGetXSpeakeasyErrorsResponse>()
            .void([200, 300], operations.StatusGetXSpeakeasyErrorsResponse$)
            .fail([400, 401, "4XX"])
    ...
    async unionErrorsGet(
        ...
        const [result$] = await this.matcher<operations.UnionErrorsGetResponse>()
            .void(200, operations.UnionErrorsGetResponse$)
            .fail(["4XX", "5XX"])
