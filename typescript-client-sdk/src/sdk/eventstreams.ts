...
export class Eventstreams extends ClientSDK {
    ...
    async chat(
        ...
        const context = { operationID: "chat" };
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = operations.ChatResponse$.inboundSchema.parse({
                ...responseFields$,
                chatCompletionStream: response.body,
            });
            return result;
        } else {
    ...
    async differentDataSchemas(
        ...
        const context = { operationID: "differentDataSchemas" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
        ...
        if (this.matchResponse(response, 200, "text/event-stream")) {
            const result = operations.DifferentDataSchemasResponse$.inboundSchema.parse({
                ...responseFields$,
                differentDataSchemas: response.body,
            });
            return result;
        } else {
            const responseBody = await response.text();
    ...
    async json(
        ...
        const context = { operationID: "json" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async multiline(
        ...
        const context = { operationID: "multiline" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async rich(
        ...
        const context = { operationID: "rich" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async text(
        ...
        const context = { operationID: "text" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
