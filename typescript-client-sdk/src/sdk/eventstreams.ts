...
export class Eventstreams extends ClientSDK {
    async chat(
        ...
        return unwrapAsync(eventstreamsChat(this, request, options));
    }
    ...
    async chatSkipSentinel(
        ...
        return unwrapAsync(eventstreamsChatSkipSentinel(this, request, options));
    }

    async differentDataSchemas(
        options?: RequestOptions & { serverURL?: string }
    ): Promise<EventStream<shared.DifferentDataSchemas>> {
        return unwrapAsync(eventstreamsDifferentDataSchemas(this, options));
    }

    async json(
        options?: RequestOptions & { serverURL?: string }
    ): Promise<operations.JsonResponse> {
        return unwrapAsync(eventstreamsJson(this, options));
    }

    async multiline(
        options?: RequestOptions & { serverURL?: string }
    ): Promise<EventStream<shared.TextEvent>> {
        return unwrapAsync(eventstreamsMultiline(this, options));
    }

    async rich(
        options?: RequestOptions & { serverURL?: string }
    ): Promise<EventStream<shared.RichStream>> {
        return unwrapAsync(eventstreamsRich(this, options));
    }

    async text(
        options?: RequestOptions & { serverURL?: string }
    ): Promise<EventStream<shared.TextEvent>> {
        return unwrapAsync(eventstreamsText(this, options));
    }
}
