...
export class Flattening extends ClientSDK {
    async componentBodyAndParamConflict(
        ...
        return unwrapAsync(
            flatteningComponentBodyAndParamConflict(this, simpleObject, str, options)
        );
    }
    ...
    async componentBodyAndParamNoConflict(
        ...
        return unwrapAsync(
            flatteningComponentBodyAndParamNoConflict(this, paramStr, simpleObject, options)
        );
    }
    ...
    async conflictingParams(
        ...
        return unwrapAsync(
            flatteningConflictingParams(this, strPathParameter, strQueryParameter, options)
        );
    }
    ...
    async inlineBodyAndParamConflict(
        ...
        return unwrapAsync(flatteningInlineBodyAndParamConflict(this, requestBody, str, options));
    }
    ...
    async inlineBodyAndParamNoConflict(
        ...
        return unwrapAsync(
            flatteningInlineBodyAndParamNoConflict(this, requestBody, paramStr, options)
        );
    }
}
