...
import { generationDeprecatedOperationWithMultilineCommentGet } from "../funcs/generationDeprecatedOperationWithMultilineCommentGet.js";
...
export class Generation extends ClientSDK {
   ...
   */
  async deprecatedOperationWithMultilineCommentGet(
    deprecatedParameter?: string | undefined,
    newParameter?: string | undefined,
    options?: RequestOptions,
  ): Promise<void> {
    return unwrapAsync(generationDeprecatedOperationWithMultilineCommentGet(
      this,
      deprecatedParameter,
      newParameter,
      options,
