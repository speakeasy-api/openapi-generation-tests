...
export class Globals extends ClientSDK {
    ...
    async globalsHiddenPost(
        ...
        const pathParams$ = {
            globalHiddenPathParam: enc$.encodeSimple(
        ...
        const query$ = [
            enc$.encodeForm("globalHiddenQueryParam", this.options$.globalHiddenQueryParam, {
                explode: true,
        ...
        headers$.set(
            ...
            enc$.encodeSimple("globalHiddenHeaderParam", this.options$.globalHiddenHeaderParam, {
                explode: false,
                charEncoding: "none",
            })
        );
