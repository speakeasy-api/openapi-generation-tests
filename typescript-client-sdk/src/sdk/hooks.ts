...
export class Hooks extends ClientSDK {
  async authorizationHeaderModification(
    ...
    return unwrapAsync(hooksAuthorizationHeaderModification(
      this,
      options,
    ));
  }
  ...
  async testHooks(
    someParam: string,
    options?: RequestOptions,
  ): Promise<operations.TestHooksRes> {
    return unwrapAsync(hooksTestHooks(
      this,
      someParam,
      options,
    ));
  ...
  async testHooksAfterResponse(
    ...
    return unwrapAsync(hooksTestHooksAfterResponse(
      this,
      options,
    ));
  }
  ...
  async testHooksBeforeCreateRequestPaths(
    ...
    return unwrapAsync(hooksTestHooksBeforeCreateRequestPaths(
      this,
      namespace,
      options,
    ));
  ...
  async testHooksError(
    options?: RequestOptions,
  ): Promise<void> {
    return unwrapAsync(hooksTestHooksError(
      this,
      options,
    ));
  }
