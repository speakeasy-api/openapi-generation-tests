...
export class Hooks extends ClientSDK {
    ...
    async authorizationHeaderModification(
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.AuthorizationHeaderModificationResponse$.inboundSchema.parse({
                        ...responseFields$,
                        token: val$,
                    });
                },
    ...
    async testHooksBeforeCreateRequestPaths(
        ...
        const pathParams$ = {
            namespace: enc$.encodeSimple("namespace", payload$.namespace, {
                explode: false,
                charEncoding: "percent",
            }),
        };
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.TestHooksBeforeCreateRequestPathsResponse$.inboundSchema.parse(
                        {
                            ...responseFields$,
                            res: val$,
                        }
