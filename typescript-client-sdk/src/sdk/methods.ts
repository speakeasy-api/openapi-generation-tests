...
export class Methods extends ClientSDK {
  async methodDelete(
    ...
    return unwrapAsync(methodsMethodDelete(
      this,
      request,
      options,
    ));
  ...
  async methodGet(
    ...
    return unwrapAsync(methodsMethodGet(
      this,
      options,
    ));
  }
  ...
  async methodHead(
    ...
    return unwrapAsync(methodsMethodHead(
      this,
      options,
    ));
  }
  ...
  async methodOptions(
    ...
    return unwrapAsync(methodsMethodOptions(
      this,
      options,
    ));
  }
  ...
  async methodPatch(
    ...
    return unwrapAsync(methodsMethodPatch(
      this,
      request,
      options,
    ));
  ...
  async methodPost(
    ...
    return unwrapAsync(methodsMethodPost(
      this,
      request,
      options,
    ));
  ...
  async methodPut(
    ...
    return unwrapAsync(methodsMethodPut(
      this,
      request,
      options,
    ));
  ...
  async methodTrace(
    ...
    return unwrapAsync(methodsMethodTrace(
      this,
      options,
    ));
  }
