...
export function schemasErrorToJSON(schemasError: SchemasError): string {
  return JSON.stringify(SchemasError$outboundSchema.parse(schemasError));
}
...
/** @internal */
export const ErrorType2$inboundSchema: z.ZodType<
  ErrorType2,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const ErrorType2$outboundSchema: z.ZodType<
  ErrorType2$Outbound,
  z.ZodTypeDef,
  ErrorType2
> = z.instanceof(ErrorType2)
  .transform(v => v.data$)
  .pipe(z.object({
