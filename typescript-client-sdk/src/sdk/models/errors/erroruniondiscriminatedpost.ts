...
export namespace ErrorUnionDiscriminatedPostResponseBody$ {
    ...
    export const inboundSchema = ErrorUnionDiscriminatedPostResponseBody$inboundSchema;
    /** @deprecated use `ErrorUnionDiscriminatedPostResponseBody$outboundSchema` instead. */
    export const outboundSchema = ErrorUnionDiscriminatedPostResponseBody$outboundSchema;
