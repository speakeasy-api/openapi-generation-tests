...
export namespace ComponentBodyAndParamConflictRequest$ {
  ...
  export const inboundSchema =
    ComponentBodyAndParamConflictRequest$inboundSchema;
  /** @deprecated use `ComponentBodyAndParamConflictRequest$outboundSchema` instead. */
  export const outboundSchema =
    ComponentBodyAndParamConflictRequest$outboundSchema;
...
export function componentBodyAndParamConflictRequestToJSON(
  componentBodyAndParamConflictRequest: ComponentBodyAndParamConflictRequest,
): string {
  return JSON.stringify(
    ComponentBodyAndParamConflictRequest$outboundSchema.parse(
      componentBodyAndParamConflictRequest,
    ),
  );
}

export function componentBodyAndParamConflictRequestFromJSON(
  jsonString: string,
): SafeParseResult<ComponentBodyAndParamConflictRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      ComponentBodyAndParamConflictRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ComponentBodyAndParamConflictRequest' from JSON`,
  );
}
...
export function componentBodyAndParamConflictResToJSON(
  componentBodyAndParamConflictRes: ComponentBodyAndParamConflictRes,
): string {
  return JSON.stringify(
    ComponentBodyAndParamConflictRes$outboundSchema.parse(
      componentBodyAndParamConflictRes,
    ),
  );
}

export function componentBodyAndParamConflictResFromJSON(
  jsonString: string,
): SafeParseResult<ComponentBodyAndParamConflictRes, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ComponentBodyAndParamConflictRes$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ComponentBodyAndParamConflictRes' from JSON`,
  );
}
