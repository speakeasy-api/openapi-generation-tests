...
export namespace ConflictingParamsRequest$ {
    ...
    export const inboundSchema: z.ZodType<ConflictingParamsRequest, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace ConflictingParamsRes$ {
    ...
    export const inboundSchema: z.ZodType<ConflictingParamsRes, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace ConflictingParamsResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        res?: ConflictingParamsRes$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<ConflictingParamsResponse, z.ZodTypeDef, Inbound> = z
        .object({
