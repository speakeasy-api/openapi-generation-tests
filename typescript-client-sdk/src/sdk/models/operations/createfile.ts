...
export namespace CreateFileFile$ {
    export const inboundSchema: z.ZodType<CreateFileFile, z.ZodTypeDef, unknown> = z
        .object({
...
export namespace CreateFileRequestBody$ {
    export const inboundSchema: z.ZodType<CreateFileRequestBody, z.ZodTypeDef, unknown> = z
        .object({
