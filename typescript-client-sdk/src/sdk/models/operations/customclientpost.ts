...
export function customClientPostRequestToJSON(
  customClientPostRequest: CustomClientPostRequest,
): string {
  return JSON.stringify(
    CustomClientPostRequest$outboundSchema.parse(customClientPostRequest),
  );
}

export function customClientPostRequestFromJSON(
  jsonString: string,
): SafeParseResult<CustomClientPostRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CustomClientPostRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomClientPostRequest' from JSON`,
  );
}
...
export function customClientPostResToJSON(
  customClientPostRes: CustomClientPostRes,
): string {
  return JSON.stringify(
    CustomClientPostRes$outboundSchema.parse(customClientPostRes),
  );
}

export function customClientPostResFromJSON(
  jsonString: string,
): SafeParseResult<CustomClientPostRes, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CustomClientPostRes$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomClientPostRes' from JSON`,
  );
}
