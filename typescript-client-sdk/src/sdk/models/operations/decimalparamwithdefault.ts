...
export namespace DecimalParamWithDefaultRequest$ {
    ...
    export const inboundSchema: z.ZodType<DecimalParamWithDefaultRequest, z.ZodTypeDef, Inbound> = z
        .object({
            decimalInput: z.number().transform((v) => new Decimal$(v ?? "903275809834567386763")),
        })
        .transform((v) => {
            return {
                ...(v.decimalInput === undefined ? null : { decimalInput: v.decimalInput }),
            };
        });
        ...
        z
            .object({
                decimalInput: z
                    ...
                    .default(() => new Decimal$("903275809834567386763"))
