...
/** @internal */
export const ObjArrParam$inboundSchema: z.ZodType<
  ObjArrParam,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function objArrParamToJSON(objArrParam: ObjArrParam): string {
  return JSON.stringify(ObjArrParam$outboundSchema.parse(objArrParam));
}

export function objArrParamFromJSON(
  jsonString: string,
): SafeParseResult<ObjArrParam, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ObjArrParam$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ObjArrParam' from JSON`,
  );
}
...
export namespace DeepObjectQueryParamsObjectRequest$ {
  ...
  export const outboundSchema =
    DeepObjectQueryParamsObjectRequest$outboundSchema;
...
export function deepObjectQueryParamsObjectRequestToJSON(
  deepObjectQueryParamsObjectRequest: DeepObjectQueryParamsObjectRequest,
): string {
  return JSON.stringify(
    DeepObjectQueryParamsObjectRequest$outboundSchema.parse(
      deepObjectQueryParamsObjectRequest,
    ),
  );
}

export function deepObjectQueryParamsObjectRequestFromJSON(
  jsonString: string,
): SafeParseResult<DeepObjectQueryParamsObjectRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      DeepObjectQueryParamsObjectRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeepObjectQueryParamsObjectRequest' from JSON`,
  );
}
...
export function deepObjectQueryParamsObjectArgsToJSON(
  deepObjectQueryParamsObjectArgs: DeepObjectQueryParamsObjectArgs,
): string {
  return JSON.stringify(
    DeepObjectQueryParamsObjectArgs$outboundSchema.parse(
      deepObjectQueryParamsObjectArgs,
    ),
  );
}

export function deepObjectQueryParamsObjectArgsFromJSON(
  jsonString: string,
): SafeParseResult<DeepObjectQueryParamsObjectArgs, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DeepObjectQueryParamsObjectArgs$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeepObjectQueryParamsObjectArgs' from JSON`,
  );
}
...
export function deepObjectQueryParamsObjectResToJSON(
  deepObjectQueryParamsObjectRes: DeepObjectQueryParamsObjectRes,
): string {
  return JSON.stringify(
    DeepObjectQueryParamsObjectRes$outboundSchema.parse(
      deepObjectQueryParamsObjectRes,
    ),
  );
}

export function deepObjectQueryParamsObjectResFromJSON(
  jsonString: string,
): SafeParseResult<DeepObjectQueryParamsObjectRes, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DeepObjectQueryParamsObjectRes$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeepObjectQueryParamsObjectRes' from JSON`,
  );
}
