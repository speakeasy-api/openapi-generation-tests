...
export namespace DiscriminatedOneMultipleMembershipsRes$ {
    ...
    export const inboundSchema = DiscriminatedOneMultipleMembershipsRes$inboundSchema;
    /** @deprecated use `DiscriminatedOneMultipleMembershipsRes$outboundSchema` instead. */
    export const outboundSchema = DiscriminatedOneMultipleMembershipsRes$outboundSchema;
