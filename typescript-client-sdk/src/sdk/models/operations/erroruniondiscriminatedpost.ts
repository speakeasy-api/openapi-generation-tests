...
export type TaggedError2RequestBody = {
    tag: string;
    taggedError2Message?: TaggedError2Message | undefined;
};
...
> = z.object({
    tag: z.string(),
    taggedError2Message: z.lazy(() => TaggedError2Message$inboundSchema).optional(),
});

/** @internal */
export type TaggedError2RequestBody$Outbound = {
    tag: string;
    taggedError2Message?: TaggedError2Message$Outbound | undefined;
};
...
> = z.object({
    tag: z.string(),
    taggedError2Message: z.lazy(() => TaggedError2Message$outboundSchema).optional(),
});
