...
export const ErrorUnionDiscriminatedPostServerList = [
...
export function taggedError2MessageToJSON(
  taggedError2Message: TaggedError2Message,
): string {
  return JSON.stringify(
    TaggedError2Message$outboundSchema.parse(taggedError2Message),
  );
}

export function taggedError2MessageFromJSON(
  jsonString: string,
): SafeParseResult<TaggedError2Message, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TaggedError2Message$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TaggedError2Message' from JSON`,
  );
}
...
export function taggedError2RequestBodyToJSON(
  taggedError2RequestBody: TaggedError2RequestBody,
): string {
  return JSON.stringify(
    TaggedError2RequestBody$outboundSchema.parse(taggedError2RequestBody),
  );
}

export function taggedError2RequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<TaggedError2RequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TaggedError2RequestBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TaggedError2RequestBody' from JSON`,
  );
}
...
export function taggedError1RequestBodyToJSON(
  taggedError1RequestBody: TaggedError1RequestBody,
): string {
  return JSON.stringify(
    TaggedError1RequestBody$outboundSchema.parse(taggedError1RequestBody),
  );
}

export function taggedError1RequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<TaggedError1RequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TaggedError1RequestBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TaggedError1RequestBody' from JSON`,
  );
}
...
export namespace ErrorUnionDiscriminatedPostRequestBody$ {
  ...
  export const inboundSchema =
    ErrorUnionDiscriminatedPostRequestBody$inboundSchema;
  /** @deprecated use `ErrorUnionDiscriminatedPostRequestBody$outboundSchema` instead. */
  export const outboundSchema =
    ErrorUnionDiscriminatedPostRequestBody$outboundSchema;
...
export function errorUnionDiscriminatedPostRequestBodyToJSON(
  errorUnionDiscriminatedPostRequestBody:
    ErrorUnionDiscriminatedPostRequestBody,
): string {
  return JSON.stringify(
    ErrorUnionDiscriminatedPostRequestBody$outboundSchema.parse(
      errorUnionDiscriminatedPostRequestBody,
    ),
  );
}

export function errorUnionDiscriminatedPostRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<ErrorUnionDiscriminatedPostRequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      ErrorUnionDiscriminatedPostRequestBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ErrorUnionDiscriminatedPostRequestBody' from JSON`,
  );
}
