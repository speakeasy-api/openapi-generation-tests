...
/** @internal */
export const FlattenedUnionResponseResponseBodiesResponseBody$inboundSchema: z.ZodType<
    FlattenedUnionResponseResponseBodiesResponseBody,
    z.ZodTypeDef,
    unknown
> = z.object({
...
/** @internal */
export const FlattenedUnionResponseResponseBodiesResponseBody$outboundSchema: z.ZodType<
...
export namespace FlattenedUnionResponseResponseBodiesResponseBody$ {
    ...
    export const inboundSchema = FlattenedUnionResponseResponseBodiesResponseBody$inboundSchema;
    /** @deprecated use `FlattenedUnionResponseResponseBodiesResponseBody$outboundSchema` instead. */
    export const outboundSchema = FlattenedUnionResponseResponseBodiesResponseBody$outboundSchema;
    /** @deprecated use `FlattenedUnionResponseResponseBodiesResponseBody$Outbound` instead. */
    export type Outbound = FlattenedUnionResponseResponseBodiesResponseBody$Outbound;
}
...
export namespace FlattenedUnionResponseResponseBody$ {
    ...
    export const outboundSchema = FlattenedUnionResponseResponseBody$outboundSchema;
