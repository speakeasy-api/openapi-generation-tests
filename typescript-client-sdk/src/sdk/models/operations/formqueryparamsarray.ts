...
export namespace FormQueryParamsArrayRequest$ {
    export const inboundSchema: z.ZodType<FormQueryParamsArrayRequest, z.ZodTypeDef, unknown> = z
        .object({
...
export namespace FormQueryParamsArrayArgs$ {
    export const inboundSchema: z.ZodType<FormQueryParamsArrayArgs, z.ZodTypeDef, unknown> = z
        .object({
            arrParam: z.string(),
...
export namespace FormQueryParamsArrayRes$ {
    export const inboundSchema: z.ZodType<FormQueryParamsArrayRes, z.ZodTypeDef, unknown> = z
        .object({
