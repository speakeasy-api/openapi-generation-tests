...
export namespace ObjParam$ {
    ...
    export const inboundSchema: z.ZodType<ObjParam, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace ObjParamExploded$ {
    ...
    export const inboundSchema: z.ZodType<ObjParamExploded, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace FormQueryParamsCamelObjectRequest$ {
    export type Inbound = {
        obj_param_exploded: ObjParamExploded$.Inbound;
        obj_param?: ObjParam$.Inbound | undefined;
    };
...
export namespace FormQueryParamsCamelObjectArgs$ {
    ...
    export const inboundSchema: z.ZodType<FormQueryParamsCamelObjectArgs, z.ZodTypeDef, Inbound> = z
        .object({
            item_count: z.string(),
...
export namespace FormQueryParamsCamelObjectRes$ {
    export type Inbound = {
        args: FormQueryParamsCamelObjectArgs$.Inbound;
        url: string;
    };

    export const inboundSchema: z.ZodType<FormQueryParamsCamelObjectRes, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace FormQueryParamsCamelObjectResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        res?: FormQueryParamsCamelObjectRes$.Inbound | undefined;
    };
