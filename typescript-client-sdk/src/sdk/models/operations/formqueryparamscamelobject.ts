...
/** @internal */
export const ObjParam$inboundSchema: z.ZodType<
  ObjParam,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const ObjParam$outboundSchema: z.ZodType<
  ObjParam$Outbound,
  z.ZodTypeDef,
  ObjParam
> = z.object({
...
export function objParamToJSON(objParam: ObjParam): string {
  return JSON.stringify(ObjParam$outboundSchema.parse(objParam));
}

export function objParamFromJSON(
  jsonString: string,
): SafeParseResult<ObjParam, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ObjParam$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ObjParam' from JSON`,
  );
}

/** @internal */
export const ObjParamExploded$inboundSchema: z.ZodType<
  ObjParamExploded,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function objParamExplodedToJSON(
  objParamExploded: ObjParamExploded,
): string {
  return JSON.stringify(
    ObjParamExploded$outboundSchema.parse(objParamExploded),
  );
}

export function objParamExplodedFromJSON(
  jsonString: string,
): SafeParseResult<ObjParamExploded, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ObjParamExploded$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ObjParamExploded' from JSON`,
  );
}
...
export namespace FormQueryParamsCamelObjectRequest$ {
  ...
  export const outboundSchema =
    FormQueryParamsCamelObjectRequest$outboundSchema;
...
export function formQueryParamsCamelObjectRequestToJSON(
  formQueryParamsCamelObjectRequest: FormQueryParamsCamelObjectRequest,
): string {
  return JSON.stringify(
    FormQueryParamsCamelObjectRequest$outboundSchema.parse(
      formQueryParamsCamelObjectRequest,
    ),
  );
}

export function formQueryParamsCamelObjectRequestFromJSON(
  jsonString: string,
): SafeParseResult<FormQueryParamsCamelObjectRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => FormQueryParamsCamelObjectRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'FormQueryParamsCamelObjectRequest' from JSON`,
  );
}
...
export function formQueryParamsCamelObjectArgsToJSON(
  formQueryParamsCamelObjectArgs: FormQueryParamsCamelObjectArgs,
): string {
  return JSON.stringify(
    FormQueryParamsCamelObjectArgs$outboundSchema.parse(
      formQueryParamsCamelObjectArgs,
    ),
  );
}

export function formQueryParamsCamelObjectArgsFromJSON(
  jsonString: string,
): SafeParseResult<FormQueryParamsCamelObjectArgs, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => FormQueryParamsCamelObjectArgs$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'FormQueryParamsCamelObjectArgs' from JSON`,
  );
}
...
export function formQueryParamsCamelObjectResToJSON(
  formQueryParamsCamelObjectRes: FormQueryParamsCamelObjectRes,
): string {
  return JSON.stringify(
    FormQueryParamsCamelObjectRes$outboundSchema.parse(
      formQueryParamsCamelObjectRes,
    ),
  );
}

export function formQueryParamsCamelObjectResFromJSON(
  jsonString: string,
): SafeParseResult<FormQueryParamsCamelObjectRes, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => FormQueryParamsCamelObjectRes$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'FormQueryParamsCamelObjectRes' from JSON`,
  );
}
