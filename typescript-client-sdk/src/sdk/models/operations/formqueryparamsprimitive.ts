...
export namespace FormQueryParamsPrimitiveRequest$ {
    ...
    export const inboundSchema: z.ZodType<FormQueryParamsPrimitiveRequest, z.ZodTypeDef, Inbound> =
        z
            .object({
                boolParam: z.boolean(),
...
export namespace FormQueryParamsPrimitiveArgs$ {
    ...
    export const inboundSchema: z.ZodType<FormQueryParamsPrimitiveArgs, z.ZodTypeDef, Inbound> = z
        .object({
            boolParam: z.string(),
            intParam: z.string(),
            numParam: z.string(),
...
export namespace FormQueryParamsPrimitiveRes$ {
    export type Inbound = {
        args: FormQueryParamsPrimitiveArgs$.Inbound;
        url: string;
    };

    export const inboundSchema: z.ZodType<FormQueryParamsPrimitiveRes, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace FormQueryParamsPrimitiveResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        res?: FormQueryParamsPrimitiveRes$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<FormQueryParamsPrimitiveResponse, z.ZodTypeDef, Inbound> =
        z
            .object({
