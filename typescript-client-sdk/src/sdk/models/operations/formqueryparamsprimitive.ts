...
export function formQueryParamsPrimitiveRequestToJSON(
  formQueryParamsPrimitiveRequest: FormQueryParamsPrimitiveRequest,
): string {
  return JSON.stringify(
    FormQueryParamsPrimitiveRequest$outboundSchema.parse(
      formQueryParamsPrimitiveRequest,
    ),
  );
}

export function formQueryParamsPrimitiveRequestFromJSON(
  jsonString: string,
): SafeParseResult<FormQueryParamsPrimitiveRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => FormQueryParamsPrimitiveRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'FormQueryParamsPrimitiveRequest' from JSON`,
  );
}
...
export function formQueryParamsPrimitiveArgsToJSON(
  formQueryParamsPrimitiveArgs: FormQueryParamsPrimitiveArgs,
): string {
  return JSON.stringify(
    FormQueryParamsPrimitiveArgs$outboundSchema.parse(
      formQueryParamsPrimitiveArgs,
    ),
  );
}

export function formQueryParamsPrimitiveArgsFromJSON(
  jsonString: string,
): SafeParseResult<FormQueryParamsPrimitiveArgs, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => FormQueryParamsPrimitiveArgs$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'FormQueryParamsPrimitiveArgs' from JSON`,
  );
}
...
export function formQueryParamsPrimitiveResToJSON(
  formQueryParamsPrimitiveRes: FormQueryParamsPrimitiveRes,
): string {
  return JSON.stringify(
    FormQueryParamsPrimitiveRes$outboundSchema.parse(
      formQueryParamsPrimitiveRes,
    ),
  );
}

export function formQueryParamsPrimitiveResFromJSON(
  jsonString: string,
): SafeParseResult<FormQueryParamsPrimitiveRes, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => FormQueryParamsPrimitiveRes$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'FormQueryParamsPrimitiveRes' from JSON`,
  );
}
