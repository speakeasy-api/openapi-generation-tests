...
export namespace FormQueryParamsRefParamObjectRequest$ {
    ...
    export const inboundSchema = FormQueryParamsRefParamObjectRequest$inboundSchema;
    /** @deprecated use `FormQueryParamsRefParamObjectRequest$outboundSchema` instead. */
    export const outboundSchema = FormQueryParamsRefParamObjectRequest$outboundSchema;
...
export namespace FormQueryParamsRefParamObjectArgs$ {
    ...
    export const outboundSchema = FormQueryParamsRefParamObjectArgs$outboundSchema;
