...
export namespace GlobalBearerAuthToken$ {
    ...
    export const inboundSchema: z.ZodType<GlobalBearerAuthToken, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace GlobalBearerAuthResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        token?: GlobalBearerAuthToken$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<GlobalBearerAuthResponse, z.ZodTypeDef, Inbound> = z
        .object({
