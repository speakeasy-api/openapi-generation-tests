...
export function globalsHiddenPostGlobalsToJSON(
  globalsHiddenPostGlobals: GlobalsHiddenPostGlobals,
): string {
  return JSON.stringify(
    GlobalsHiddenPostGlobals$outboundSchema.parse(globalsHiddenPostGlobals),
  );
}

export function globalsHiddenPostGlobalsFromJSON(
  jsonString: string,
): SafeParseResult<GlobalsHiddenPostGlobals, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GlobalsHiddenPostGlobals$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GlobalsHiddenPostGlobals' from JSON`,
  );
}
...
export function globalsHiddenPostRequestBodyToJSON(
  globalsHiddenPostRequestBody: GlobalsHiddenPostRequestBody,
): string {
  return JSON.stringify(
    GlobalsHiddenPostRequestBody$outboundSchema.parse(
      globalsHiddenPostRequestBody,
    ),
  );
}

export function globalsHiddenPostRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<GlobalsHiddenPostRequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GlobalsHiddenPostRequestBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GlobalsHiddenPostRequestBody' from JSON`,
  );
}
...
export function globalsHiddenPostArgsToJSON(
  globalsHiddenPostArgs: GlobalsHiddenPostArgs,
): string {
  return JSON.stringify(
    GlobalsHiddenPostArgs$outboundSchema.parse(globalsHiddenPostArgs),
  );
}

export function globalsHiddenPostArgsFromJSON(
  jsonString: string,
): SafeParseResult<GlobalsHiddenPostArgs, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GlobalsHiddenPostArgs$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GlobalsHiddenPostArgs' from JSON`,
  );
}
...
export function globalsHiddenPostJsonToJSON(
  globalsHiddenPostJson: GlobalsHiddenPostJson,
): string {
  return JSON.stringify(
    GlobalsHiddenPostJson$outboundSchema.parse(globalsHiddenPostJson),
  );
}

export function globalsHiddenPostJsonFromJSON(
  jsonString: string,
): SafeParseResult<GlobalsHiddenPostJson, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GlobalsHiddenPostJson$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GlobalsHiddenPostJson' from JSON`,
  );
}
...
export function globalsHiddenPostResToJSON(
  globalsHiddenPostRes: GlobalsHiddenPostRes,
): string {
  return JSON.stringify(
    GlobalsHiddenPostRes$outboundSchema.parse(globalsHiddenPostRes),
  );
}

export function globalsHiddenPostResFromJSON(
  jsonString: string,
): SafeParseResult<GlobalsHiddenPostRes, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GlobalsHiddenPostRes$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GlobalsHiddenPostRes' from JSON`,
  );
}
