...
export function headerParamsArrayRequestToJSON(
  headerParamsArrayRequest: HeaderParamsArrayRequest,
): string {
  return JSON.stringify(
    HeaderParamsArrayRequest$outboundSchema.parse(headerParamsArrayRequest),
  );
}

export function headerParamsArrayRequestFromJSON(
  jsonString: string,
): SafeParseResult<HeaderParamsArrayRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => HeaderParamsArrayRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'HeaderParamsArrayRequest' from JSON`,
  );
}
...
export function headerParamsArrayHeadersToJSON(
  headerParamsArrayHeaders: HeaderParamsArrayHeaders,
): string {
  return JSON.stringify(
    HeaderParamsArrayHeaders$outboundSchema.parse(headerParamsArrayHeaders),
  );
}

export function headerParamsArrayHeadersFromJSON(
  jsonString: string,
): SafeParseResult<HeaderParamsArrayHeaders, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => HeaderParamsArrayHeaders$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'HeaderParamsArrayHeaders' from JSON`,
  );
}
...
export function headerParamsArrayResToJSON(
  headerParamsArrayRes: HeaderParamsArrayRes,
): string {
  return JSON.stringify(
    HeaderParamsArrayRes$outboundSchema.parse(headerParamsArrayRes),
  );
}

export function headerParamsArrayResFromJSON(
  jsonString: string,
): SafeParseResult<HeaderParamsArrayRes, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => HeaderParamsArrayRes$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'HeaderParamsArrayRes' from JSON`,
  );
}
