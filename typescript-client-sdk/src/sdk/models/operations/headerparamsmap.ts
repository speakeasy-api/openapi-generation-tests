...
export namespace HeaderParamsMapRequest$ {
    export type Inbound = {
        "X-Header-Map": Record<string, string>;
        "X-Header-Map-Explode": Record<string, string>;
    };

    export const inboundSchema: z.ZodType<HeaderParamsMapRequest, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace HeaderParamsMapHeaders$ {
    ...
    export const inboundSchema: z.ZodType<HeaderParamsMapHeaders, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace HeaderParamsMapRes$ {
    export type Inbound = {
        headers: HeaderParamsMapHeaders$.Inbound;
    };

    export const inboundSchema: z.ZodType<HeaderParamsMapRes, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace HeaderParamsMapResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        res?: HeaderParamsMapRes$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<HeaderParamsMapResponse, z.ZodTypeDef, Inbound> = z
        .object({
