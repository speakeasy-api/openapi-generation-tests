...
export namespace HeaderParamsObjectRequest$ {
    export type Inbound = {
        "X-Header-Obj": shared.SimpleObject$.Inbound;
        "X-Header-Obj-Explode": shared.SimpleObject$.Inbound;
    };

    export const inboundSchema: z.ZodType<HeaderParamsObjectRequest, z.ZodTypeDef, Inbound> = z
        .object({
        ...
        .transform((v) => {
            return {
                xHeaderObj: v["X-Header-Obj"],
                xHeaderObjExplode: v["X-Header-Obj-Explode"],
            };
        });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, HeaderParamsObjectRequest> = z
        ...
        .transform((v) => {
            return {
                "X-Header-Obj": v.xHeaderObj,
                "X-Header-Obj-Explode": v.xHeaderObjExplode,
            };
        });
}
...
export namespace HeaderParamsObjectHeaders$ {
    ...
    export const inboundSchema: z.ZodType<HeaderParamsObjectHeaders, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace HeaderParamsObjectRes$ {
    export type Inbound = {
        headers: HeaderParamsObjectHeaders$.Inbound;
    };

    export const inboundSchema: z.ZodType<HeaderParamsObjectRes, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, HeaderParamsObjectRes> = z
        .object({
...
export namespace HeaderParamsObjectResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        res?: HeaderParamsObjectRes$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<HeaderParamsObjectResponse, z.ZodTypeDef, Inbound> = z
        .object({
