...
export function ignoresPostRequestBodyToJSON(
  ignoresPostRequestBody: IgnoresPostRequestBody,
): string {
  return JSON.stringify(
    IgnoresPostRequestBody$outboundSchema.parse(ignoresPostRequestBody),
  );
}

export function ignoresPostRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<IgnoresPostRequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => IgnoresPostRequestBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'IgnoresPostRequestBody' from JSON`,
  );
}
...
export function ignoresPostRequestToJSON(
  ignoresPostRequest: IgnoresPostRequest,
): string {
  return JSON.stringify(
    IgnoresPostRequest$outboundSchema.parse(ignoresPostRequest),
  );
}

export function ignoresPostRequestFromJSON(
  jsonString: string,
): SafeParseResult<IgnoresPostRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => IgnoresPostRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'IgnoresPostRequest' from JSON`,
  );
}
