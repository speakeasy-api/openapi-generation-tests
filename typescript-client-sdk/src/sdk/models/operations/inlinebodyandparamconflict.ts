...
export namespace Json$ {
    export const inboundSchema: z.ZodType<Json, z.ZodTypeDef, unknown> = z
        .object({
            str: z.string(),
        })
        .transform((v) => {
...
export namespace InlineBodyAndParamConflictRes$ {
    export const inboundSchema: z.ZodType<InlineBodyAndParamConflictRes, z.ZodTypeDef, unknown> = z
        .object({
