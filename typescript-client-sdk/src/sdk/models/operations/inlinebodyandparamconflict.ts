...
export namespace InlineBodyAndParamConflictRequestBody$ {
    ...
    export const inboundSchema = InlineBodyAndParamConflictRequestBody$inboundSchema;
    /** @deprecated use `InlineBodyAndParamConflictRequestBody$outboundSchema` instead. */
    export const outboundSchema = InlineBodyAndParamConflictRequestBody$outboundSchema;
...
export namespace InlineBodyAndParamConflictRequest$ {
    ...
    export const outboundSchema = InlineBodyAndParamConflictRequest$outboundSchema;
...
/** @internal */
export const Json$inboundSchema: z.ZodType<Json, z.ZodTypeDef, unknown> = z.object({
    str: z.string(),
});
...
/** @internal */
export const Json$outboundSchema: z.ZodType<Json$Outbound, z.ZodTypeDef, Json> = z.object({
    str: z.string(),
});
