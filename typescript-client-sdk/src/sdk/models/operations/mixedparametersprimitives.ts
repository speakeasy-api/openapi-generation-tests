...
export namespace MixedParametersPrimitivesRequest$ {
    ...
    export const inboundSchema: z.ZodType<MixedParametersPrimitivesRequest, z.ZodTypeDef, Inbound> =
        z
            .object({
...
export namespace MixedParametersPrimitivesArgs$ {
    ...
    export const inboundSchema: z.ZodType<MixedParametersPrimitivesArgs, z.ZodTypeDef, Inbound> = z
        .object({
            queryStringParam: z.string(),
        })
        .transform((v) => {
...
export namespace MixedParametersPrimitivesHeaders$ {
    ...
    export const inboundSchema: z.ZodType<MixedParametersPrimitivesHeaders, z.ZodTypeDef, Inbound> =
        z
            .object({
                Headerparam: z.string(),
            })
...
export namespace MixedParametersPrimitivesRes$ {
    export type Inbound = {
        args: MixedParametersPrimitivesArgs$.Inbound;
        headers: MixedParametersPrimitivesHeaders$.Inbound;
        url: string;
    };

    export const inboundSchema: z.ZodType<MixedParametersPrimitivesRes, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace MixedParametersPrimitivesResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        res?: MixedParametersPrimitivesRes$.Inbound | undefined;
    };
