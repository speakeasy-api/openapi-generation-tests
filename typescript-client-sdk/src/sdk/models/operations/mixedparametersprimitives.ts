...
export function mixedParametersPrimitivesRequestToJSON(
  mixedParametersPrimitivesRequest: MixedParametersPrimitivesRequest,
): string {
  return JSON.stringify(
    MixedParametersPrimitivesRequest$outboundSchema.parse(
      mixedParametersPrimitivesRequest,
    ),
  );
}

export function mixedParametersPrimitivesRequestFromJSON(
  jsonString: string,
): SafeParseResult<MixedParametersPrimitivesRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => MixedParametersPrimitivesRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MixedParametersPrimitivesRequest' from JSON`,
  );
}
...
export function mixedParametersPrimitivesArgsToJSON(
  mixedParametersPrimitivesArgs: MixedParametersPrimitivesArgs,
): string {
  return JSON.stringify(
    MixedParametersPrimitivesArgs$outboundSchema.parse(
      mixedParametersPrimitivesArgs,
    ),
  );
}

export function mixedParametersPrimitivesArgsFromJSON(
  jsonString: string,
): SafeParseResult<MixedParametersPrimitivesArgs, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => MixedParametersPrimitivesArgs$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MixedParametersPrimitivesArgs' from JSON`,
  );
}
...
export function mixedParametersPrimitivesHeadersToJSON(
  mixedParametersPrimitivesHeaders: MixedParametersPrimitivesHeaders,
): string {
  return JSON.stringify(
    MixedParametersPrimitivesHeaders$outboundSchema.parse(
      mixedParametersPrimitivesHeaders,
    ),
  );
}

export function mixedParametersPrimitivesHeadersFromJSON(
  jsonString: string,
): SafeParseResult<MixedParametersPrimitivesHeaders, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => MixedParametersPrimitivesHeaders$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MixedParametersPrimitivesHeaders' from JSON`,
  );
}
...
export function mixedParametersPrimitivesResToJSON(
  mixedParametersPrimitivesRes: MixedParametersPrimitivesRes,
): string {
  return JSON.stringify(
    MixedParametersPrimitivesRes$outboundSchema.parse(
      mixedParametersPrimitivesRes,
    ),
  );
}

export function mixedParametersPrimitivesResFromJSON(
  jsonString: string,
): SafeParseResult<MixedParametersPrimitivesRes, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => MixedParametersPrimitivesRes$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MixedParametersPrimitivesRes' from JSON`,
  );
}
