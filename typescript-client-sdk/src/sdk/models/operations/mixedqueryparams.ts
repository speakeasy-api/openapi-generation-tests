...
export function mixedQueryParamsRequestToJSON(
  mixedQueryParamsRequest: MixedQueryParamsRequest,
): string {
  return JSON.stringify(
    MixedQueryParamsRequest$outboundSchema.parse(mixedQueryParamsRequest),
  );
}

export function mixedQueryParamsRequestFromJSON(
  jsonString: string,
): SafeParseResult<MixedQueryParamsRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => MixedQueryParamsRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MixedQueryParamsRequest' from JSON`,
  );
}
...
export function mixedQueryParamsResToJSON(
  mixedQueryParamsRes: MixedQueryParamsRes,
): string {
  return JSON.stringify(
    MixedQueryParamsRes$outboundSchema.parse(mixedQueryParamsRes),
  );
}

export function mixedQueryParamsResFromJSON(
  jsonString: string,
): SafeParseResult<MixedQueryParamsRes, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => MixedQueryParamsRes$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MixedQueryParamsRes' from JSON`,
  );
}
