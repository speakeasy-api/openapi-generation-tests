...
/** @internal */
export const EnumNameOverride$inboundSchema: z.ZodNativeEnum<
  typeof EnumNameOverride
> = z.nativeEnum(EnumNameOverride);

/** @internal */
export const EnumNameOverride$outboundSchema: z.ZodNativeEnum<
  typeof EnumNameOverride
...
export function nameOverrideGetRequestToJSON(
  nameOverrideGetRequest: NameOverrideGetRequest,
): string {
  return JSON.stringify(
    NameOverrideGetRequest$outboundSchema.parse(nameOverrideGetRequest),
  );
}

export function nameOverrideGetRequestFromJSON(
  jsonString: string,
): SafeParseResult<NameOverrideGetRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => NameOverrideGetRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'NameOverrideGetRequest' from JSON`,
  );
}
...
export function deepOverriddenAllOfToJSON(
  deepOverriddenAllOf: DeepOverriddenAllOf,
): string {
  return JSON.stringify(
    DeepOverriddenAllOf$outboundSchema.parse(deepOverriddenAllOf),
  );
}

export function deepOverriddenAllOfFromJSON(
  jsonString: string,
): SafeParseResult<DeepOverriddenAllOf, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DeepOverriddenAllOf$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeepOverriddenAllOf' from JSON`,
  );
}

/** @internal */
export const OverriddenAllOf$inboundSchema: z.ZodType<
  OverriddenAllOf,
  z.ZodTypeDef,
  unknown
> = z.object({});
...
export function overriddenAllOfToJSON(
  overriddenAllOf: OverriddenAllOf,
): string {
  return JSON.stringify(OverriddenAllOf$outboundSchema.parse(overriddenAllOf));
}

export function overriddenAllOfFromJSON(
  jsonString: string,
): SafeParseResult<OverriddenAllOf, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => OverriddenAllOf$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'OverriddenAllOf' from JSON`,
  );
}

/** @internal */
export const OverriddenNormal$inboundSchema: z.ZodType<
  OverriddenNormal,
  z.ZodTypeDef,
  unknown
> = z.object({});
...
export function overriddenNormalToJSON(
  overriddenNormal: OverriddenNormal,
): string {
  return JSON.stringify(
    OverriddenNormal$outboundSchema.parse(overriddenNormal),
  );
}

export function overriddenNormalFromJSON(
  jsonString: string,
): SafeParseResult<OverriddenNormal, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => OverriddenNormal$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'OverriddenNormal' from JSON`,
  );
}
...
export const NameOverrideGetOverriddenResponse$outboundSchema: z.ZodType<
  ...
  NameOverrideGetOverriddenResponse
> = z.object({
  deepOverriddenAllOf: z.lazy(() => DeepOverriddenAllOf$outboundSchema)
    .optional(),
...
export namespace NameOverrideGetOverriddenResponse$ {
  ...
  export const outboundSchema =
    NameOverrideGetOverriddenResponse$outboundSchema;
...
export function nameOverrideGetOverriddenResponseToJSON(
  nameOverrideGetOverriddenResponse: NameOverrideGetOverriddenResponse,
): string {
  return JSON.stringify(
    NameOverrideGetOverriddenResponse$outboundSchema.parse(
      nameOverrideGetOverriddenResponse,
    ),
  );
}

export function nameOverrideGetOverriddenResponseFromJSON(
  jsonString: string,
): SafeParseResult<NameOverrideGetOverriddenResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => NameOverrideGetOverriddenResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'NameOverrideGetOverriddenResponse' from JSON`,
  );
}
