...
export function nullableRequiredPropertyPostRequestBodyToJSON(
  nullableRequiredPropertyPostRequestBody:
    NullableRequiredPropertyPostRequestBody,
): string {
  return JSON.stringify(
    NullableRequiredPropertyPostRequestBody$outboundSchema.parse(
      nullableRequiredPropertyPostRequestBody,
    ),
  );
}

export function nullableRequiredPropertyPostRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<
  NullableRequiredPropertyPostRequestBody,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      NullableRequiredPropertyPostRequestBody$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'NullableRequiredPropertyPostRequestBody' from JSON`,
  );
}
...
export function nullableRequiredPropertyPostJsonToJSON(
  nullableRequiredPropertyPostJson: NullableRequiredPropertyPostJson,
): string {
  return JSON.stringify(
    NullableRequiredPropertyPostJson$outboundSchema.parse(
      nullableRequiredPropertyPostJson,
    ),
  );
}

export function nullableRequiredPropertyPostJsonFromJSON(
  jsonString: string,
): SafeParseResult<NullableRequiredPropertyPostJson, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => NullableRequiredPropertyPostJson$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'NullableRequiredPropertyPostJson' from JSON`,
  );
}
...
export function nullableRequiredPropertyPostResponseBodyToJSON(
  nullableRequiredPropertyPostResponseBody:
    NullableRequiredPropertyPostResponseBody,
): string {
  return JSON.stringify(
    NullableRequiredPropertyPostResponseBody$outboundSchema.parse(
      nullableRequiredPropertyPostResponseBody,
    ),
  );
}

export function nullableRequiredPropertyPostResponseBodyFromJSON(
  jsonString: string,
): SafeParseResult<
  NullableRequiredPropertyPostResponseBody,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      NullableRequiredPropertyPostResponseBody$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'NullableRequiredPropertyPostResponseBody' from JSON`,
  );
}
