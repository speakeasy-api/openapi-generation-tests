...
/** @internal */
export const NullableRequiredEnum$inboundSchema: z.ZodNativeEnum<typeof NullableRequiredEnum> =
    z.nativeEnum(NullableRequiredEnum);

/** @internal */
export const NullableRequiredEnum$outboundSchema: z.ZodNativeEnum<typeof NullableRequiredEnum> =
...
export namespace NullableRequiredPropertyPostRequestBody$ {
    ...
    export const inboundSchema = NullableRequiredPropertyPostRequestBody$inboundSchema;
    /** @deprecated use `NullableRequiredPropertyPostRequestBody$outboundSchema` instead. */
    export const outboundSchema = NullableRequiredPropertyPostRequestBody$outboundSchema;
...
/** @internal */
export const NullableRequiredPropertyPostNullableRequiredEnum$inboundSchema: z.ZodNativeEnum<
    typeof NullableRequiredPropertyPostNullableRequiredEnum
> = z.nativeEnum(NullableRequiredPropertyPostNullableRequiredEnum);

/** @internal */
export const NullableRequiredPropertyPostNullableRequiredEnum$outboundSchema: z.ZodNativeEnum<
    typeof NullableRequiredPropertyPostNullableRequiredEnum
...
export namespace NullableRequiredPropertyPostNullableRequiredEnum$ {
    ...
    export const inboundSchema = NullableRequiredPropertyPostNullableRequiredEnum$inboundSchema;
    /** @deprecated use `NullableRequiredPropertyPostNullableRequiredEnum$outboundSchema` instead. */
    export const outboundSchema = NullableRequiredPropertyPostNullableRequiredEnum$outboundSchema;
}
...
export namespace NullableRequiredPropertyPostResponseBody$ {
    ...
    export const inboundSchema = NullableRequiredPropertyPostResponseBody$inboundSchema;
    /** @deprecated use `NullableRequiredPropertyPostResponseBody$outboundSchema` instead. */
    export const outboundSchema = NullableRequiredPropertyPostResponseBody$outboundSchema;
