...
/** @internal */
export const NullableRequiredSharedObjectPostRequestBody$inboundSchema: z.ZodType<
    NullableRequiredSharedObjectPostRequestBody,
    z.ZodTypeDef,
    unknown
> = z
    .object({
        NullableOptionalObj: z.nullable(shared.NullableOptionalObject$inboundSchema).optional(),
...
/** @internal */
export const NullableRequiredSharedObjectPostRequestBody$outboundSchema: z.ZodType<
    NullableRequiredSharedObjectPostRequestBody$Outbound,
    z.ZodTypeDef,
    NullableRequiredSharedObjectPostRequestBody
> = z
    .object({
        nullableOptionalObj: z.nullable(shared.NullableOptionalObject$outboundSchema).optional(),
...
export namespace NullableRequiredSharedObjectPostRequestBody$ {
    ...
    export const inboundSchema = NullableRequiredSharedObjectPostRequestBody$inboundSchema;
    /** @deprecated use `NullableRequiredSharedObjectPostRequestBody$outboundSchema` instead. */
    export const outboundSchema = NullableRequiredSharedObjectPostRequestBody$outboundSchema;
...
export namespace NullableRequiredSharedObjectPostJson$ {
    ...
    export const inboundSchema = NullableRequiredSharedObjectPostJson$inboundSchema;
    /** @deprecated use `NullableRequiredSharedObjectPostJson$outboundSchema` instead. */
    export const outboundSchema = NullableRequiredSharedObjectPostJson$outboundSchema;
...
/** @internal */
export const NullableRequiredSharedObjectPostResponseBody$inboundSchema: z.ZodType<
...
/** @internal */
export const NullableRequiredSharedObjectPostResponseBody$outboundSchema: z.ZodType<
...
export namespace NullableRequiredSharedObjectPostResponseBody$ {
    ...
    export const inboundSchema = NullableRequiredSharedObjectPostResponseBody$inboundSchema;
    /** @deprecated use `NullableRequiredSharedObjectPostResponseBody$outboundSchema` instead. */
    export const outboundSchema = NullableRequiredSharedObjectPostResponseBody$outboundSchema;
