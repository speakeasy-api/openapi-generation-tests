...
export function paginationAmbiguousInputRequestBodyToJSON(
  paginationAmbiguousInputRequestBody: PaginationAmbiguousInputRequestBody,
): string {
  return JSON.stringify(
    PaginationAmbiguousInputRequestBody$outboundSchema.parse(
      paginationAmbiguousInputRequestBody,
    ),
  );
}

export function paginationAmbiguousInputRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<PaginationAmbiguousInputRequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      PaginationAmbiguousInputRequestBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PaginationAmbiguousInputRequestBody' from JSON`,
  );
}
...
export function paginationAmbiguousInputRequestToJSON(
  paginationAmbiguousInputRequest: PaginationAmbiguousInputRequest,
): string {
  return JSON.stringify(
    PaginationAmbiguousInputRequest$outboundSchema.parse(
      paginationAmbiguousInputRequest,
    ),
  );
}

export function paginationAmbiguousInputRequestFromJSON(
  jsonString: string,
): SafeParseResult<PaginationAmbiguousInputRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => PaginationAmbiguousInputRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PaginationAmbiguousInputRequest' from JSON`,
  );
}
...
export function paginationAmbiguousInputResToJSON(
  paginationAmbiguousInputRes: PaginationAmbiguousInputRes,
): string {
  return JSON.stringify(
    PaginationAmbiguousInputRes$outboundSchema.parse(
      paginationAmbiguousInputRes,
    ),
  );
}

export function paginationAmbiguousInputResFromJSON(
  jsonString: string,
): SafeParseResult<PaginationAmbiguousInputRes, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => PaginationAmbiguousInputRes$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PaginationAmbiguousInputRes' from JSON`,
  );
}
...
export function paginationAmbiguousInputResponseToJSON(
  paginationAmbiguousInputResponse: PaginationAmbiguousInputResponse,
): string {
  return JSON.stringify(
    PaginationAmbiguousInputResponse$outboundSchema.parse(
      paginationAmbiguousInputResponse,
    ),
  );
}

export function paginationAmbiguousInputResponseFromJSON(
  jsonString: string,
): SafeParseResult<PaginationAmbiguousInputResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => PaginationAmbiguousInputResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PaginationAmbiguousInputResponse' from JSON`,
  );
}
