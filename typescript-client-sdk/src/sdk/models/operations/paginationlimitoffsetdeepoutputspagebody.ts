...
/** @internal */
export const PaginationLimitOffsetDeepOutputsPageBodyRes$inboundSchema:
  z.ZodType<
...
/** @internal */
export const PaginationLimitOffsetDeepOutputsPageBodyRes$outboundSchema:
  z.ZodType<
...
export namespace PaginationLimitOffsetDeepOutputsPageBodyRes$ {
  ...
  export const inboundSchema =
    PaginationLimitOffsetDeepOutputsPageBodyRes$inboundSchema;
  /** @deprecated use `PaginationLimitOffsetDeepOutputsPageBodyRes$outboundSchema` instead. */
  export const outboundSchema =
    PaginationLimitOffsetDeepOutputsPageBodyRes$outboundSchema;
...
export function paginationLimitOffsetDeepOutputsPageBodyResToJSON(
  paginationLimitOffsetDeepOutputsPageBodyRes:
    PaginationLimitOffsetDeepOutputsPageBodyRes,
): string {
  return JSON.stringify(
    PaginationLimitOffsetDeepOutputsPageBodyRes$outboundSchema.parse(
      paginationLimitOffsetDeepOutputsPageBodyRes,
    ),
  );
}

export function paginationLimitOffsetDeepOutputsPageBodyResFromJSON(
  jsonString: string,
): SafeParseResult<
  PaginationLimitOffsetDeepOutputsPageBodyRes,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      PaginationLimitOffsetDeepOutputsPageBodyRes$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'PaginationLimitOffsetDeepOutputsPageBodyRes' from JSON`,
  );
}

/** @internal */
export const PaginationLimitOffsetDeepOutputsPageBodyResponse$inboundSchema:
  z.ZodType<
...
/** @internal */
export const PaginationLimitOffsetDeepOutputsPageBodyResponse$outboundSchema:
  z.ZodType<
...
export namespace PaginationLimitOffsetDeepOutputsPageBodyResponse$ {
  ...
  export const inboundSchema =
    PaginationLimitOffsetDeepOutputsPageBodyResponse$inboundSchema;
  /** @deprecated use `PaginationLimitOffsetDeepOutputsPageBodyResponse$outboundSchema` instead. */
  export const outboundSchema =
    PaginationLimitOffsetDeepOutputsPageBodyResponse$outboundSchema;
  /** @deprecated use `PaginationLimitOffsetDeepOutputsPageBodyResponse$Outbound` instead. */
  export type Outbound =
    PaginationLimitOffsetDeepOutputsPageBodyResponse$Outbound;
}

export function paginationLimitOffsetDeepOutputsPageBodyResponseToJSON(
  paginationLimitOffsetDeepOutputsPageBodyResponse:
    PaginationLimitOffsetDeepOutputsPageBodyResponse,
): string {
  return JSON.stringify(
    PaginationLimitOffsetDeepOutputsPageBodyResponse$outboundSchema.parse(
      paginationLimitOffsetDeepOutputsPageBodyResponse,
    ),
  );
}

export function paginationLimitOffsetDeepOutputsPageBodyResponseFromJSON(
  jsonString: string,
): SafeParseResult<
  PaginationLimitOffsetDeepOutputsPageBodyResponse,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      PaginationLimitOffsetDeepOutputsPageBodyResponse$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'PaginationLimitOffsetDeepOutputsPageBodyResponse' from JSON`,
  );
}
