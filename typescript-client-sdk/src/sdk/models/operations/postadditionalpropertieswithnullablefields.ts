...
/** @internal */
export const PostAdditionalPropertiesWithNullableFieldsRequestBody$inboundSchema: z.ZodType<
...
/** @internal */
export const PostAdditionalPropertiesWithNullableFieldsRequestBody$outboundSchema: z.ZodType<
...
export namespace PostAdditionalPropertiesWithNullableFieldsRequestBody$ {
    ...
    export type Outbound = PostAdditionalPropertiesWithNullableFieldsRequestBody$Outbound;
}

/** @internal */
export const PostAdditionalPropertiesWithNullableFieldsResponseBody$inboundSchema: z.ZodType<
...
/** @internal */
export const PostAdditionalPropertiesWithNullableFieldsResponseBody$outboundSchema: z.ZodType<
...
export namespace PostAdditionalPropertiesWithNullableFieldsResponseBody$ {
    ...
    export type Outbound = PostAdditionalPropertiesWithNullableFieldsResponseBody$Outbound;
}
