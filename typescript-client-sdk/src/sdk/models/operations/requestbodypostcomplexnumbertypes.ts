...
export namespace RequestBodyPostComplexNumberTypesRequest$ {
    ...
    export const inboundSchema = RequestBodyPostComplexNumberTypesRequest$inboundSchema;
    /** @deprecated use `RequestBodyPostComplexNumberTypesRequest$outboundSchema` instead. */
    export const outboundSchema = RequestBodyPostComplexNumberTypesRequest$outboundSchema;
...
/** @internal */
export const RequestBodyPostComplexNumberTypesResponseBody$inboundSchema: z.ZodType<
...
/** @internal */
export const RequestBodyPostComplexNumberTypesResponseBody$outboundSchema: z.ZodType<
...
export namespace RequestBodyPostComplexNumberTypesResponseBody$ {
    ...
    export const inboundSchema = RequestBodyPostComplexNumberTypesResponseBody$inboundSchema;
    /** @deprecated use `RequestBodyPostComplexNumberTypesResponseBody$outboundSchema` instead. */
    export const outboundSchema = RequestBodyPostComplexNumberTypesResponseBody$outboundSchema;
