...
export function requestBodyPostFormSimpleFormToJSON(
  requestBodyPostFormSimpleForm: RequestBodyPostFormSimpleForm,
): string {
  return JSON.stringify(
    RequestBodyPostFormSimpleForm$outboundSchema.parse(
      requestBodyPostFormSimpleForm,
    ),
  );
}

export function requestBodyPostFormSimpleFormFromJSON(
  jsonString: string,
): SafeParseResult<RequestBodyPostFormSimpleForm, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => RequestBodyPostFormSimpleForm$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RequestBodyPostFormSimpleForm' from JSON`,
  );
}
...
export function requestBodyPostFormSimpleHeadersToJSON(
  requestBodyPostFormSimpleHeaders: RequestBodyPostFormSimpleHeaders,
): string {
  return JSON.stringify(
    RequestBodyPostFormSimpleHeaders$outboundSchema.parse(
      requestBodyPostFormSimpleHeaders,
    ),
  );
}

export function requestBodyPostFormSimpleHeadersFromJSON(
  jsonString: string,
): SafeParseResult<RequestBodyPostFormSimpleHeaders, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => RequestBodyPostFormSimpleHeaders$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RequestBodyPostFormSimpleHeaders' from JSON`,
  );
}
...
export function requestBodyPostFormSimpleResToJSON(
  requestBodyPostFormSimpleRes: RequestBodyPostFormSimpleRes,
): string {
  return JSON.stringify(
    RequestBodyPostFormSimpleRes$outboundSchema.parse(
      requestBodyPostFormSimpleRes,
    ),
  );
}

export function requestBodyPostFormSimpleResFromJSON(
  jsonString: string,
): SafeParseResult<RequestBodyPostFormSimpleRes, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => RequestBodyPostFormSimpleRes$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RequestBodyPostFormSimpleRes' from JSON`,
  );
}
