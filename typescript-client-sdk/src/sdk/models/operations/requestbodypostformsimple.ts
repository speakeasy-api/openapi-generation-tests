...
export namespace RequestBodyPostFormSimpleForm$ {
    export const inboundSchema: z.ZodType<RequestBodyPostFormSimpleForm, z.ZodTypeDef, unknown> = z
        .object({
            any: z.string(),
...
export namespace RequestBodyPostFormSimpleRes$ {
    export const inboundSchema: z.ZodType<RequestBodyPostFormSimpleRes, z.ZodTypeDef, unknown> = z
        .object({
