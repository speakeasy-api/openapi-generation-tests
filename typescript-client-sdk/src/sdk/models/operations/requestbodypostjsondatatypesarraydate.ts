...
/** @internal */
export const RequestBodyPostJsonDataTypesArrayDateResponseBody$inboundSchema:
  z.ZodType<
...
/** @internal */
export const RequestBodyPostJsonDataTypesArrayDateResponseBody$outboundSchema:
  z.ZodType<
...
export namespace RequestBodyPostJsonDataTypesArrayDateResponseBody$ {
  ...
  export const inboundSchema =
    RequestBodyPostJsonDataTypesArrayDateResponseBody$inboundSchema;
  /** @deprecated use `RequestBodyPostJsonDataTypesArrayDateResponseBody$outboundSchema` instead. */
  export const outboundSchema =
    RequestBodyPostJsonDataTypesArrayDateResponseBody$outboundSchema;
  /** @deprecated use `RequestBodyPostJsonDataTypesArrayDateResponseBody$Outbound` instead. */
  export type Outbound =
    RequestBodyPostJsonDataTypesArrayDateResponseBody$Outbound;
}

export function requestBodyPostJsonDataTypesArrayDateResponseBodyToJSON(
  requestBodyPostJsonDataTypesArrayDateResponseBody:
    RequestBodyPostJsonDataTypesArrayDateResponseBody,
): string {
  return JSON.stringify(
    RequestBodyPostJsonDataTypesArrayDateResponseBody$outboundSchema.parse(
      requestBodyPostJsonDataTypesArrayDateResponseBody,
    ),
  );
}

export function requestBodyPostJsonDataTypesArrayDateResponseBodyFromJSON(
  jsonString: string,
): SafeParseResult<
  RequestBodyPostJsonDataTypesArrayDateResponseBody,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      RequestBodyPostJsonDataTypesArrayDateResponseBody$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'RequestBodyPostJsonDataTypesArrayDateResponseBody' from JSON`,
  );
}
