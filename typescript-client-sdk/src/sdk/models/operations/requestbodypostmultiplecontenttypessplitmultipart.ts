...
/** @internal */
export const RequestBodyPostMultipleContentTypesSplitMultipartRequestBody$inboundSchema: z.ZodType<
...
/** @internal */
export const RequestBodyPostMultipleContentTypesSplitMultipartRequestBody$outboundSchema: z.ZodType<
...
export namespace RequestBodyPostMultipleContentTypesSplitMultipartRequestBody$ {
    ...
    export type Outbound = RequestBodyPostMultipleContentTypesSplitMultipartRequestBody$Outbound;
}

/** @internal */
export const RequestBodyPostMultipleContentTypesSplitMultipartRes$inboundSchema: z.ZodType<
...
/** @internal */
export const RequestBodyPostMultipleContentTypesSplitMultipartRes$outboundSchema: z.ZodType<
...
export namespace RequestBodyPostMultipleContentTypesSplitMultipartRes$ {
    ...
    export const inboundSchema = RequestBodyPostMultipleContentTypesSplitMultipartRes$inboundSchema;
    ...
    export type Outbound = RequestBodyPostMultipleContentTypesSplitMultipartRes$Outbound;
}
