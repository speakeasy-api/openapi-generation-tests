...
/** @internal */
export const RequestBodyPostMultipleContentTypesSplitParamJsonRequestBody$inboundSchema:
  z.ZodType<
...
/** @internal */
export const RequestBodyPostMultipleContentTypesSplitParamJsonRequestBody$outboundSchema:
  z.ZodType<
...
export function requestBodyPostMultipleContentTypesSplitParamJsonRequestBodyToJSON(
  requestBodyPostMultipleContentTypesSplitParamJsonRequestBody:
    RequestBodyPostMultipleContentTypesSplitParamJsonRequestBody,
): string {
  return JSON.stringify(
    RequestBodyPostMultipleContentTypesSplitParamJsonRequestBody$outboundSchema
      .parse(requestBodyPostMultipleContentTypesSplitParamJsonRequestBody),
  );
}

export function requestBodyPostMultipleContentTypesSplitParamJsonRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<
  RequestBodyPostMultipleContentTypesSplitParamJsonRequestBody,
  SDKValidationError
> {
  return safeParse(
    ...
    (x) =>
      RequestBodyPostMultipleContentTypesSplitParamJsonRequestBody$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'RequestBodyPostMultipleContentTypesSplitParamJsonRequestBody' from JSON`,
  );
}

/** @internal */
export const RequestBodyPostMultipleContentTypesSplitParamJsonRequest$inboundSchema:
  z.ZodType<
...
/** @internal */
export const RequestBodyPostMultipleContentTypesSplitParamJsonRequest$outboundSchema:
  z.ZodType<
...
export function requestBodyPostMultipleContentTypesSplitParamJsonRequestToJSON(
  requestBodyPostMultipleContentTypesSplitParamJsonRequest:
    RequestBodyPostMultipleContentTypesSplitParamJsonRequest,
): string {
  return JSON.stringify(
    RequestBodyPostMultipleContentTypesSplitParamJsonRequest$outboundSchema
      .parse(requestBodyPostMultipleContentTypesSplitParamJsonRequest),
  );
}

export function requestBodyPostMultipleContentTypesSplitParamJsonRequestFromJSON(
  jsonString: string,
): SafeParseResult<
  RequestBodyPostMultipleContentTypesSplitParamJsonRequest,
  SDKValidationError
> {
  return safeParse(
    ...
    (x) =>
      RequestBodyPostMultipleContentTypesSplitParamJsonRequest$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'RequestBodyPostMultipleContentTypesSplitParamJsonRequest' from JSON`,
  );
}

/** @internal */
export const RequestBodyPostMultipleContentTypesSplitParamJsonRes$inboundSchema:
  z.ZodType<
...
/** @internal */
export const RequestBodyPostMultipleContentTypesSplitParamJsonRes$outboundSchema:
  z.ZodType<
...
export namespace RequestBodyPostMultipleContentTypesSplitParamJsonRes$ {
  ...
  export const inboundSchema =
    RequestBodyPostMultipleContentTypesSplitParamJsonRes$inboundSchema;
...
export function requestBodyPostMultipleContentTypesSplitParamJsonResToJSON(
  requestBodyPostMultipleContentTypesSplitParamJsonRes:
    RequestBodyPostMultipleContentTypesSplitParamJsonRes,
): string {
  return JSON.stringify(
    RequestBodyPostMultipleContentTypesSplitParamJsonRes$outboundSchema.parse(
      requestBodyPostMultipleContentTypesSplitParamJsonRes,
    ),
  );
}

export function requestBodyPostMultipleContentTypesSplitParamJsonResFromJSON(
  jsonString: string,
): SafeParseResult<
  RequestBodyPostMultipleContentTypesSplitParamJsonRes,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      RequestBodyPostMultipleContentTypesSplitParamJsonRes$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'RequestBodyPostMultipleContentTypesSplitParamJsonRes' from JSON`,
  );
}
