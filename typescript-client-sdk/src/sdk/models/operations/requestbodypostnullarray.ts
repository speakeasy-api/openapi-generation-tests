...
export namespace RequestBodyPostNullArrayResponseBody$ {
    ...
    export const inboundSchema = RequestBodyPostNullArrayResponseBody$inboundSchema;
    /** @deprecated use `RequestBodyPostNullArrayResponseBody$outboundSchema` instead. */
    export const outboundSchema = RequestBodyPostNullArrayResponseBody$outboundSchema;
