...
export namespace RequestBodyPostNullArrayResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        object?: RequestBodyPostNullArrayResponseBody$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<RequestBodyPostNullArrayResponse, z.ZodTypeDef, Inbound> =
        z
            .object({
