...
export namespace RequestBodyPutBytesWithParamsRequest$ {
  ...
  export const inboundSchema =
    RequestBodyPutBytesWithParamsRequest$inboundSchema;
  /** @deprecated use `RequestBodyPutBytesWithParamsRequest$outboundSchema` instead. */
  export const outboundSchema =
    RequestBodyPutBytesWithParamsRequest$outboundSchema;
...
export function requestBodyPutBytesWithParamsRequestToJSON(
  requestBodyPutBytesWithParamsRequest: RequestBodyPutBytesWithParamsRequest,
): string {
  return JSON.stringify(
    RequestBodyPutBytesWithParamsRequest$outboundSchema.parse(
      requestBodyPutBytesWithParamsRequest,
    ),
  );
}

export function requestBodyPutBytesWithParamsRequestFromJSON(
  jsonString: string,
): SafeParseResult<RequestBodyPutBytesWithParamsRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      RequestBodyPutBytesWithParamsRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RequestBodyPutBytesWithParamsRequest' from JSON`,
  );
}
...
export namespace RequestBodyPutBytesWithParamsArgs$ {
  ...
  export const outboundSchema =
    RequestBodyPutBytesWithParamsArgs$outboundSchema;
...
export function requestBodyPutBytesWithParamsArgsToJSON(
  requestBodyPutBytesWithParamsArgs: RequestBodyPutBytesWithParamsArgs,
): string {
  return JSON.stringify(
    RequestBodyPutBytesWithParamsArgs$outboundSchema.parse(
      requestBodyPutBytesWithParamsArgs,
    ),
  );
}

export function requestBodyPutBytesWithParamsArgsFromJSON(
  jsonString: string,
): SafeParseResult<RequestBodyPutBytesWithParamsArgs, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => RequestBodyPutBytesWithParamsArgs$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RequestBodyPutBytesWithParamsArgs' from JSON`,
  );
}
...
export function requestBodyPutBytesWithParamsResToJSON(
  requestBodyPutBytesWithParamsRes: RequestBodyPutBytesWithParamsRes,
): string {
  return JSON.stringify(
    RequestBodyPutBytesWithParamsRes$outboundSchema.parse(
      requestBodyPutBytesWithParamsRes,
    ),
  );
}

export function requestBodyPutBytesWithParamsResFromJSON(
  jsonString: string,
): SafeParseResult<RequestBodyPutBytesWithParamsRes, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => RequestBodyPutBytesWithParamsRes$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RequestBodyPutBytesWithParamsRes' from JSON`,
  );
}
