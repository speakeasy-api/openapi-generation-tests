...
export function differentFileNameToJSON(
  differentFileName: DifferentFileName,
): string {
  return JSON.stringify(
    DifferentFileName$outboundSchema.parse(differentFileName),
  );
}

export function differentFileNameFromJSON(
  jsonString: string,
): SafeParseResult<DifferentFileName, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DifferentFileName$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DifferentFileName' from JSON`,
  );
}
...
export function requestBodyPutMultipartDifferentFileNameRequestBodyToJSON(
  requestBodyPutMultipartDifferentFileNameRequestBody:
    RequestBodyPutMultipartDifferentFileNameRequestBody,
): string {
  return JSON.stringify(
    RequestBodyPutMultipartDifferentFileNameRequestBody$outboundSchema.parse(
      requestBodyPutMultipartDifferentFileNameRequestBody,
    ),
  );
}

export function requestBodyPutMultipartDifferentFileNameRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<
  RequestBodyPutMultipartDifferentFileNameRequestBody,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      RequestBodyPutMultipartDifferentFileNameRequestBody$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'RequestBodyPutMultipartDifferentFileNameRequestBody' from JSON`,
  );
}
...
export function requestBodyPutMultipartDifferentFileNameResToJSON(
  requestBodyPutMultipartDifferentFileNameRes:
    RequestBodyPutMultipartDifferentFileNameRes,
): string {
  return JSON.stringify(
    RequestBodyPutMultipartDifferentFileNameRes$outboundSchema.parse(
      requestBodyPutMultipartDifferentFileNameRes,
    ),
  );
}

export function requestBodyPutMultipartDifferentFileNameResFromJSON(
  jsonString: string,
): SafeParseResult<
  RequestBodyPutMultipartDifferentFileNameRes,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      RequestBodyPutMultipartDifferentFileNameRes$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'RequestBodyPutMultipartDifferentFileNameRes' from JSON`,
  );
}
