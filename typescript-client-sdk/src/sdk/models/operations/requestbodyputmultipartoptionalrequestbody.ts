...
export namespace SampleFile$ {
    ...
    export const inboundSchema: z.ZodType<SampleFile, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace RequestBodyPutMultipartOptionalRequestBodyRequestBody$ {
    export type Inbound = {
        sampleField?: string | undefined;
        sampleFile?: SampleFile$.Inbound | undefined;
    };
...
export namespace RequestBodyPutMultipartOptionalRequestBodyRes$ {
    export type Inbound = {
        files: Record<string, string>;
        form?: RequestBodyPutMultipartOptionalRequestBodyForm$.Inbound | undefined;
    };
...
export namespace RequestBodyPutMultipartOptionalRequestBodyResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        res?: RequestBodyPutMultipartOptionalRequestBodyRes$.Inbound | undefined;
    };
