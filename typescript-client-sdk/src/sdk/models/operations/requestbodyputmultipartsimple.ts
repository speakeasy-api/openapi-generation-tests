...
export namespace RequestBodyPutMultipartSimpleForm$ {
    ...
    export const outboundSchema = RequestBodyPutMultipartSimpleForm$outboundSchema;
...
export namespace RequestBodyPutMultipartSimpleHeaders$ {
    ...
    export const inboundSchema = RequestBodyPutMultipartSimpleHeaders$inboundSchema;
    /** @deprecated use `RequestBodyPutMultipartSimpleHeaders$outboundSchema` instead. */
    export const outboundSchema = RequestBodyPutMultipartSimpleHeaders$outboundSchema;
