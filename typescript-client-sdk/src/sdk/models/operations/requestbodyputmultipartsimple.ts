...
export function requestBodyPutMultipartSimpleFormToJSON(
  requestBodyPutMultipartSimpleForm: RequestBodyPutMultipartSimpleForm,
): string {
  return JSON.stringify(
    RequestBodyPutMultipartSimpleForm$outboundSchema.parse(
      requestBodyPutMultipartSimpleForm,
    ),
  );
}

export function requestBodyPutMultipartSimpleFormFromJSON(
  jsonString: string,
): SafeParseResult<RequestBodyPutMultipartSimpleForm, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => RequestBodyPutMultipartSimpleForm$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RequestBodyPutMultipartSimpleForm' from JSON`,
  );
}
...
export function requestBodyPutMultipartSimpleHeadersToJSON(
  requestBodyPutMultipartSimpleHeaders: RequestBodyPutMultipartSimpleHeaders,
): string {
  return JSON.stringify(
    RequestBodyPutMultipartSimpleHeaders$outboundSchema.parse(
      requestBodyPutMultipartSimpleHeaders,
    ),
  );
}

export function requestBodyPutMultipartSimpleHeadersFromJSON(
  jsonString: string,
): SafeParseResult<RequestBodyPutMultipartSimpleHeaders, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      RequestBodyPutMultipartSimpleHeaders$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RequestBodyPutMultipartSimpleHeaders' from JSON`,
  );
}
...
export function requestBodyPutMultipartSimpleResToJSON(
  requestBodyPutMultipartSimpleRes: RequestBodyPutMultipartSimpleRes,
): string {
  return JSON.stringify(
    RequestBodyPutMultipartSimpleRes$outboundSchema.parse(
      requestBodyPutMultipartSimpleRes,
    ),
  );
}

export function requestBodyPutMultipartSimpleResFromJSON(
  jsonString: string,
): SafeParseResult<RequestBodyPutMultipartSimpleRes, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => RequestBodyPutMultipartSimpleRes$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RequestBodyPutMultipartSimpleRes' from JSON`,
  );
}
