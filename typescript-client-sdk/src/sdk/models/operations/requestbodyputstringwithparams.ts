...
export namespace RequestBodyPutStringWithParamsRequest$ {
  ...
  export const inboundSchema =
    RequestBodyPutStringWithParamsRequest$inboundSchema;
  /** @deprecated use `RequestBodyPutStringWithParamsRequest$outboundSchema` instead. */
  export const outboundSchema =
    RequestBodyPutStringWithParamsRequest$outboundSchema;
...
export function requestBodyPutStringWithParamsRequestToJSON(
  requestBodyPutStringWithParamsRequest: RequestBodyPutStringWithParamsRequest,
): string {
  return JSON.stringify(
    RequestBodyPutStringWithParamsRequest$outboundSchema.parse(
      requestBodyPutStringWithParamsRequest,
    ),
  );
}

export function requestBodyPutStringWithParamsRequestFromJSON(
  jsonString: string,
): SafeParseResult<RequestBodyPutStringWithParamsRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      RequestBodyPutStringWithParamsRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RequestBodyPutStringWithParamsRequest' from JSON`,
  );
}
...
export namespace RequestBodyPutStringWithParamsArgs$ {
  ...
  export const outboundSchema =
    RequestBodyPutStringWithParamsArgs$outboundSchema;
...
export function requestBodyPutStringWithParamsArgsToJSON(
  requestBodyPutStringWithParamsArgs: RequestBodyPutStringWithParamsArgs,
): string {
  return JSON.stringify(
    RequestBodyPutStringWithParamsArgs$outboundSchema.parse(
      requestBodyPutStringWithParamsArgs,
    ),
  );
}

export function requestBodyPutStringWithParamsArgsFromJSON(
  jsonString: string,
): SafeParseResult<RequestBodyPutStringWithParamsArgs, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      RequestBodyPutStringWithParamsArgs$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RequestBodyPutStringWithParamsArgs' from JSON`,
  );
}
...
export namespace RequestBodyPutStringWithParamsRes$ {
  ...
  export const outboundSchema =
    RequestBodyPutStringWithParamsRes$outboundSchema;
...
export function requestBodyPutStringWithParamsResToJSON(
  requestBodyPutStringWithParamsRes: RequestBodyPutStringWithParamsRes,
): string {
  return JSON.stringify(
    RequestBodyPutStringWithParamsRes$outboundSchema.parse(
      requestBodyPutStringWithParamsRes,
    ),
  );
}

export function requestBodyPutStringWithParamsResFromJSON(
  jsonString: string,
): SafeParseResult<RequestBodyPutStringWithParamsRes, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => RequestBodyPutStringWithParamsRes$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RequestBodyPutStringWithParamsRes' from JSON`,
  );
}
