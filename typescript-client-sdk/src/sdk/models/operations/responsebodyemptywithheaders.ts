...
export namespace ResponseBodyEmptyWithHeadersRequest$ {
    ...
    export const inboundSchema = ResponseBodyEmptyWithHeadersRequest$inboundSchema;
    /** @deprecated use `ResponseBodyEmptyWithHeadersRequest$outboundSchema` instead. */
    export const outboundSchema = ResponseBodyEmptyWithHeadersRequest$outboundSchema;
...
export namespace ResponseBodyEmptyWithHeadersResponse$ {
    ...
    export const inboundSchema = ResponseBodyEmptyWithHeadersResponse$inboundSchema;
    /** @deprecated use `ResponseBodyEmptyWithHeadersResponse$outboundSchema` instead. */
    export const outboundSchema = ResponseBodyEmptyWithHeadersResponse$outboundSchema;
