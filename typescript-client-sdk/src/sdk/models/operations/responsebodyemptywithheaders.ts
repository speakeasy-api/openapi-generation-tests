...
export function responseBodyEmptyWithHeadersRequestToJSON(
  responseBodyEmptyWithHeadersRequest: ResponseBodyEmptyWithHeadersRequest,
): string {
  return JSON.stringify(
    ResponseBodyEmptyWithHeadersRequest$outboundSchema.parse(
      responseBodyEmptyWithHeadersRequest,
    ),
  );
}

export function responseBodyEmptyWithHeadersRequestFromJSON(
  jsonString: string,
): SafeParseResult<ResponseBodyEmptyWithHeadersRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      ResponseBodyEmptyWithHeadersRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ResponseBodyEmptyWithHeadersRequest' from JSON`,
  );
}
...
export function responseBodyEmptyWithHeadersResponseToJSON(
  responseBodyEmptyWithHeadersResponse: ResponseBodyEmptyWithHeadersResponse,
): string {
  return JSON.stringify(
    ResponseBodyEmptyWithHeadersResponse$outboundSchema.parse(
      responseBodyEmptyWithHeadersResponse,
    ),
  );
}

export function responseBodyEmptyWithHeadersResponseFromJSON(
  jsonString: string,
): SafeParseResult<ResponseBodyEmptyWithHeadersResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      ResponseBodyEmptyWithHeadersResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ResponseBodyEmptyWithHeadersResponse' from JSON`,
  );
}
