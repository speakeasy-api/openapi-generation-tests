...
export const RetriesAfterServerList = [
...
export function retriesAfterRequestToJSON(
  retriesAfterRequest: RetriesAfterRequest,
): string {
  return JSON.stringify(
    RetriesAfterRequest$outboundSchema.parse(retriesAfterRequest),
  );
}

export function retriesAfterRequestFromJSON(
  jsonString: string,
): SafeParseResult<RetriesAfterRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => RetriesAfterRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RetriesAfterRequest' from JSON`,
  );
}
...
export function retriesAfterRetriesToJSON(
  retriesAfterRetries: RetriesAfterRetries,
): string {
  return JSON.stringify(
    RetriesAfterRetries$outboundSchema.parse(retriesAfterRetries),
  );
}

export function retriesAfterRetriesFromJSON(
  jsonString: string,
): SafeParseResult<RetriesAfterRetries, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => RetriesAfterRetries$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RetriesAfterRetries' from JSON`,
  );
}
