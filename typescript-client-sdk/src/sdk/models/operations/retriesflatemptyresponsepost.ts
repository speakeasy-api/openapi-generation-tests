...
export namespace RetriesFlatEmptyResponsePostRequestBody$ {
    ...
    export const inboundSchema = RetriesFlatEmptyResponsePostRequestBody$inboundSchema;
    /** @deprecated use `RetriesFlatEmptyResponsePostRequestBody$outboundSchema` instead. */
    export const outboundSchema = RetriesFlatEmptyResponsePostRequestBody$outboundSchema;
...
> = z
    .object({
        RequestBody: z.lazy(() => RetriesFlatEmptyResponsePostRequestBody$inboundSchema).optional(),
...
export namespace RetriesFlatEmptyResponsePostRequest$ {
    ...
    export const inboundSchema = RetriesFlatEmptyResponsePostRequest$inboundSchema;
    /** @deprecated use `RetriesFlatEmptyResponsePostRequest$outboundSchema` instead. */
    export const outboundSchema = RetriesFlatEmptyResponsePostRequest$outboundSchema;
