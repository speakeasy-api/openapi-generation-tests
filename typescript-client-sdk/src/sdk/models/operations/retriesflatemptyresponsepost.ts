...
export function retriesFlatEmptyResponsePostRequestBodyToJSON(
  retriesFlatEmptyResponsePostRequestBody:
    RetriesFlatEmptyResponsePostRequestBody,
): string {
  return JSON.stringify(
    RetriesFlatEmptyResponsePostRequestBody$outboundSchema.parse(
      retriesFlatEmptyResponsePostRequestBody,
    ),
  );
}

export function retriesFlatEmptyResponsePostRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<
  RetriesFlatEmptyResponsePostRequestBody,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      RetriesFlatEmptyResponsePostRequestBody$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'RetriesFlatEmptyResponsePostRequestBody' from JSON`,
  );
}
...
export function retriesFlatEmptyResponsePostRequestToJSON(
  retriesFlatEmptyResponsePostRequest: RetriesFlatEmptyResponsePostRequest,
): string {
  return JSON.stringify(
    RetriesFlatEmptyResponsePostRequest$outboundSchema.parse(
      retriesFlatEmptyResponsePostRequest,
    ),
  );
}

export function retriesFlatEmptyResponsePostRequestFromJSON(
  jsonString: string,
): SafeParseResult<RetriesFlatEmptyResponsePostRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      RetriesFlatEmptyResponsePostRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RetriesFlatEmptyResponsePostRequest' from JSON`,
  );
}
