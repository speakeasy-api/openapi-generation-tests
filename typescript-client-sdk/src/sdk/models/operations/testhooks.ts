...
export namespace TestHooksRequest$ {
    export const inboundSchema: z.ZodType<TestHooksRequest, z.ZodTypeDef, unknown> = z
        .object({
            someParam: z.string(),
        })
        .transform((v) => {
...
export namespace TestHooksArgs$ {
    export const inboundSchema: z.ZodType<TestHooksArgs, z.ZodTypeDef, unknown> = z
        .object({
            someParam: z.string(),
        })
        .transform((v) => {
...
export namespace TestHooksRes$ {
    export const inboundSchema: z.ZodType<TestHooksRes, z.ZodTypeDef, unknown> = z
        .object({
