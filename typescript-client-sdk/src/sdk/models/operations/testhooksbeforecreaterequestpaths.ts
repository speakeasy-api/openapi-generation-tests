...
export namespace TestHooksBeforeCreateRequestPathsRequest$ {
    ...
    export const inboundSchema = TestHooksBeforeCreateRequestPathsRequest$inboundSchema;
    /** @deprecated use `TestHooksBeforeCreateRequestPathsRequest$outboundSchema` instead. */
    export const outboundSchema = TestHooksBeforeCreateRequestPathsRequest$outboundSchema;
...
export namespace TestHooksBeforeCreateRequestPathsHeaders$ {
    ...
    export const inboundSchema = TestHooksBeforeCreateRequestPathsHeaders$inboundSchema;
    /** @deprecated use `TestHooksBeforeCreateRequestPathsHeaders$outboundSchema` instead. */
    export const outboundSchema = TestHooksBeforeCreateRequestPathsHeaders$outboundSchema;
...
export namespace TestHooksBeforeCreateRequestPathsRes$ {
    ...
    export const inboundSchema = TestHooksBeforeCreateRequestPathsRes$inboundSchema;
    /** @deprecated use `TestHooksBeforeCreateRequestPathsRes$outboundSchema` instead. */
    export const outboundSchema = TestHooksBeforeCreateRequestPathsRes$outboundSchema;
