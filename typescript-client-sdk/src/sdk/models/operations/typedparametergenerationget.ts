...
/** @internal */
export const Obj$inboundSchema: z.ZodType<Obj, z.ZodTypeDef, unknown> = z.object({
    bool: z.boolean(),
    num: z.number(),
    str: z.string(),
});
...
/** @internal */
export const Obj$outboundSchema: z.ZodType<Obj$Outbound, z.ZodTypeDef, Obj> = z.object({
    bool: z.boolean(),
    num: z.number(),
    str: z.string(),
});
...
export namespace TypedParameterGenerationGetRequest$ {
    ...
    export const outboundSchema = TypedParameterGenerationGetRequest$outboundSchema;
