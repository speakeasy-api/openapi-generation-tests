...
export type UnionOfArraysPostRes = {
    json: Array<shared.UnionOfArrays>;
};
...
export const UnionOfArraysPostRes$inboundSchema: z.ZodType<
    ...
    unknown
> = z.object({
    json: z.array(z.lazy(() => shared.UnionOfArrays$inboundSchema)),
});

/** @internal */
export type UnionOfArraysPostRes$Outbound = {
    json: Array<shared.UnionOfArrays$Outbound>;
};
...
export const UnionOfArraysPostRes$outboundSchema: z.ZodType<
    ...
    UnionOfArraysPostRes
> = z.object({
    json: z.array(z.lazy(() => shared.UnionOfArrays$outboundSchema)),
});
