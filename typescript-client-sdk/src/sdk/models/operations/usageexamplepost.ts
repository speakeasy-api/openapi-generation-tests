...
export namespace UsageExamplePostRequestBody$ {
    export const inboundSchema: z.ZodType<UsageExamplePostRequestBody, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const inboundSchema: z.ZodType<UsageExamplePostRequest, z.ZodTypeDef, unknown> = z
        ...
        .transform((v) => {
            return {
                ...
                float64StringParameter: v.float64StringParameter,
                floatParameter: v.floatParameter,
                int64Parameter: v.int64Parameter,
                int64StringParameter: v.int64StringParameter,
...
export namespace UsageExamplePostJson$ {
    export const inboundSchema: z.ZodType<UsageExamplePostJson, z.ZodTypeDef, unknown> = z
        .object({
            fakerFormattedStrings: shared.FakerFormattedStrings$.inboundSchema.optional(),
            fakerStrings: shared.FakerStrings$.inboundSchema.optional(),
            simpleObject: shared.SimpleObject$.inboundSchema.optional(),
...
export namespace UsageExamplePostResponseBody$ {
    export const inboundSchema: z.ZodType<UsageExamplePostResponseBody, z.ZodTypeDef, unknown> = z
        .object({
