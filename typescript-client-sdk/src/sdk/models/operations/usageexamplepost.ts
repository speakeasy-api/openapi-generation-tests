...
export function usageExamplePostSecurityToJSON(
  usageExamplePostSecurity: UsageExamplePostSecurity,
): string {
  return JSON.stringify(
    UsageExamplePostSecurity$outboundSchema.parse(usageExamplePostSecurity),
  );
}

export function usageExamplePostSecurityFromJSON(
  jsonString: string,
): SafeParseResult<UsageExamplePostSecurity, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UsageExamplePostSecurity$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UsageExamplePostSecurity' from JSON`,
  );
}
...
> = z.object({
  fakerCamelCasePropertyNameStrings:
    shared.FakerCamelCasePropertyNameStrings$inboundSchema,
  fakerFormattedStrings: shared.FakerFormattedStrings$inboundSchema,
  fakerKebobCasePropertyNameStrings:
    shared.FakerKebobCasePropertyNameStrings$inboundSchema,
  fakerPascalCasePropertyNameStrings:
    shared.FakerPascalCasePropertyNameStrings$inboundSchema,
  fakerSnakeCasePropertyNameStrings:
    shared.FakerSnakeCasePropertyNameStrings$inboundSchema,
...
export type UsageExamplePostRequestBody$Outbound = {
  fakerCamelCasePropertyNameStrings:
    shared.FakerCamelCasePropertyNameStrings$Outbound;
  fakerFormattedStrings: shared.FakerFormattedStrings$Outbound;
  fakerKebobCasePropertyNameStrings:
    shared.FakerKebobCasePropertyNameStrings$Outbound;
  fakerPascalCasePropertyNameStrings:
    shared.FakerPascalCasePropertyNameStrings$Outbound;
  fakerSnakeCasePropertyNameStrings:
    shared.FakerSnakeCasePropertyNameStrings$Outbound;
...
> = z.object({
  fakerCamelCasePropertyNameStrings:
    shared.FakerCamelCasePropertyNameStrings$outboundSchema,
  fakerFormattedStrings: shared.FakerFormattedStrings$outboundSchema,
  fakerKebobCasePropertyNameStrings:
    shared.FakerKebobCasePropertyNameStrings$outboundSchema,
  fakerPascalCasePropertyNameStrings:
    shared.FakerPascalCasePropertyNameStrings$outboundSchema,
  fakerSnakeCasePropertyNameStrings:
    shared.FakerSnakeCasePropertyNameStrings$outboundSchema,
...
export function usageExamplePostRequestBodyToJSON(
  usageExamplePostRequestBody: UsageExamplePostRequestBody,
): string {
  return JSON.stringify(
    UsageExamplePostRequestBody$outboundSchema.parse(
      usageExamplePostRequestBody,
    ),
  );
}

export function usageExamplePostRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<UsageExamplePostRequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UsageExamplePostRequestBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UsageExamplePostRequestBody' from JSON`,
  );
}

/** @internal */
export const EnumParameter$inboundSchema: z.ZodNativeEnum<
  typeof EnumParameter
> = z.nativeEnum(EnumParameter);

/** @internal */
export const EnumParameter$outboundSchema: z.ZodNativeEnum<
  typeof EnumParameter
...
/** @internal */
export const OptEnumParameter$inboundSchema: z.ZodNativeEnum<
  typeof OptEnumParameter
> = z.nativeEnum(OptEnumParameter);

/** @internal */
export const OptEnumParameter$outboundSchema: z.ZodNativeEnum<
  typeof OptEnumParameter
...
export const UsageExamplePostRequest$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  RequestBody: z.lazy(() => UsageExamplePostRequestBody$inboundSchema)
    .optional(),
  bigintParameter: z.number().transform(v => BigInt(v)),
  bigintParameterOptional: z.number().transform(v => BigInt(v)).optional(),
  bigintStrParameter: z.string().transform(v => BigInt(v)),
  bigintStrParameterOptional: z.string().transform(v => BigInt(v)).optional(),
  boolParameter: z.boolean(),
  dateParameter: z.string().transform(v => new RFCDate(v)),
  dateTimeDefaultParameter: z.string().datetime({ offset: true }).transform(v =>
    new Date(v)
  ),
  dateTimeParameter: z.string().datetime({ offset: true }).transform(v =>
    new Date(v)
  ),
  decimalParameter: z.number().transform(v => new Decimal$(v)),
  decimalParameterOptional: z.number().transform(v => new Decimal$(v))
    .optional(),
  decimalStrParameter: z.string().transform(v => new Decimal$(v)),
  decimalStrParameterOptional: z.string().transform(v => new Decimal$(v))
    .optional(),
  ...
  int64StringParameter: z.string().transform(v => parseInt(v, 10)),
...
export const UsageExamplePostRequest$outboundSchema: z.ZodType<
  ...
  UsageExamplePostRequest
> = z.object({
  requestBody: z.lazy(() => UsageExamplePostRequestBody$outboundSchema)
    .optional(),
  bigintParameter: z.bigint().transform(v => Number(v)),
  bigintParameterOptional: z.bigint().transform(v => Number(v)).optional(),
  bigintStrParameter: z.bigint().transform(v => `${v}`),
  bigintStrParameterOptional: z.bigint().transform(v => `${v}`).optional(),
  boolParameter: z.boolean(),
  ...
  decimalParameter: z.union([z.instanceof(Decimal$), z.number()]).transform(v =>
    typeof v === "number" ? v : v.toNumber()
  ),
  decimalParameterOptional: z.union([z.instanceof(Decimal$), z.number()])
    .transform(v => typeof v === "number" ? v : v.toNumber()).optional(),
  decimalStrParameter: z.union([z.instanceof(Decimal$), z.number()]).transform(
    v => `${v}`
  ),
  decimalStrParameterOptional: z.union([z.instanceof(Decimal$), z.number()])
  ...
  floatParameter: z.number(),
  int64Parameter: z.number().int(),
  int64StringParameter: z.number().int().transform(v => `${v}`),
  intParameter: z.number().int(),
...
export function usageExamplePostRequestToJSON(
  usageExamplePostRequest: UsageExamplePostRequest,
): string {
  return JSON.stringify(
    UsageExamplePostRequest$outboundSchema.parse(usageExamplePostRequest),
  );
}

export function usageExamplePostRequestFromJSON(
  jsonString: string,
): SafeParseResult<UsageExamplePostRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UsageExamplePostRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UsageExamplePostRequest' from JSON`,
  );
}
...
export function usageExamplePostJsonToJSON(
  usageExamplePostJson: UsageExamplePostJson,
): string {
  return JSON.stringify(
    UsageExamplePostJson$outboundSchema.parse(usageExamplePostJson),
  );
}

export function usageExamplePostJsonFromJSON(
  jsonString: string,
): SafeParseResult<UsageExamplePostJson, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UsageExamplePostJson$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UsageExamplePostJson' from JSON`,
  );
}
...
export function usageExamplePostResponseBodyToJSON(
  usageExamplePostResponseBody: UsageExamplePostResponseBody,
): string {
  return JSON.stringify(
    UsageExamplePostResponseBody$outboundSchema.parse(
      usageExamplePostResponseBody,
    ),
  );
}

export function usageExamplePostResponseBodyFromJSON(
  jsonString: string,
): SafeParseResult<UsageExamplePostResponseBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UsageExamplePostResponseBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UsageExamplePostResponseBody' from JSON`,
  );
}
