...
export namespace UsageExamplePostSecurity$ {
    export const inboundSchema: z.ZodType<UsageExamplePostSecurity, z.ZodTypeDef, unknown> = z
        .object({
            Password: z.string(),
            Username: z.string(),
        })
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UsageExamplePostSecurity> = z
        .object({
            password: z.string(),
            username: z.string(),
        })
...
export namespace UsageExamplePostRequestBody$ {
    export const inboundSchema: z.ZodType<UsageExamplePostRequestBody, z.ZodTypeDef, unknown> =
        z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UsageExamplePostRequestBody> =
        z.object({
...
export namespace EnumParameter$ {
    export const inboundSchema: z.ZodNativeEnum<typeof EnumParameter> = z.nativeEnum(EnumParameter);
    export const outboundSchema: z.ZodNativeEnum<typeof EnumParameter> = inboundSchema;
}

/** @internal */
export namespace OptEnumParameter$ {
    export const inboundSchema: z.ZodNativeEnum<typeof OptEnumParameter> =
        z.nativeEnum(OptEnumParameter);
    export const outboundSchema: z.ZodNativeEnum<typeof OptEnumParameter> = inboundSchema;
}

/** @internal */
export namespace UsageExamplePostRequest$ {
    export const inboundSchema: z.ZodType<UsageExamplePostRequest, z.ZodTypeDef, unknown> = z
        .object({
...
export namespace UsageExamplePostJson$ {
    export const inboundSchema: z.ZodType<UsageExamplePostJson, z.ZodTypeDef, unknown> = z.object({
        fakerFormattedStrings: shared.FakerFormattedStrings$.inboundSchema.optional(),
        fakerStrings: shared.FakerStrings$.inboundSchema.optional(),
        simpleObject: shared.SimpleObject$.inboundSchema.optional(),
    });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UsageExamplePostJson> = z.object(
        {
            fakerFormattedStrings: shared.FakerFormattedStrings$.outboundSchema.optional(),
            fakerStrings: shared.FakerStrings$.outboundSchema.optional(),
            simpleObject: shared.SimpleObject$.outboundSchema.optional(),
...
export namespace UsageExamplePostResponseBody$ {
    export const inboundSchema: z.ZodType<UsageExamplePostResponseBody, z.ZodTypeDef, unknown> =
        z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UsageExamplePostResponseBody> =
        z.object({
...
export namespace UsageExamplePostResponse$ {
    export const inboundSchema: z.ZodType<UsageExamplePostResponse, z.ZodTypeDef, unknown> = z
        .object({
