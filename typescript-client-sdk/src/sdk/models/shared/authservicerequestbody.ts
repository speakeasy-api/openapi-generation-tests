...
export namespace BasicAuth$ {
    export const inboundSchema: z.ZodType<BasicAuth, z.ZodTypeDef, unknown> = z
        .object({
            password: z.string(),
            username: z.string(),
        })
...
export namespace HeaderAuth$ {
    export const inboundSchema: z.ZodType<HeaderAuth, z.ZodTypeDef, unknown> = z
        .object({
...
export namespace AuthServiceRequestBody$ {
    export const inboundSchema: z.ZodType<AuthServiceRequestBody, z.ZodTypeDef, unknown> = z
        .object({
