...
/** @internal */
export const BasicAuth$inboundSchema: z.ZodType<BasicAuth, z.ZodTypeDef, unknown> = z.object({
    password: z.string(),
    username: z.string(),
});
...
/** @internal */
export const BasicAuth$outboundSchema: z.ZodType<BasicAuth$Outbound, z.ZodTypeDef, BasicAuth> =
    z.object({
        password: z.string(),
        username: z.string(),
    });
...
/** @internal */
export const HeaderAuth$inboundSchema: z.ZodType<HeaderAuth, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const HeaderAuth$outboundSchema: z.ZodType<HeaderAuth$Outbound, z.ZodTypeDef, HeaderAuth> =
    z.object({
        expectedValue: z.string(),
        headerName: z.string(),
    });
