...
/** @internal */
export const Bike$inboundSchema: z.ZodType<Bike, z.ZodTypeDef, unknown> = z.object({
    colour: z.string(),
...
/** @internal */
export const Bike$outboundSchema: z.ZodType<Bike$Outbound, z.ZodTypeDef, Bike> = z.object({
    colour: z.string(),
