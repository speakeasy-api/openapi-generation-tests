...
export const Any$inboundSchema: z.ZodType<Any, z.ZodTypeDef, unknown> = z.union(
  [SimpleObject$inboundSchema, z.string()],
);
...
export const Any$outboundSchema: z.ZodType<Any$Outbound, z.ZodTypeDef, Any> = z
  .union([SimpleObject$outboundSchema, z.string()]);
...
/** @internal */
export const DeepObject$inboundSchema: z.ZodType<
  DeepObject,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const DeepObject$outboundSchema: z.ZodType<
  DeepObject$Outbound,
  z.ZodTypeDef,
  DeepObject
> = z.object({
...
export function deepObjectToJSON(deepObject: DeepObject): string {
  return JSON.stringify(DeepObject$outboundSchema.parse(deepObject));
}

export function deepObjectFromJSON(
  jsonString: string,
): SafeParseResult<DeepObject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DeepObject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeepObject' from JSON`,
  );
}
