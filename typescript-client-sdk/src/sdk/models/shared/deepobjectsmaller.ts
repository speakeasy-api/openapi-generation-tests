...
export function deepObjectSmallerAnyToJSON(
  deepObjectSmallerAny: DeepObjectSmallerAny,
): string {
  return JSON.stringify(
    DeepObjectSmallerAny$outboundSchema.parse(deepObjectSmallerAny),
  );
}

export function deepObjectSmallerAnyFromJSON(
  jsonString: string,
): SafeParseResult<DeepObjectSmallerAny, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DeepObjectSmallerAny$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeepObjectSmallerAny' from JSON`,
  );
}
...
export function deepObjectSmallerToJSON(
  deepObjectSmaller: DeepObjectSmaller,
): string {
  return JSON.stringify(
    DeepObjectSmaller$outboundSchema.parse(deepObjectSmaller),
  );
}

export function deepObjectSmallerFromJSON(
  jsonString: string,
): SafeParseResult<DeepObjectSmaller, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DeepObjectSmaller$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeepObjectSmaller' from JSON`,
  );
}
