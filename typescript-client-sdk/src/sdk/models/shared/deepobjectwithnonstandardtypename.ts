...
/** @internal */
export type DeepObjectWithNonStandardTypeNameAny$Outbound =
  | SimpleObject$Outbound
  | string;
...
export namespace DeepObjectWithNonStandardTypeNameAny$ {
  ...
  export const inboundSchema =
    DeepObjectWithNonStandardTypeNameAny$inboundSchema;
  /** @deprecated use `DeepObjectWithNonStandardTypeNameAny$outboundSchema` instead. */
  export const outboundSchema =
    DeepObjectWithNonStandardTypeNameAny$outboundSchema;
...
export function deepObjectWithNonStandardTypeNameAnyToJSON(
  deepObjectWithNonStandardTypeNameAny: DeepObjectWithNonStandardTypeNameAny,
): string {
  return JSON.stringify(
    DeepObjectWithNonStandardTypeNameAny$outboundSchema.parse(
      deepObjectWithNonStandardTypeNameAny,
    ),
  );
}

export function deepObjectWithNonStandardTypeNameAnyFromJSON(
  jsonString: string,
): SafeParseResult<DeepObjectWithNonStandardTypeNameAny, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      DeepObjectWithNonStandardTypeNameAny$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeepObjectWithNonStandardTypeNameAny' from JSON`,
  );
}
...
export function deepObjectWithNonStandardTypeNameToJSON(
  deepObjectWithNonStandardTypeName: DeepObjectWithNonStandardTypeName,
): string {
  return JSON.stringify(
    DeepObjectWithNonStandardTypeName$outboundSchema.parse(
      deepObjectWithNonStandardTypeName,
    ),
  );
}

export function deepObjectWithNonStandardTypeNameFromJSON(
  jsonString: string,
): SafeParseResult<DeepObjectWithNonStandardTypeName, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DeepObjectWithNonStandardTypeName$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeepObjectWithNonStandardTypeName' from JSON`,
  );
}
