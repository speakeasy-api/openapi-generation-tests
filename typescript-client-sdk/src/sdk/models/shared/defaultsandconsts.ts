...
import { constDateTime } from "../../types/constdatetime.js";
...
/** @internal */
export const DefaultEnumInt$inboundSchema: z.ZodNativeEnum<
  typeof DefaultEnumInt
> = z.nativeEnum(DefaultEnumInt);

/** @internal */
export const DefaultEnumInt$outboundSchema: z.ZodNativeEnum<
  typeof DefaultEnumInt
...
/** @internal */
export const DefaultEnumStr$inboundSchema: z.ZodNativeEnum<
  typeof DefaultEnumStr
> = z.nativeEnum(DefaultEnumStr);

/** @internal */
export const DefaultEnumStr$outboundSchema: z.ZodNativeEnum<
  typeof DefaultEnumStr
...
/** @internal */
export const DefaultsAndConsts$inboundSchema: z.ZodType<
  DefaultsAndConsts,
  z.ZodTypeDef,
  unknown
> = z.object({
  constBigInt: z.number().transform(v => BigInt(v)).pipe(
    z.literal(BigInt("9007199254740991") as 9007199254740991n),
  ).optional(),
  constBigIntStr: z.string().transform(v => BigInt(v)).pipe(
    z.literal(BigInt("9223372036854775807") as 9223372036854775807n),
  ).optional(),
  constBool: z.literal(true).optional(),
  constDate: z.literal("2020-01-01").transform(v => new RFCDate(v)).optional(),
  constDateTime: constDateTime("2020-01-01T00:00:00Z").pipe(
    z.string().datetime({ offset: true }),
  ).transform(v => new Date(v)).optional(),
  constDecimal: z.literal(3.141592653589793).transform(v => new Decimal$(v))
    .optional(),
  constDecimalStr: z.literal("3.141592653589793238462643383279").transform(v =>
    new Decimal$(v)
  ).optional(),
  ...
  constStrNull: z.literal(null).optional(),
  constStrSQuotes: z.literal("const with 'single quotes'").optional(),
  defaultBigInt: z.number().default(9007199254740991).transform(v => BigInt(v)),
  defaultBigIntStr: z.string().default("9223372036854775807").transform(v =>
    BigInt(v)
  ),
  defaultBool: z.boolean().default(true),
  defaultDate: z.string().default("2020-01-01").transform(v => new RFCDate(v)),
  defaultDateTime: z.string().datetime({ offset: true }).default(
    "2020-01-01T00:00:00Z",
  ).transform(v => new Date(v)),
  defaultDecimal: z.number().transform(v =>
    new Decimal$(v ?? "3.141592653589793")
  ),
  defaultDecimalStr: z.string().transform(v =>
    new Decimal$(v ?? "3.141592653589793238462643383279")
  ),
...
export const DefaultsAndConsts$outboundSchema: z.ZodType<
  ...
  DefaultsAndConsts
> = z.object({
  constBigInt: z.literal(BigInt("9007199254740991") as 9007199254740991n)
    .default(BigInt("9007199254740991") as 9007199254740991n).transform(v =>
      Number(v)
    ),
  constBigIntStr: z.literal(
    BigInt("9223372036854775807") as 9223372036854775807n,
  ).default(BigInt("9223372036854775807") as 9223372036854775807n).transform(
    v => `${v}`
  ),
  constBool: z.literal(true).default(true as const),
  constDate: z.instanceof(RFCDate).default(new RFCDate("2020-01-01")).refine(
    (v) => v.toString() === "2020-01-01",
    { message: "Value must be 2020-01-01" },
  ).transform(v => v.toString()),
  constDateTime: z.date().default(new Date("2020-01-01T00:00:00Z")).refine(
    (v) => v.getTime() === new Date("2020-01-01T00:00:00Z").getTime(),
    { message: "Value must be equivelant to 2020-01-01T00:00:00Z" },
  ).transform(v => v.toISOString()),
  constDecimal: z.union([z.instanceof(Decimal$), z.number()]).default(
    new Decimal$("3.141592653589793"),
  ).refine((v) => v.toString() === "3.141592653589793", {
    message: "Value must be 3.141592653589793",
  }).transform(v => typeof v === "number" ? v : v.toNumber()),
  constDecimalStr: z.union([z.instanceof(Decimal$), z.number()]).default(
  ...
  constStrDQuotes: z.literal("const with \"double quotes\"").default(
    "const with \"double quotes\"" as const,
  ),
  constStrNull: z.literal(null).default(null),
  constStrSQuotes: z.literal("const with 'single quotes'").default(
    "const with 'single quotes'" as const,
  ),
  defaultBigInt: z.bigint().default(BigInt("9007199254740991")).transform(v =>
    Number(v)
  ),
  defaultBigIntStr: z.bigint().default(BigInt("9223372036854775807")).transform(
    v => `${v}`
  ),
  defaultBool: z.boolean().default(true),
  defaultDate: z.instanceof(RFCDate).default(() => new RFCDate("2020-01-01"))
    .transform(v => v.toString()),
  defaultDateTime: z.date().default(() => new Date("2020-01-01T00:00:00Z"))
    .transform(v => v.toISOString()),
  defaultDecimal: z.union([z.instanceof(Decimal$), z.number()]).default(() =>
    new Decimal$("3.141592653589793")
  ).transform(v => typeof v === "number" ? v : v.toNumber()),
  defaultDecimalStr: z.union([z.instanceof(Decimal$), z.number()]).default(() =>
    new Decimal$("3.141592653589793238462643383279")
  ).transform(v => `${v}`),
...
export function defaultsAndConstsToJSON(
  defaultsAndConsts: DefaultsAndConsts,
): string {
  return JSON.stringify(
    DefaultsAndConsts$outboundSchema.parse(defaultsAndConsts),
  );
}

export function defaultsAndConstsFromJSON(
  jsonString: string,
): SafeParseResult<DefaultsAndConsts, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DefaultsAndConsts$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DefaultsAndConsts' from JSON`,
  );
}
