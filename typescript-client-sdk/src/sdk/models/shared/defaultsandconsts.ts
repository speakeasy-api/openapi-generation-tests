...
export namespace ConstEnumInt$ {
    export const inboundSchema = z.nativeEnum(ConstEnumInt);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace ConstEnumStr$ {
    export const inboundSchema = z.nativeEnum(ConstEnumStr);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace DefaultEnumInt$ {
    export const inboundSchema = z.nativeEnum(DefaultEnumInt);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace DefaultEnumStr$ {
    export const inboundSchema = z.nativeEnum(DefaultEnumStr);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace DefaultsAndConsts$ {
    export const inboundSchema: z.ZodType<DefaultsAndConsts, z.ZodTypeDef, unknown> = z
        .object({
            constBigInt: z
                .number()
        ...
        .transform((v) => {
            return {
                ...(v.constBigInt === undefined ? null : { constBigInt: v.constBigInt }),
                ...(v.constBigIntStr === undefined ? null : { constBigIntStr: v.constBigIntStr }),
                ...(v.constBool === undefined ? null : { constBool: v.constBool }),
                ...(v.constDate === undefined ? null : { constDate: v.constDate }),
                ...(v.constDateTime === undefined ? null : { constDateTime: v.constDateTime }),
                ...(v.constDecimal === undefined ? null : { constDecimal: v.constDecimal }),
                ...(v.constDecimalStr === undefined
                    ? null
                    : { constDecimalStr: v.constDecimalStr }),
                ...(v.constEnumInt === undefined ? null : { constEnumInt: v.constEnumInt }),
                ...(v.constEnumStr === undefined ? null : { constEnumStr: v.constEnumStr }),
                ...(v.constInt === undefined ? null : { constInt: v.constInt }),
                ...(v.constNum === undefined ? null : { constNum: v.constNum }),
                ...(v.constStr === undefined ? null : { constStr: v.constStr }),
                ...(v.constStrDQuotes === undefined
                    ? null
                    : { constStrDQuotes: v.constStrDQuotes }),
                ...(v.constStrNull === undefined ? null : { constStrNull: v.constStrNull }),
                ...(v.constStrSQuotes === undefined
                    ? null
