    ...
    export const inboundSchema: z.ZodType<DefaultsAndConsts, z.ZodTypeDef, Inbound> = z
        ...
        .transform((v) => {
            return {
                ...
                ...(v.defaultBigInt === undefined ? null : { defaultBigInt: v.defaultBigInt }),
                ...(v.defaultBigIntStr === undefined
                    ? null
                    : { defaultBigIntStr: v.defaultBigIntStr }),
                ...(v.defaultBool === undefined ? null : { defaultBool: v.defaultBool }),
                ...(v.defaultDate === undefined ? null : { defaultDate: v.defaultDate }),
                ...(v.defaultDateTime === undefined
                    ? null
                    : { defaultDateTime: v.defaultDateTime }),
                ...(v.defaultDecimal === undefined ? null : { defaultDecimal: v.defaultDecimal }),
                ...(v.defaultDecimalStr === undefined
                    ? null
                    : { defaultDecimalStr: v.defaultDecimalStr }),
                ...(v.defaultEnumInt === undefined ? null : { defaultEnumInt: v.defaultEnumInt }),
                ...(v.defaultEnumStr === undefined ? null : { defaultEnumStr: v.defaultEnumStr }),
                ...(v.defaultInt === undefined ? null : { defaultInt: v.defaultInt }),
                ...(v.defaultNum === undefined ? null : { defaultNum: v.defaultNum }),
                ...(v.defaultStr === undefined ? null : { defaultStr: v.defaultStr }),
                ...(v.defaultStrDQuotes === undefined
                    ? null
                    : { defaultStrDQuotes: v.defaultStrDQuotes }),
                ...(v.defaultStrNullable === undefined
                    ? null
                    : { defaultStrNullable: v.defaultStrNullable }),
                ...(v.defaultStrOptional === undefined
                    ? null
                    : { defaultStrOptional: v.defaultStrOptional }),
                ...(v.defaultStrSQuotes === undefined
                    ? null
