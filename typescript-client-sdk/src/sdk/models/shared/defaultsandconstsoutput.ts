...
export namespace DefaultsAndConstsOutputConstEnumInt$ {
    export const inboundSchema: z.ZodNativeEnum<typeof DefaultsAndConstsOutputConstEnumInt> =
        z.nativeEnum(DefaultsAndConstsOutputConstEnumInt);
    export const outboundSchema: z.ZodNativeEnum<typeof DefaultsAndConstsOutputConstEnumInt> =
        inboundSchema;
}

/** @internal */
export namespace DefaultsAndConstsOutputConstEnumStr$ {
    export const inboundSchema: z.ZodNativeEnum<typeof DefaultsAndConstsOutputConstEnumStr> =
        z.nativeEnum(DefaultsAndConstsOutputConstEnumStr);
    export const outboundSchema: z.ZodNativeEnum<typeof DefaultsAndConstsOutputConstEnumStr> =
        inboundSchema;
}

/** @internal */
export namespace DefaultsAndConstsOutputDefaultEnumInt$ {
    export const inboundSchema: z.ZodNativeEnum<typeof DefaultsAndConstsOutputDefaultEnumInt> =
        z.nativeEnum(DefaultsAndConstsOutputDefaultEnumInt);
    export const outboundSchema: z.ZodNativeEnum<typeof DefaultsAndConstsOutputDefaultEnumInt> =
        inboundSchema;
}

/** @internal */
export namespace DefaultsAndConstsOutputDefaultEnumStr$ {
    export const inboundSchema: z.ZodNativeEnum<typeof DefaultsAndConstsOutputDefaultEnumStr> =
        z.nativeEnum(DefaultsAndConstsOutputDefaultEnumStr);
    export const outboundSchema: z.ZodNativeEnum<typeof DefaultsAndConstsOutputDefaultEnumStr> =
        inboundSchema;
}
