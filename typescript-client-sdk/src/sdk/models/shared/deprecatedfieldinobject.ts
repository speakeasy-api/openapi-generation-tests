...
/** @internal */
export const DeprecatedEnum$inboundSchema: z.ZodNativeEnum<
  typeof DeprecatedEnum
> = z.nativeEnum(DeprecatedEnum);

/** @internal */
export const DeprecatedEnum$outboundSchema: z.ZodNativeEnum<
  typeof DeprecatedEnum
...
export function deprecatedFieldInObjectToJSON(
  deprecatedFieldInObject: DeprecatedFieldInObject,
): string {
  return JSON.stringify(
    DeprecatedFieldInObject$outboundSchema.parse(deprecatedFieldInObject),
  );
}

export function deprecatedFieldInObjectFromJSON(
  jsonString: string,
): SafeParseResult<DeprecatedFieldInObject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DeprecatedFieldInObject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeprecatedFieldInObject' from JSON`,
  );
}
