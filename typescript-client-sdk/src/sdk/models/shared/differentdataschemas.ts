...
/** @internal */
export type DifferentDataSchemasData$Outbound =
  | MessageEvent$Outbound
  | UrlEvent$Outbound;
...
export function differentDataSchemasDataToJSON(
  differentDataSchemasData: DifferentDataSchemasData,
): string {
  return JSON.stringify(
    DifferentDataSchemasData$outboundSchema.parse(differentDataSchemasData),
  );
}

export function differentDataSchemasDataFromJSON(
  jsonString: string,
): SafeParseResult<DifferentDataSchemasData, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DifferentDataSchemasData$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DifferentDataSchemasData' from JSON`,
  );
}
...
export function differentDataSchemasToJSON(
  differentDataSchemas: DifferentDataSchemas,
): string {
  return JSON.stringify(
    DifferentDataSchemas$outboundSchema.parse(differentDataSchemas),
  );
}

export function differentDataSchemasFromJSON(
  jsonString: string,
): SafeParseResult<DifferentDataSchemas, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DifferentDataSchemas$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DifferentDataSchemas' from JSON`,
  );
}
