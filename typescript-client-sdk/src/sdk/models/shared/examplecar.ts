...
/** @internal */
export const ExampleCarType$inboundSchema: z.ZodNativeEnum<typeof ExampleCarType> =
    z.nativeEnum(ExampleCarType);

/** @internal */
export const ExampleCarType$outboundSchema: z.ZodNativeEnum<typeof ExampleCarType> =
...
/** @internal */
export const ExampleCar$inboundSchema: z.ZodType<ExampleCar, z.ZodTypeDef, unknown> = z.object({
    createdAt: z
        .string()
...
/** @internal */
export const ExampleCar$outboundSchema: z.ZodType<ExampleCar$Outbound, z.ZodTypeDef, ExampleCar> =
    z.object({
        createdAt: z
            .date()
