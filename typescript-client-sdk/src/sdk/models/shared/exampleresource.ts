...
export function chocolatesToJSON(chocolates: Chocolates): string {
  return JSON.stringify(Chocolates$outboundSchema.parse(chocolates));
}

export function chocolatesFromJSON(
  jsonString: string,
): SafeParseResult<Chocolates, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => Chocolates$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'Chocolates' from JSON`,
  );
}
...
export function inlineObjectToJSON(inlineObject: InlineObject): string {
  return JSON.stringify(InlineObject$outboundSchema.parse(inlineObject));
}

export function inlineObjectFromJSON(
  jsonString: string,
): SafeParseResult<InlineObject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => InlineObject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'InlineObject' from JSON`,
  );
}
...
export function exampleResourceToJSON(
  exampleResource: ExampleResource,
): string {
  return JSON.stringify(ExampleResource$outboundSchema.parse(exampleResource));
}

export function exampleResourceFromJSON(
  jsonString: string,
): SafeParseResult<ExampleResource, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ExampleResource$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ExampleResource' from JSON`,
  );
}
