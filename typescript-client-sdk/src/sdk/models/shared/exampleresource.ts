...
/** @internal */
export const Chocolates$inboundSchema: z.ZodType<Chocolates, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Chocolates$outboundSchema: z.ZodType<Chocolates$Outbound, z.ZodTypeDef, Chocolates> =
    z.object({
        description: z.string(),
    });
...
/** @internal */
export const EnumNumber$inboundSchema: z.ZodNativeEnum<typeof EnumNumber> =
    z.nativeEnum(EnumNumber);
...
/** @internal */
export const EnumStr$inboundSchema: z.ZodNativeEnum<typeof EnumStr> = z.nativeEnum(EnumStr);

/** @internal */
export const EnumStr$outboundSchema: z.ZodNativeEnum<typeof EnumStr> = EnumStr$inboundSchema;
...
/** @internal */
export const InlineObject$inboundSchema: z.ZodType<InlineObject, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const ExampleResource$inboundSchema: z.ZodType<ExampleResource, z.ZodTypeDef, unknown> = z
    .object({
