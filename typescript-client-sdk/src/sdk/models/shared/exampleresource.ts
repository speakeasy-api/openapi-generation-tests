...
import { ExampleVehicle, ExampleVehicle$ } from "./examplevehicle.js";
...
export namespace EnumNumber$ {
    export const inboundSchema: z.ZodNativeEnum<typeof EnumNumber> = z.nativeEnum(EnumNumber);
    export const outboundSchema: z.ZodNativeEnum<typeof EnumNumber> = inboundSchema;
}

/** @internal */
export namespace EnumStr$ {
    export const inboundSchema: z.ZodNativeEnum<typeof EnumStr> = z.nativeEnum(EnumStr);
    export const outboundSchema: z.ZodNativeEnum<typeof EnumStr> = inboundSchema;
}
