...
export type InfectedWithAny = {
    data: DeepObject | SimpleObject | any;
};
...
export type InfectedWithAny$Outbound = {
    data: DeepObject$Outbound | SimpleObject$Outbound | any;
};
...
export const InfectedWithAny$outboundSchema: z.ZodType<
    ...
    InfectedWithAny
> = z.object({
    data: z.union([DeepObject$outboundSchema, SimpleObject$outboundSchema, z.any()]),
});
