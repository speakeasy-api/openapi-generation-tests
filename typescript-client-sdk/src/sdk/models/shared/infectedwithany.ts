...
/** @internal */
export type InfectedWithAnyData$Outbound =
  | DeepObject$Outbound
  | SimpleObject$Outbound
  | any;
...
export function infectedWithAnyDataToJSON(
  infectedWithAnyData: InfectedWithAnyData,
): string {
  return JSON.stringify(
    InfectedWithAnyData$outboundSchema.parse(infectedWithAnyData),
  );
}

export function infectedWithAnyDataFromJSON(
  jsonString: string,
): SafeParseResult<InfectedWithAnyData, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => InfectedWithAnyData$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'InfectedWithAnyData' from JSON`,
  );
}

/** @internal */
export const InfectedWithAny$inboundSchema: z.ZodType<
  InfectedWithAny,
  z.ZodTypeDef,
  unknown
> = z.object({
  data: z.union([DeepObject$inboundSchema, SimpleObject$inboundSchema, z.any()])
    .optional(),
});
...
export function infectedWithAnyToJSON(
  infectedWithAny: InfectedWithAny,
): string {
  return JSON.stringify(InfectedWithAny$outboundSchema.parse(infectedWithAny));
}

export function infectedWithAnyFromJSON(
  jsonString: string,
): SafeParseResult<InfectedWithAny, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => InfectedWithAny$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'InfectedWithAny' from JSON`,
  );
}
