...
/** @internal */
export const NullableOneOfTwo$inboundSchema: z.ZodType<
  NullableOneOfTwo,
  z.ZodTypeDef,
  unknown
...
/** @internal */
export type NullableOneOfTwo$Outbound =
  | TypedObject1$Outbound
  | TypedObject2$Outbound;
...
export function nullableOneOfTwoToJSON(
  nullableOneOfTwo: NullableOneOfTwo,
): string {
  return JSON.stringify(
    NullableOneOfTwo$outboundSchema.parse(nullableOneOfTwo),
  );
}

export function nullableOneOfTwoFromJSON(
  jsonString: string,
): SafeParseResult<NullableOneOfTwo, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => NullableOneOfTwo$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'NullableOneOfTwo' from JSON`,
  );
}

/** @internal */
export const OneOfOne$inboundSchema: z.ZodType<
  OneOfOne,
  z.ZodTypeDef,
  unknown
> = TypedObject1$inboundSchema;
...
/** @internal */
export const OneOfOne$outboundSchema: z.ZodType<
  OneOfOne$Outbound,
  z.ZodTypeDef,
  OneOfOne
> = TypedObject1$outboundSchema;
...
export function oneOfOneToJSON(oneOfOne: OneOfOne): string {
  return JSON.stringify(OneOfOne$outboundSchema.parse(oneOfOne));
}

export function oneOfOneFromJSON(
  jsonString: string,
): SafeParseResult<OneOfOne, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => OneOfOne$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'OneOfOne' from JSON`,
  );
}
...
export function nullableOneOfRefInObjectToJSON(
  nullableOneOfRefInObject: NullableOneOfRefInObject,
): string {
  return JSON.stringify(
    NullableOneOfRefInObject$outboundSchema.parse(nullableOneOfRefInObject),
  );
}

export function nullableOneOfRefInObjectFromJSON(
  jsonString: string,
): SafeParseResult<NullableOneOfRefInObject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => NullableOneOfRefInObject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'NullableOneOfRefInObject' from JSON`,
  );
}
