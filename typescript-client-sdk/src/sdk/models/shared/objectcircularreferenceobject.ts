...
export function objectCircularReferenceObjectToJSON(
  objectCircularReferenceObject: ObjectCircularReferenceObject,
): string {
  return JSON.stringify(
    ObjectCircularReferenceObject$outboundSchema.parse(
      objectCircularReferenceObject,
    ),
  );
}

export function objectCircularReferenceObjectFromJSON(
  jsonString: string,
): SafeParseResult<ObjectCircularReferenceObject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ObjectCircularReferenceObject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ObjectCircularReferenceObject' from JSON`,
  );
}
