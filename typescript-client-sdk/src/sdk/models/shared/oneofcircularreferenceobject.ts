...
export namespace OneOfCircularReferenceObject$ {
    export const inboundSchema: z.ZodType<OneOfCircularReferenceObject, z.ZodTypeDef, unknown> =
        z.object({
            child: z.union([
                z.lazy(() => OneOfCircularReferenceObject$.inboundSchema),
                SimpleObject$.inboundSchema,
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, OneOfCircularReferenceObject> =
        z.object({
            child: z.union([
                z.lazy(() => OneOfCircularReferenceObject$.outboundSchema),
                SimpleObject$.outboundSchema,
