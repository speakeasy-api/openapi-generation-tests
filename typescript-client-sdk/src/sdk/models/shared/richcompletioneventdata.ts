...
export namespace StopReason$ {
    export const inboundSchema: z.ZodNativeEnum<typeof StopReason> = z.nativeEnum(StopReason);
    export const outboundSchema: z.ZodNativeEnum<typeof StopReason> = inboundSchema;
}
