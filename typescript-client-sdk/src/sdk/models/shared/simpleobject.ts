...
export namespace Int32Enum$ {
    export const inboundSchema: z.ZodNativeEnum<typeof Int32Enum> = z.nativeEnum(Int32Enum);
    export const outboundSchema: z.ZodNativeEnum<typeof Int32Enum> = inboundSchema;
}

/** @internal */
export namespace IntEnum$ {
    export const inboundSchema: z.ZodNativeEnum<typeof IntEnum> = z.nativeEnum(IntEnum);
    export const outboundSchema: z.ZodNativeEnum<typeof IntEnum> = inboundSchema;
}

/** @internal */
export namespace SimpleObject$ {
    export const inboundSchema: z.ZodType<SimpleObject, z.ZodTypeDef, unknown> = z.object({
        bool: z.boolean(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, SimpleObject> = z.object({
        bool: z.boolean(),
