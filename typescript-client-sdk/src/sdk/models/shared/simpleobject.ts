...
/** @internal */
export const Int32Enum$inboundSchema: z.ZodNativeEnum<typeof Int32Enum> = z
  .nativeEnum(Int32Enum);

/** @internal */
export const Int32Enum$outboundSchema: z.ZodNativeEnum<typeof Int32Enum> =
  Int32Enum$inboundSchema;
...
/** @internal */
export const IntEnum$inboundSchema: z.ZodNativeEnum<typeof IntEnum> = z
  .nativeEnum(IntEnum);

/** @internal */
export const IntEnum$outboundSchema: z.ZodNativeEnum<typeof IntEnum> =
  IntEnum$inboundSchema;
...
/** @internal */
export const SimpleObject$inboundSchema: z.ZodType<
  SimpleObject,
  z.ZodTypeDef,
  unknown
> = z.object({
