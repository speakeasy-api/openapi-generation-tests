...
/** @internal */
export const SimpleObjectWithNonStandardTypeNameInt32Enum$inboundSchema:
  z.ZodNativeEnum<typeof SimpleObjectWithNonStandardTypeNameInt32Enum> = z
    .nativeEnum(SimpleObjectWithNonStandardTypeNameInt32Enum);

/** @internal */
export const SimpleObjectWithNonStandardTypeNameInt32Enum$outboundSchema:
  z.ZodNativeEnum<typeof SimpleObjectWithNonStandardTypeNameInt32Enum> =
...
export namespace SimpleObjectWithNonStandardTypeNameInt32Enum$ {
  ...
  export const outboundSchema =
    SimpleObjectWithNonStandardTypeNameInt32Enum$outboundSchema;
}

/** @internal */
export const SimpleObjectWithNonStandardTypeNameIntEnum$inboundSchema:
  z.ZodNativeEnum<typeof SimpleObjectWithNonStandardTypeNameIntEnum> = z
    .nativeEnum(SimpleObjectWithNonStandardTypeNameIntEnum);

/** @internal */
export const SimpleObjectWithNonStandardTypeNameIntEnum$outboundSchema:
  z.ZodNativeEnum<typeof SimpleObjectWithNonStandardTypeNameIntEnum> =
...
export namespace SimpleObjectWithNonStandardTypeNameIntEnum$ {
  ...
  export const outboundSchema =
    SimpleObjectWithNonStandardTypeNameIntEnum$outboundSchema;
}
...
export function simpleObjectWithNonStandardTypeNameToJSON(
  simpleObjectWithNonStandardTypeName: SimpleObjectWithNonStandardTypeName,
): string {
  return JSON.stringify(
    SimpleObjectWithNonStandardTypeName$outboundSchema.parse(
      simpleObjectWithNonStandardTypeName,
    ),
  );
}

export function simpleObjectWithNonStandardTypeNameFromJSON(
  jsonString: string,
): SafeParseResult<SimpleObjectWithNonStandardTypeName, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      SimpleObjectWithNonStandardTypeName$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'SimpleObjectWithNonStandardTypeName' from JSON`,
  );
}
