 ...
 */
export const SimpleObjectWithNonStandardTypeNameIntEnum = {
    First: 1,
    Second: 2,
    Third: 3,
} as const;
 ...
 * An integer enum property.
 */
export type SimpleObjectWithNonStandardTypeNameIntEnum = ClosedEnum<
...
export namespace SimpleObjectWithNonStandardTypeNameIntEnum$ {
    export const inboundSchema: z.ZodNativeEnum<typeof SimpleObjectWithNonStandardTypeNameIntEnum> =
