...
export namespace SimpleObjectWithNonStandardTypeNameInt32Enum$ {
    export const inboundSchema = z.nativeEnum(SimpleObjectWithNonStandardTypeNameInt32Enum);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace SimpleObjectWithNonStandardTypeNameIntEnum$ {
    export const inboundSchema = z.nativeEnum(SimpleObjectWithNonStandardTypeNameIntEnum);
    export const outboundSchema = inboundSchema;
}
