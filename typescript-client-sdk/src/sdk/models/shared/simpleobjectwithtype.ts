 ...
 * An int32 enum property.
 */
export type SimpleObjectWithTypeInt32Enum = ClosedEnum<typeof SimpleObjectWithTypeInt32Enum>;

/**
 * An integer enum property.
 */
export const SimpleObjectWithTypeIntEnum = {
    First: 1,
    Second: 2,
    Third: 3,
} as const;
 ...
 * An integer enum property.
 */
export type SimpleObjectWithTypeIntEnum = ClosedEnum<typeof SimpleObjectWithTypeIntEnum>;
...
export namespace SimpleObjectWithTypeInt32Enum$ {
    export const inboundSchema: z.ZodNativeEnum<typeof SimpleObjectWithTypeInt32Enum> =
        z.nativeEnum(SimpleObjectWithTypeInt32Enum);
    export const outboundSchema: z.ZodNativeEnum<typeof SimpleObjectWithTypeInt32Enum> =
        inboundSchema;
}

/** @internal */
export namespace SimpleObjectWithTypeIntEnum$ {
    export const inboundSchema: z.ZodNativeEnum<typeof SimpleObjectWithTypeIntEnum> = z.nativeEnum(
        SimpleObjectWithTypeIntEnum
    );
    export const outboundSchema: z.ZodNativeEnum<typeof SimpleObjectWithTypeIntEnum> =
        inboundSchema;
}

/** @internal */
export namespace SimpleObjectWithType$ {
    export const inboundSchema: z.ZodType<SimpleObjectWithType, z.ZodTypeDef, unknown> = z.object({
        any: z.any().optional(),
        bigint: z
            .number()
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, SimpleObjectWithType> = z.object(
        {
            any: z.any().optional(),
            bigint: z
                .bigint()
