...
export namespace StronglyTypedOneOfDiscriminatedObject$ {
    ...
    export const inboundSchema: z.ZodType<
        ...
        Inbound
    > = z.union([
        TaggedObject1$.inboundSchema.and(z.object({ tag: z.literal(Tag.Tag1) })),
        TaggedObject2$.inboundSchema.and(z.object({ tag: z.literal(TaggedObject2Tag.Tag2) })),
        TaggedObject3$.inboundSchema.and(z.object({ tag: z.literal("tag3") })),
    ]);
    ...
    export const outboundSchema: z.ZodType<
        ...
        StronglyTypedOneOfDiscriminatedObject
    > = z.union([
        TaggedObject1$.outboundSchema.and(z.object({ tag: z.literal(Tag.Tag1) })),
        TaggedObject2$.outboundSchema.and(z.object({ tag: z.literal(TaggedObject2Tag.Tag2) })),
        TaggedObject3$.outboundSchema.and(z.object({ tag: z.literal("tag3") })),
    ]);
}
