...
export namespace StronglyTypedOneOfDiscriminatedObject$ {
  ...
  export const inboundSchema =
    StronglyTypedOneOfDiscriminatedObject$inboundSchema;
  /** @deprecated use `StronglyTypedOneOfDiscriminatedObject$outboundSchema` instead. */
  export const outboundSchema =
    StronglyTypedOneOfDiscriminatedObject$outboundSchema;
...
export function stronglyTypedOneOfDiscriminatedObjectToJSON(
  stronglyTypedOneOfDiscriminatedObject: StronglyTypedOneOfDiscriminatedObject,
): string {
  return JSON.stringify(
    StronglyTypedOneOfDiscriminatedObject$outboundSchema.parse(
      stronglyTypedOneOfDiscriminatedObject,
    ),
  );
}

export function stronglyTypedOneOfDiscriminatedObjectFromJSON(
  jsonString: string,
): SafeParseResult<StronglyTypedOneOfDiscriminatedObject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      StronglyTypedOneOfDiscriminatedObject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'StronglyTypedOneOfDiscriminatedObject' from JSON`,
  );
}
