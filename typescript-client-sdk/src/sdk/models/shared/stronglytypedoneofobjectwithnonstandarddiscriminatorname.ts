...
export type StronglyTypedOneOfObjectWithNonStandardDiscriminatorName =
  | (DeepObjectWithNonStandardTypeName & {
    objType: "deepObjectWithNonStandardTypeName";
  })
  | (SimpleObjectWithNonStandardTypeName & {
...
/** @internal */
export const StronglyTypedOneOfObjectWithNonStandardDiscriminatorName$inboundSchema:
  z.ZodType<
  ...
  > = z.union([
    DeepObjectWithNonStandardTypeName$inboundSchema.and(
      z.object({ "obj.type": z.literal("deepObjectWithNonStandardTypeName") })
        .transform((v) => ({ objType: v["obj.type"] })),
    ),
    SimpleObjectWithNonStandardTypeName$inboundSchema.and(
      z.object({ "obj.type": z.literal("simpleObjectWithNonStandardTypeName") })
        .transform((v) => ({ objType: v["obj.type"] })),
    ),
  ]);
...
/** @internal */
export const StronglyTypedOneOfObjectWithNonStandardDiscriminatorName$outboundSchema:
  z.ZodType<
  ...
  > = z.union([
    DeepObjectWithNonStandardTypeName$outboundSchema.and(
      z.object({ objType: z.literal("deepObjectWithNonStandardTypeName") })
        .transform((v) => ({ "obj.type": v.objType })),
    ),
    SimpleObjectWithNonStandardTypeName$outboundSchema.and(
      z.object({ objType: z.literal("simpleObjectWithNonStandardTypeName") })
        .transform((v) => ({ "obj.type": v.objType })),
    ),
  ]);
...
export function stronglyTypedOneOfObjectWithNonStandardDiscriminatorNameToJSON(
  stronglyTypedOneOfObjectWithNonStandardDiscriminatorName:
    StronglyTypedOneOfObjectWithNonStandardDiscriminatorName,
): string {
  return JSON.stringify(
    StronglyTypedOneOfObjectWithNonStandardDiscriminatorName$outboundSchema
      .parse(stronglyTypedOneOfObjectWithNonStandardDiscriminatorName),
  );
}

export function stronglyTypedOneOfObjectWithNonStandardDiscriminatorNameFromJSON(
  jsonString: string,
): SafeParseResult<
  StronglyTypedOneOfObjectWithNonStandardDiscriminatorName,
  SDKValidationError
> {
  return safeParse(
    ...
    (x) =>
      StronglyTypedOneOfObjectWithNonStandardDiscriminatorName$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'StronglyTypedOneOfObjectWithNonStandardDiscriminatorName' from JSON`,
  );
}
