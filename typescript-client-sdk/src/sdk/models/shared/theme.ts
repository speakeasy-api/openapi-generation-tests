...
/** @internal */
export const Color$inboundSchema: z.ZodType<Color, z.ZodTypeDef, unknown> = z.union([
    z.nativeEnum(Color),
    z.string().transform(catchUnrecognizedEnum),
]);

/** @internal */
export const Color$outboundSchema: z.ZodType<Color, z.ZodTypeDef, Color> = z.union([
    z.nativeEnum(Color),
...
/** @internal */
export const HeroWidth$inboundSchema: z.ZodType<HeroWidth, z.ZodTypeDef, unknown> = z.union([
    z.nativeEnum(HeroWidth),
    z.number().transform(catchUnrecognizedEnum),
]);

/** @internal */
export const HeroWidth$outboundSchema: z.ZodType<HeroWidth, z.ZodTypeDef, HeroWidth> = z.union([
    z.nativeEnum(HeroWidth),
...
/** @internal */
export const Icon$inboundSchema: z.ZodNativeEnum<typeof Icon> = z.nativeEnum(Icon);

/** @internal */
export const Icon$outboundSchema: z.ZodNativeEnum<typeof Icon> = Icon$inboundSchema;
...
/** @internal */
export const Theme$inboundSchema: z.ZodType<Theme, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Theme$outboundSchema: z.ZodType<Theme$Outbound, z.ZodTypeDef, Theme> = z.object({
