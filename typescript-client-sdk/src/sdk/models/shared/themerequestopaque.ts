...
export namespace ThemeRequestOpaque$ {
    export const inboundSchema: z.ZodType<ThemeRequestOpaque, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ThemeRequestOpaque> = z
        .object({
            color: z.string().optional(),
            heroWidth: z.number().int().optional(),
            icon: z.string().optional(),
