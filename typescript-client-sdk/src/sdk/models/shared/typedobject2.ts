...
/** @internal */
export const TypedObject2Type$inboundSchema: z.ZodNativeEnum<typeof TypedObject2Type> =
    z.nativeEnum(TypedObject2Type);

/** @internal */
export const TypedObject2Type$outboundSchema: z.ZodNativeEnum<typeof TypedObject2Type> =
...
/** @internal */
export const TypedObject2$inboundSchema: z.ZodType<TypedObject2, z.ZodTypeDef, unknown> = z.object({
