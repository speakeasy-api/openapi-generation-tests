...
export function unionOfArrays2ToJSON(unionOfArrays2: UnionOfArrays2): string {
  return JSON.stringify(UnionOfArrays2$outboundSchema.parse(unionOfArrays2));
}

export function unionOfArrays2FromJSON(
  jsonString: string,
): SafeParseResult<UnionOfArrays2, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UnionOfArrays2$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UnionOfArrays2' from JSON`,
  );
}
...
export function unionOfArraysToJSON(unionOfArrays: UnionOfArrays): string {
  return JSON.stringify(UnionOfArrays$outboundSchema.parse(unionOfArrays));
}

export function unionOfArraysFromJSON(
  jsonString: string,
): SafeParseResult<UnionOfArrays, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UnionOfArrays$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UnionOfArrays' from JSON`,
  );
}
