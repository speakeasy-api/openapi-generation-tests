...
export namespace ValidCircularReferenceObject$ {
    export const inboundSchema: z.ZodType<ValidCircularReferenceObject, z.ZodTypeDef, unknown> =
        z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ValidCircularReferenceObject> =
        z.object({
            circular: z
