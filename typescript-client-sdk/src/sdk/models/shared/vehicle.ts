...
/** @internal */
export const Vehicle$inboundSchema: z.ZodType<Vehicle, z.ZodTypeDef, unknown> =
  z.union([
    Car$inboundSchema.and(
      z.object({ vehicleType: z.literal("car") }).transform((v) => ({
        vehicleType: v.vehicleType,
      })),
    ),
    Bike$inboundSchema.and(
      z.object({ vehicleType: z.literal("bike") }).transform((v) => ({
        vehicleType: v.vehicleType,
      })),
    ),
  ]);
...
/** @internal */
export const Vehicle$outboundSchema: z.ZodType<
  Vehicle$Outbound,
  z.ZodTypeDef,
  Vehicle
> = z.union([
...
export function vehicleToJSON(vehicle: Vehicle): string {
  return JSON.stringify(Vehicle$outboundSchema.parse(vehicle));
}
