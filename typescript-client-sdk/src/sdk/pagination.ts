...
import { paginationPaginationEncapsulatedParameter } from "../funcs/paginationPaginationEncapsulatedParameter.js";
...
import { paginationPaginationLimitOffsetDefaultOffsetBody } from "../funcs/paginationPaginationLimitOffsetDefaultOffsetBody.js";
import { paginationPaginationLimitOffsetDefaultOffsetParams } from "../funcs/paginationPaginationLimitOffsetDefaultOffsetParams.js";
...
import { paginationPaginationLimitOffsetOptionalPageParams } from "../funcs/paginationPaginationLimitOffsetOptionalPageParams.js";
...
export class Pagination extends ClientSDK {
   ...
   */
  async paginationEncapsulatedParameter(
    ...
    >
  > {
    return unwrapResultIterator(paginationPaginationEncapsulatedParameter(
      this,
      request,
      options,
    ));
  ...
  async paginationLimitOffsetDefaultOffsetBody(
  ...
  async paginationLimitOffsetDefaultOffsetParams(
  ...
  async paginationLimitOffsetOptionalPageParams(
  ...
  > {
    return unwrapResultIterator(
      paginationPaginationLimitOffsetOptionalPageParams(
        this,
        page,
        options,
      ),
