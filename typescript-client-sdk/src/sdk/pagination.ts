...
export class Pagination extends ClientSDK {
    ...
    async paginationLimitOffsetDeepOutputsPageBody(
        ...
        const baseURL$ =
            options?.serverURL ||
            this.templateURLComponent(PaginationLimitOffsetDeepOutputsPageBodyServerList[0], {
                charEncoding: "percent",
            })();

        const path$ = this.templateURLComponent("/pagination/limitoffset/deep_outputs/page")();
        ...
        const [result$, raw$] =
            await this.matcher<operations.PaginationLimitOffsetDeepOutputsPageBodyResponse>()
                .json(
                    200,
