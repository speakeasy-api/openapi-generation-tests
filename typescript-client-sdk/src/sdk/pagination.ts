...
export class Pagination extends ClientSDK {
  ...
  ): Promise<PageIterator<operations.PaginationAmbiguousInputResponse>> {
  ...
  async paginationBodyFlattenedOptionalSecurity(
    ...
    PageIterator<operations.PaginationBodyFlattenedOptionalSecurityResponse>
  > {
  ...
  async paginationBodyFlattenedWithSecurity(
    ...
    PageIterator<operations.PaginationBodyFlattenedWithSecurityResponse>
  > {
  ...
  async paginationBodyWrappedRequest(
    ...
    options?: RequestOptions & { serverURL?: string },
  ): Promise<PageIterator<operations.PaginationBodyWrappedRequestResponse>> {
  ...
  async paginationLimitOffsetDeepOutputsPageBody(
    ...
    PageIterator<operations.PaginationLimitOffsetDeepOutputsPageBodyResponse>
  > {
    return unwrapResultIterator(
  ...
  async paginationLimitOffsetOffsetParams(
    ...
    PageIterator<operations.PaginationLimitOffsetOffsetParamsResponse>
  > {
  ...
  async paginationWrappedOptionalBody(
    ...
    options?: RequestOptions & { serverURL?: string },
  ): Promise<PageIterator<operations.PaginationWrappedOptionalBodyResponse>> {
