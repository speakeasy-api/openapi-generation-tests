...
export class Pagination extends ClientSDK {
    ...
    async paginationCursorBody(
        ...
        const context = { operationID: "paginationCursorBody" };
    ...
    async paginationCursorParams(
        ...
        const context = { operationID: "paginationCursorParams" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async paginationLimitOffsetOffsetBody(
        ...
        const context = { operationID: "paginationLimitOffsetOffsetBody" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async paginationLimitOffsetOffsetParams(
        ...
        const context = { operationID: "paginationLimitOffsetOffsetParams" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async paginationLimitOffsetPageBody(
        ...
        const context = { operationID: "paginationLimitOffsetPageBody" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async paginationLimitOffsetPageParams(
        ...
        const context = { operationID: "paginationLimitOffsetPageParams" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async paginationURLParams(
        ...
        const payload$ = operations.PaginationURLParamsRequest$.outboundSchema.parse(input$);
        const body$ = null;
        const baseURL$ =
        ...
        const context = { operationID: "paginationURLParams" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            const responseBody = await response.json();
            const parsed = operations.PaginationURLParamsResponse$.inboundSchema.parse({
                ...responseFields$,
                res: responseBody,
            });
            const next$ = nextFunc(responseBody);
