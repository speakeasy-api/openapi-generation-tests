...
export class ParametersT extends ClientSDK {
    ...
    async deepObjectQueryParamsDeepObject(
        ...
        const path$ = this.templateURLComponent("/anything/queryParams/deepObject/deepObj")();
        ...
        const [result$] = await this.matcher<operations.DeepObjectQueryParamsDeepObjectRes>()
            .json(200, operations.DeepObjectQueryParamsDeepObjectRes$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
