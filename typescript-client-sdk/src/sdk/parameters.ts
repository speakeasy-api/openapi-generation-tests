...
import { parametersHeaderParamsNil } from "../funcs/parametersHeaderParamsNil.js";
...
export class ParametersT extends ClientSDK {
  ...
  async headerParamsNil(
    request: operations.HeaderParamsNilRequest,
    options?: RequestOptions,
  ): Promise<operations.HeaderParamsNilRes> {
    return unwrapAsync(parametersHeaderParamsNil(
      this,
      request,
      options,
    ));
