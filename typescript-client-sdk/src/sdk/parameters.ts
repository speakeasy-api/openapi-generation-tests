...
export class ParametersT extends ClientSDK {
    async deepObjectQueryParamsDeepObject(
        ...
        return unwrapAsync(parametersDeepObjectQueryParamsDeepObject(this, deepObj, options));
    }
    ...
    async deepObjectQueryParamsMap(
        ...
        return unwrapAsync(
            parametersDeepObjectQueryParamsMap(this, mapParam, mapArrParam, options)
        );
    }
    ...
    async deepObjectQueryParamsObject(
        ...
        return unwrapAsync(
            parametersDeepObjectQueryParamsObject(this, objParam, objArrParam, options)
        );
    }
    ...
    async duplicateParam(
        ...
        return unwrapAsync(parametersDuplicateParam(this, duplicateParamRequest, options));
    }
    ...
    async formQueryParamsArray(
        ...
        return unwrapAsync(
            parametersFormQueryParamsArray(this, arrParam, arrParamExploded, options)
        );
    }
    ...
    async formQueryParamsCamelObject(
        ...
        return unwrapAsync(
            parametersFormQueryParamsCamelObject(this, objParamExploded, objParam, options)
        );
    }
    ...
    async formQueryParamsMap(
        ...
        return unwrapAsync(parametersFormQueryParamsMap(this, mapParam, mapParamExploded, options));
    }
    ...
    async formQueryParamsObject(
        ...
        return unwrapAsync(
            parametersFormQueryParamsObject(this, objParamExploded, objParam, options)
        );
    }
    ...
    async formQueryParamsPrimitive(
        ...
        return unwrapAsync(
            parametersFormQueryParamsPrimitive(
                this,
                boolParam,
                intParam,
                numParam,
    ...
    async formQueryParamsRefParamObject(
        ...
        return unwrapAsync(
            parametersFormQueryParamsRefParamObject(this, refObjParam, refObjParamExploded, options)
        );
    }
    ...
    async headerParamsArray(
        ...
        return unwrapAsync(parametersHeaderParamsArray(this, xHeaderArray, options));
    }
    ...
    async headerParamsMap(
        ...
        return unwrapAsync(parametersHeaderParamsMap(this, xHeaderMap, xHeaderMapExplode, options));
    }
    ...
    async headerParamsObject(
        ...
        return unwrapAsync(
            parametersHeaderParamsObject(this, xHeaderObj, xHeaderObjExplode, options)
        );
    }
    ...
    async headerParamsPrimitive(
        ...
        return unwrapAsync(
            parametersHeaderParamsPrimitive(
                this,
                xHeaderBoolean,
                xHeaderInteger,
                xHeaderNumber,
    ...
    async jsonQueryParamsObject(
        ...
        return unwrapAsync(
            parametersJsonQueryParamsObject(this, deepObjParam, simpleObjParam, options)
        );
    }
    ...
    async jsonQueryParamsObjectSmaller(
        ...
        return unwrapAsync(
            parametersJsonQueryParamsObjectSmaller(this, deepObjParam, simpleObjParam, options)
        );
    }
    ...
    async mixedParametersCamelCase(
        ...
        return unwrapAsync(
            parametersMixedParametersCamelCase(
                this,
                headerParam,
                pathParam,
                queryStringParam,
    ...
    async mixedParametersPrimitives(
        ...
        return unwrapAsync(
            parametersMixedParametersPrimitives(
                this,
                headerParam,
                pathParam,
                queryStringParam,
    ...
    async mixedQueryParams(
        ...
        return unwrapAsync(
            parametersMixedQueryParams(this, deepObjectParam, formParam, jsonParam, options)
        );
    }
    ...
    async pathParameterJson(
        ...
        return unwrapAsync(parametersPathParameterJson(this, jsonObj, options));
    }
    ...
    async pipeDelimitedQueryParamsArray(
        ...
        return unwrapAsync(
            parametersPipeDelimitedQueryParamsArray(
                this,
                arrParam,
                arrParamExploded,
                mapParam,
    ...
    async simplePathParameterArrays(
        ...
        return unwrapAsync(parametersSimplePathParameterArrays(this, arrParam, options));
    }
    ...
    async simplePathParameterMaps(
        ...
        return unwrapAsync(
            parametersSimplePathParameterMaps(this, mapParam, mapParamExploded, options)
        );
    }
    ...
    async simplePathParameterObjects(
        ...
        return unwrapAsync(
            parametersSimplePathParameterObjects(this, objParam, objParamExploded, options)
        );
    }
    ...
    async simplePathParameterPrimitives(
        ...
        return unwrapAsync(
            parametersSimplePathParameterPrimitives(
                this,
                boolParam,
                intParam,
                numParam,
