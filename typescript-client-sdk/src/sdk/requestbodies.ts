...
import { requestBodiesRequestBodyGetInferredOptionalRequestWrapper } from "../funcs/requestBodiesRequestBodyGetInferredOptionalRequestWrapper.js";
...
import { requestBodiesRequestBodyPutMultipartFileRef } from "../funcs/requestBodiesRequestBodyPutMultipartFileRef.js";
...
export class RequestBodies extends ClientSDK {
  ...
  async requestBodyGetInferredOptionalRequestWrapper(
  ...
  > {
    return unwrapAsync(
      requestBodiesRequestBodyGetInferredOptionalRequestWrapper(
        this,
        request,
        options,
      ),
  ...
  async requestBodyPostWildcard(
    request?:
      ...
      | undefined,
    options?: RequestOptions,
  ): Promise<operations.RequestBodyPostWildcardRes> {
    return unwrapAsync(requestBodiesRequestBodyPostWildcard(
      this,
      request,
      options,
    ));
  ...
  async requestBodyPutMultipartFileRef(
    request: operations.RequestBodyPutMultipartFileRefRequestBody,
    options?: RequestOptions,
  ): Promise<operations.RequestBodyPutMultipartFileRefRes> {
    return unwrapAsync(requestBodiesRequestBodyPutMultipartFileRef(
      this,
      request,
      options,
    ));
