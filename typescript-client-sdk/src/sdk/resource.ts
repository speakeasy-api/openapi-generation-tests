...
export class Resource extends ClientSDK {
    async createFile(
        ...
        return unwrapAsync(resourceCreateFile(this, request, options));
    }
    ...
    async createResource(
        ...
        return unwrapAsync(resourceCreateResource(this, request, options));
    }

    async deleteResource(resourceId: string, options?: RequestOptions): Promise<void> {
        return unwrapAsync(resourceDeleteResource(this, resourceId, options));
    }

    async getArrayDataSource(filter: string, options?: RequestOptions): Promise<Array<string>> {
        return unwrapAsync(resourceGetArrayDataSource(this, filter, options));
    }
    ...
    async getResource(
        ...
        return unwrapAsync(resourceGetResource(this, resourceId, options));
    }
    ...
    async updateResource(
        ...
        return unwrapAsync(resourceUpdateResource(this, augment, resourceId, options));
    }
}
