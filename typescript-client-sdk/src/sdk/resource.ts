...
export class Resource extends ClientSDK {
    ...
    async createFile(
        ...
        const [result$] = await this.matcher<operations.CreateFileResponse>()
            .json(200, operations.CreateFileResponse$, { key: "FileResource" })
            .fail(["4XX", "5XX"])
    ...
    async createResource(
        ...
        const [result$] = await this.matcher<operations.CreateResourceResponse>()
            .json(200, operations.CreateResourceResponse$, { key: "ExampleResource" })
            .fail(["4XX", "5XX"])
            .match(response, { extraFields: responseFields$ });
    ...
    async deleteResource(
        ...
        const [result$] = await this.matcher<operations.DeleteResourceResponse>()
            .void(204, operations.DeleteResourceResponse$)
            .fail(["4XX", "5XX"])
            .match(response, { extraFields: responseFields$ });
    ...
    async getArrayDataSource(
        ...
        const [result$] = await this.matcher<operations.GetArrayDataSourceResponse>()
            .json(200, operations.GetArrayDataSourceResponse$, { key: "ArrayDataSource" })
            .fail(["4XX", "5XX"])
            .match(response, { extraFields: responseFields$ });
    ...
    async getResource(
        ...
        const [result$] = await this.matcher<operations.GetResourceResponse>()
            .json(200, operations.GetResourceResponse$, { key: "ExampleResource" })
            .fail(["4XX", "5XX"])
            .match(response, { extraFields: responseFields$ });
    ...
    async updateResource(
        ...
        const [result$] = await this.matcher<operations.UpdateResourceResponse>()
            .void(202, operations.UpdateResourceResponse$)
            .fail(["4XX", "5XX"])
            .match(response, { extraFields: responseFields$ });
