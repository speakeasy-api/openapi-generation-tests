...
import { responseBodiesResponseBodies2xxJSONObjectAllOptionalProperties } from "../funcs/responseBodiesResponseBodies2xxJSONObjectAllOptionalProperties.js";
...
export class ResponseBodies extends ClientSDK {
  ...
  async responseBodies2xxJSONObjectAllOptionalProperties(
    options?: RequestOptions,
  ): Promise<
    operations.ResponseBodies2xxJSONObjectAllOptionalPropertiesResponseBody
  > {
    return unwrapAsync(
      responseBodiesResponseBodies2xxJSONObjectAllOptionalProperties(
        this,
        options,
      ),
    );
