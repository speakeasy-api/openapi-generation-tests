...
export class Retries extends ClientSDK {
    ...
    async retriesAfter(
        ...
        const [result$] = await this.matcher<operations.RetriesAfterRetries>()
            .json(200, operations.RetriesAfterRetries$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async retriesConnectErrorGet(
        ...
        const [result$] = await this.matcher<operations.RetriesConnectErrorGetRetries>()
            .json(200, operations.RetriesConnectErrorGetRetries$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async retriesGet(
        ...
        const [result$] = await this.matcher<operations.RetriesGetRetries>()
            .json(200, operations.RetriesGetRetries$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async retriesPost(
        ...
        const [result$] = await this.matcher<operations.RetriesPostRetries>()
            .json(200, operations.RetriesPostRetries$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
