...
export class Retries extends ClientSDK {
    async retriesAfter(
        ...
        return unwrapAsync(
            retriesRetriesAfter(this, requestId, numRetries, retryAfterVal, options)
        );
    }
    ...
    async retriesConnectErrorGet(
        ...
        return unwrapAsync(retriesRetriesConnectErrorGet(this, options));
    }
    ...
    async retriesFlatEmptyResponsePost(
        ...
        return unwrapAsync(
            retriesRetriesFlatEmptyResponsePost(this, requestId, requestBody, numRetries, options)
        );
    }
    ...
    async retriesGet(
        ...
        return unwrapAsync(retriesRetriesGet(this, requestId, numRetries, options));
    }
    ...
    async retriesPost(
        ...
        return unwrapAsync(retriesRetriesPost(this, requestId, requestBody, numRetries, options));
    }
}
