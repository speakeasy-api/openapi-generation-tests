...
export class SDK extends ClientSDK {
  ...
  get unions(): Unions {
    return (this._unions ??= new Unions(this._options));
  }
  ...
  get customClient(): CustomClient {
    return (this._customClient ??= new CustomClient(this._options));
  }

  private _responseBodies?: ResponseBodies;
  get responseBodies(): ResponseBodies {
    return (this._responseBodies ??= new ResponseBodies(this._options));
  }

  private _flattening?: Flattening;
  get flattening(): Flattening {
    return (this._flattening ??= new Flattening(this._options));
  }

  private _globals?: Globals;
  get globals(): Globals {
    return (this._globals ??= new Globals(this._options));
  }
  ...
  get requestBodies(): RequestBodies {
    return (this._requestBodies ??= new RequestBodies(this._options));
  }

  private _nest?: Nest;
  get nest(): Nest {
    return (this._nest ??= new Nest(this._options));
  }
  ...
  get openEnums(): OpenEnums {
    return (this._openEnums ??= new OpenEnums(this._options));
  }
  ...
  get authNew(): AuthNew {
    return (this._authNew ??= new AuthNew(this._options));
  }
  ...
  get documentation(): Documentation {
    return (this._documentation ??= new Documentation(this._options));
  }
  ...
  get first(): First {
    return (this._first ??= new First(this._options));
  }

  private _second?: Second;
  get second(): Second {
    return (this._second ??= new Second(this._options));
  }
  ...
  get pagination(): Pagination {
    return (this._pagination ??= new Pagination(this._options));
  }
  ...
  get statusCode(): StatusCode {
    return (this._statusCode ??= new StatusCode(this._options));
  }
  ...
  async ambiguousQueryParam(
    ...
    return unwrapAsync(ambiguousQueryParam(
      this,
      console,
      options,
    ));
  ...
  async authenticatedRequest(
    ...
    return unwrapAsync(authenticatedRequest(
      this,
      security,
      request,
      options,
  ...
  async conflictingEnum(
    ...
    return unwrapAsync(conflictingEnum(
      this,
      request,
      options,
    ));
  ...
  async ignoredGenerationPut(
    ...
    return unwrapAsync(ignoredGenerationPut(
      this,
      request,
      options,
    ));
  ...
  > {
    return unwrapAsync(postAdditionalPropertiesWithNullableFields(
      this,
      request,
      options,
    ));
  ...
  async responseBodyJsonGet(
    ...
    return unwrapAsync(responseBodyJsonGet(
      this,
      options,
    ));
  }
  ...
  async validateWebhook({
    ...
    secret: string;
  }): Promise<shared.WebhookRequestCreated | shared.WebhookRequestUpdated> {
