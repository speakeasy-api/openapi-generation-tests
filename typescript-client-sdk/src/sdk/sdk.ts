...
export class SDK extends ClientSDK {
    ...
    async authenticatedRequest(
        ...
        const path$ = pathToFunc("/clientcredentials/authenticatedrequest")();
    ...
    async conflictingEnum(
        ...
        const path$ = pathToFunc("/anything/conflictingEnum/")();
    ...
    async ignoredGenerationPut(
        ...
        >(
            m$.json(200, operations.IgnoredGenerationPutResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
