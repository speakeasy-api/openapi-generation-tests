...
export class Servers extends ClientSDK {
    async selectGlobalServer(
        ...
        return unwrapAsync(serversSelectGlobalServer(this, options));
    }
    ...
    async selectServerWithID(options?: RequestOptions & { serverURL?: string }): Promise<void> {
        return unwrapAsync(serversSelectServerWithID(this, options));
    }

    async serverWithProtocolTemplate(
        options?: RequestOptions & { serverURL?: string }
    ): Promise<void> {
        return unwrapAsync(serversServerWithProtocolTemplate(this, options));
    }

    async serverWithTemplates(options?: RequestOptions & { serverURL?: string }): Promise<void> {
        return unwrapAsync(serversServerWithTemplates(this, options));
    }

    async serverWithTemplatesGlobal(options?: RequestOptions): Promise<void> {
        return unwrapAsync(serversServerWithTemplatesGlobal(this, options));
    }

    async serversByIDWithTemplates(
        options?: RequestOptions & { serverURL?: string }
    ): Promise<void> {
        return unwrapAsync(serversServersByIDWithTemplates(this, options));
    }
}
