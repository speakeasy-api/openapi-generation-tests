...
export class Servers extends ClientSDK {
    ...
    async selectGlobalServer(
        ...
        const context = { operationID: "selectGlobalServer" };
    ...
    async selectServerWithID(
        ...
        const context = { operationID: "selectServerWithID" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = this.createRequest$(
            {
                security: securitySettings$,
    ...
    async serverWithProtocolTemplate(
        ...
        const context = { operationID: "serverWithProtocolTemplate" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = this.createRequest$(
            {
                security: securitySettings$,
    ...
    async serverWithTemplates(
        ...
        const context = { operationID: "serverWithTemplates" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = this.createRequest$(
            {
                security: securitySettings$,
    ...
    async serverWithTemplatesGlobal(
        ...
        const context = { operationID: "serverWithTemplatesGlobal" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = this.createRequest$(
            {
                security: securitySettings$,
    ...
    async serversByIDWithTemplates(
        ...
        const context = { operationID: "serversByIDWithTemplates" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = this.createRequest$(
            {
                security: securitySettings$,
