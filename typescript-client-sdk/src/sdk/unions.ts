...
export class Unions extends ClientSDK {
    ...
    async constDiscriminatedOneOf(
        ...
        const path$ = this.templateURLComponent("/anything/constDiscriminatedOneOf")();
        ...
        const [result$] = await this.matcher<operations.ConstDiscriminatedOneOfRes>()
            .json(200, operations.ConstDiscriminatedOneOfRes$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async discriminatedOneMultipleMemberships(
        ...
        const path$ = this.templateURLComponent("/anything/discriminatedOneMultipleMemberships")();
        ...
        const [result$] = await this.matcher<operations.DiscriminatedOneMultipleMembershipsRes>()
            .json(200, operations.DiscriminatedOneMultipleMembershipsRes$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async discriminatedOneMultipleMembershipsHasWheels(
        ...
        const [result$] =
            await this.matcher<operations.DiscriminatedOneMultipleMembershipsHasWheelsRes>()
                .json(200, operations.DiscriminatedOneMultipleMembershipsHasWheelsRes$inboundSchema)
                .fail(["4XX", "5XX"])
                .match(response);
