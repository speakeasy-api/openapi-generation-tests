...
export class Unions extends ClientSDK {
    async collectionOneOfPost(
        ...
        return unwrapAsync(unionsCollectionOneOfPost(this, request, options));
    }
    ...
    async constDiscriminatedOneOf(
        ...
        return unwrapAsync(unionsConstDiscriminatedOneOf(this, request, options));
    }
    ...
    async discriminatedOneMultipleMemberships(
        ...
        return unwrapAsync(unionsDiscriminatedOneMultipleMemberships(this, request, options));
    }
    ...
    async discriminatedOneMultipleMembershipsHasWheels(
        ...
        return unwrapAsync(
            unionsDiscriminatedOneMultipleMembershipsHasWheels(this, request, options)
        );
    }
    ...
    async flattenedTypedObjectPost(
        ...
        return unwrapAsync(unionsFlattenedTypedObjectPost(this, request, options));
    }
    ...
    async infectedWithAny(
        ...
        return unwrapAsync(unionsInfectedWithAny(this, request, options));
    }
    ...
    async mixedTypeOneOfPost(
        ...
        return unwrapAsync(unionsMixedTypeOneOfPost(this, request, options));
    }
    ...
    async nullableOneOfRefInObjectPost(
        ...
        return unwrapAsync(unionsNullableOneOfRefInObjectPost(this, request, options));
    }
    ...
    async nullableOneOfSchemaPost(
        ...
        return unwrapAsync(unionsNullableOneOfSchemaPost(this, request, options));
    }
    ...
    async nullableOneOfTypeInObjectPost(
        ...
        return unwrapAsync(unionsNullableOneOfTypeInObjectPost(this, request, options));
    }
    ...
    async nullableTypedObjectPost(
        ...
        return unwrapAsync(unionsNullableTypedObjectPost(this, request, options));
    }
    ...
    async oneOfOverlappingObjects(
        ...
        return unwrapAsync(unionsOneOfOverlappingObjects(this, request, options));
    }
    ...
    async primitiveTypeOneOfPost(
        ...
        return unwrapAsync(unionsPrimitiveTypeOneOfPost(this, request, options));
    }
    ...
    async stronglyTypedOneOfDiscriminatedPost(
        ...
        return unwrapAsync(unionsStronglyTypedOneOfDiscriminatedPost(this, request, options));
    }
    ...
    async stronglyTypedOneOfPost(
        ...
        return unwrapAsync(unionsStronglyTypedOneOfPost(this, request, options));
    }
    ...
    async stronglyTypedOneOfPostWithNonStandardDiscriminatorName(
        ...
        return unwrapAsync(
            unionsStronglyTypedOneOfPostWithNonStandardDiscriminatorName(this, request, options)
        );
    }
    ...
    async typedObjectNullableOneOfPost(
        ...
        return unwrapAsync(unionsTypedObjectNullableOneOfPost(this, request, options));
    }
    ...
    async typedObjectOneOfPost(
        ...
        return unwrapAsync(unionsTypedObjectOneOfPost(this, request, options));
    }
    ...
    async unionBigIntStrDecimal(
        ...
        return unwrapAsync(unionsUnionBigIntStrDecimal(this, request, options));
    }
    ...
    async unionDateNull(
        ...
        return unwrapAsync(unionsUnionDateNull(this, request, options));
    }
    ...
    async unionDateTimeBigInt(
        ...
        return unwrapAsync(unionsUnionDateTimeBigInt(this, request, options));
    }
    ...
    async unionDateTimeNull(
        ...
        return unwrapAsync(unionsUnionDateTimeNull(this, request, options));
    }
    ...
    async unionMap(
        ...
        return unwrapAsync(unionsUnionMap(this, request, options));
    }
    ...
    async unionNestedEnumsForm(
        ...
        return unwrapAsync(unionsUnionNestedEnumsForm(this, request, options));
    }
    ...
    async unionNestedEnumsMultipart(
        ...
        return unwrapAsync(unionsUnionNestedEnumsMultipart(this, request, options));
    }

    async unionOfArraysPost(
        request: Array<shared.UnionOfArrays>,
        options?: RequestOptions
    ): Promise<operations.UnionOfArraysPostRes> {
        return unwrapAsync(unionsUnionOfArraysPost(this, request, options));
    }
    ...
    async weaklyTypedOneOfNullEnumPost(
        ...
        return unwrapAsync(unionsWeaklyTypedOneOfNullEnumPost(this, request, options));
    }
    ...
    async weaklyTypedOneOfPost(
        ...
        return unwrapAsync(unionsWeaklyTypedOneOfPost(this, request, options));
    }
}
