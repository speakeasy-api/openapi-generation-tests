...
export class Unions {
    ...
    async stronglyTypedOneOfDiscriminatedPost(
        ...
        const operationUrl: string =
            baseURL.replace(/\/$/, "") + "/anything/stronglyTypedOneOfDiscriminated";
        ...
        const res: operations.StronglyTypedOneOfDiscriminatedPostResponse =
            new operations.StronglyTypedOneOfDiscriminatedPostResponse({
                statusCode: httpRes.status,
                contentType: responseContentType,
                rawResponse: httpRes,
            });
    ...
    async unionBigIntDecimal(
        ...
        const res: operations.UnionBigIntDecimalResponse =
            new operations.UnionBigIntDecimalResponse({
                statusCode: httpRes.status,
                contentType: responseContentType,
                rawResponse: httpRes,
            });
    ...
    async unionDateTimeBigInt(
        ...
        const res: operations.UnionDateTimeBigIntResponse =
            new operations.UnionDateTimeBigIntResponse({
                statusCode: httpRes.status,
                contentType: responseContentType,
                rawResponse: httpRes,
            });
