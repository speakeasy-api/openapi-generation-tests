...
import { unionsArrayOfDiscriminatedUnions } from "../funcs/unionsArrayOfDiscriminatedUnions.js";
import { unionsArrayOfDiscriminatedUnionsMap } from "../funcs/unionsArrayOfDiscriminatedUnionsMap.js";
...
import { unionsNestedArrayOfDiscriminatedUnions } from "../funcs/unionsNestedArrayOfDiscriminatedUnions.js";
...
export class Unions extends ClientSDK {
  async arrayOfDiscriminatedUnions(
    request: Array<shared.StronglyTypedOneOfObject>,
    options?: RequestOptions,
  ): Promise<operations.ArrayOfDiscriminatedUnionsRes> {
    return unwrapAsync(unionsArrayOfDiscriminatedUnions(
      this,
      request,
      options,
    ));
  ...
  async arrayOfDiscriminatedUnionsMap(
    request: shared.ArrayOfDiscriminatedUnionsMap,
    options?: RequestOptions,
  ): Promise<operations.ArrayOfDiscriminatedUnionsMapRes> {
    return unwrapAsync(unionsArrayOfDiscriminatedUnionsMap(
      this,
      request,
      options,
    ));
  ...
  async nestedArrayOfDiscriminatedUnions(
    request: shared.NestedArrayOfDiscriminatedUnions,
    options?: RequestOptions,
  ): Promise<operations.NestedArrayOfDiscriminatedUnionsRes> {
    return unwrapAsync(unionsNestedArrayOfDiscriminatedUnions(
      this,
      request,
      options,
    ));
